  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_GI_D_PREDIOS_CALCULO_DESTINO" ("ID_PRDIO_CLCLO_DSTNO", "CDGO_CLNTE", "NMBRE_CLNTE", "ID_IMPSTO", "NMBRE_IMPSTO", "ID_IMPSTO_SBMPSTO", "NMBRE_IMPSTO_SBMPSTO", "FCHA_INCIAL", "FCHA_FNAL", "CDGO_PRDIO_CLSFCCION", "DSCRPCION_PRDIO_CLSFCCION", "CDGO_DSTNO_IGAC", "NMBRE_DSTNO_IGAC", "INDCDOR_CLCLO_AREA", "DSCRPCION_INDCDOR_CLCLO_AREA", "ID_PRDIO_DSTNO", "CDGO_PRDIO_DSTNO", "DSCRPCION_PRDIO_DSTNO", "AREA_TRRNO_MNMA", "AREA_TRRNO_MXMA", "AREA_CNSCTRDA_MNMA", "AREA_CNSCTRDA_MXMA", "PRCNTJE_MNMO", "VLOR_PRCNTJE_MNMO", "PRCNTJE_MXMO", "VLOR_PRCNTJE_MXMO") AS
  select a.id_prdio_clclo_dstno
	...
	join df_s_destinos_igac 			f on a.cdgo_dstno_igac 		= f.cdgo_dstno_igac
	join df_i_predios_destino 			g on a.id_prdio_dstno 		= g.id_prdio_dstno
;
