  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_MC_G_EMBARGOS_RESOLUCION_V2" ("ID_EMBRGOS_CRTRA", "ID_EMBRGOS_RSLCION", "NMRO_ACTO", "FCHA_ACTO", "ID_ESTDOS_CRTRA", "CDGO_ESTDOS_CRTRA", "DSCRPCION_ESTADO_CRTRA", "IDNTFCCION", "VGNCIAS", "VLOR_EMBRGO", "IMPUESTO", "IDNTFCCION_RSPNSBLE", "NMBRE_RSPNSBLE") AS
  select a.id_embrgos_crtra,
       ...
       a.id_estdos_crtra,
       a.cdgo_estdos_crtra,
       a.dscrpcion_estado_crtra,trim(a.idntfccion) as idntfccion,a.vgncias,
       ...
       trim(d.idntfccion) as idntfccion_rspnsble, trim(d.nmbre_cmplto) as nmbre_rspnsble
