  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_GI_G_DECLARACIONES_ANTICIPO_APLICADOS" ("ID_DCLRCION", "ID_DCLRCION_VGNCIA_FRMLRIO", "CDGO_CLNTE", "ID_SJTO_IMPSTO", "ID_IMPSTO", "ID_IMPSTO_SBMPSTO", "VGNCIA", "ID_PRDO", "NMRO_CNSCTVO", "CDGO_DCLRCION_ESTDO", "VLOR_PAGO", "ID_DCLRCION_TPO_VGNCIA", "DSCRPCION", "INDCDOR_DCLRCION_FNAL", "CDGO_DCLRCN_TPO", "ID_DCLRCION_CRRCCION") AS
  select   a.id_dclrcion,
           ...
           d.cdgo_dclrcn_tpo,
           e.id_dclrcion as id_dclrcion_crrccion
    ...
    inner join gi_g_declaraciones_anticipo e on   e.id_dclrcion_rgstrda = a.id_dclrcion
    and e.aplcdo = 'S'
