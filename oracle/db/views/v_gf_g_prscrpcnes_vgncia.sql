  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_GF_G_PRSCRPCNES_VGNCIA" ("ID_PRSCRPCION_VGNCIA", "ID_PRSCRPCION_SJTO_IMPSTO", "ID_PRSCRPCION", "ID_SLCTUD", "ID_INSTNCIA_FLJO", "CDGO_CLNTE", "ID_IMPSTO", "NMBRE_IMPSTO", "ID_IMPSTO_SBMPSTO", "NMBRE_IMPSTO_SBMPSTO", "ID_SJTO_IMPSTO", "ID_SJTO", "IDNTFCCION", "VGNCIA", "ID_PRDO", "PRDO", "DSCRPCION_PRDO", "INDCDOR_APRBDO", "APLCDO", "CDGO_RSPSTA", "DSCRPCION_RSPSTA", "INDCDOR_MNJA_ORGEN", "ID_LQDCION") AS
