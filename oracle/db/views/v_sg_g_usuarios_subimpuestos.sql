  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_SG_G_USUARIOS_SUBIMPUESTOS" ("ID_USRIO_SBMPSTO", "ID_USRIO", "USER_NAME", "NMBRE_TRCRO", "IDNTFCCION", "ID_FNCNRIO", "ID_TRCRO", "ID_IMPSTO", "NMBRE_IMPSTO", "ID_IMPSTO_SBMPSTO", "NMBRE_IMPSTO_SBMPSTO", "ACTVO", "DSCRPCION_ACTVO") AS
