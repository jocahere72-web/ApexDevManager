  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "SI_I_PRSNAS_ACTVDAD_ECNMCA_IU"
	for insert or update on si_i_prsnas_actvdad_ecnmca
	compound trigger
...
/
ALTER TRIGGER "SI_I_PRSNAS_ACTVDAD_ECNMCA_IU" ENABLE;
