  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "SI_H_PRSNAS_ACTVDAD_ECNMCA_AD" for insert or update or delete on SI_H_PRSNAS_ACTVDAD_ECNMCA compound trigger
					...
					begin
						--if inserting then
							...
							insert into ad_g_audit_trail(
								...
								, proxy_user
								, proxy_userid)
							values(v_id_auditoria, 'SI_H_PRSNAS_ACTVDAD_ECNMCA', nvl(:new.ID_PRSNA_ACTVDAD_ECNMCA, :old.ID_PRSNA_ACTVDAD_ECNMCA),
								 v_tpo_oprcion,
								 v_json,
...
/
ALTER TRIGGER "SI_H_PRSNAS_ACTVDAD_ECNMCA_AD" ENABLE;
