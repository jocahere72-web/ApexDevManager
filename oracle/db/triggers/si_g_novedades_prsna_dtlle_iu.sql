  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "SI_G_NOVEDADES_PRSNA_DTLLE_IU"
	for insert or update on si_g_novedades_prsna_dtlle
	compound trigger
...
/
ALTER TRIGGER "SI_G_NOVEDADES_PRSNA_DTLLE_IU" ENABLE;
