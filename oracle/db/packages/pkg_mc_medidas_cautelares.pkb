  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_MC_MEDIDAS_CAUTELARES" as
  ...
  begin
    ...
    exception
      when no_data_found then
        o_cdgo_rspsta  := 10;
        o_mnsje_rspsta := '|MCT_PRCSMNTO_DSMBRGO CDGO: ' || o_cdgo_rspsta ||
    ...
    exception
      when others then
        o_cdgo_rspsta  := 50;
        o_mnsje_rspsta := '|MCT_PRCSMNTO_DSMBRGO CDGO: ' || o_cdgo_rspsta ||
                          'Error al calcualar el numero de registros ene le json: ' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
    ...
    if (v_nmro_rgstro_prcsar <= v_nmro_rslcion_mxmo_sncrno) then
      ...
      begin
        o_nmro_mdda_ctlar_lte := pkg_gn_generalidades.fnc_cl_consecutivo(p_cdgo_clnte,
                                                                         'LMC');
  ...
  begin
    ...
    exception
      when no_data_found then
        ...
        o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                          ' No se encontro el lote de medida cautelar (desmebargo): ';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
      ...
      when others then
        o_cdgo_rspsta  := 20;
        o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                          ' Error al consultar el lote de medidas cautelar (desembargo): ' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
    ...
    for i in 1 .. p_nmro_jobs loop
      if i = p_nmro_jobs then
        v_nmro_rgstro_x_job := t_mc_g_lotes_mdda_ctlar.nmro_rgstro_prcsar -
                               v_nmro_rgstro_ttal;
        ...
        v_nmro_rgstro_x_job := round(t_mc_g_lotes_mdda_ctlar.nmro_rgstro_prcsar /
                                     p_nmro_jobs);
        ...
        select json_arrayagg(json_object('ID_ER' value id_embrgos_rslcion,
          ...
          from (select *
                  from (select rownum nmro_rgstro,
                               ...
                               id_instncia_fljo,
                               id_fljo_trea
                          from json_table(t_mc_g_lotes_mdda_ctlar.json,
      ...
      -- Se crea el Job
      begin
        v_nmbre_job := 'IT_MC_DSMBRGO_LTE_' || p_id_mdda_ctlar_lte || '_' ||
        ...
        begin
          insert into mc_g_desembargos_dtlle_lte
            (cdgo_clnte,
             id_lte_mdda_ctlar,
             json_lte,
             incio_json,
          ...
          o_mnsje_rspsta := 'Se insertaron ' || sql%rowcount ||
                            ' registros en mc_g_desembargos_dtlle_lte. ' ||
                            v_id_dsmbrgo_dtlle_lte;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
        ...
        exception
          when others then
            o_cdgo_rspsta  := 40;
            o_mnsje_rspsta := '|MCT_PRCSMNTO_DSMBRGO CDGO: ' ||
                              o_cdgo_rspsta ||
                              ': Error al registrar el detalle del lote de la medida cautelar. ' ||
                              sqlerrm;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
        ...
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 2,
                                              argument_value    => p_id_mdda_ctlar_lte);
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 3,
                                              argument_value    => p_id_usrio);
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 4,
                                              argument_value    => v_json_job);
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 5,
                                              argument_value    => t_mc_g_lotes_mdda_ctlar.nmro_rgstro_prcsar);
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 6,
                                              argument_value    => null); --p_app_ssion);
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 7,
                                              argument_value    => t_mc_g_lotes_mdda_ctlar.dsmbrgo_tpo);
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 8,
                                              argument_value    => v_indcdor_prcsmnto);
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 9,
                                              argument_value    => v_id_dsmbrgo_dtlle_lte);

        -- OUT
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 10,
                                              argument_value    => v_id_mdda_ctlar_lte);
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
                                              argument_position => 11,
                                              argument_value    => v_nmro_mdda_ctlar_lte);
        dbms_scheduler.set_job_argument_value(job_name          => v_nmbre_job,
      ...
      o_mnsje_rspsta := 'Termina v_nmbre_job: ' || v_nmbre_job ||
                        to_char(systimestamp, 'DDMMYYYHHMI') || '_' ||
                        v_incio || '_' || v_fin;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
  ...
  begin
    ...
    o_mnsje_rspsta := 'p_cdgo_clnte - ' || p_cdgo_clnte ||
                      ...
                      'p_id_usrio - ' || p_id_usrio || 'p_app_ssion - ' ||
                      p_app_ssion || 'p_dsmbrgo_tpo - ' || p_dsmbrgo_tpo;
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
                          v_nl,
    ...
    --Se consulta el id del funcionario
    begin
      select id_fncnrio, nmbre_trcro
        into v_id_fncnrio, v_nmbre_trcro
        from v_sg_g_usuarios
       where id_usrio = p_id_usrio;
    ...
    if p_app_ssion is null then
      ...
      exception
        when others then
          o_cdgo_rspsta  := 10;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            ': Error al crear la sesscion.' || sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
    ...
    begin
      ...
      o_mnsje_rspsta := 'v_id_estdos_crtra: ' || v_id_estdos_crtra ||
    ...
    exception
      when no_data_found then
        o_cdgo_rspsta  := 20;
        o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                          ': No se encontraron los datos del estado de la cartera.' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
      ...
      when others then
        o_cdgo_rspsta  := 30;
        o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                          ': Error al consultar los datos del estado de la cartera.' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
      ...
      begin
        ...
        values
          (p_cdgo_clnte,
           ...
           p_dsmbrgo_tpo,
           p_json,
           p_nmro_rgstro_prcsar,
           'PEJ')
        returning id_lte_mdda_ctlar into o_id_mdda_ctlar_lte;

        v_id_mdda_ctlar_lte := o_id_mdda_ctlar_lte;
        o_mnsje_rspsta      := 'o_nmro_mdda_ctlar_lte: ' ||
                               o_nmro_mdda_ctlar_lte ||
                               ' o_id_mdda_ctlar_lte: ' ||
                               o_id_mdda_ctlar_lte;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
    ...
    for c_embrgos in (select a.id_embrgos_rslcion,
      ...
      begin
        insert into mc_g_desembargos_resolucion
          (cdgo_clnte,
           ...
           id_lte_mdda_ctlar)
        values
          (c_embrgos.cdgo_clnte,
           c_embrgos.id_tpos_embrgo,
           systimestamp,
           c_embrgos.id_csles_dsmbrgo,
           v_id_fncnrio,
           v_id_mdda_ctlar_lte)
      ...
      exception
        when others then
          o_cdgo_rspsta  := 70;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            ': No se pudo registrar la resolución de desembargo.' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      begin
        ...
        values
          (v_id_dsmbrgos_rslcion, c_embrgos.id_embrgos_crtra);
      ...
      o_mnsje_rspsta := 'c_embrgos.id_embrgos_crtra: ' ||
      ...
      begin
        ...
        o_mnsje_rspsta := 'v_id_acto: ' || v_id_acto || ' v_fcha: ' ||
      ...
      exception
        when others then
          o_cdgo_rspsta  := 110;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            ': No se pudo generar el acto de resolución de desembargo. ' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      exception
        when others then
          o_cdgo_rspsta  := 120;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            'Error al actualizar la información del acto a la resolución de desembargo. ' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      begin
        ...
        v_dcmnto_html := pkg_gn_generalidades.fnc_ge_dcmnto('{"id_embrgos_crtra":' ||
                                                            c_embrgos.id_embrgos_crtra ||
                                                            ',"id_dsmbrgos_rslcion":' ||
                                                            v_id_dsmbrgos_rslcion ||
                                                            ',"id_acto":' ||
      ...
      exception
        when others then
          o_cdgo_rspsta  := 150;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            ' Error al generar el blob de la resolucion de desembargo. ' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      o_mnsje_rspsta := 'FIN GENERACIÓN DEL ACTO DE RESOLUCIÓN DE DESEMBARGO ' ||
                        v_nmbre_up;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
      ...
      o_mnsje_rspsta := 'v_id_estdos_crtra : ' || v_id_estdos_crtra || ' ' ||
                        'id_embrgos_crtra: ' || c_embrgos.id_embrgos_crtra;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
      ...
      begin
        ...
        o_mnsje_rspsta := 'Se acualizaron ' || sql%rowcount ||
                          ' registros en mc_g_embargos_cartera.';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
      ...
      begin
        ...
        o_mnsje_rspsta := 'Se acualizaron ' || sql%rowcount ||
                          ' registros en wf_g_instancias_transicion.';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
      ...
      exception
        when others then
          o_cdgo_rspsta  := 170;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            ': No se pudo actualizar la transición de la medida cautelar.' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      exception
        when others then
          o_cdgo_rspsta  := 180;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            ': No se pudo generar la transición de la medida cautelar.' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      begin
        ...
        o_mnsje_rspsta := 'Se borraron ' || sql%rowcount ||
                          ' registros en mc_g_desembargos_poblacion.';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
      ...
      exception
        when others then
          o_cdgo_rspsta  := 190;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            ': No se pudo eliminar el candidato de la población.' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      if p_id_dsmbrgo_dtlle_lte is not null and v_count > 0 then
        ...
        exception
          when others then
            o_cdgo_rspsta  := 200;
            o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                              ': Error al actualizar el total de registros que han sido procesados por el Job. ' ||
                              sqlerrm;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
      ...
      if p_indcdor_prcsmnto = 'ULTMO' then
        ...
        exception
          when others then
            o_cdgo_rspsta  := 230;
            o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                              ': Error al consultar la información del tipo de acto de oficio por lote de desembargo. ' ||
  ...
  begin
    ...
    for c_rslcnes in (select a.id_rslcion_dsmbrgo, c.file_blob, c.file_name
                        from json_table(p_json,
                                        '$[*]'
                                        columns(id_rslcion_dsmbrgo number path
                                                '$.id_rslcion_dsmbrgo')) a
                        join mc_g_desembargos_resolucion b
                          on a.id_rslcion_dsmbrgo = b.id_dsmbrgos_rslcion
                        join v_gn_g_actos c
                          on b.id_acto = c.id_acto) loop
      ...
      begin
        ...
        o_mnsje_rspsta := 'Se agrego la Resolución ID: ' ||
                          c_rslcnes.id_rslcion_dsmbrgo || ' al zip';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
      ...
      exception
        when others then
          o_cdgo_rspsta  := 1;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            ': Error al agregar el blob de la resolución ' ||
                            c_rslcnes.id_rslcion_dsmbrgo || ' al zip ' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
    ...
    exception
      when others then
        o_cdgo_rspsta  := 2;
        o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                          ': Error al finalizar el zip. ' || sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
  ...
  procedure prc_gn_dsmbrgo_prptrio(p_cdgo_clnte   in number,
                                   p_json         in clob,
                                   p_id_usrio     in sg_g_usuarios.id_usrio%type,
                                   p_dsmbrgo_tpo  in varchar2,
                                   o_cdgo_rspsta  out number,
    ...
    v_id_fncnrio            number;
    v_nmbre_trcro           varchar2(1000);
    v_mnsje_rspsta          varchar2(70) := '|MCT_DSMBRGO_PROP ';
    v_count                 number := 0;
    v_id_dsmbrgos_rslcion   number;
    v_id_plntlla_rslcion    mc_d_tipos_mdda_ctlr_dcmnto.id_plntlla%type;
    v_id_rprte              gn_d_reportes.id_rprte%type;
    v_id_rprte_ofi          gn_d_reportes.id_rprte%type;
    v_cdgo_acto_tpo_rslcion gn_d_plantillas.id_acto_tpo%type;
    v_cdgo_cnsctvo          df_c_consecutivos.cdgo_cnsctvo%type;
    v_id_embrgos_rspnsble   varchar2(4000);
    v_id_embrgos_crtra      number;
    v_id_embrgos_rslcion    number;
    v_documento             clob;
    v_tpo_dsmbrgo           varchar2(1) := 'T';
    ...
    v_nmbre_up varchar2(70) := 'pkg_mc_medidas_cautelares.prc_gn_dsmbrgo_prptrio';
    ...
    TYPE t_id_tabla IS TABLE OF MC_G_EMBARGOS_RESPONSABLE.ID_EMBRGOS_RSPNSBLE%TYPE INDEX BY PLS_INTEGER;
    v_ids t_id_tabla;
  ...
  begin
    ...
    v_id_prcso_dsmbrgo := to_number(pkg_cb_proceso_persuasivo.fnc_cl_parametro_configuracion(p_cdgo_clnte     => p_cdgo_clnte,
                                                                                             p_cdgo_cnfgrcion => 'DPR'));
    -- Si n
    -- se selecciona el funcionario
    Begin
      select id_fncnrio, nmbre_trcro
        into v_id_fncnrio, v_nmbre_trcro
        from v_sg_g_usuarios
    ...
    exception
      ...
      when others then
        ...
        o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                          ...
                          sqlerrm;
        return;
    end; --Fin consulta del funcionario
    ...
    begin
      ...
      v_nmro_mdda_ctlar_lte := pkg_gn_generalidades.fnc_cl_consecutivo(p_cdgo_clnte,
                                                                       'LMC');
      ...
      values
        (p_cdgo_clnte,
         ...
         1,
         'PEJ')
      returning id_lte_mdda_ctlar into v_id_mdda_ctlar_lte;
    ...
    -- Se recorre el json con los embargos a desembargar(Siempre trae un solo registro)
    for c_embrgos in (select a.id_embrgos_rslcion,
                             a.id_embrgos_crtra,
                             a.cdgo_clnte,
                             a.cdgo_csal,
      ...
      v_id_embrgos_crtra   := c_embrgos.id_embrgos_crtra;
      v_id_embrgos_rslcion := c_embrgos.id_embrgos_rslcion;
      v_id_csles_dsmbrgo   := c_embrgos.id_csles_dsmbrgo;
      v_id_csles_dsmbrgo   := c_embrgos.id_csles_dsmbrgo;

      select v.id_tpos_embrgo
        into v_id_tpos_embrgo
        from v_mc_g_embargos_resolucion v
       where v.id_embrgos_rslcion = c_embrgos.id_embrgos_rslcion;

      if v_id_embrgos_rspnsble is null then
        v_id_embrgos_rspnsble := c_embrgos.id_embrgos_rspnsble;
      else
        v_id_embrgos_rspnsble := v_id_embrgos_rspnsble || ',' ||
                                 c_embrgos.id_embrgos_rspnsble;
      end if;

      o_mnsje_rspsta := 'v_count: ' || v_count ||
                        ' v_id_dsmbrgos_rslcion: ' || v_id_dsmbrgos_rslcion;

      v_ids(v_count) := c_embrgos.id_embrgos_rspnsble;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
    ...
    --Se consultan los datos de la plantilla de resolucion de desembargo
    begin
      o_mnsje_rspsta := 'id_tpos_embrgo ' || v_id_tpos_embrgo ||
                        ' id_csles_dsmbrgo  ' || v_id_csles_dsmbrgo ||
                        'v_id_prcso_dsmbrgo' || v_id_prcso_dsmbrgo;
      ...
      select a.id_acto_tpo, c.cdgo_cnsctvo, b.id_plntlla, a.id_rprte
        ...
        join mc_d_tipos_mdda_ctlr_dcmnto b
          on b.id_plntlla = a.id_plntlla
         and b.id_tpos_mdda_ctlar = v_id_tpos_embrgo
        join df_c_consecutivos c
          on c.id_cnsctvo = b.id_cnsctvo
    ...
    begin
      ...
      -- Se registra el acto de resolucion de desembargo

      o_mnsje_rspsta := 'p_cdgo_clnte -' || p_cdgo_clnte || ' p_id_usrio -' ||
                        p_id_usrio || ' v_id_embrgos_crtra - ' ||
                        v_id_embrgos_crtra || ' v_id_embrgos_rspnsble ' ||
                        v_id_embrgos_rspnsble || ' v_id_dsmbrgos_rslcion ' ||
                        v_id_dsmbrgos_rslcion || ' - v_cdgo_cnsctvo' ||
                        v_cdgo_cnsctvo || ' v_cdgo_acto_tpo_rslcion ' ||
                        v_cdgo_acto_tpo_rslcion ||
                        ' v_id_embrgos_rslcion -' || v_id_embrgos_rslcion;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
    ...
    exception
      when others then
        o_cdgo_rspsta  := 70;
        o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                          ': No se pudo registrar la resolucion de desembargo.' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
    ...
    begin
      pkg_cb_medidas_cautelares.prc_rg_acto_prop(p_cdgo_clnte          => p_cdgo_clnte,
                                                 p_id_usuario          => p_id_usrio,
                                                 ...
                                                 p_id_acto_tpo         => v_cdgo_acto_tpo_rslcion,
                                                 p_vlor_embrgo         => 1,
                                                 p_id_embrgos_rslcion  => v_id_embrgos_rslcion,
                                                 o_id_acto             => v_id_acto,
                                                 o_fcha                => v_fcha,
                                                 o_nmro_acto           => v_nmro_acto);

      o_mnsje_rspsta := v_id_acto || '-' || v_fcha || ' - ' || v_nmro_acto;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
      ...
      select json_object('id_embrgos_crtra' value v_id_embrgos_crtra,
                         'id_dsmbrgos_rslcion' value v_id_dsmbrgos_rslcion,
                         'v_id_acto' value v_id_acto)
        into v_data
        from dual;

      for c_responsables in (select a.cdgo_csal, a.id_embrgos_rspnsble
                               from json_table(p_json,
                                               '$[*]'
                                               columns(cdgo_csal varchar2 path
                                                       '$.CD_TD',
                                                       id_embrgos_rspnsble
                                                       number path '$.ID_RE')) a
                               join mc_d_causales_desembargo b
                                 on a.cdgo_csal = b.cdgo_csal
                                and b.cdgo_clnte = p_cdgo_clnte) loop

        update mc_g_embargos_responsable r
           set r.id_dsmbrgos_rslcion = v_id_dsmbrgos_rslcion,
               r.dsmbrgdo            = 'S'
         where r.id_embrgos_rspnsble = c_responsables.id_embrgos_rspnsble;

        o_mnsje_rspsta := ' update mc_g_embargos_responsable r  ' ||
                          v_id_dsmbrgos_rslcion || '-' || 'r.dsmbrgdo = S';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
      ...
      o_mnsje_rspsta := ' pkg_gn_generalidades.fnc_ge_dcmnto ' ||
                        v_id_embrgos_crtra || '-' || v_id_dsmbrgos_rslcion ||
                        ' - ' || v_id_acto || ' - ' || v_id_plntlla_rslcion;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
      ...
      o_mnsje_rspsta := ' update mc_g_desembargos_resolucion ' || v_id_acto || '-' ||
                        v_fcha || ' - ' || v_nmro_acto || ' - ' ||
                        v_id_plntlla_rslcion;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
      ...
      o_mnsje_rspsta := ' pkg_cb_medidas_cautelares.prc_rg_blob_acto_embargo  ' ||
                        v_id_acto || '-' || v_id_dsmbrgos_rslcion || ' - ' ||
                        v_id_rprte;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
    ...
    exception
      when others then
        o_cdgo_rspsta  := 110;
        o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                          ': No se pudo generar el acto de resolucion de desembargo. ' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
        ...
        rollback;
        return;
    end; -- Fin Se genera el acto de Resolucion
    ...
    begin
      ...
      begin
        ...
        select a.id_acto_tpo, c.cdgo_cnsctvo, b.id_plntlla, a.id_rprte
         ...
         inner join df_c_consecutivos c
            on c.id_cnsctvo = b.id_cnsctvo
         where NVL(b.id_csles_dsmbrgo, v_id_csles_dsmbrgo) =
               v_id_csles_dsmbrgo
           and a.actvo = 'S'
           and a.id_prcso = v_id_prcso_dsmbrgo
           and b.tpo_dcmnto = 'O'
      ...
      exception
        when others then
          o_cdgo_rspsta  := 110;
          o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                            ': No se encontró acto de oficio configurado para ' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      o_mnsje_rspsta := 'v_cdgo_acto_tpo_ofcio, v_cdgo_cnsctvo_oficio, v_id_plntlla_ofcio, v_id_rprte_ofi ' ||
      ...
      if v_tpo_dsmbrgo = 'T' then
        ...
        for oficios in (select b.id_slctd_ofcio, b.id_embrgos_rspnsble
          ...
          o_mnsje_rspsta := 'v_id_dsmbrgos_rslcion, oficios.id_slctd_ofcio, N ' ||
                            v_id_dsmbrgos_rslcion || ' - ' ||
                            oficios.id_slctd_ofcio ||
                            ' v_id_dsmbrgo_ofcio ' || v_id_dsmbrgo_ofcio;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
          ...
          begin
            ...
            pkg_cb_medidas_cautelares.prc_rg_acto(p_cdgo_clnte          => p_cdgo_clnte,
                                                  ...
                                                  p_vlor_embrgo         => 1,
                                                  p_id_embrgos_rslcion  => v_id_dsmbrgos_rslcion,
          ...
          o_mnsje_rspsta := 'pkg_cb_medidas_cautelares.prc_rg_acto ' ||
                            v_id_acto_ofi || ' - ' || v_fcha_ofi || ' - ' ||
                            v_nmro_acto_ofi;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
          ...
          o_mnsje_rspsta := '  update mc_g_desembargos_oficio  ' ||
                            v_id_acto_ofi || ' - ' || v_fcha_ofi || ' - ' ||
                            v_nmro_acto_ofi;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
          ...
          /* v_documento_ofi := pkg_gn_generalidades.fnc_ge_dcmnto('<id_embrgos_crtra>' ||
           ...
           o_mnsje_rspsta := 'pkg_gn_generalidades.fnc_ge_dcmnto '||v_id_embrgos_crtra||' - '||v_id_dsmbrgo_ofcio ||' - '||v_id_acto_ofi ||' - '||v_id_plntlla_ofcio||' v_documento_ofi ';
          ...
          begin
            select json_object('id_rprte' value v_id_rprte_ofi,
                               'cdgo_clnte' value p_cdgo_clnte,
                               'id_dsmbrgo_ofcio' value v_id_dsmbrgo_ofcio,
                               'id_slctd_ofcio' value oficios.id_slctd_ofcio,
                               'id_tpos_mdda_ctlar' value v_id_tpos_embrgo,
                               'id_dsmbrgos_rslcion' value
                               json_object('id_dsmbrgos_rslcion' value
                                           v_id_dsmbrgos_rslcion),
                               'vlor_cnfgrcion' value 'G')
              into v_data
              from dual;
          ...
          exception
            when others then
              o_cdgo_rspsta  := 160;
              o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                                ': No se genero el documento del oficio ' ||
                                sqlerrm;
              pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                    null,
                                    v_nmbre_up,
          ...
          o_mnsje_rspsta := ' pkg_cb_medidas_cautelares.prc_rg_blob_acto_embargo ' ||
                            v_id_acto_ofi || ' - ' || v_id_dsmbrgo_ofcio ||
                            ' - ' || v_id_rprte_ofi;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
        ...
        o_cdgo_rspsta  := 0;
        o_mnsje_rspsta := 'Proceso Ejecutado';
        commit;
      end if;
    exception
      when others then
        ...
        o_cdgo_rspsta  := 230;
        o_mnsje_rspsta := v_mnsje_rspsta || o_cdgo_rspsta ||
                          ': Error al consultar la informacion del tipo de acto de oficio por lote de desembargo. ' ||
                          o_mnsje_rspsta || ' - ' || sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
