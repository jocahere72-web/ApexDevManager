  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_SG_AUTENTICACION" is
...
-- FunciÃ³n que encripta  la clave de un usuario -
-- gti_seg_hash
...
-- FunciÃ³n para la sutenticaciÃ³n de un usuario
-- gti_seg_autenticar
