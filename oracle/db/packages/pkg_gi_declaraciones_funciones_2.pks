  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_GI_DECLARACIONES_FUNCIONES_2" as
  ...
  function fnc_ca_digito_verificacion(p_identificacion varchar2)
    ...
    --Funcion para generar un json con los valores de calculo interes y descuento de una declaración
  --FDCL170
