  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_WS_CONFECAMARAS" as
  ...
  */
  ...
  procedure prc_gn_novedades(p_cdgo_clnte        in number,
    ...
    v_id_dclrcns_esqma_trfa    gi_d_dclrcns_esqma_trfa.id_dclrcns_esqma_trfa%type;
  begin
        ...
        begin
          select id_dclrcns_esqma_trfa
           ...
           where c.cdgo_dclrcns_esqma_trfa = c_expdntes.cdgo_ciiu_1
             and extract(year from c.fcha_hsta) =
  ...
  */
  procedure prc_co_DatosPropietario(p_cdgo_clnte   in number,
    ...
    v_nl                  number;
    nmbre_up              varchar2(100) := 'pkg_ws_confecamaras.prc_co_DatosPropietario';
    v_id_cnfcmra_sjto_lte number;
    v_id_sesion           number;
  ...
  begin
    ...
    for c_expdntes in (select c.idntfccion_prptrio, b.id_cnfcmra_lte
      ...
      begin
        ...
        pkg_ws_confecamaras.prc_co_identificacion(p_cdgo_clnte   => p_cdgo_clnte,
                                                  p_id_impsto    => p_id_impsto,
                                                  p_id_prvdor    => p_id_prvdor,
