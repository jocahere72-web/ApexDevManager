  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_GF_AJUSTES" as
  /**---- DS ---**/
  ...
  procedure prc_rg_ajustes(p_cdgo_clnte              gf_g_ajustes.cdgo_clnte%type,
                           ...
                           p_ind_ajste_msvo varchar2 default 'N',
  ...
  begin
    ...
    if p_json is not null then
      ...
      exception
        when others then
          ...
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                ...
                                o_mnsje_rspsta || v_mnsje,
                                2);
          if (p_ind_ajste_msvo = 'S') then
            o_mnsje_rspsta := 'No se registró el ajuste ' || v_mnsje;
          end if;
          return;
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            1);
      if (p_ind_ajste_msvo = 'S') then
        o_mnsje_rspsta := 'Revise el Detalle del Ajuste: vigencia,periodo,concepto,valor capital,valor del ajuste';
      end if;
      return;
    end if;
      ...
      for c_ajste_dtlle in (select vgncia,
        ...
        exception
          ...
          when others then
            ...
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  ...
                                  1);
            if (p_ind_ajste_msvo = 'S') then
              o_mnsje_rspsta := 'El Valor del Ajuste no puede ser mayor que el saldo Capital o igual a Cero si el Ajuste Credito';
            end if;
            return;
        end;
        ...
        if (c_ajste_dtlle.ajste_dtlle_tpo = 'C') or
            ...
            exception
              when v_crtra_blqdda then
                ...
                pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                      ...
                                      1);
                if (p_ind_ajste_msvo = 'S') then
                  o_mnsje_rspsta := 'Cartera bloqueada';
                end if;
                return;
              when no_data_found then
                rollback;
          ...
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                ...
                                v_indcdor_mvmnto_blqdo || ' vigencia ' ||
                                c_ajste_dtlle.vgncia,
                                1);
          ...
          begin
            ...
            select b.id_mvmnto_dtlle
             ...
             where a.id_sjto_impsto = p_id_sjto_impsto
               ...
               and b.cdgo_mvmnto_orgn_dtlle <> 'RE'
               and (CASE
          ...
          exception
            when no_data_found then
              ...
              pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                    ...
                                    6);
              if (p_ind_ajste_msvo = 'S') then
                o_mnsje_rspsta := 'No se encontro detalle del movimiento el Detalle del Ajuste, verifique: vigencia,periodo,concepto,valor capital';
              end if;
              return;
            when others then
              o_cdgo_rspsta  := 80;
              ...
              pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                    ...
                                    6);
              if (p_ind_ajste_msvo = 'S') then
                o_mnsje_rspsta := 'Error al buscar detalle del movimiento para Detalle del Ajuste, verifique: vigencia,periodo,concepto,valor capital' ||
                                  v_mnsje;
              end if;
              return;
          end;
          ...
          exception
            when others then
              ...
              pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                    ...
                                    1);
              if (p_ind_ajste_msvo = 'S') then
                o_mnsje_rspsta := 'No se pudo registrar el deetalle del Ajuste(C)' ||
                                  v_mnsje;
              end if;
              return;
          end;
        ...
        exception
          ...
          when others then
            ...
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  ...
                                  1);
            if (p_ind_ajste_msvo = 'S') then
              o_mnsje_rspsta := 'No se pudo registrar el detalle del Ajuste(I)' ||
                                v_mnsje;
            end if;
            return;
        end;
          ...
          exception
            ...
            when others then
              ...
              pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                    ...
                                    1);
              if (p_ind_ajste_msvo = 'S') then
                o_mnsje_rspsta := ' No se pudo bloquear la cartera para este sujeto en la vigencia y periodo seleccionado' ||
                                  v_mnsje;
              end if;
              return;
          end;
    ...
    if (v_acum = 0 or v_acum is null) then
      ...
      if (p_ind_ajste_msvo = 'S') then
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              'p_ind_ajste_msvo = S',
                              1);
        o_mnsje_rspsta := 'Para la vigencia actual no se encontro cartera para el ajuste';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              'pkg_gf_ajustes.prc_rg_ajustes',
                              v_nl,
                              'o_mnsje_rspsta p_ind_ajste_msvo = S: ' ||
                              o_mnsje_rspsta,
                              1);
      end if;
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          'pkg_gf_ajustes.prc_rg_ajustes',
                          v_nl,
                          'Antes de prc_rg_propiedad_evento p_id_instncia_fljo: ' ||
                          p_id_instncia_fljo || ' - v_id_ajste: ' ||
                          v_id_ajste,
                          1);
    ...
    exception
      when others then
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              1);
        if (p_ind_ajste_msvo = 'S') then
          o_mnsje_rspsta := 'No se pudo registrar la propiedad del id del Ajuste del evento.' ||
                            v_mnsje;
        end if;
        return;
    end;
 ...
 procedure prc_ap_ajuste(p_xml          clob,
      ...
      for c_ajste_dtlle in (select a.id_ajste_dtlle,
        ...
        begin
          ...
          begin
            ...
            select distinct a.id_mvmnto_fncro,
                            a.cdgo_mvmnto_orgn,
                            a.cdgo_prdcdad
      ...
      if (o_cdgo_rspsta = 0) then
        ...
        begin
          ...
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                ...
                                'pkg_gf_ajustes.prc_ap_ajuste',
                                v_nl,
                                'Saliendo de prc_rg_finalizar_instancia: ' ||
                                v_mnsje,
                                1);
        exception
          when others then
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          p_id_instncia_fljo_pdre ||
                          ' - p_id_instncia_fljo:' || p_id_instncia_fljo ||
                          ' - v_id_instncia_fljo: ' || v_id_instncia_fljo ||
                          ' - v_id_fljo_trea: ' || v_id_fljo_trea,
                          6);
    ...
    begin
      pkg_gf_ajustes.prc_rg_ajustes(p_cdgo_clnte              => p_cdgo_clnte,
                                    ...
                                    p_ind_ajste_msvo          => p_ind_ajste_msvo,
    ...
    exception
      ...
      when others then
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              1);
        if p_ind_ajste_msvo = 'S' then
          o_mnsje_rspsta := v_mnsje_rspsta || '-' || SQLERRM;
        end if;
        return;
    end;
  ...
  end prc_co_documnto_sprte_ajustes;

  procedure prc_rg_ajustes_masivos(p_cdgo_clnte    number,
                                   p_id_usrio      number,
    ...
    v_nl               number;
    v_nmbre_up         varchar2(100) := 'pkg_gf_ajustes.prc_rg_ajustes_masivos';
    v_fcha_incio_prcso timestamp;
    v_fcha_fin_prcso   timestamp;
    v_id_ajs_crg_lte   number;

    v_filename varchar2(100);
    v_mymetype varchar2(100);
    v_blob     blob;
    ...
    v_sjtos_vldos        number := 0;
    v_nmro_ajstes_gnrar  number := 0;
    v_nmro_ajstes_gnrdos number := 0;
    ...
    v_cdgo_rspsta_aj     number;
    v_mnsje_rspsta_aj    varchar2(2000);
    v_ttal_intres_ajste  number;
  begin
    ...
    -- Registra lote sino existe
    begin
      select id_ajs_crg_lte
        into v_id_ajs_crg_lte
        from gf_g_ajustes_cargue_lote
       where id_ajs_crg_lte = p_id_prcso_crga;

      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
                            'Existe lote para: ' || p_id_prcso_crga,
                            3);
    ...
    exception
      when no_data_found then
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nmbre_up,
                              v_nl,
                              'Se crea lote para: ' || p_id_prcso_crga,
                              3);
        select count(1)
          into v_nmro_rgstros
        ...
        begin
          select c001 as nombre, c002 as filemymetype, blob001 as blobfile
            into v_filename, v_mymetype, v_blob
        ...
        exception
          when others then
            ...
            v_mnsje_rspsta := v_cdgo_rspsta ||
                              ' - No se pudo consultar la resolucion. Error: ' ||
                              sqlerrm;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
        ...
        begin
          insert into gf_g_ajustes_cargue_lote
            (id_ajs_crg_lte,
             id_impsto,
             id_impsto_sbmpsto,
             id_usrio,
          ...
          values
            (p_id_prcso_crga,
             ...
             v_filename,
             v_mymetype);
          commit; -- se asegura el lote
        exception
          when others then
            rollback;
            v_cdgo_rspsta  := 10;
            v_mnsje_rspsta := v_cdgo_rspsta ||
                              'No se pudo registrar el lote. Error: ' ||
                              sqlerrm;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
    ...
    -- Se actualizan los sujetos válidos en el sistema
    for c_sjto in (select idntfccion_sjto, id_impsto
                     from v_gf_g_ajustes_cargue
                    where id_prcso_crga = p_id_prcso_crga
                      and estdo != 'PROCESADO'
                      and id_sjto_impsto is null
                    group by idntfccion_sjto, id_impsto) loop
      -- Valida si el sujeto existe en el sistema
      begin
        select id_sjto_impsto
          into v_id_sjto_impsto
          from v_si_i_sujetos_impuesto
         where cdgo_clnte = p_cdgo_clnte
           and id_impsto = c_sjto.id_impsto
           and idntfccion_sjto = TO_CHAR(c_sjto.idntfccion_sjto);

        begin
          update gf_g_ajustes_cargue
             set id_sjto_impsto = v_id_sjto_impsto
           where id_prcso_crga = p_id_prcso_crga
             and idntfccion_sjto = c_sjto.idntfccion_sjto;
          commit;

          v_sjtos_vldos := v_sjtos_vldos + 1;
        exception
          when others then
            rollback;
            v_cdgo_rspsta  := 20;
            v_mnsje_rspsta := 'No se pudo actualizar sjto_impsto. Error: ' ||
                              sqlerrm;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
            ...
            update gf_g_ajustes_cargue
               set estdo           = 'ERROR',
                   obsrvcion_prcso = v_mnsje_rspsta,
                   nmro_intntos    = nvl(nmro_intntos, 0) + 1
             where id_prcso_crga = p_id_prcso_crga
               and idntfccion_sjto = c_sjto.idntfccion_sjto;
            commit;
        end;
      ...
      exception
        when no_data_found then
          rollback;
          v_cdgo_rspsta  := 30;
          v_mnsje_rspsta := 'Sujeto no existe en el sistema';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
          ...
          update gf_g_ajustes_cargue
             set estdo           = 'ERROR',
                 cdgo_estdo      = 'SNV' -- sujeto no válido
                ,
                 obsrvcion_prcso = v_mnsje_rspsta,
                 nmro_intntos    = nvl(nmro_intntos, 0) + 1
           where id_prcso_crga = p_id_prcso_crga
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          v_nmbre_up,
                          v_nl,
                          'v_sjtos_vldos: ' || v_sjtos_vldos,
                          1);

    select count(1)
      into v_nmro_ajstes_gnrar
      from (select id_sjto_impsto, cdgo_ajste_mtvo
              from gf_g_ajustes_cargue
             where id_prcso_crga = p_id_prcso_crga
               and id_sjto_impsto is not null
             group by id_sjto_impsto, cdgo_ajste_mtvo);

    -- Se actualiza el total de sujetos válidos
    update gf_g_ajustes_cargue_lote
       set nmro_sjtos_vldos  = v_sjtos_vldos,
           nmro_ajstes_gnrar = v_nmro_ajstes_gnrar
     where id_ajs_crg_lte = p_id_prcso_crga;

    -- Busca duplicados
    for dplcdo in (select id_ajste_crgue
                     from (select id_ajste_crgue,
                                  idntfccion_sjto,
                                  vgncia,
                                  prdo,
                                  cdgo_cncpto,
                                  ...
                                  case
                                    when (row_number()
                                          over(partition by idntfccion_sjto,
                                               vgncia,
                                               prdo,
                                               cdgo_cncpto,
                                               cdgo_ajste_mtvo order by
                                               idntfccion_sjto)) > 1 then
                                     'S'
                                    else
                                     'N'
                                  end dplcdo,
                                  row_number() over (partition by idntfccion_sjto, vgncia, prdo, cdgo_cncpto, cdgo_ajste_mtvo order by idntfccion_sjto) FILA
                             from gf_g_ajustes_cargue
                            where id_prcso_crga = p_id_prcso_crga
                            order by idntfccion_sjto)
                    where dplcdo = 'S') loop
      begin
        update gf_g_ajustes_cargue
           set estdo           = 'ERROR',
               cdgo_estdo      = 'DPC' -- Duplicado
              ,
               obsrvcion_prcso = 'Sujeto Duplicado'
         where id_ajste_crgue = dplcdo.id_ajste_crgue;
        commit;
      exception
        when others then
          rollback;
          v_cdgo_rspsta  := 30;
          v_mnsje_rspsta := 'No se pudo marcar el registro duplicado';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
    ...
    -- Se recorre por sujeto y motivo para generarlos ajustes
    for c_dtos in (select distinct id_sjto_impsto,
                                   id_impsto,
                                   id_impsto_sbmpsto,
                                   id_ajste_mtvo,
                                   tpo_ajste,
                    ...
                    where id_prcso_crga = p_id_prcso_crga
                      and estdo != 'PROCESADO'
                      and id_sjto_impsto is not null
                    order by id_sjto_impsto, id_ajste_mtvo, tpo_ajste) loop
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
                            'Inicia ajuste sujeto: ' ||
                            c_dtos.id_sjto_impsto || ' - Motivo: ' ||
                            c_dtos.id_ajste_mtvo || ' - Tipo: ' ||
                            c_dtos.tpo_ajste,
                            1);

      --se inicializa el array de json
      v_json_array := json_array_t();

      --se recorrren los saldos capitales de cada concepto a ajustar
      for c_sldo_cncpto in (select a.vgncia,
                                   a.id_prdo,
                                   a.id_cncpto,
                                   a.vlor_sldo_cptal,
                                   a.vlor_intres,
                                   ...
                                   b.id_ajste_crgue
                              from v_gf_g_cartera_x_concepto a
                              join v_gf_g_ajustes_cargue b
                                on a.id_sjto_impsto = b.id_sjto_impsto
                             where a.id_sjto_impsto = c_dtos.id_sjto_impsto
                               and a.vgncia = b.vgncia
                               and a.prdo = b.prdo
                               and a.cdgo_cncpto = b.cdgo_cncpto
                               and b.id_prcso_crga = p_id_prcso_crga
                               and b.id_ajste_mtvo = c_dtos.id_ajste_mtvo
                               and b.tpo_ajste = c_dtos.tpo_ajste
                               and b.estdo != 'ERROR') loop
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
                              'Concepto: ' || c_sldo_cncpto.id_cncpto ||
                              ' - valor: ' || c_sldo_cncpto.vlor_ajste,
                              1);

        if (c_dtos.tpo_ajste = 'CR' and
           c_sldo_cncpto.vlor_sldo_cptal < c_sldo_cncpto.vlor_ajste) then

          update gf_g_ajustes_cargue
             set estdo           = 'ERROR',
                 cdgo_estdo      = 'SVC' -- Sin saldo valor capital
                ,
                 obsrvcion_prcso = 'Sujeto con Saldo capital menor al valor ajuste(CR)',
                 nmro_intntos    = nvl(nmro_intntos, 0) + 1
           where id_ajste_crgue = c_sldo_cncpto.id_ajste_crgue;
          commit;
          ...
          v_json := json_object_t();
          v_json.put('VGNCIA', c_sldo_cncpto.vgncia);
          v_json.put('ID_PRDO', c_sldo_cncpto.id_prdo);
          v_json.put('ID_CNCPTO', c_sldo_cncpto.id_cncpto); -- cada concepto a ajustar
          v_json.put('VLOR_SLDO_CPTAL', c_sldo_cncpto.vlor_sldo_cptal); --- saldo capital pero de cada concepto
          v_json.put('VLOR_INTRES', 0);
          v_json.put('VLOR_INTRES_CPTAL', c_sldo_cncpto.vlor_intres);
          v_json.put('VLOR_AJSTE', c_sldo_cncpto.vlor_ajste);
          v_json.put('AJSTE_DTLLE_TPO', 'C'); -- Capital
          v_json.put('ID_ORGEN', c_sldo_cncpto.id_orgen);
          v_json_array.append(v_json);
        end if;

      end loop;
      v_json_ajste := v_json_array.to_clob();

      begin
        pkg_gf_ajustes.prc_ap_ajuste_automatico(p_cdgo_clnte        => p_cdgo_clnte,
                                                p_id_impsto         => c_dtos.id_impsto,
                                                p_id_impsto_sbmpsto => c_dtos.id_impsto_sbmpsto,
                                                p_id_sjto_impsto    => c_dtos.id_sjto_impsto,
                                                p_tpo_ajste         => c_dtos.tpo_ajste -- CR(CREDITO), DB(DEBITO)
                                               ,
                                                p_id_ajste_mtvo     => c_dtos.id_ajste_mtvo,
                                                p_obsrvcion         => c_dtos.obsrvcion_ajste,
                                                p_tpo_dcmnto_sprte  => 'Resolución',
                                                p_nmro_dcmto_sprte  => null,
                                                p_fcha_dcmnto_sprte => systimestamp,
                                                p_nmro_slctud       => null -- NUMERO DE LA SOLICITUD POR LA CUAL SE GENERA EL AJUSTE.
                                               ,
                                                p_id_usrio          => p_id_usrio,
                                                p_json              => v_json_ajste,
                                                p_ind_ajste_prcso   => 'C',
                                               ...
                                               ,
                                                p_id_impsto_acto    => null,
                                                p_ind_ajste_msvo    => 'S',
                                                o_id_ajste          => v_id_ajste,
                                                o_cdgo_rspsta       => v_cdgo_rspsta_aj,
                                                o_mnsje_rspsta      => v_mnsje_rspsta_aj);

        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
                              'v_cdgo_rspsta_aj: ' || v_cdgo_rspsta_aj,
                              1);
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
                              substr('v_mnsje_rspsta_aj: ' ||
                                     v_mnsje_rspsta_aj,
                                     1,
                                     3500),
                              1);

        if v_cdgo_rspsta_aj > 0 then
          rollback;
          v_cdgo_rspsta  := 40;
          v_mnsje_rspsta := v_mnsje_rspsta_aj;

          update gf_g_ajustes_cargue
             set estdo           = 'ERROR',
                 cdgo_estdo      = 'SAJ' -- Sin ajuste
                ,
                 obsrvcion_prcso = v_mnsje_rspsta_aj,
                 nmro_intntos    = nvl(nmro_intntos, 0) + 1
           where id_prcso_crga = p_id_prcso_crga
             and id_sjto_impsto = c_dtos.id_sjto_impsto
             and cdgo_ajste_mtvo = c_dtos.cdgo_ajste_mtvo
             and estdo != 'ERROR';
          commit;
        else

          -- Se guardan los intereses ajustados
          begin
            for c_intres in (select a.id_ajste,
                                    b.tpo_ajste,
                                    c.vlor_intres,
                                    a.vgncia,
                                    a.id_prdo,
                              ...
                              where a.id_ajste = v_id_ajste
                                ...
                                and c.id_cncpto = a.id_cncpto) loop
              update gf_g_ajuste_detalle
                 set intres_ajste_mrtrio = nvl(abs(intres_cptal_mrtrio -
                                                   c_intres.vlor_intres),
                                               0)
               where id_ajste = c_intres.id_ajste
                 and vgncia = c_intres.vgncia
                 and id_prdo = c_intres.id_prdo
                 and id_cncpto = c_intres.id_cncpto;
            end loop;
            commit;

            select sum(intres_ajste_mrtrio)
              into v_ttal_intres_ajste
              from gf_g_ajuste_detalle
             where id_ajste = v_id_ajste;

            update gf_g_ajustes
               set vlor_intres = v_ttal_intres_ajste
             where id_ajste = v_id_ajste;
            commit;
            ...
            when others then
              ...
              update gf_g_ajustes_cargue
                 set estdo           = 'ERROR',
                     cdgo_estdo      = 'SAJ' -- Sin ajuste
                    ,
                     obsrvcion_prcso = 'No se pudo actualiar el interés ajustado',
                     nmro_intntos    = nvl(nmro_intntos, 0) + 1
               where id_prcso_crga = p_id_prcso_crga
                 and id_sjto_impsto = c_dtos.id_sjto_impsto
                 and cdgo_ajste_mtvo = c_dtos.cdgo_ajste_mtvo
          ...
          update gf_g_ajustes_cargue
             set estdo           = 'PROCESADO',
                 cdgo_estdo      = 'PRC',
                 obsrvcion_prcso = 'Sujeto con ajustes',
                 id_ajste        = v_id_ajste,
                 nmro_intntos    = nvl(nmro_intntos, 0) + 1
           where id_prcso_crga = p_id_prcso_crga
             and id_sjto_impsto = c_dtos.id_sjto_impsto
          ...
          -- cada 50 ajsutes, actualiza lote
          v_nmro_ajstes_gnrdos := v_nmro_ajstes_gnrdos + 1;
          if (v_nmro_ajstes_gnrdos = 50) then

            select count(distinct id_ajste)
              into v_nmro_ajstes_gnrdos
              from gf_g_ajustes_cargue
             where id_prcso_crga = p_id_prcso_crga
               and id_ajste is not null;

            update gf_g_ajustes_cargue_lote
               set nmro_ajstes_gnrdos = v_nmro_ajstes_gnrdos
             where id_ajs_crg_lte = p_id_prcso_crga;
            commit;
            v_nmro_ajstes_gnrdos := 0;
          end if;
      ...
      exception
        when others then
          rollback;
          v_cdgo_rspsta  := 50;
          v_mnsje_rspsta := 'Sin ajuste. ' || sqlerrm;
    ...
    update gf_g_ajustes_cargue_lote
       set nmro_ajstes_gnrdos = v_nmro_ajstes_gnrdos,
           fcha_fin_prcso     = systimestamp,
           cdgo_lte_estdo     = 'PRC'
     where id_ajs_crg_lte = p_id_prcso_crga;
    commit;

    delete from gn_g_temporal a where id_ssion = p_id_ssion;
    commit;

    -- validar
    update et_g_procesos_carga a
       set a.indcdor_prcsdo = 'S'
     where id_prcso_crga = p_id_prcso_crga;
    commit;
  ...
  exception
    when others then
      v_cdgo_rspsta  := 100;
      v_mnsje_rspsta := 'Error controlado: ' || sqlerrm;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
