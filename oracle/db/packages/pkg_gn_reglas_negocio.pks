  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_GN_REGLAS_NEGOCIO" as
  ...
  function fnc_vl_exncion_prdio_actlzdo(p_xml clob) return varchar2;

  function fnc_vl_exncion_cmbio_trfa(p_xml clob) return varchar2;
  ...
  function fnc_vl_descuento_formalizacion_ica(p_xml clob) return varchar2;
