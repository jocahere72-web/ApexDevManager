  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_CB_PROCESO_JURIDICO" as
  ...
  begin
    ...
    for movimientos in (select sujeto_impsto,
      ...
      v_xml := v_xml || '"P_ID_SJTO_IMPSTO":"' || movimientos.sujeto_impsto || '",';
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_nmbre_up,
                            v_nl,
                            'ALC  v_determinacion1  - ' || v_determinacion,
                            1);
    END LOOP;
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(23001,
                          ...
                          v_nmbre_up,
                          6,
                          'ALC  v_id_fncnrio  - ' || v_id_fncnrio,
                          1);
    pkg_sg_log.prc_rg_log(23001,
                          null,
                          v_nmbre_up,
                          6,
                          'ALC  p_json_procesos  - ' || p_json_procesos,
                          1);
    ...
    for procesos in (select id_prcsos_jrdco,
      ...
      if dbms_lob.compare(v_documento, empty_clob()) != 0 then
        ...
        pkg_sg_log.prc_rg_log(23001,
                              ...
                              v_nmbre_up,
                              6,
                              'ALC  v_plntllas_prcso_jrdco_dcmnto  - ' ||
                              v_plntllas_prcso_jrdco_dcmnto,
                              1);
        pkg_sg_log.prc_rg_log(23001,
                              null,
                              v_nmbre_up,
                              6,
                              'ALC  p_id_plntlla  - ' || p_id_plntlla,
                              1);
        pkg_sg_log.prc_rg_log(23001,
                              null,
                              v_nmbre_up,
      ...
      pkg_sg_log.prc_rg_log(23001,
                            ...
                            v_nmbre_up,
                            6,
                            'ALC  v_indcdor_procsar_estdo  - ' ||
                            v_indcdor_procsar_estdo,
                            1);
  ...
  procedure prc_rg_fnlzcion_prcso_jrdco(p_id_plntlla    gn_d_plantillas.id_plntlla%type,
    ...
    v_page_id number := nvl(v('APP_PAGE_ID'), 21);

    v_type       varchar2(1);
    v_error      varchar2(4000);
    v_count_save number := 0;
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          v_nmbre_up,
                          v_nl,
                          'p_json_procesos ' || p_json_procesos,
                          6);
    --pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'p_id_usuario '||p_id_usuario,6);
    ...
    exception
      when others then
        v_mnsje := 'Error al consultar v_id_prcso_jrdco_fncnrio : ' ||
    ...
    for procesos in (select id_prcsos_jrdco,
      ...
      exception
        when others then
          v_mnsje := 'Error al consultar v_id_fljo_trea : ' ||
                     v_id_fljo_trea;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      exception
        when others then
          v_mnsje := 'Error al consultar v_id_acto_tpo : ' || v_id_acto_tpo;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
      ...
      --Validamos que no exista documento 03/09/2025
      begin
        select id_prcsos_jrdco_dcmnto, id_acto
          into v_id_prcsos_jrdco_dcmnto, v_id_acto
          from cb_g_procesos_jrdco_dcmnto
         where id_prcsos_jrdco = procesos.id_prcsos_jrdco
           and id_acto_tpo = v_id_acto_tpo;
      exception
        when others then
          v_id_prcsos_jrdco_dcmnto := null;
          v_id_acto                := null;
      end;

      --pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'v_id_prcsos_jrdco_dcmnto :'||v_id_prcsos_jrdco_dcmnto,6);
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
      ...
      if v_id_prcsos_jrdco_dcmnto is null then
        --03/09/2025
      ...
      --validamos si existe documento plantilla
      begin
        select count(id_prcsos_jrdco_dcmnto)
          into v_exste_dcmnto
          from cb_g_prcsos_jrdc_dcmnt_plnt
         where id_prcsos_jrdco_dcmnto = v_id_prcsos_jrdco_dcmnto
           and dcmnto is not null;
      exception
        when others then
          v_exste_dcmnto := 0;
      end;
      ...
      if v_exste_dcmnto = 0 then
        ...
        exception
          when others then
            v_mnsje := 'Error al consultar el tipo de acto :' ||
                       v_id_acto_tpo;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
        ...
        /*pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'v_cdgo_acto_tpo: ' || v_cdgo_acto_tpo,1);
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'v_id_prcsos_jrdco_dcmnto: ' ||v_id_prcsos_jrdco_dcmnto,1);
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'v_id_acto_tpo: ' || v_id_acto_tpo,1);
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'v_cdgo_acto_tpo: ' || v_cdgo_acto_tpo,1);
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'p_id_usuario: ' || p_id_usuario,1);
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'v_slct_sjto_impsto: ' || v_slct_sjto_impsto,1);
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'v_slct_vgncias: ' || v_slct_vgncias,1);
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,'v_slct_rspnsble: ' || v_slct_rspnsble,1);*/
        ...
        exception
          when others then
            v_mnsje := 'Error al consultar la información del acto : ' ||
                       v_id_acto;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
      ...
      begin
        ...
        -- consultamos el id fel reporte a generar
        begin
        ...
        exception
          when others then
            v_mnsje := 'Error al consultar v_id_rprte :' || v_id_rprte;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
                                  v_nl,
        ...
        --consultamos la información del reporte para posteriormente generar el documento
        begin
          select r.*
        ...
        exception
          when others then
            v_mnsje := 'Error al consultar informacion del reporte v_id_rprte :' ||
                       v_id_rprte;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
        ...
        if v_blob is not null and v_id_acto is not null then
          begin
            pkg_cb_proceso_juridico.prc_ac_acto(p_file_blob => v_blob,
                                                p_id_acto   => v_id_acto);
          exception
            when others then
              v_mnsje := 'Error al actualizar el acto ';
              pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                    null,
                                    v_nmbre_up,
                                    v_nl,
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_nmbre_up,
                            v_nl,
                            'Inicia transición v_id_fljo_trea: ' ||
                            v_id_fljo_trea,
                            6);
      ...
      exception
        when others then
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                ...
                                v_nmbre_up,
                                v_nl,
                                'Error al finalizar el flujo : ' || v_o_msg ||
                                ' - ' || v_o_error,
                                6);
          --raise_application_error(-20001, v_cdgo_rspsta || '-' || v_o_msg);
      end;
      v_count_save := v_count_save + 1;
      if v_count_save = 100 then
        commit;
      end if;
    end loop;
    /*v_mnsje := 'proceso finalizado con exito';
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,null,v_nmbre_up,v_nl,v_mnsje,6);
  ...
  end prc_rg_fnlzcion_prcso_jrdco;
  ...
  begin
    ...
    begin
      select count(*)
        ...
        join v_gf_g_cartera_x_concepto a
      ...
      pkg_sg_log.prc_rg_log(23001,
                            null,
                            'pkg_cb_proceso_juridico.fnc_vl_prcso_jrdco_dtrmncion',
                            6,
                            'ALC  v_count_deter  - ' || v_count_deter,
                            1);
      pkg_sg_log.prc_rg_log(23001,
                            null,
                            'pkg_cb_proceso_juridico.fnc_vl_prcso_jrdco_dtrmncion',
  ...
  function fnc_gn_tabla_vigencias_concepto(p_id_prcsos_jrdco_dcmnto number)
    return clob as
    v_select clob;
  begin
    ...
    <tr>
      ...
      <th style="text-align:center;"><font size=1>CONCEPTO</font></th>
      <th style="text-align:center;"><font size=1>CAPITAL</font></th>
      <th style="text-align:center;"><font size=1>INTERÉS</font></th>
      <th style="text-align:center;"><font size=1>TOTAL</font></th>
    </tr>';

    for c_detalle in (select a.vgncia,
                             a.concepto,
                             sum(a.vlor_cptal) as capital,
                             sum(a.vlor_intres) as interes,
                             sum(a.vlor_cptal + a.vlor_intres) as total
                        from v_CB_G_PRCSOS_JRDC_DCMNT_MVNT a
                       where a.id_prcsos_jrdco_dcmnto =
                             p_id_prcsos_jrdco_dcmnto
                       group by a.vgncia, a.concepto
                       order by a.vgncia, a.concepto) loop
      v_select := v_select || '<tr>';
      v_select := v_select ||
                  '<td style="text-align:center;"><font size=1>' ||
                  c_detalle.vgncia || '</font></td>';
      v_select := v_select || '<td style="text-align:left;"><font size=1>' ||
                  c_detalle.concepto || '</font></td>';
      v_select := v_select || '<td style="text-align:right;"><font size=1>' ||
                  to_char(c_detalle.capital, 'FM$999G999G990') ||
                  '</font></td>';
      v_select := v_select || '<td style="text-align:right;"><font size=1>' ||
                  to_char(c_detalle.interes, 'FM$999G999G990') ||
                  '</font></td>';
      v_select := v_select || '<td style="text-align:right;"><font size=1>' ||
                  to_char(c_detalle.total, 'FM$999G999G990') ||
                  '</font></td>';
      v_select := v_select || '</tr>';
    end loop;
  ...
  exception
    when others then
      pkg_sg_log.prc_rg_log(23001,
                            ...
                            'Error: ' || sqlerrm,
                            6);
  end fnc_gn_tabla_vigencias_concepto;
  ...
  function fnc_gn_tabla_declaraciones(p_id_prcsos_jrdco_dcmnto number)
    return clob as
    v_select clob;
  begin
    ...
    v_select := '<table width="100%" align="center" border="1px"  style="border-collapse: collapse; font-family: Arial">';
    v_select := v_select || '<tr>
                             <th style="text-align:center; width:20%;" colspan="1"><FONT SIZE=1>NÚMERO CONSECUTIVO</font></th>
                             <th style="text-align:center; width:20%;" colspan="1"><FONT SIZE=1>FECHA PRESENTACIÓN</font></th>
                             <th style="text-align:center; width:10%;" colspan="1"><FONT SIZE=1>VIGENCIA</font></th>
                             <th style="text-align:center; width:35%;" colspan="1"><FONT SIZE=1>CONCEPTO</font></th>
                             <th style="text-align:center; width:15%;" colspan="1"><FONT SIZE=1>VALOR</font></th>
                            </tr>';

    for c_declaracion in (select d.nmro_cnsctvo,
                                 d.fcha_prsntcion,
                                 d.vgncia,
                                 sum(c.vlor_cptal + c.vlor_intres) vlor_ttal
                            from CB_G_PRCSOS_JRDC_DCMNT_MVNT c
                            join gi_g_declaraciones d
                              on d.id_dclrcion = c.id_orgen
                             and d.id_sjto_impsto = c.id_sjto_impsto
                           where c.id_prcsos_jrdco_dcmnto =
                                 p_id_prcsos_jrdco_dcmnto
      ...
      v_select := v_select ||
                  '<td style="text-align:center;"><FONT SIZE=1>' ||
                  c_declaracion.nmro_cnsctvo || '</font></td>';
      v_select := v_select ||
                  '<td style="text-align:center;"><FONT SIZE=1>' ||
                  to_char(c_declaracion.fcha_prsntcion, 'DD/MM/YYYY') ||
                  '</font></td>';
      v_select := v_select ||
                  '<td style="text-align:center;"><FONT SIZE=1>' ||
                  c_declaracion.vgncia || '</font></td>';
      v_select := v_select ||
                  '<td style="text-align:center;"><FONT SIZE=1>IMPUESTO DE INDUSTRIA Y COMERCIO</font></td>';
      v_select := v_select ||
                  '<td style="text-align:center;"><FONT SIZE=1>' ||
                  trim(to_char(c_declaracion.vlor_ttal,
  ...
  exception
    when others then
      pkg_sg_log.prc_rg_log(23001,
                            null,
                            'pkg_cb_proceso_juridico.fnc_gn_tabla_declaraciones',
                            6,
                            'Error: ' || sqlerrm,
                            6);

  end fnc_gn_tabla_declaraciones;

  function fnc_gn_tabla_aforos(p_id_prcsos_jrdco_dcmnto number) return clob as
    v_select clob;
  begin

    v_select := '<table width="100%" align="center" border="1px"  style="border-collapse: collapse; font-family: Arial">';
    v_select := v_select || '<tr>
                             <th align="center" valign="middle" width="13%" colspan="1"><FONT SIZE=1>LIQUIDACION<br>DE AFORO</font></th>
                             <th align="center" valign="middle" width="12%" colspan="1"><FONT SIZE=1>FECHA</font></th>
                             <th align="center" valign="middle" width="12%" colspan="1"><FONT SIZE=1>VIGENCIA</font></th>
                             <th align="center" valign="middle" width="21%" colspan="1"><FONT SIZE=1>INDUSTRIA Y COMERCIO Y COMPLEMENTARIOS</font></th>
                             <th align="center" valign="middle" width="21%" colspan="1"><FONT SIZE=1>SANCION</font></th>
                             <th align="center" valign="middle" width="21%" colspan="1"><FONT SIZE=1>TOTAL</font></th>
                            </tr>';

    for c_aforo in (select e.nmro_acto,
                           e.fcha_acto,
                           e.vgncia,
                           sum(e.cptal) cptal,
                           sum(e.intres) intres,
                           sum(e.sncion) sncion,
                           Sum(e.cptal + e.intres + e.sncion) ttal
                      from (select c.nmro_acto,
                                   trunc(c.fcha) fcha_acto,
                                   a.vgncia,
                                   decode(b.sncion, 'S', 0, sum(a.vlor_cptal)) cptal,
                                   decode(b.sncion,
                                          'S',
                                          0,
                                          sum(a.vlor_intres)) intres,
                                   decode(b.sncion, 'S', sum(a.vlor_cptal), 0) sncion
                              from CB_G_PRCSOS_JRDC_DCMNT_MVNT a
                              join df_i_conceptos b
                                on b.id_cncpto = a.id_cncpto
                              join v_gn_g_actos_sujeto_impuesto c
                                on c.id_sjto_impsto = a.id_sjto_impsto
                               and c.id_acto_tpo = 133
                             where a.id_prcsos_jrdco_dcmnto =
                                   p_id_prcsos_jrdco_dcmnto
                               and exists
                             (select 1
                                      from gn_g_actos_vigencia d
                                     where d.id_acto = c.id_acto
                                       and d.id_sjto_impsto = a.Id_Sjto_Impsto
                                       and d.vgncia = a.vgncia
                                       and d.id_prdo = a.id_prdo)
                             group by c.nmro_acto, c.fcha, a.vgncia, b.sncion) e
                     group by e.nmro_acto, e.fcha_acto, e.vgncia
                     order by e.vgncia) loop

      v_select := v_select || '<tr>';
      v_select := v_select ||
                  '<td style="text-align:center;"><FONT SIZE=1>' ||
                  c_aforo.nmro_acto || '</font></td>';
      v_select := v_select ||
                  '<td style="text-align:center;"><FONT SIZE=1>' ||
                  to_char(c_aforo.fcha_acto, 'DD/MM/YYYY') ||
                  '</font></td>';
      v_select := v_select ||
                  '<td style="text-align:center;"><FONT SIZE=1>' ||
                  c_aforo.vgncia || '</font></td>';
      v_select := v_select ||
                  '<td style="text-align:right;padding-right: 2px;"><FONT SIZE=1>' ||
                  trim(to_char(c_aforo.cptal,
                               'FM$999G999G999G999G999G999G990')) ||
                  '</font></td>';
      v_select := v_select ||
                  '<td style="text-align:right;padding-right: 2px;"><FONT SIZE=1>' ||
                  trim(to_char(c_aforo.sncion,
                               'FM$999G999G999G999G999G999G990')) ||
                  '</font></td>';
      v_select := v_select ||
                  '<td style="text-align:right;padding-right: 2px;"><FONT SIZE=1>' ||
                  trim(to_char(c_aforo.ttal,
                               'FM$999G999G999G999G999G999G990')) ||
                  '</font></td>';
      v_select := v_select || '</tr>';
  ...
  exception
    when others then
      pkg_sg_log.prc_rg_log(23001,
                            null,
                            'pkg_cb_proceso_juridico.fnc_gn_tabla_aforos',
                            6,
                            'Error: ' || sqlerrm,
                            6);

  end fnc_gn_tabla_aforos;
