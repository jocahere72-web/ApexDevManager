  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_GI_RENTAS" as
  /*
  ...
  */
  ...
  type t_impuesto_acto_conceptos is record(
    ...
    prcntje_bse_lqdcion      number, --Req0026109
    indcdor_utlza_bse_pntual gi_d_tarifas_esquema.indcdor_utlza_bse_pntual%type, --Req0026754
    indcdor_rqre_fctor       gi_d_tarifas_esquema.indcdor_rqre_fctor%type, --Req0026754
    fctor                    number); --Req0026754
  ...
  --Req0026754
  function fnc_cl_detalle_liquidacion(p_id_dcmnto in number) return clob;
