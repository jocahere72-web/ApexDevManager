  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_GJ_RECURSO" as

  --Procedimiento para regístrar en recursos
  ...
  function fn_co_cartera_recurso(p_xml in clob) return varchar2;
  ...
  procedure prc_co_acto_recurso(p_cdgo_clnte   in number,
                                p_id_acto      in number,
                                o_json         out clob,
                                o_mnsje_rspsta out varchar2,
                                o_cdgo_rspsta  out number);
