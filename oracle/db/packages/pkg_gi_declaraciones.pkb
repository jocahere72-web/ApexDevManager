  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_GI_DECLARACIONES" as
  ...
  begin
    select listagg(atributo, ',') within group(order by atributo) "atributo"
      into v_atributos
      from (select substr(regexp_substr(p_orgen,
                                        '\:RGN[0-9]+ATR[0-9]+FLA((X)|([0-9]+))',
                                        1,
                                        level),
                          2) as atributo
              from dual
            connect by regexp_substr(p_orgen,
                                     '\:RGN[0-9]+ATR[0-9]+FLA((X)|([0-9]+))',
                                     1,
                                     level) is not null);
    return v_atributos;
  ...
  procedure prc_rg_declaracion(p_cdgo_clnte                 in number,
                               ...
                               p_json                       in clob,
                               p_id_orgen_tpo               in number default 1, --Nuevo, agregado por Luis Ariza - Versión 2
                               p_id_dclrcion                in out number,
                               p_id_sjto_impsto             in number default null, --Nuevo, agregado por Luis Ariza - Versión 2
    ...
    v_id_dclrcion_crrcion2        varchar2(50);
    ...
    v_num_duplicados        number;
    v_indcdor_dlneacion     varchar2(1);
    v_indcdor_dclrcion_fnal varchar2(1);
    v_hmlgcion_prpdad       t_hmlgcion_prpdad := t_hmlgcion_prpdad();
    v_hmlgcion_prpdad2      t_hmlgcion_prpdad := t_hmlgcion_prpdad();
    v_hmlgcion_prpdad3      t_hmlgcion_prpdad := t_hmlgcion_prpdad();
    v_prpddes_items         t_prpddes_items := t_prpddes_items(); --Nuevo
    v_prpddes_items2        t_prpddes_items := t_prpddes_items(); --Nuevo
    v_prpddes_items3        t_prpddes_items := t_prpddes_items(); --Nuevo
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          p_id_cnddto_vgncia || '-' || p_id_usrio || '-' ||
                          p_json || '-' || p_id_orgen_tpo || '-' ||
                          p_id_dclrcion || '-' || p_id_sjto_impsto || '-' ||
                          o_mnsje_rspsta,
                          1);
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          v_prcdmnto,
                          v_nl,
                          'Consultar el formulario de la declaración',
                          6);
    ...
    if (p_id_dclrcion is null) then
      ...
      exception
        when others then
          o_cdgo_rspsta  := 4;
          o_mnsje_rspsta := '|' || v_cdgo_prcso || '-' || o_cdgo_rspsta ||
                            ' Problemas al generar el consecutivo con el cual se registra la declaración,' ||
                            ' por favor, solicitar apoyo técnico con este mensaje.' ||
                            o_mnsje_rspsta;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_prcdmnto,
    ...
    --Se valida para el impuesto de delineación Urbada sí la declaración final de pago
    --En la región de registro de anticipo no existan registros duplicados.

    o_mnsje_rspsta := 'Antes de consular delineación urbana v_indcdor_dclrcion_fnal => ' ||
                      v_indcdor_dclrcion_fnal ||
                      '- v_indcdor_dlneacion => ' || v_indcdor_dlneacion;
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_prcdmnto,
                          v_nl,
    ...
    if /*v_indcdor_dclrcion_fnal = 'S' and*/
     v_indcdor_dlneacion = 'S' then
      ...
      --Se consulta la identificación de la propiedad de homologación
      o_mnsje_rspsta := 'Consultar atributos';
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_prcdmnto,
                            v_nl,
      ...
      v_hmlgcion_prpdad2 := pkg_gi_declaraciones.fnc_co_id_hmlgcion_prpdad(p_id_hmlgcion => v_id_hmlgcion,
                                                                           p_cdgo_prpdad => 'ANV');

      v_hmlgcion_prpdad3 := pkg_gi_declaraciones.fnc_co_id_hmlgcion_prpdad(p_id_hmlgcion => v_id_hmlgcion,
                                                                           p_cdgo_prpdad => 'ANC');
      ...
      v_prpddes_items2 := pkg_gi_declaraciones.fnc_co_hmlgcnes_prpddes_items(p_id_hmlgcion_prpdad => v_hmlgcion_prpdad2.id_hmlgcion_prpdad,
                                                                             p_id_frmlrio         => v_id_frmlrio);

      v_prpddes_items2 := pkg_gi_declaraciones.fnc_co_hmlgcnes_prpddes_items(p_id_hmlgcion_prpdad => v_hmlgcion_prpdad2.id_hmlgcion_prpdad,
                                                                             p_id_frmlrio         => v_id_frmlrio);

      v_prpddes_items3 := pkg_gi_declaraciones.fnc_co_hmlgcnes_prpddes_items(p_id_hmlgcion_prpdad => v_hmlgcion_prpdad3.id_hmlgcion_prpdad,
                                                                             p_id_frmlrio         => v_id_frmlrio);
      o_mnsje_rspsta   := 'Antes de validar si hay duplicados';
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_prcdmnto,
                            v_nl,
                            ...
                            2);
      begin
        select num_duplicados
          into v_num_duplicados
          from (select to_number(a.vlor), count(*) as num_duplicados
                  from gi_g_declaraciones_detalle a
                 where a.id_dclrcion = p_id_dclrcion
                   and a.id_frmlrio_rgion_atrbto =
                       v_prpddes_items.id_frmlrio_rgion_atrbto
                 group by to_number(a.vlor)
                having count(*) > 1)
         where rownum = 1;

        o_cdgo_rspsta  := 37;
        o_mnsje_rspsta := '|' || v_cdgo_prcso || '-' || o_cdgo_rspsta ||
                          ' No se pudo registrar la declaración, ya que se encontraron declaraciones de anticio duplicadas,' ||
                          ' por favor valide la región de anticipo e intente nuevamente.' ||
                          o_mnsje_rspsta;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_prcdmnto,
      ...
      exception
        when no_data_found then
          prc_rg_declaracion_anticipo(p_cdgo_clnte           => p_cdgo_clnte,
                                      p_id_dclrcion          => p_id_dclrcion,
                                      p_id_dclrcion_atrbto   => v_prpddes_items.id_frmlrio_rgion_atrbto,
                                      p_vlor_dclrcion_atrbto => v_prpddes_items2.id_frmlrio_rgion_atrbto,
      ...
      begin
        select num_duplicados
          ...
          from (select to_number(a.vlor), count(*) as num_duplicados
                 ...
                 where a.id_dclrcion = p_id_dclrcion
                   and a.id_frmlrio_rgion_atrbto =
                       v_prpddes_items3.id_frmlrio_rgion_atrbto
                 group by to_number(a.vlor)
                having count(*) > 1)
         where rownum = 1;
      ...
      exception
        ...
        when others then
          o_cdgo_rspsta  := 37;
          o_mnsje_rspsta := '|' || v_cdgo_prcso || '-' || o_cdgo_rspsta ||
                            ' Error al intentar validar los registros duplicados de los anticipos de corrección.' ||
                            o_mnsje_rspsta;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_prcdmnto,
    ...
    --Se consulta el atributo y el valor predefinido (si es el caso) de una homologación
    ...
    if (p_id_orgen_tpo <> 2) then
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_prcdmnto,
                            v_nl,
                            'consulta id_sjto_impsto: ' || v_idntfccion,
                            6);
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_prcdmnto,
                            v_nl,
                            '(antes de consultar <> 2 v_fcha_prsntcion_pryctda: ',
                            6);
      ...
      begin
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_prcdmnto,
                              v_nl,
                              '(p_id_orgen_tpo <> 2) v_fcha_prsntcion_pryctda: ' ||
      ...
      if (v_fcha_prsntcion_pryctda is null) then
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_prcdmnto,
                              v_nl,
                              '(Entro a : v_fcha_prsntcion_pryctda is null ',
                              6);
      ...
      if (v_cdgo_dclrcion_uso = 'DCO') then
        ...
        begin
          ...
          select max(a.id_dclrcion), a.cdgo_dclrcion_estdo
           ...
           where a.id_dclrcion_vgncia_frmlrio =
             ...
             and a.id_dclrcion = to_number(v_id_dclrcion_crrcion2)
        ...
        exception
          ...
          when too_many_rows then
            ...
            o_cdgo_rspsta  := 277;
            o_mnsje_rspsta := '<details>' ||
                              '<summary>No se pudo registrar la declaración de corrección, ' ||
                              'se recupero más de una Declaración.' ||
                              o_mnsje_rspsta || '</summary>' || '<p>' ||
        ...
        if (v_id_dclrcion_crrcion2 = '0') then
          rollback;
          o_cdgo_rspsta  := 29;
          o_mnsje_rspsta := '<details>' ||
                            '<summary>No se pudo registrar la declaracion de correccion, ' ||
      ...
      */
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_prcdmnto,
                            v_nl,
                            'Antes de consultar : v_fcha_prsntcion_pryctda ',
                            6);
      ...
      begin
        ...
        --  v_fcha_prsntcion_pryctda := to_date(v_fcha_prsntcion_pryctda,'dd/mm/yyyy');
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_prcdmnto,
                              v_nl,
        ...
        if (o_cdgo_rspsta <> 0) then
          ...
          o_mnsje_rspsta := '<details>' ||
                            ...
                            'por favor intente nuevamente.' ||
                            o_mnsje_rspsta || '</summary>' || '<p>' ||
                            'Para mas informaci¿n consultar el c¿digo ' ||
                            v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
                            '</details>';
          --        pkg_sg_log.prc_rg_log( p_cdgo_clnte, null, v_prcdmnto,  v_nl, o_mnsje_rspsta, 2);
          --        pkg_sg_log.prc_rg_log( p_cdgo_clnte, null, v_prcdmnto,  v_nl, sqlerrm, 2);
      ...
      select count(1)
       ...
       where b.id_sjto_impsto = p_id_sjto_impsto
         ...
         and b.id_dclrcion = to_number(v_id_dclrcion_crrcion2);
    ...
    --pkg_sg_log.prc_rg_log( p_cdgo_clnte, null, v_prcdmnto,  v_nl, 'v_fcha_prsntcion_pryctda => '||v_fcha_prsntcion_pryctda, 6);
    --pkg_sg_log.prc_rg_log( p_cdgo_clnte, null, v_prcdmnto,  v_nl, 'v_fcha_prsntcion_pryctda => '||to_timestamp(v_fcha_prsntcion_pryctda, 'dd/mm/yyyy'), 6);

    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_prcdmnto,
                          v_nl,
                          'ID DECLARACIÓN ANTERIOR  => ' ||
                          v_id_dclrcion_crrcion2,
                          6);
    ...
    begin
      update gi_g_declaraciones a
         set a.id_sjto_impsto  = v_id_sjto_impsto,
             a.id_dclrcion_uso = v_id_dclrcion_uso,
             -- a.id_dclrcion_crrccion  = v_id_dclrcion_crrcion,
             a.id_dclrcion_crrccion   = to_number(v_id_dclrcion_crrcion2),
             a.fcha_prsntcion_pryctda = to_timestamp(v_fcha_prsntcion_pryctda,
                                                     'dd/mm/yyyy'),
             a.bse_grvble             = to_number(v_bse_grvble),
             a.vlor_ttal              = to_number(v_vlor_ttal),
    ...
    exception
      when others then
        ...
        o_mnsje_rspsta := '<details>' ||
                          ...
                          '.</p>' || '<br><p>p_id_dclrcion: ' ||
                          p_id_dclrcion || '.</p>' ||
                          '<br><p>v_fcha_prsntcion_pryctda: ' ||
                          v_fcha_prsntcion_pryctda || '.</p>' ||
  ...
  begin
    ...
    --Se valida si existe la declaración
    begin
      select a.cdgo_dclrcion_estdo, a.id_dclrcion_crrccion
        into v_cdgo_dclrcion_estdo, v_id_dclrcion_crrccion
        from gi_g_declaraciones a
    ...
    exception
      when others then
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := '<details>' ||
                          '<summary>La declaración no existe, ' ||
                          'por favor intente nuevamente. ' ||
                          o_mnsje_rspsta || '</summary>' || '<p>' ||
                          'Para mas información consultar el código ' ||
                          v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
    ...
    --Se valida el estado de la declaración
    if (v_cdgo_dclrcion_estdo not in ('RLA', 'PRS') and
       p_indcdor_pgo is null) then
      o_cdgo_rspsta  := 2;
      o_mnsje_rspsta := '<details>' ||
                        '<summary>El estado de la declaración no permite actualizar información financiera, ' ||
                        'por favor intente nuevamente. ' || o_mnsje_rspsta ||
                        '</summary>' || '<p>' ||
                        'Para mas información consultar el código ' ||
                        v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
    ...
    exception
      when others then
        ...
        o_cdgo_rspsta  := 3;
        o_mnsje_rspsta := '<details>' ||
                          '<summary>Los datos financieros actuales de la declaración no han podido ser eliminados, ' ||
                          'por favor intente nuevamente. ' ||
                          o_mnsje_rspsta || '</summary>' || '<p>' ||
                          'Para mas información consultar el código ' ||
                          v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
    ...
    --Se recorren los conceptos de la declaración
    begin
      for c_prueba in (select b.fcha_prsntcion_pryctda,
        ...
        --Se registran los conceptos de capital e interés
        if (c_prueba.ctgria_cncpto in ('C', 'I') and
          ...
          exception
            when others then
              ...
              o_cdgo_rspsta  := 4;
              o_mnsje_rspsta := '<details>' ||
                                '<summary>No pudo ser actualizado un concepto capital de la declaración, ' ||
                                'por favor intente nuevamente. ' ||
                                o_mnsje_rspsta || '</summary>' || '<p>' ||
                                'Para mas información consultar el código ' ||
                                v_cdgo_prcso || '-' || o_cdgo_rspsta ||
          ...
          if ((v_id_dclrcion_crrccion is null and
            ...
            exception
              ...
              when others then
                ...
                o_cdgo_rspsta  := 5;
                o_mnsje_rspsta := '<details>' ||
                                  '<summary>No pudo ser validado un concepto de descuento en la declaración, ' ||
                                  'por favor intente nuevamente. ' ||
                                  o_mnsje_rspsta || '</summary>' || '<p>' ||
                                  'Para mas información consultar el código ' ||
                                  v_cdgo_prcso || '-' || o_cdgo_rspsta ||
            ...
            --Se valida la fecha de presentación de la declaración
            if (c_prueba.fcha_prsntcion_pryctda is null) then
              rollback;
              o_cdgo_rspsta  := 6;
              o_mnsje_rspsta := '<details>' ||
                                '<summary>La fecha de presentación se encuentra nula, ' ||
                                'por favor intente nuevamente. ' ||
                                o_mnsje_rspsta || '</summary>' || '<p>' ||
                                'Para mas información consultar el código ' ||
                                v_cdgo_prcso || '-' || o_cdgo_rspsta ||
              ...
              for c_dscntos in (select a.id_dscnto_rgla,
                ...
                exception
                  when others then
                    ...
                    o_cdgo_rspsta  := 7;
                    o_mnsje_rspsta := '<details>' ||
                                      '<summary>No pudo ser actualizado un concepto de descuento en la declaración, ' ||
                                      'por favor intente nuevamente. ' ||
            ...
            exception
              when others then
                ...
                o_cdgo_rspsta  := 8;
                o_mnsje_rspsta := '<details>' ||
                                  '<summary>Los conceptos de descuentos en la declaración no han podido ser identificados, ' ||
                                  'por favor intente nuevamente. ' ||
                                  o_mnsje_rspsta || '</summary>' || '<p>' ||
                                  'Para mas información consultar el código ' ||
                                  v_cdgo_prcso || '-' || o_cdgo_rspsta ||
            ...
            exception
              when others then
                ...
                o_cdgo_rspsta  := 9;
                o_mnsje_rspsta := '<details>' ||
                                  '<summary>No pudo ser identificado el valor de descuento en uno de los conceptos en la declaración, ' ||
                                  'por favor intente nuevamente. ' ||
                                  o_mnsje_rspsta || '</summary>' || '<p>' ||
                                  'Para mas información consultar el código ' ||
                                  v_cdgo_prcso || '-' || o_cdgo_rspsta ||
            ...
            if (v_dscnto <> to_number(c_prueba.vlor)) then
              ...
              o_cdgo_rspsta  := 10;
              o_mnsje_rspsta := '<details>' ||
                                '<summary>El valor de los descuentos en la declaración no pudo ser validado, ' ||
                                'por favor intente nuevamente. ' ||
                                o_mnsje_rspsta || '</summary>' || '<p>' ||
                                'Para mas información consultar el código ' ||
                                v_cdgo_prcso || '-' || o_cdgo_rspsta ||
    ...
    exception
      when others then
        ...
        o_cdgo_rspsta  := 11;
        o_mnsje_rspsta := '<details>' ||
                          '<summary>Los conceptos en la declaración no han podido ser identificados, ' ||
                          'por favor intente nuevamente. ' ||
                          o_mnsje_rspsta || '</summary>' || '<p>' ||
                          'Para mas información consultar el código ' ||
                          v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
  ...
  begin
    ...
    exception
      when others then
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := '<details>' ||
                          '<summary>No se pudo validar la declaración, por favor intente nuevamente.</summary>' ||
                          '<p>' ||
                          'Para mas información consultar el código ' ||
                          v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
                          '<p>' || sqlerrm || '.</p>' || '<p>' ||
    ...
    if (v_cdgo_dclrcion_estdo <> 'AUT') then
      o_cdgo_rspsta  := 2;
      o_mnsje_rspsta := '<details>' ||
                        '<summary>La declaración no se encuentra en estado Autorizada, por este motivo no puede ser presentada.</summary>' ||
                        '<p>' ||
                        'Para mas información consultar el código ' ||
                        v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
                        '<p>' || sqlerrm || '.</p>' || '<p>' ||
    ...
    exception
      when others then
        o_cdgo_rspsta  := 3;
        o_mnsje_rspsta := '<details>' ||
                          '<summary>No se pudo validar si declaración requiere adjuntos, por este motivo no puede ser presentada.</summary>' ||
                          '<p>' ||
                          'Para mas información consultar el código ' ||
                          v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
                          '<p>' || sqlerrm || '.</p>' || '<p>' ||
    ...
    if (v_indcdor_prsntcion_web <> 'S') then
      o_cdgo_rspsta  := 4;
      o_mnsje_rspsta := '<details>' ||
                        '<summary>La declaración no admite presentación web, por favor descargarla y hacer la presentación física.</summary>' ||
                        '<p>' ||
                        'Para mas información consultar el código ' ||
                        v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
                        '<p>' || sqlerrm || '.</p>' || '<p>' ||
    ...
    begin
      ...
      if (o_cdgo_rspsta <> 0) then
        ...
        o_cdgo_rspsta  := 5;
        o_mnsje_rspsta := '<details>' ||
                          '<summary>La declaración no pudo ser presentada, por favor intente nuevamente.</summary>' ||
                          '<p>' ||
                          'Para mas información consultar el código ' ||
                          v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
                          '<p>' || sqlerrm || '.</p>' || '<p>' ||
    ...
    if (v_vlor_pago = 0) then
      ...
      o_cdgo_rspsta  := 9;
      o_mnsje_rspsta := '<details>' ||
                        '<summary>La declaración no pudo ser presentada, todo el proceso se hará automáticamente una vez hecho el pago.</summary>' ||
                        '<p>' ||
                        'Para mas información consultar el código ' ||
                        v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
                        '<p>' || sqlerrm || '.</p>' || '<p>' ||
      ...
      o_cdgo_rspsta  := 10;
      o_mnsje_rspsta := '<details>' ||
                        '<summary>La declaración tiene un valor a pagar errado, por favor gestione una nuevamente, si el problema persiste comuníquese con la administración.</summary>' ||
                        '<p>' ||
                        'Para mas información consultar el código ' ||
                        v_cdgo_prcso || '-' || o_cdgo_rspsta || '.</p>' ||
                        '<p>' || sqlerrm || '.</p>' || '<p>' ||
  ...
  function fnc_co_valor_descuento(p_id_dclrcion_vgncia_frmlrio number,
                                  ...
                                  p_cdgo_orgen                 varchar2 default 'DCL' --Se agrega el parametro p_cdgo_orgen para definifir si el calculo del concepto proviene de DECLARACIONES  Ejemplo: DNO = DOCUMENTO ; DCL= DECLARACIONES
  ...
  begin
    ...
    --Se valida si es una declaración de corrección
    if (p_id_dclrcion_crrccion is not null and p_id_dclrcion_crrccion > 0) then
      ...
      select a.id_dscnto_rgla,
        ...
        from table(pkg_re_documentos.fnc_cl_descuento_x_vgncia_prdo(p_cdgo_clnte           => v_cdgo_clnte,
                                                                    ...
                                                                    p_fcha_pryccion        => to_date(p_fcha_pryccion,
                                                                                                      'dd/mm/yyyy'),
                                                                    p_vlor                 => p_vlor_cncpto,
                                                                    p_cdna_vgncia_prdo_pgo => '{}',
                                                                    p_cdgo_orgen           => 'DCL')) a
       where a.id_dscnto_rgla is not null;
  ...
  begin
    ...
    select b.cdgo_tpo_dscnto_crrccion, a.cdgo_clnte, a.id_impsto
      into v_cdgo_tpo_dscnto_crrccion, v_cdgo_clnte, v_id_impsto
      from gi_g_declaraciones a
     inner join gi_d_dclrcnes_vgncias_frmlr b
        on b.id_dclrcion_vgncia_frmlrio = a.id_dclrcion_vgncia_frmlrio
     where a.id_dclrcion = p_id_dclrcion_crrccion;

    --Se consulta el número de decimales parametrizado por el cliente
    ...
    --Busca la Definición del Impuesto
    begin
      select vlor
        into v_nmro_dcmles
       ...
       where cdgo_clnte = v_cdgo_clnte
         and id_impsto = v_id_impsto
         and cdgo_dfncn_impsto = 'RVI';
    exception
      when others then
        v_nmro_dcmles := to_number('-2');
    end;

    --Se valida si el tipo de descuento parametrizado para un declaración de corrección es de valor
    if (v_cdgo_tpo_dscnto_crrccion = 'V') then
      ...
      --Si el valor del concepto en la declaración inicial es menor al de la declaración de corrección
    ...
    --Se recorren los descuentos de la declaración inicial
    ...
    for c_dscntos in (select a.id_dscnto_rgla,
      ...
      --Se define el valor del descuento según la parametrización en el periodo de la declaración
      if (v_cdgo_tpo_dscnto_crrccion = 'V') then
        v_vlor_dscnto := c_dscntos.vlor_dscnto;
      elsif (v_cdgo_tpo_dscnto_crrccion = 'P') then
        v_vlor_dscnto := round(v_vlor_cncpto * c_dscntos.prcntje_dscnto,
                               v_nmro_dcmles);
    ...
    select a.id_dclrcns_esqma_trfa_tpo,
     ...
     where a.cdgo_clnte = p_cdgo_clnte
       ...
       and EXTRACT(YEAR FROM(b.fcha_hsta)) in
           (SELECT c.vgncia
              FROM gi_d_dclrcnes_tpos_vgncias c
             WHERE c.vgncia = EXTRACT(YEAR FROM(b.fcha_hsta))
               AND c.id_dclrcion_tpo_vgncia IN
                   (SELECT d.id_dclrcion_tpo_vgncia
                      FROM gi_d_dclrcnes_vgncias_frmlr d
                     WHERE d.id_dclrcion_vgncia_frmlrio =
                           p_id_dclrcion_vgncia_frmlrio));
    ...
    exception
      when others then
        o_msje_rspsta := o_msje_rspsta ||
                         ' Excepcion al Registrar el Oficio de declaracion. ' ||
                         sqlerrm;
        o_cdgo_rspta  := 2;
  ...
  begin
    ...
    exception
      when others then
        o_cdgo_rspta  := 25;
        o_msje_rspsta := 'Error al intentar consultar si la declaracion tiene documentos cargados: ' ||
                         sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
    ...
    -- Insertar el estado del documento en gi_re_dclrcnes_arhvos segun la cantidad de documentos
    begin
      if v_cntdad_dcmntos > 0 then
        insert into gi_re_dcl_archvos_trza
          (nmro_cnsctvo, cdgo_estdo_crga, obsrvcion)
        values
          (p_nmro_dclrcion, p_estdo, p_obsrvcion);
      else
        insert into gi_re_dcl_archvos_trza
          (nmro_cnsctvo, cdgo_estdo_crga, obsrvcion)
        values
    ...
    exception
      when others then
        o_cdgo_rspta  := 30;
        o_msje_rspsta := 'Error al intentar guardar el estado del documento: ' ||
                         sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
  ...
  begin
    ...
    begin
      select d.id_dclrcn_archvo_tpo, c.nmro_cnsctvo, id_dclrcion
        ...
        join gi_g_declaraciones c
          on c.id_dclrcion_vgncia_frmlrio = a.id_dclrcion_vgncia_frmlrio
        join gi_d_dclrcnes_archvos_tpo d
          on d.id_dclrcn_tpo = b.id_dclrcn_tpo
        join gi_d_subimpuestos_adjnto_tp e
       ...
       where c.nmro_cnsctvo = p_nmro_dclrcion
         and e.dscrpcion_adjnto_tpo like '%HISTORICA%';
    exception
      when no_data_found then
        begin
      ...
      when others then
        o_cdgo_rspta  := 10;
        o_msje_rspsta := 'Error al intentar consultar el tipo de archivo de la declaracion. ' ||
                         p_nmro_dclrcion || sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nvel,
    ...
    if v_cntdad_dcmntos = 0 then
      ...
      exception
        when others then
          o_cdgo_rspta  := 30;
          o_msje_rspsta := 'Error al intentar guardar documento recibido. ' ||
                           sqlerrm;
          rollback;
          return;
      end;
  ...
  --Procedimiento que registra las declaraciones de anticipo para el impuesto de delineación Urbana.
  -- Para las declaraciones final o pago se pueden registrar declaraciones de anticipo o reconocimiento
  -- Por el cual se debera registrar y controlar para que solo sean aplicada una vez.
  -- Creado: Luis Ariza
  -- Fecha:  24/10/2024
  procedure prc_rg_declaracion_anticipo(p_cdgo_clnte           in number,
                                        p_id_dclrcion          in number,
                                        p_id_dclrcion_atrbto   in number,
                                        p_vlor_dclrcion_atrbto in number,
                                        o_cdgo_rspsta          out number,
                                        o_mnsje_rspsta         out varchar2) as
    v_nl                         number;
    v_prcdmnto                   varchar2(200) := 'pkg_gi_declaraciones.prc_rg_declaracion_anticipo';
    v_gi_g_declaraciones_detalle gi_g_declaraciones_detalle%rowtype;
    v_vlro_pgo                   number;
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          'p_id_dclrcion =>' || p_id_dclrcion ||
                          '- p_id_frmlrio_rgion_atrbto' ||
                          p_id_dclrcion_atrbto ||
                          '- p_vlor_dclrcion_atrbto' ||
                          p_vlor_dclrcion_atrbto,
                          1);
    begin
      for c_anticipos in (select id_dclrcion,
                                 id_frmlrio_rgion,
                                 fla,
                                 orden,
                                 vlor,
                           ...
                           where a.id_dclrcion = p_id_dclrcion
                             and a.id_frmlrio_rgion_atrbto =
                                 p_id_dclrcion_atrbto
                             and vlor is not null) loop

        begin
          select to_number(b.vlor)
            into v_vlro_pgo
            from gi_g_declaraciones_detalle b
           where b.id_dclrcion = p_id_dclrcion
             and b.id_frmlrio_rgion_atrbto = p_vlor_dclrcion_atrbto
             and b.fla = c_anticipos.fla;

        exception
          when no_data_found then
            o_cdgo_rspsta  := 1;
            o_mnsje_rspsta := '<details>' ||
                              '<summary> No se encontró la homologación del atributo , RGN' ||
                              c_anticipos.id_frmlrio_rgion || 'ATR' ||
                              p_vlor_dclrcion_atrbto || 'FLA' ||
                              c_anticipos.fla ||
                              'por favor intente nuevamente.' ||
                              o_mnsje_rspsta || '</summary>' || '<p>' ||
                              ' Error: ' || sqlerrm || '.</p>' ||
          ...
          when others then
            o_cdgo_rspsta  := 1;
            o_mnsje_rspsta := '<details>' ||
                              '<summary> Error al consultar la homologación del atributo , RGN' ||
                              c_anticipos.id_frmlrio_rgion || 'ATR' ||
                              p_vlor_dclrcion_atrbto || 'FLA' ||
                              c_anticipos.fla ||
                              'por favor intente nuevamente.' ||
        ...
        begin
          ...
          insert into gi_g_declaraciones_anticipo
            (id_dclrcion,
             id_dclrcion_rgstrda,
             dscrpcion,
             vlro_pgo,
          ...
          values
            (p_id_dclrcion,
             to_number(c_anticipos.vlor),
             c_anticipos.vlor_dsplay,
             v_vlro_pgo,
             'N',
             c_anticipos.fla);
        exception
          when others then
            ...
            o_cdgo_rspsta  := 2;
            o_mnsje_rspsta := '<details>' ||
                              '<summary>No se pudo registrar las declaraciones de anticipos, ' ||
                              'por favor intente nuevamente.' ||
                              o_mnsje_rspsta || '</summary>' || '<p>' ||
                              ' Error: ' || sqlerrm || '.</p>' ||
                              '</details>';
    ...
    exception
      when no_data_found then
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := '<details>' ||
                          '<summary> No se encontraron declaraciones de anticipo para la declaración ' ||
                          p_id_dclrcion || 'por favor intente nuevamente.' ||
                          o_mnsje_rspsta || '</summary>' || '<p>' ||
                          ' Error: ' || sqlerrm || '.</p>' || '</details>';

      when others then
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          ' Error al consultar el detalle de la declaración para registrar las declaraciones de anticipo';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_prcdmnto,
                              v_nl,
  ...
  end prc_rg_declaracion_anticipo;

  procedure prc_ap_declaracion_anticipo_crrcion(p_cdgo_clnte           in number,
                                                p_id_dclrcion          in number,
                                                p_id_dclrcion_atrbto   in number,
                                                p_vlor_dclrcion_atrbto in number default null,
                                                o_cdgo_rspsta          out number,
                                                o_mnsje_rspsta         out varchar2) as
    v_nl                         number;
    v_prcdmnto                   varchar2(200) := 'pkg_gi_declaraciones.prc_ap_declaracion_anticipo_crrcion';
    v_gi_g_declaraciones_detalle gi_g_declaraciones_detalle%rowtype;
    v_vlro_pgo                   number;
    v_id_dclrcion_crrccion       number;
  begin
    ...
    exception
      when no_data_found then
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := '<details>' ||
                          '<summary> No se encontró una declaración de corrección para el ID declaración: ' ||
                          p_id_dclrcion || o_mnsje_rspsta || '</summary>' ||
                          '<p>' || ' Error: ' || sqlerrm || '.</p>' ||
                          '</details>';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
      ...
      when others then
        o_cdgo_rspsta  := 2;
        o_mnsje_rspsta := '<details>' ||
                          '<summary> Error al consultar la declaración de corrección para el ID declaración: ' ||
                          p_id_dclrcion || o_mnsje_rspsta || '</summary>' ||
                          '<p>' || ' Error: ' || sqlerrm || '.</p>' ||
                          '</details>';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
    ...
    exception
      ...
      when others then
        o_cdgo_rspsta  := 4;
        o_mnsje_rspsta := '<details>' ||
                          '<summary> Error al intentar acutalizar el estado de los anticipos registrados a  la declaración id # ' ||
                          p_id_dclrcion || o_mnsje_rspsta || '</summary>' ||
                          '<p>' || ' Error: ' || sqlerrm || '.</p>' ||
                          '</details>';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
    ...
    begin
      for c_anticipos in (select id_dclrcion,
        ...
        begin
          update gi_g_declaraciones_anticipo a
             set a.id_dclrcion = p_id_dclrcion, a.aplcdo = 'S'
           where a.id_dclrcion_rgstrda = to_number(c_anticipos.vlor);
  ...
  end prc_ap_declaracion_anticipo_crrcion;
