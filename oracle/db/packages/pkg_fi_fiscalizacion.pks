  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_FI_FISCALIZACION" as
  ...
  function fnc_co_tbla_declaracion(p_id_cnddto in number) return clob;
  ...
  */
  ...
  function fnc_co_tbla_dclrcion_crrgda(p_id_cnddto in number) return clob;

  function fnc_gn_tabla_sancion(p_id_fsclzcion_expdnte number) return clob;
  ...
  */
  ...
  /*
      Procedimeinto para generar y registrar el acto de expediente analisis
      07/09/2023
      @Luis ariza
  */
