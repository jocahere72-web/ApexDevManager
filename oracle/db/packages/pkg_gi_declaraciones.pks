  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_GI_DECLARACIONES" as
  ...
  --Función de declaraciones que calcula el valor de descuento de un concepto
  --FDCL140
  ...
  --Procedimiento que aplica las declaraciones de anticipo para el impuesto de delineación Urbana.
  -- Para las declaraciones final o pago de corección se pueden desvincular las declaraciones de
  -- anticipo registradas y aplicadas en la declaración inicial
  -- Por el cual se debera actualizar y controlar para que esten asociadas a la nueva corrección o queden en estado no aplicado para
  --poder usarse en otra declaración final o pago.
  -- Creado: Luis Ariza
  -- Fecha:  24/10/2024
