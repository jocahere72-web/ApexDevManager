  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_CB_MEDIDAS_CAUTELARES" as
  ...
  function fnc_rt_csal_dsmbargo(p_id_embrgos_crtra in number,
                                p_cdgo_clnte       in number) return number;
  ...
  procedure prc_rg_acto_prop(p_cdgo_clnte          in cb_g_procesos_simu_lote.cdgo_clnte%type,
                             p_id_usuario          in sg_g_usuarios.id_usrio%type,
                             p_id_embrgos_crtra    in mc_g_embargos_cartera.id_embrgos_crtra%type,
                             p_id_embrgos_rspnsble in varchar2,
                             p_id_slctd_ofcio      in mc_g_solicitudes_y_oficios.id_slctd_ofcio%type,
                             --p_id_plntlla_slctud    in mc_d_tipos_embargo.id_plntlla_slctud%type,
                             p_id_cnsctvo_slctud  in varchar2,
                             p_id_acto_tpo        in gn_d_plantillas.id_acto_tpo%type,
  ...
  procedure prc_rg_gnrcion_actos_desembargo_prop(p_cdgo_clnte     in cb_g_procesos_simu_lote.cdgo_clnte%type,
                                                 p_id_usuario     in sg_g_usuarios.id_usrio%type,
                                                 p_json_rslciones in clob,
                                                 o_cdgo_rspsta    out number,
                                                 o_mnsje_rspsta   out varchar2);
