  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_GF_SALDOS_FAVOR" as
...
***/
  ...
  begin
    ...
    -- Req. 0026271. Si el acto existe porque hubo rechazo, solo se debe generar el BLOB con los cambios
    select a.id_acto into v_id_acto
    from    gf_g_saldos_favor_documento a
    where a.id_sldo_fvor_dcmnto = p_id_sldo_fvor_dcmnto;
