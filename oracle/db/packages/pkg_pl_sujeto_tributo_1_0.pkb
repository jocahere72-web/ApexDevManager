  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_PL_SUJETO_TRIBUTO_1_0" as
  ...
  begin
    ...
    v_html := v_html || '<div class="' || nvl(p_class, g_region_class) || '">' || case
                when p_title is not null then
                 '<div class="t-Region-header">
                                     <div class="t-Region-headerItems t-Region-headerItems--controls">' || case
                   when regexp_like(p_class, 'is-expanded|is-collapsed') then
              ...
              end || '<div class="t-Region-bodyWrap">
  ...
  begin
    ...
    if (nvl(p_label_colspan, 0) + nvl(p_value_colspan, 0) > p_colspan) then
      raise_application_error(-20001,
                              'El componente ' || p_id ||
                              ' no se pueden presentar debido a que la configuracion no es valida.' ||
                              ' colspan: ' || p_colspan ||
                              ' label_colspan: ' || p_label_colspan ||
                              ' value_colspan: ' || p_value_colspan ||
                              ' - (' || (p_label_colspan + p_value_colspan) ||
                              ' > ' || p_colspan || ').');
    end if;

    v_html := '<div class="col col-' || p_colspan || ' apex-col-auto">';
    v_html := v_html || '<div class="t-Form-fieldContainer ' ||
              nvl(p_class, g_display_only_class) || '">
                                <div class="t-Form-labelContainer' ||
              (case
                when p_value_colspan is not null then
                 ' col col-' || p_label_colspan
              end) || '">
                                    <label for="' || v_id ||
              '" id="' || v_id || '_LABEL" class="t-Form-label">' ||
              ...
              '" value="' || apex_escape.html_attribute(p_value) || '">
                                        <span id="' || v_id ||
              '_DISPLAY" class="display_only apex-item-display-only">' ||
  ...
  begin
    ...
    v_elements := g_elements(t_element('p1_idntfccion_sjto_frmtda',
                                       'Identificacion:',
                                       r_si_i_sujetos_impuesto.idntfccion_sjto_frmtda),
                             t_element('p1_idntfccion_antrior_frmtda',
                                       'Identificacion Anterior:',
                                       r_si_i_sujetos_impuesto.idntfccion_antrior_frmtda),
                             t_element('p1_ubccion',
                                       'Ubicacion:',
                                       upper(r_si_i_sujetos_impuesto.nmbre_pais || ' ' ||
                                             r_si_i_sujetos_impuesto.nmbre_dprtmnto || ' ' ||
                                             r_si_i_sujetos_impuesto.nmbre_mncpio)),
                             t_element('p1_drccion',
                                       'Direccion:',
                                       r_si_i_sujetos_impuesto.drccion),
                             t_element('p1_ubccion_ntfccion',
                                       'Ubicacion Notificacion:',
                                       upper(r_si_i_sujetos_impuesto.nmbre_pais_ntfccion || ' ' ||
                                             r_si_i_sujetos_impuesto.nmbre_dprtmnto_ntfccion || ' ' ||
                                             r_si_i_sujetos_impuesto.nmbre_mncpio_ntfccion)),
                             t_element('p1_drccion_ntfccion',
                                       'Direccion Notificacion:',
                                       r_si_i_sujetos_impuesto.drccion_ntfccion),
                             t_element('p1_tlfno',
                                       'Telefono:',
                                       r_si_i_sujetos_impuesto.tlfno),
                             t_element('p1_email',
                                       'Email:',
                                       r_si_i_sujetos_impuesto.email),
                             t_element('p1_sjto_estdo',
                                       'Estado',
                                       r_si_i_sujetos_impuesto.dscrpcion_sjto_estdo),
                             t_element('p1_estdo_blqdo',
                                       'Bloqueado',
                                       r_si_i_sujetos_impuesto.desc_estdo_blqdo_sjto_impsto)
    ...
    for i in 1 .. v_elements.count loop
      ...
      v_html := v_html ||
                pkg_pl_sujeto_tributo_1_0.fnc_create_display_only(p_id            => v_elements(i).id,
                                                                  p_colspan       => g_col_6,
    ...
    if (r_si_i_sujetos_impuesto.cdgo_sjto_tpo = 'P') then
      ...
      v_elements := g_elements(t_element('p2_dscrpcion_prdo_dstno',
                                         'Destino',
                                         r_si_i_predios.dscrpcion_prdo_dstno,
                                         4),
                               t_element('p2_dscrpcion_estrto',
                                         'Estrato',
                                         r_si_i_predios.dscrpcion_estrto,
                                         4),
                               t_element('p2_nmbre_dstno_igac',
                                         'Destino IGAC',
                                         r_si_i_predios.nmbre_dstno_igac,
                                         4),
                               t_element('p2_dscrpcion_prdio_clsfccion',
                                         'Clasificacion',
                                         r_si_i_predios.dscrpcion_prdio_clsfccion,
                                         4,
                                         true),
                               t_element('p2_dscrpcion_uso_suelo',
                                         'Uso del Suelo',
                                         r_si_i_predios.dscrpcion_uso_suelo,
                                         4),
                               t_element('p2_mtrcla_inmblria',
                                         'Matricula Inmobiliaria',
                                         nvl(r_si_i_predios.mtrcla_inmblria,
                                             'No registra'),
                                         4),
                               t_element('p2_avluo_ctstral',
                                         'Avaluo Catastral',
                                         to_char(r_si_i_predios.avluo_ctstral,
                                                 'FM999G999G999G999G999G999G990'),
                                         3,
                                         true),
                               t_element('p2_avluo_cmrcial',
                                         'Avaluo Comercial',
                                         to_char(r_si_i_predios.avluo_cmrcial,
                                                 'FM999G999G999G999G999G999G990'),
                                         3),
                               t_element('p2_area_trrno',
                                         'Area Terreno',
                                         to_char(r_si_i_predios.area_trrno,
                                                 'FM999G999G999G999G999G999G990') ||
                                         ' mts2',
                                         3),
                               t_element('p2_area_cnstrda',
                                         'Area Construida',
                                         to_char(r_si_i_predios.area_cnstrda,
                                                 'FM999G999G999G999G999G999G990') ||
                                         ' mts2',
                                         3),
                               t_element('p2_area_grvble',
                                         'Area Gravable',
                                         to_char(r_si_i_predios.area_grvble,
                                                 'FM999G999G999G999G999G999G990') ||
                                         ' mts2',
                                         3,
                                         true),
                               t_element('p2_vgncia_actlzda',
                                         'Vigencia Actualización',
                                         r_si_i_predios.vgncia_actlzda,
                                         3),
                               t_element('p2_nmbre_brrio',
                                         'Barrio',
                                         nvl(r_si_i_predios.nmbre_brrio,
                                             'NO DEFINIDO'),
                                         3),
                               t_element('p2_nmbre_entdad',
                                         'Entidad',
                                         nvl(r_si_i_predios.nmbre_entdad,
                                             'NO DEFINIDO'),
                                         3));
      ...
      begin
        select count(*)
          into v_nmro_scrsal
          from si_i_sujetos_sucursal b
         where b.id_sjto_impsto = r_si_i_personas.id_sjto_impsto
           and b.actvo = 'S';
      exception
        when no_data_found then
          v_nmro_scrsal := null;
      ...
      v_elements := g_elements(t_element('p3_nmbre_rzon_scial',
                                         'Nombre Razon Social',
                                         r_si_i_personas.nmbre_rzon_scial,
                                         4),
                               t_element('p3_dscrpcion_tpo_prsna',
                                         'Tipo Persona',
                                         nvl(r_si_i_personas.dscrpcion_tpo_prsna,
                                             'NO DEFINIDO'),
                                         4),
                               t_element('p3_nmbre_sjto_tpo',
                                         'Tipo Regimen',
                                         r_si_i_personas.nmbre_sjto_tpo,
                                         4),
                               t_element('p3_nmro_rgstro_cmra_cmrcio',
                                         'N? Registro Camara Comercio',
                                         nvl(r_si_i_personas.nmro_rgstro_cmra_cmrcio,
                                             'NO DEFINIDO'),
                                         4,
                                         true),
                               t_element('p3_fcha_rgstro_cmra_cmrcio',
                                         'Fecha Camara Comercio',
                                         nvl(to_char(r_si_i_personas.fcha_rgstro_cmra_cmrcio,
                                                     'DD/MM/YYYY'),
                                             'NO DEFINIDO'),
                                         4),
                               t_element('p3_fcha_incio_actvddes',
                                         'Fecha Inicio Actividades',
                                         nvl(to_char(r_si_i_personas.fcha_incio_actvddes,
                                                     'DD/MM/YYYY'),
                                             'NO DEFINIDO'),
                                         4),
                               t_element('p3_drccion_cmra_cmrcio',
                                         'Direccion Camara Comercio',
                                         nvl(r_si_i_personas.drccion_cmra_cmrcio,
                                             'NO DEFINIDO'),
                                         4),
                               t_element('p3_nmro_scrsles',
                                         'Numero Sucursales',
                                         nvl('' || v_nmro_scrsal,
                                             'NO DEFINIDO'),
                                         4,
                                         false),
                               t_element('p3_actvdad_ecnmca',
                                         'Actividad',
                                         nvl('' || r_si_i_personas.dscrpcion,
                                             'NO DEFINIDO'),
                                         4,
                                         false));
      ...
      v_elements := g_elements(t_element('p4',
                                         'Categoria',
                                         r_si_i_vehiculos.dscrpcion_vhclo_ctgtria,
                                         4),
                               t_element('p4',
                                         'Clase',
                                         r_si_i_vehiculos.dscrpcion_vhclo_clse,
                                         4),
                               t_element('p4',
                                         'Marca',
                                         r_si_i_vehiculos.dscrpcion_vhclo_mrca,
                                         4),
                               t_element('p4',
                                         'Linea',
                                         r_si_i_vehiculos.dscrpcion_vhclo_lnea,
                                         4),
                               t_element('p4',
                                         'Cilindraje',
                                         r_si_i_vehiculos.clndrje,
                                         4),
                               t_element('p4',
                                         'Modelo',
                                         r_si_i_vehiculos.mdlo,
                                         4)
                               -- , t_element( 'p4' , 'Blindaje' , r_si_i_vehiculos.dscrpcion_vhclo_blndje, 4 )
                              ,
                               t_element('p4',
                                         'Carroceria',
                                         r_si_i_vehiculos.dscrpcion_vhclo_crrocria,
                                         4),
                               t_element('p4',
                                         'Servicio',
                                         r_si_i_vehiculos.dscrpcion_vhclo_srvcio,
                                         3)
                              ...
                              ,
                               t_element('p4',
                                         'Fecha Compra',
                                         r_si_i_vehiculos.fcha_cmpra,
                                         3),
                               t_element('p4',
                                         'Fecha Matricula',
                                         r_si_i_vehiculos.fcha_mtrcla,
                                         3),
                               t_element('p4',
                                         'Cap. Carga',
                                         r_si_i_vehiculos.cpcdad_crga,
                                         3),
                               t_element('p4',
                                         'Cap. Pasajeros',
                                         r_si_i_vehiculos.cpcdad_psjro,
                                         3),
                               t_element('p4',
                                         'Avaluo',
                                         to_char(r_si_i_vehiculos.avluo,
                                                 'FM$999G999G999G999G999G999G990'),
                                         3),
                               t_element('p4',
                                         'Valor Comercial',
                                         to_char(r_si_i_vehiculos.vlor_cmrcial,
                                                 'FM$999G999G999G999G999G999G990'),
                                         3)
    ...
    for j in 1 .. v_elements.count loop
      ...
      v_html := v_html ||
                pkg_pl_sujeto_tributo_1_0.fnc_create_display_only(p_id      => v_elements(j).id,
    ...
    v_html :=  --Informacion Basica
     (case
             ...
             --Responsables
              fnc_create_region(p_colspan => (case
                                               when v_render then
                                                g_col_6
                                               else
                                                g_col_12
    ...
    v_html := fnc_create_region(p_colspan => g_col_12,
                                p_class   => 't-Region t-Region--hideShow t-Region--noPadding js-useLocalStorage t-Region--scrollBody t-Form--noPadding t-Form--stretchInputs margin-top-none margin-bottom-none margin-left-none margin-right-none a-Collapsible is-expanded',
    ...
    begin
      ...
      if (r_si_i_sujetos_impuesto.cdgo_sjto_tpo = 'P') then
        apex_json.write('% Participación');
      end if;
      apex_json.write('Activo'); -- NUEVO
      ...
      apex_json.write('C'); -- NUEVO (para Activo)
      apex_json.close_array;
    ...
    apex_javascript.add_onload_code(p_code => 'load(' ||
                                              apex_json.stringify(apex_json.get_clob_output) || ');');
