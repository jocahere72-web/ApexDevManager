  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_GN_GENERALIDADES" as
  ...
  function fnc_cl_convertir_bfile_a_base64(p_bfile bfile) return clob;
  ...
  */
  ...
  function fnc_gn_blob_documento(p_id_rprte    in number,
                                 ...
                                 p_app_id      in number,
                                 p_page_id     in number) return blob;
  ...
  function fnc_decode_base64(p_clob_in in clob) return blob;
