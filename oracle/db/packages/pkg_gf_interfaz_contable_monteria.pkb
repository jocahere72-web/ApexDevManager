  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_GF_INTERFAZ_CONTABLE_MONTERIA" as
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          v_nmbre_up,
                          v_nl,
                          'Inicio prc_rg_recaudo_intrfaz_total',
                          1);
    pkg_gf_interfaz_contable_monteria.prc_rg_recaudo_intrfaz_total(p_cdgo_clnte,
                                                                   p_vgncia);
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
                          v_nl,
                          'Fin prc_rg_recaudo_intrfaz_total',
                          1);
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          v_nmbre_up,
                          v_nl,
                          'Inicio prc_rg_ajuste_intrfaz',
                          1);
    pkg_gf_interfaz_contable_monteria.prc_rg_ajuste_intrfaz(p_cdgo_clnte,
                                                            p_vgncia);
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
                          v_nl,
                          'Fin prc_rg_ajuste_intrfaz',
                          1);
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          v_nmbre_up,
                          v_nl,
                          'Inicio prc_rg_liquidacion_intrfaz',
                          1);
    pkg_gf_interfaz_contable_monteria.prc_rg_liquidacion_intrfaz(p_cdgo_clnte,
                                                                 p_vgncia);
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
                          v_nl,
                          'Fin prc_rg_liquidacion_intrfaz',
                          1);
    ...
    begin
      ...
      exception
        when no_data_found then
          v_cdgo_rspsta  := 20;
          v_mnsje_rspsta := v_nmbre_up || ' ' || v_cdgo_rspsta ||
                            '. No hay correo configurado para el envio ';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
        ...
        when others then
          v_cdgo_rspsta  := 30;
          v_mnsje_rspsta := v_nmbre_up || ' ' || v_cdgo_rspsta ||
                            '. Error al consultar correo para el envio. ' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      if v_correo is not null then
        v_mensaje := v_nmbre_up || ' ' || 'Despues de la session - ' ||
                     'v_correo: ' || v_correo;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          v_nmbre_up,
                          v_nl,
                          'Inicio Recaudo conciliado',
                          1);
    pkg_gf_interfaz_contable_monteria.prc_rg_recaudo_intrfaz_cncldo(p_cdgo_clnte,
                                                                    p_vgncia);
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
                          v_nl,
                          'Fin Recaudo conciliado',
                          1);
    /*
    --Up de Interfaz Recaudo
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
  ...
  begin
    ...
    v_nl           := pkg_sg_log.fnc_ca_nivel_log(p_cdgo_clnte,
                                                  null,
                                                  v_nmbre_up);
    v_mnsje_rspsta := 'Inicio del procedimiento ' || p_cdgo_clnte || ' - ' ||
                      p_vgncia;
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
    ...
    for c_rcdos in (select distinct a.id_rcdo,
                     ...
                     where d.cdgo_clnte = p_cdgo_clnte
                       ...
                       and (extract(year from a.fcha_ingrso_bnco) = p_vgncia and
                           extract(year from a.fcha_apliccion) = p_vgncia)
                       and a.cdgo_rcdo_estdo = 'AP'
                       and a.vlor > 0
                       and a.indcdor_intrfaz = 'N'
                    /* and a.nmro_dcmnto in (120240056048,
                    20240162873,
                    20240107071,
                    20250245319)*/
                    /*and a.id_rcdo in (2161099,
                    2167841,
                    2167845,
                    2168310,
                    2168312,
          ...
          begin
            select upper(d.nmbre_dclrcns_esqma_trfa_tpo)
              ...
              join gi_d_dclrcns_esqma_trfa_tpo d
                on d.id_dclrcns_esqma_trfa_tpo =
                   c.id_dclrcns_esqma_trfa_tpo
            ...
            exception
              when others then
                ...
                v_error := 'Tipo: RE' || ' Id_rcdo: ' || c_rcdos.id_rcdo ||
                           ...
                           c_cncptos.id_cncpto_csdo || ' Error: ' ||
                           sqlerrm;
                insert into genesys_interfaz.sg_g_log
                  (col1, col2)
                values
  ...
  begin
    ...
    for c_rcdos in (select distinct a.id_rcdo,
                    ...
                    --AND     A.ID_RCDO in ( 1433426,1433047,1433226,1432758,1432803,1432893,1432827,1432961,1432968,1432963 )
      ...
      if sql%rowcount > 0 then
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nmbre_up,
                              v_nl,
                              'Actualizados: ' || sql%rowcount ||
                              ' registros, recaudo: ' || c_rcdos.id_rcdo,
                              1);
    ...
    for c_dscntos in (select a.id_rcdo,
      ...
      if (c_dscntos.cdgo_sjto_tpo = 'E') then
        ...
        exception
          when others then
            o_cdgo_rspsta := 1;
            v_error       := 'Tipo: RE' || ' Id_Rcdo: ' ||
                             c_dscntos.id_rcdo || ' - Error en persona- : ' ||
    ...
    for c_ajste in (select a.id_ajste,
      ...
      if (c_ajste.cdgo_sjto_tpo = 'E') then
        ...
        exception
          when others then
            o_cdgo_rspsta := 1;
            v_error       := 'Tipo: AJ' || ' Id_Ajuste: ' ||
                             c_ajste.id_ajste || ' - Error en persona- : ' ||
                          ...
                          from (select a.id_orgen,
                                 ...
                                 where cdgo_mvmnto_orgn = 'AJ'
                                   ...
                                   and a.cdgo_mvmnto_tpo in
                                       ('AC', 'AD', 'IT') -- 'Codigo del tipo de movimiento, Ejemplo: IN:Ingreso, AD:Ajuste Debito, AC:Ajuste Credito, PC:Pago Capital, PI:Pago Interes, DC:Descuento Capital, DI:Decescuento Interes, IT:Interes'
                                 group by a.id_orgen,
                                          a.vgncia,
                                          a.id_cncpto_csdo,
                                          a.cdgo_mvmnto_tpo) a
      ...
      if (o_cdgo_rspsta = 0) then
        ...
        if (s_vlor = c_lqdciones.vlor_ttal) then
          ...
          v_error := 'Descuadre id_lqdcion:' || c_lqdciones.id_lqdcion ||
                     ...
                     ' - impuesto:' || c_lqdciones.id_impsto ||
                     ' - s_vlor: ' || s_vlor ||
                     ' - c_lqdciones.vlor_ttal: ' || c_lqdciones.vlor_ttal;
          /*insert into genesys_interfaz.sg_g_log (col1, col2)
