  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_GF_TITULOS_JUDICIAL" as
  ...
  --Registra los docuemnto de cobro asociados al título judicil
  ...
  function fnc_frmto_idntfccion_sjto(p_idntfccion_sjto in varchar2) return varchar2;
  ...
  procedure prc_rg_muerto(p_n_001 in number default null,
                          ...
                          p_d_001 in date default null);

   function fnc_co_titulos_tabla(p_id_instncia_fljo in number)
    return clob;

   function fnc_co_titulos_cartera_consignar(p_id_instncia_fljo in number) return clob;

   function fnc_co_titulos_cartera_compensar(p_id_instncia_fljo in number) return clob;
