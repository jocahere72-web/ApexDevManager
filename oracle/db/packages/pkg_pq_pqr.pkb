  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_PQ_PQR" as
  ...
  procedure prc_rg_solicitud_pqr(p_id_tpo                in pq_g_solicitudes.id_tpo%type,
    ...
    v_anio                   pq_g_solicitudes.anio%type := extract(year from
                                                                   sysdate);
    ...
    begin
      if v_id_rdcdor is null then
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nmbre_up,
                              v_nl,
                              'Se inserto el radicador: ' || v_id_rdcdor,
                              6);
      else
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nmbre_up,
                              v_nl,
                              'Se actualizo el radicador: ' || v_id_rdcdor,
                              6);
      end if;
    exception
      when others then
        ...
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se pudo procesar el radicador de la solicitud.';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
    ...
    if v_id_slctud is null then
      ...
      begin
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nmbre_up,
                              v_nl,
                              'v_id_estdo ' || v_id_estdo,
                              6);
      exception
        when others then
          o_cdgo_rspsta  := 2;
          o_mnsje_rspsta := o_cdgo_rspsta ||
                            '. No se Encontraron Datos para el Estado de la Solicitud';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
      ...
      if p_obsrvcion is not null then
        declare
          v_id_fljo_trea number := nvl(v('F_ID_FLJO_TREA'),
                                       pkg_pq_pqr.g_id_fljo_trea);
        begin
          insert into pq_g_solicitudes_obsrvcion
            (id_slctud, id_fljo_trea, id_usrio, fcha, obsrvcion)
          values
            (v_id_slctud, v_id_fljo_trea, p_id_usrio, sysdate, p_obsrvcion);
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
                                'Se inseto la observacion ',
                                6);
        exception
          when others then
            o_cdgo_rspsta  := 4;
            o_mnsje_rspsta := o_cdgo_rspsta ||
                              '. No se pudo registrar la observacion de la solicitud.';
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
                                  v_nl,
      ...
      begin
        select id_fljo,
               pk_util_calendario.fnc_cl_fecha_final(p_cdgo_clnte    => p_cdgo_clnte,
                                                     p_fecha_inicial => nvl(v_fcha_rdcdo,
                                                                            systimestamp) -- req.0023223
                                                    ,
        ...
        o_mnsje_rspsta := 'v_id_fljo: ' || v_id_fljo || ' v_fcha_pryctda: ' ||
                          v_fcha_pryctda || ' v_fcha_lmte_ley: ' ||
                          v_fcha_lmte_ley || ' v_vldar_sjto_impsto: ' ||
                          v_vldar_sjto_impsto ||
                          ' v_indcdor_rdccion_atmtca: ' ||
                          v_indcdor_rdccion_atmtca;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
      ...
      exception
        when others then
          o_cdgo_rspsta  := 7;
          o_mnsje_rspsta := o_cdgo_rspsta ||
                            '. No se pudieron Generar las Fechas Proyectada y Limite de Ley.';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
      ...
      begin
        insert into pq_g_solicitudes_motivo
          (id_slctud, id_mtvo)
        values
          (v_id_slctud, p_id_motivo)
        returning id_slctud_mtvo into v_id_slctud_mtvo;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
                              'v_id_slctud_mtvo: ' || v_id_slctud_mtvo,
                              6);
      exception
        when others then
          o_cdgo_rspsta  := 8;
          o_mnsje_rspsta := o_cdgo_rspsta ||
                            '. No se pudo registrar el motivo de la solicitud.';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
      ...
      exception
        when no_data_found then
          if v_vldar_sjto_impsto = 'S' then
            o_cdgo_rspsta  := 9;
            o_mnsje_rspsta := o_cdgo_rspsta ||
                              '. No se Encontraron Datos para la Identificacion del Sujeto.';
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
                                  v_nl,
      ...
      if p_idntfccion_sjto is not null then
        ...
        begin
          ...
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                ...
                                v_nmbre_up,
                                v_nl,
                                'Se registro el sujeto y motivo',
                                6);
        exception
          when others then
            o_cdgo_rspsta  := 10;
            o_mnsje_rspsta := o_cdgo_rspsta ||
                              '. No se pudo registrar el sujeto impuesto de la solicitud.';
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
                                  v_nl,
      ...
      if v_indcdor_rdccion_atmtca = 'S' then
        begin
          v_nmro_rdcdo        := pkg_gn_generalidades.fnc_cl_consecutivo(p_cdgo_clnte,
                                                                         'PQR');
          ...
          o_mnsje_rspsta := 'v_nmro_rdcdo: ' || v_nmro_rdcdo ||
                            ' v_nmro_rdcdo_dsplay: ' || v_nmro_rdcdo_dsplay ||
                            ' v_fcha_rdcdo: ' || v_fcha_rdcdo;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
        ...
        exception
          when others then
            o_cdgo_rspsta  := 12;
            o_mnsje_rspsta := o_cdgo_rspsta ||
                              '. No se pudo generar el numero del radicado.';
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
                                  v_nl,
      ...
      exception
        when others then
          o_cdgo_rspsta  := 14;
          o_mnsje_rspsta := o_cdgo_rspsta ||
                            '. No se pudo actualizar la solicitud con el numero del radicado.';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
      ...
      for c_documentos in (select c001    obsrvcion,
                            ...
                            where collection_name = 'DOCUMENTOS') loop

        --CREAMOS LOS DOCUMENTOS DE LA SOLICITUD
        begin
          insert into pq_g_documentos
            (id_slctud,
             id_mtvo_dcmnto,
             file_blob,
             file_name,
      ...
      if v_nmro_rdcdo_dsplay is not null then
        prc_rg_mensaje_radicado(p_id_slctud         => v_id_slctud,
                                p_nmro_rdcdo_dsplay => v_nmro_rdcdo_dsplay);
      end if;
    end if;
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
  ...
  begin
    ...
    exception
      when others then
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se encontraron datos del flujo.';
        return;
    end;

    --2. BUSCAMOS LA PRIMERA TAREA DEL FLUJO.
    begin
      select id_fljo_trea, id_fljo_trea_dstno
        into v_id_fljo_trea, v_id_fljo_trea_dstno
    ...
    exception
      when others then
        o_cdgo_rspsta  := 2;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se encontraron datos de la primera tarea del flujo.';
        return;
    end;
    ...
    begin
      ...
      values
        (v_id_fljo,
         ...
         p_id_usrio,
         'INICIADA',
         'Flujo de PQR portal. ' || p_obsrvcion)
    ...
    exception
      when others then
        o_cdgo_rspsta  := 3;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se pudo generar la instancia del flujo.';
        return;
    end;
    ...
    begin
      select b.cdgo_idntfccion_tpo,
             ...
             b.sgndo_aplldo,
             nvl(case
                   when b.id_pais_ntfccion is null then
                    b.id_pais
                   else
                    b.id_pais_ntfccion
                 end,
                 c.id_pais) as id_pais_ntfccion,
             nvl(case
                   when b.id_dprtmnto_ntfccion is null then
                    b.id_dprtmnto
                   else
             ...
             nvl(case
                   when b.id_mncpio_ntfccion is null then
                    b.id_mncpio
                   else
                    b.id_mncpio_ntfccion
                 end,
                 c.id_mncpio) as id_mncpio_ntfccion,
             b.drccion_ntfccion,
             b.email,
             b.tlfno,
             b.cllar
    ...
    begin
      select m.id_fljo, s.id_slctud
        into v_id_fljo_hjo, o_id_slctud
    ...
    exception
      when others then
        o_cdgo_rspsta  := 7;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se encontraron datos del siguiente flujo.';
        return;
    end;
    ...
    begin
      ...
      if v_id_instncia_fljo_hjo is null then
        ...
        o_cdgo_rspsta  := 8;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se pudo generar el siguiente flujo. ' ||
                          v_mnsje;
        return;
      end if;
      ...
      values
        (v_id_instncia_fljo, v_id_fljo_trea_dstno, v_id_instncia_fljo_hjo);
    exception
      when others then
        rollback;
        o_cdgo_rspsta  := 8;
    ...
    exception
      when others then
        o_cdgo_rspsta  := 9;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se pudo generar la siguiente tarea del flujo.';
        return;
    end;
  end prc_rg_solicitud_portal;

  procedure prc_rg_mensaje_radicado(p_id_slctud         in pq_g_solicitudes.id_slctud%type,
                                    p_nmro_rdcdo_dsplay in pq_g_solicitudes.nmro_rdcdo_dsplay%type default null) as
    v_cdgo_clnte      number;
    ...
    exception
      when no_data_found then
        ...
        if v_id_instncia_fljo is null then
          rollback;
          v_mnsje := 'No se pudo Realizar la Solicitud, Error Creando el Nuevo Flujo ' ||
                     v_mnsje;
          apex_error.add_error(p_message          => v_mnsje,
                               p_display_location => apex_error.c_inline_in_notification);
          raise_application_error(-20001, v_mnsje);
  ...
  begin
    ...
    returning nmro_rdcdo_dsplay into v_nmro_rdcdo_dsplay;

    --SE ENVIA UN MENSAJE DE TEXTO A EL SOLICITANTE
    pkg_pq_pqr.prc_rg_mensaje_radicado(p_id_slctud         => p_id_slctud,
                                       p_nmro_rdcdo_dsplay => v_nmro_rdcdo_dsplay);
  ...
  begin
    ...
    begin
      select a.id_slctud_mtvo_acto, m.id_slctud_mtvo
        into v_id_slctud_mtvo_acto, v_id_slctud_mtvo
    ...
    begin
      select t.id_fljo_trea_orgen, s.id_instncia_fljo
        into v_id_fljo_trea_orgen, v_id_instncia_fljo
        from pq_g_solicitudes s
        join wf_g_instancias_transicion t
          on t.id_instncia_fljo = s.id_instncia_fljo
    ...
    if v_id_slctud_mtvo_acto is null and p_id_acto is not null then
      insert into pq_g_solicitudes_mtvo_acto
        (id_slctud_mtvo, id_acto)
      values
        (v_id_slctud_mtvo, p_id_acto);
  ...
  exception
    when others then
      v_mnsje := nvl(v_mnsje, 'No se pudo actualizar la solicitud ') ||
                 p_id_acto;
      raise_application_error(-20001, v_mnsje);
  end prc_ac_solicitud;
  ...
  procedure prc_ac_documentos(p_id_slctud in pq_g_solicitudes.id_slctud%type,
    ...
    v_mnsje varchar2(4000);
  begin
    for c_documentos in (select id_dcmnto
                           from json_table(p_json,
                                           '$[*]' columns(id_dcmnto varchar2 path
                                                   '$.id_dcmnto'))) loop
      update pq_g_documentos
         set indcdor_actlzar = 'S', actvo = 'S'
       where id_slctud = p_id_slctud
  ...
  begin
    ...
    begin
      select acto,
        ...
        into v_id_acto,
             ...
             v_id_usrio,
             v_cdgo_rspsta
        from (select b.vlor, c.cdgo_prpdad
    ...
    exception
      when others then
        ...
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := 'Manejador:1 No se pudo obtener las propiedades del evento' ||
                          sqlerrm;
        --raise_application_error( -20001 , v_mnsje );
        return;
    end;
    ...
    begin
      select id_slctud, cdgo_clnte
        into v_id_slctud, v_cdgo_clnte
  ...
  procedure prc_ac_quejas_reclamo(p_id_instncia_fljo in number,
    ...
    procedure execute_job(p_id_instncia_fljo in number) as
      pragma autonomous_transaction;
      v_nmbre_job varchar2(42) := 'IT_WF_MC_' ||
  ...
  begin
    begin
      select a.id_qja_rclmo, a.cdgo_clnte, b.id_mtvo
        into v_id_orgen, v_cdgo_clnte, v_id_mtvo
    ...
    begin
      select a.id_fncnrio,
             ...
             a.id_acto_tpo,
             c.id_usrio
        into v_id_fncnrio_frma, v_anio, v_id_acto_tpo, v_id_usrio
       ...
       where b.cdgo_acto_tpo = 'QRE'
         ...
         and a.actvo = 'S'
         and trunc(sysdate) between a.fcha_incio and a.fcha_fin
         and 0 between a.rngo_dda_incio and a.rngo_dda_fin;
    exception
      when others then
        rollback;
        return;
    ...
    prc_rg_acto_quejas_reclamo(p_cdgo_clnte       => v_cdgo_clnte,
                               p_cdgo_acto_orgen  => 'QRE',
                               p_id_orgen         => v_id_orgen,
                               p_id_acto_tpo      => v_id_acto_tpo,
                               p_anio             => v_anio,
                               p_id_usrio         => v_id_usrio,
                               p_id_fncnrio_frma  => v_id_fncnrio_frma,
    ...
    begin
      ...
      insert into muerto2
        (v_001, v_002, b_001)
      values
        (p_id_instncia_fljo, v_id_acto, v_blob);
      commit;
      ...
      exception
        when others then
          insert into muerto2
            (v_001, v_002)
          values
            (20, 'No se encontro el id_dcmnto de acto ' || v_id_acto);
          commit;
      end;
  ...
  procedure prc_ac_quejas_reclamo_flujo(p_id_instncia_fljo in number) as
  begin
  ...
  begin
    ...
    begin
      select a.id_instncia_fljo_gnrdo, b.cdgo_clnte, c.id_mtvo
        into v_id_orgen, v_cdgo_clnte, v_id_mtvo
        from wf_g_instancias_flujo_gnrdo a
    ...
    exception
      when others then
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se encontraron datos para realizar el paz y salvo.';
        return;
    end;
    ...
    exception
      when others then
        o_cdgo_rspsta  := 2;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se encontraron datos para realizar el acto paz y salvo.';
        return;
    end;

    v_nmro_acto := pkg_gn_generalidades.fnc_cl_consecutivo(p_cdgo_clnte   => v_cdgo_clnte,
                                                           p_cdgo_cnsctvo => 'PQR');
    ...
    exception
      when others then
        o_cdgo_rspsta  := 5;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se pudo actualizar la instancia del flujo de trabajo.';
        rollback;
        return;
    end;
    commit;
  ...
  function fnc_cl_url_portal(p_id_slctud in number) return varchar2 is
    v_id_instncia_fljo number;
    v_id_fljo_trea     number;
    v_url              varchar2(4000);
  begin
    begin
      select c.id_instncia_fljo, c.id_fljo_trea_orgen
  ...
  begin
    ...
    for c_documentos in (select c001    obsrvcion,
                                ...
                                blob001 file_blob
                           from apex_collections
                          where collection_name = 'DOCUMENTOS_P') loop
      ...
      begin
        ...
        delete from pq_g_documentos where id_dcmnto = v_id_dcmnto;
    ...
    exception
      when others then
        o_cdgo_rspsta  := 10;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se pudo actualizar  el indicador de documentos pendientes. ' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
  ...
  begin
    ...
    exception
      ...
      when others then
        o_cdgo_rspsta  := 5;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. Error al buscar los datos de la solicitud.';
        return;
    end;
    ...
    begin
      ...
      update wf_g_instancias_flujo
         set estdo_instncia = 'FINALIZADA'
       where id_instncia_fljo in
             (v_id_instncia_fljo, v_id_instncia_fljo_gnrdo);

      if not sql%found then
        o_cdgo_rspsta  := 10;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se pudo actualizar el estado de la instancia del flujo a FINALIZADA.';
        return;
      end if;
    exception
      when others then
    ...
    begin
      ...
      if not sql%found then
        o_cdgo_rspsta  := 20;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se pudo finalizar las transiciones.';
        return;
      end if;
    ...
    exception
      when others then
        o_cdgo_rspsta  := 25;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. Error al finalizar las transiciones.';
        return;
    end;
    ...
    begin
      -- Se cierra la PQR
      update pq_g_solicitudes
         set id_estdo = 5, fcha_real = sysdate
       where id_slctud = p_id_slctud;

      if not sql%found then
        o_cdgo_rspsta  := 30;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. No se pudo actualizar el estado de la solicitud a CERRADA.';
        return;
      end if;
    ...
    exception
      when others then
        o_cdgo_rspsta  := 35;
        o_mnsje_rspsta := o_cdgo_rspsta ||
                          '. Error al actualizar el estado de la solicitud a CERRADA.';
        return;
    end;
  ...
  procedure prc_ac_solicitud_pqr(p_id_tpo                in pq_g_solicitudes.id_tpo%type,
    ...
    v_id_fljo                pq_d_motivos.id_fljo%type;
    v_id_instncia_fljo       wf_g_instancias_flujo.id_instncia_fljo%type;
    v_id_fljo_trea           v_wf_d_flujos_transicion.id_fljo_trea%type := p_id_fljo_trea;
    v_vldar_sjto_impsto      pq_d_motivos.vldar_sjto_impsto%type;
    v_id_sjto_impsto         v_si_i_sujetos_impuesto.id_sjto_impsto%type;
    v_indcdor_rdccion_atmtca pq_d_motivos.indcdor_rdccion_atmtca%type := 'N';
    v_nmro_rdcdo_dsplay      pq_g_solicitudes.nmro_rdcdo_dsplay%type;
  ...
  begin
    ...
    If v_id_rdcdor is not null and v_id_slctud is not null then
      ...
      exception
        when others then
          o_cdgo_rspsta  := 3;
          o_mnsje_rspsta := o_cdgo_rspsta ||
                            '. No se pudo Actualizar el radicador la solicitud.';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
    ...
    if p_obsrvcion is not null and v_id_fljo_trea is not null and
       v_id_slctud is not null then
      ...
      if (existe_obs > 0) then
        ...
        exception
          when others then
            o_cdgo_rspsta  := 4;
            o_mnsje_rspsta := o_cdgo_rspsta ||
                              '. No se pudo actualizar la observacion de la solicitud.';
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
                                  v_nl,
      ...
      if (existe_obs > 0) then
        ...
        exception
          when others then
            o_cdgo_rspsta  := 5;
            o_mnsje_rspsta := o_cdgo_rspsta ||
                              '. No se pudo eliminar la observacion de la solicitud.';
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
                                  v_nl,
  ...
  begin
    ...
    exception
      when others then
        ...
        o_cdgo_rspsta  := 10;
        o_mnsje_rspsta := o_cdgo_rspsta || ' - ' ||
                          'No se encontro información de obligatoriedad, el documento adjunto';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
    ...
    if (v_oblgtrio = 'N') then
      ...
      exception
        when others then
          ...
          o_cdgo_rspsta  := 15;
          o_mnsje_rspsta := o_cdgo_rspsta || ' - ' ||
                            'No se pudo eliminar el documento, el documento adjunto';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
      ...
      o_cdgo_rspsta  := 20;
      o_mnsje_rspsta := o_cdgo_rspsta || ' - ' ||
                        'No se pudo eliminar el documento, documento obligatorio';
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
  ...
  procedure prc_rg_acto_quejas_reclamo(p_cdgo_clnte       in number,
                                       ...
                                       o_id_acto          out number) as

    v_nmro_acto         gn_g_actos.nmro_acto%type;
    v_nmro_acto_dsplay  pq_g_solicitudes.nmro_rdcdo_dsplay%type;
    v_id_impsto_sbmpsto pq_g_slctdes_mtvo_sjt_impst.id_impsto_sbmpsto%type;
    v_id_sjto_impsto    pq_g_slctdes_mtvo_sjt_impst.id_sjto_impsto%type;
    v_id_slctud         pq_g_solicitudes.id_slctud%type;
  begin
    ...
    begin
      select b.nmro_rdcdo_dsplay,
        ...
        join pq_g_solicitudes_motivo c
          on c.id_slctud = b.id_slctud
        left join pq_g_slctdes_mtvo_sjt_impst d
          on d.id_slctud_mtvo = c.id_slctud_mtvo
       where a.id_instncia_fljo = p_id_instncia_fljo;

      v_nmro_acto := replace(v_nmro_acto_dsplay, '-', '');
    ...
    exception
      when others then
        ...
        v_nmro_acto_dsplay := p_anio || '-' || v_nmro_acto;
    end;
    ...
    exception
      when others then
        ...
        insert into muerto2
          (v_001)
        values
          ('Error al insertar el acto: ' || v_nmro_acto_dsplay);
        commit;
        --null;
    end;
    ...
    if v_id_impsto_sbmpsto is not null then
      begin
        ...
        values
          (o_id_acto, v_id_impsto_sbmpsto, v_id_sjto_impsto);
      exception
        when others then
          insert into muerto2
            (v_001)
          values
            ('Error al insertar el sujeto del acto: ' ||
             v_nmro_acto_dsplay);
          commit;
      end;
    end if;
    ...
    for c_sjtos_rspnsble in (select *
                              ...
                              where a.id_slctud = v_id_slctud) loop
      begin
      ...
      exception
        when others then
          insert into muerto2
            (v_001)
          values
            ('Error al insertar los responsables del acto: ' ||
             v_nmro_acto_dsplay);
          commit;
      end;
    end loop;
  ...
  procedure prc_rg_actualiza_motivo_pqr(p_nmro_rdcdo_dsplay in varchar,
                                        ...
                                        p_cdgo_clnte        in number,
                                        o_cdgo_rspsta       out number,
                                        o_mnsje_rspsta      out varchar) IS
    --cursor que extrae la informacción inicial de la solicitud
    cursor c1 is(
      select b.id_instncia_fljo_gnrdo_hjo,
             ...
             a.id_slctud,
             k.id_slctud_mtvo,
             sms.id_slctud_mtvo_sjto_impsto,
             aa.email,
             aa.drccion_ntfccion,
             b.id_fljo_trea,
             k.id_mtvo,
             ...
             a.fcha_rdcdo
        from pq_g_solicitudes a
        join pq_g_solicitantes aa
          on aa.id_slctud = a.id_slctud
        join pq_g_solicitudes_motivo k
          on a.id_slctud = k.id_slctud
        join pq_d_motivos m
          on k.id_mtvo = m.id_mtvo
        left join pq_g_slctdes_mtvo_sjt_impst sms
          on sms.id_slctud_mtvo = k.id_slctud_mtvo
    ...
    cursor c2 is(
      select b.id_fljo_trea, a.id_fljo, a.id_mtvo, a.vldar_sjto_impsto
        from pq_d_motivos a
    ...
    ----
    v_nl       NUMBER;
    v_nmbre_up varchar2(100) := 'pkg_pq_pqr.prc_rg_actualiza_motivo_pqr';
  ...
  begin
    ...
    --recorremos el cursor 1
    for r1 in c1 loop

      pkg_sg_log.prc_rg_log(6, null, v_nmbre_up, 6, 'paso 1 ', 1);
      ...
      for r2 in c2 loop
        ...
        pkg_sg_log.prc_rg_log(6,
                              ...
                              v_nmbre_up,
                              6,
                              'r1.id_instncia_trnscion ' ||
                              r1.id_instncia_trnscion,
                              1);

        -------*************ACTUALIZAMOS EL MOTIVO***************-------
        if p_id_mtvo_nuevo is not null then
          --CONSULTAMOS LOS TERMINOS DE LEY Y PROYECTADOS
          begin
            select pk_util_calendario.fnc_cl_fecha_final(p_cdgo_clnte    => p_cdgo_clnte,
                                                         p_fecha_inicial => r1.fcha_rdcdo,
                                                         p_undad_drcion  => undad_drcion_pryctda,
                                                         p_drcion        => drcion_pryctda,
                                                         p_dia_tpo       => tpo_dia) fcha_pryctda,
                   pk_util_calendario.fnc_cl_fecha_final(p_cdgo_clnte    => p_cdgo_clnte,
                                                         ...
                                                         p_drcion        => drcion_lmte_ley,
                                                         p_dia_tpo       => tpo_dia) fcha_lmte_ley
              into v_fcha_pryctda, v_fcha_lmte_ley
              from pq_d_motivos
             where id_mtvo = p_id_mtvo_nuevo;

            o_mnsje_rspsta := ' v_fcha_pryctda: ' || v_fcha_pryctda ||
                              ' v_fcha_lmte_ley: ' || v_fcha_lmte_ley;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
                                  v_nl,
          ...
          --Se actualiza la fecha proyectada y la fecha limite de ley según el motivo
          begin
            update pq_g_solicitudes
               set fcha_pryctda  = v_fcha_pryctda,
                   fcha_lmte_ley = v_fcha_lmte_ley
             where id_slctud = r1.id_slctud;
          exception
            when others then
              o_cdgo_rspsta  := 10;
              o_mnsje_rspsta := o_cdgo_rspsta ||
                                '.No se pudo actualizar el motivo de la solicitud.';
              pkg_sg_log.prc_rg_log(6,
                                    null,
                                    v_nmbre_up,
                                    6,
          ...
          --SE ACTUALIZA EL MOTIVO DE LA SOLICITUD
          begin
        ...
        if (r1.id_usrio != p_id_usrio) then
        ...
        --****ACTUALIZAMOS DIRECCION DE NOTIFICACIÓN****--
        if p_drccion is not null then
          begin
            update pq_g_solicitantes a
               set a.drccion_ntfccion = p_drccion
             where id_slctud = r1.id_slctud;
          exception
            when others then
              rollback;
        ...
        --****se actualiza la identificación del sujeto****--
        if p_idntfccion is not null then
          if r2.vldar_sjto_impsto = 'S' then
            begin
          ...
          --****Actualizamos el sujeto seleccionado para el motivo de la pqr****--
          if r1.id_slctud_mtvo_sjto_impsto is null then
            ...
            begin
              update pq_g_slctdes_mtvo_sjt_impst sms
                 set sms.idntfccion = p_idntfccion,
                     id_sjto_impsto = v_id_sjto_impsto
               where id_slctud_mtvo_sjto_impsto =
                     r1.id_slctud_mtvo_sjto_impsto;
            exception
              when others then
                o_cdgo_rspsta  := 80;
                o_mnsje_rspsta := o_cdgo_rspsta ||
                                  '. No se pudo actualizar la identificación. ' ||
                                  v_mnsje;
                pkg_sg_log.prc_rg_log(6,
                                      null,
                                      v_nmbre_up,
        ...
        --****Se actualiza el impuesto Subimpuesto****--
        if p_id_impsto <> r1.id_impsto or
           p_id_sbimpsto <> r1.id_impsto_sbmpsto then
          begin
            update pq_g_slctdes_mtvo_sjt_impst sms
               set sms.id_impsto         = p_id_impsto,
                   sms.id_impsto_sbmpsto = p_id_sbimpsto
             where id_slctud_mtvo_sjto_impsto =
                   r1.id_slctud_mtvo_sjto_impsto;
          exception
            when others then
              ...
              o_cdgo_rspsta  := 90;
              o_mnsje_rspsta := o_cdgo_rspsta ||
                                '. No se pudo actualizar el impuesto subimpuesto. ' ||
                                v_mnsje;
              pkg_sg_log.prc_rg_log(6,
                                    null,
                                    v_nmbre_up,
                                    ...
                                    o_mnsje_rspsta ||
                                    ' - impusto - subimpuesto ' ||
                                    p_id_impsto || ' - ' || p_id_sbimpsto,
                                    6);
              return;
          end;
        end if;

        --****SE CREA LA NUEVA INSTANCIA DE FLUJO Y ELIMINAMOS LA INSTANCIA ANTERIOR****--
        if (r1.id_mtvo != r2.id_mtvo or r1.idntfccion != p_idntfccion) then
          --1. BUSCAMOS LA PRIMERA TAREA DEL FLUJO.
          begin
            select id_fljo_trea, id_fljo_trea_dstno
              into v_id_fljo_trea, v_id_fljo_trea_dstno
              from wf_d_flujos_transicion
             where id_fljo = r2.id_fljo
             order by orden
             fetch first 1 rows only;
          exception
            when others then
              ...
              pkg_sg_log.prc_rg_log(6,
                                    ...
                                    v_nmbre_up,
                                    6,
                                    o_mnsje_rspsta || ' - id_fljo ' ||
                                    r2.id_fljo,
                                    6);
              return;
          end;

          --2. CONSULTAMOS LOS DATOS DEL SIGUIENTE FLUJO
          begin
            select m.id_fljo, s.id_slctud
              into v_id_fljo_hjo, v_id_slctud
              from pq_g_solicitudes s
              join pq_g_solicitudes_motivo sm
                on sm.id_slctud = s.id_slctud
              join v_pq_d_motivos m
                on m.id_mtvo = sm.id_mtvo
             where s.id_instncia_fljo = r1.id_instncia_fljo;
          exception
            when others then
              o_cdgo_rspsta  := 30;
              o_mnsje_rspsta := o_cdgo_rspsta ||
          ...
          --3. GENERAMOS EL SIGUIENTE FLUJO
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
                                'v_id_fljo_hjo ' || v_id_fljo_hjo,
                                1);
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
          ...
          pkg_sg_log.prc_rg_log(6,
                                ...
                                v_nmbre_up,
                                6,
                                'iniciamos instancia flujo nuevo ',
                                1);
          ...
          begin
            ...
            pkg_pl_workflow_1_0.prc_rg_instancias_flujo(p_id_fljo          => v_id_fljo_hjo,
                                                        p_id_usrio         => p_id_usrio,
                                                        p_id_prtcpte       => p_id_usrio, --SE PUEDE COLOCAR EL p_id_usrio PARA QUE SEA EL PARTICIPANTE DESTINO
                                                        o_id_instncia_fljo => v_id_instncia_fljo_hjo,
                                                        o_id_fljo_trea     => v_id_fljo_trea_hja,
                                                        o_mnsje            => v_mnsje);
            if v_id_instncia_fljo_hjo is null then
          ...
          --4. GENERAMOS LA TAREA SIGUIENTE DEL FLUJO
          pkg_sg_log.prc_rg_log(6,
                                null,
                                'ACTUALIZA_MOTIVO_PQR',
                                6,
          ...
          delete wf_g_instancias_flujo_gnrdo
           where id_instncia_fljo_gnrdo_hjo = r1.id_instncia_fljo_gnrdo_hjo
             and id_instncia_fljo = r1.id_instncia_fljo;
        end if;
  ...
  end prc_rg_actualiza_motivo_pqr;
  ...
  procedure prc_rg_pqg_slctdes_tsldo_trza(p_cdgo_clnte in number,
                                          ...
                                          p_json         in clob,
                                          p_mtvo_pqr_nva in number,
                                          p_id_impsto    in number,
                                          p_id_sbimpsto  in number,
                                          p_email        in varchar2,
    ...
    v_ID_SLCTUD_TRAZA       number;
    v_nivel                 number;
    v_nl                    number;
    v_nmbre_up              varchar(70) := 'pkg_pq_pqr.prc_rg_pqg_slctdes_tsldo_trza';
    v_id_usrio_fljo_antrior number;
  ...
  begin
    ...
    for datos_json in (select id_slctud,
                              nmbre_rdcdor,
                              id_rdcdor,
                              dscrpcion,
                              dscrpcion_etdo,
                         ...
                         FROM json_table(p_json,
                                         '$[*]'
                                         COLUMNS(id_slctud number PATH
                                                 '$.ID_SOLICITUD',
                                                 nmbre_rdcdor varchar2(100) PATH
                                                 '$.NMBRE_RDCDOR',
                                                 id_rdcdor number PATH
                                                 '$.ID_RDCDOR',
                                                 dscrpcion varchar2(200) PATH
                                                 '$.DSCRPCION',
                                                 dscrpcion_etdo varchar2(200) PATH
                                                 '$.DSCRPCION_ETDO',
                                                 id_mtvo_ant number PATH
                                                 '$.ID_MTVO',
                                                 idntfccion_ant varchar2(50) PATH
                                                 '$.IDNTFCCION',
                                                 impsto_ant varchar2(50) PATH
                                                 '$.ID_IMPSTO',
                                                 sbimpsto_ant varchar2(50) PATH
                                                 '$.ID_SBIMPSTO',
                                                 id_instncia_fljo number PATH
                                                 '$.ID_INSTNCIA_FLJO',
                                                 fcha_rdcdo date PATH
                                                 '$.FCHA_RDCDO',
                                                 email_ant varchar2(100) PATH
                                                 '$.EMAIL',
                                                 drccion_ntfccion_ant
                                                 varchar2(200) PATH
                                                 '$.DRCCION_NTFCCION',
                                                 id_slctnte number PATH
                                                 '$.ID_SLCTNTE',
                                                 cllar_ant varchar2(50) PATH
                                                 '$.CLLAR',
                                                 nmro_rdcdo_frmtdo
                                                 varchar2(50) PATH
                                                 '$.NMRO_RDCDO_FRMTDO',
                                                 id_usrio_trslda number PATH
                                                 '$.ID_USRIO_TRSLDA')) a) LOOP
      BEGIN
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nmbre_up,
                              v_nl,
                              'datos_json.IDNTFCCION: ' ||
                              datos_json.idntfccion_ant,
                              6);
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nl,
                              'Instancia del flujo: ' ||
                              datos_json.id_instncia_fljo,
                              6);
        begin
          select e.id_usrio
            into v_id_usrio_fljo_antrior
            from genesys.pq_g_solicitudes a
            join genesys.wf_g_instancias_flujo_gnrdo b
              on a.id_instncia_fljo = b.id_instncia_fljo
            join genesys.wf_g_instancias_flujo c
              on b.id_instncia_fljo_gnrdo_hjo = c.id_instncia_fljo
            join genesys.wf_g_instancias_transicion e
              on c.id_instncia_fljo = e.id_instncia_fljo
           where A.ID_INSTNCIA_FLJO = datos_json.id_instncia_fljo
           order by e.fcha_incio desc
           fetch first 1 row only;
        exception
          when others then
            v_id_usrio_fljo_antrior := null;
        end;
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nmbre_up,
                              v_nl,
                              'Usuario actual del flujo hijo: ' ||
                              v_id_usrio_fljo_antrior,
                              6);

        insert into pq_g_solicitudes_trslado_traza
          (id_slctud,
           nmbre_rdcdor,
           id_rdcdor,
           dscrpcion,
           ...
           email_antror,
           email_nva,
           drccion_ntfccion_antror,
           drccion_ntfccion_nva,
           id_slctnte,
           cllar_antror,
           cllar_nva,
           nmro_rdcdo_frmtdo,
           ...
           fcha_trsldo,
           id_usrio_trslda,
           id_usrio_fljo_antrior)
        VALUES
          (datos_json.id_slctud,
           datos_json.nmbre_rdcdor,
           datos_json.id_rdcdor,
           datos_json.dscrpcion,
           datos_json.dscrpcion_etdo,
           datos_json.id_mtvo_ant,
           p_mtvo_pqr_nva,
           datos_json.idntfccion_ant,
           p_idntfccion,
           datos_json.impsto_ant,
           p_id_impsto,
           datos_json.sbimpsto_ant,
           p_id_sbimpsto,
           datos_json.id_instncia_fljo,
           --TO_DATE(datos_json.fcha_rdcdo, 'YYYY-MM-DD'),
           to_char(datos_json.fcha_rdcdo, 'DD-MM-YYYY'),
           datos_json.email_ant,
           p_email,
           datos_json.drccion_ntfccion_ant,
           p_drccion,
           datos_json.id_slctnte,
           datos_json.cllar_ant,
           p_cllar,
           datos_json.nmro_rdcdo_frmtdo,
           p_obsrvcion,
           sysdate,
           datos_json.id_usrio_trslda,
           v_id_usrio_fljo_antrior)
        returning ID_SLCTUD_TRZA into v_ID_SLCTUD_TRAZA;
      EXCEPTION
        WHEN OTHERS THEN
          o_cdgo_rspsta  := 1;
          o_mnsje_rspsta := 'Error No. ' || o_cdgo_rspsta ||
                            ' - Insertando en PQ_G_SOLICITUDES_TRSLADO_TRAZA. ' ||
                            SQLERRM;
          return;
      END;
    ...
    END LOOP;
  END prc_rg_pqg_slctdes_tsldo_trza;
end pkg_pq_pqr;
/
