  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_GF_MOVIMIENTOS_FINANCIERO" as
  ...
  type t_mvmntos_x_cncpto is record(
    ...
    vlor_sldo_cptal_prcntje        number, -- DOC. PORCENTUALIDAD
    vlor_intres_prcntje            number, -- DOC. PORCENTUALIDAD
    vlor_ttal_prcntje              number, -- DOC. PORCENTUALIDAD
    prcntje_real                   number, -- DOC. PORCENTUALIDAD
    indcdor_pgdo                   number -- DOC. PORCENTUALIDAD
    );
  ...
  function fnc_co_mvmnto_x_cncpto(p_cdgo_clnte        df_s_clientes.cdgo_clnte%type,
                                  ...
                                  p_fcha_vncmnto      date,
                                  p_id_orgen          number default null,
                                  p_id_rspnsble       number default 0) -- DOC. PORCENTUALIDAD
