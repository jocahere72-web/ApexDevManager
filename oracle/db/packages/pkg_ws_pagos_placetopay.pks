  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_WS_PAGOS_PLACETOPAY" as

  /*
      @ Autor: JAGUAS
      @ Fecha_modificacion: 04/09/2020
      @ Descripcion: Paquete que contiene unidades de programa relacionadas con la gestion de recaudos
  ...
  */
  ...
  v_entityCode      ws_d_prvdor_prpddes_impsto.vlor%type;
  v_notificationURL ws_d_prvdor_prpddes_impsto.vlor%type;
  -- ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  ...
  /*
      ...
      Descripcion: Procedimiento que inicia una transaccion de pago en linea mediante
                   comunicacion  con  la  pasarela  de  pagos  de  PLACE TO PAY  (Metodo
                   START_TRANSACTION).
  */
  ...
  /*
      ...
      Fecha de modificacion: 04/09/2020
      Descripcion: Procedimiento encargado de consumir servicio de PLACE TO PAY que devuelve el estado
                   de la transaccion.
  */
  ...
  /*
      ...
      Descripcion: Procedimiento encargado registrar las transacciones iniciadas con PLACE TO PAY
  ...
  */
  ...
  /*
      ...
      Descripcion: Procedimiento encargado de consultar las transacciones  que son procesadas mediante
                   la  pasarela  PLACE TO PAY  que se encuentren en estado PENDIENTE, tambien se encarga de
  ...
  */
  ...
  /*
      ...
      Descripcion: Procedimiento encargado de registrar la respuesta del estado de
                   la transaccion devuelta por PLACE TO PAY.
  */
  ...
  /*
      Funcion que recorre los items homologados entre la declaracion de
  ...
  */
  ...
  function fnc_co_actvdad_tpo(p_id_prvdor   in number,
                              p_actvdad_tpo in varchar2) return varchar2;
