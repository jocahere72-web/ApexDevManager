  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_CB_MEDIDAS_CAUTELARES" as
  ...
  begin
    ...
    for sujetos in (select id_embrgos_smu_sjto
                      from json_table(p_json_sujetos,
                                      '$[*]'
                                      columns(id_embrgos_smu_sjto number path
                                              '$.ID_EMBRGOS_SMU_SJTO'))) loop
  ...
  begin
    ...
    if v_indcdor_prcsdo = 0 then
      ...
      delete from mc_g_embargos_simu_lote
       where id_embrgos_smu_lte = p_id_embrgos_smu_lte;
  ...
  begin
    ...
    for c_sjtos in (select a.id_embrgos_smu_sjto,
                      ...
                      from json_table(p_json_sujetos,
                                      ...
                                      columns(id_embrgos_smu_sjto number path
                                              '$.ID_EMBRGOS_SMU_SJTO',
                                              id_embrgos_smu_lte number path
                                              '$.ID_EMBRGOS_SMU_LTE',
      ...
      v_mnsjes := 'datos del sujeto - id_sjto: ' || c_sjtos.id_sjto ||
                  ' - idntfccion: ' || c_sjtos.idntfccion;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
      ...
      if v_indcdor_prcsdo = 'N' then
        ...
        v_mnsjes := 'v_id_instncia_fljo: ' || v_id_instncia_fljo ||
        ...
        for c_mvmntos in (select m.id_embrgos_smu_sjto,
                           ...
                           (select 1
                                   ...
                                   (select 1
                                            ...
                                            join mc_d_estados_cartera d
                                              on d.id_estdos_crtra =
                                                 c.id_estdos_crtra
                                           where c.id_embrgos_crtra =
                                                 b.id_embrgos_crtra
                                             and d.cdgo_estdos_crtra in
                                                 ('I', 'E', 'S')))
          ...
          v_xml := v_xml || '"P_ID_EMBRGOS_SMU_SJTO":"' ||
                   c_sjtos.id_embrgos_smu_sjto || '"}';
          ...
          v_mnsjes := 'Dentro del for c_mvmntos - v_indcdor_cmplio: ' ||
                      v_indcdor_cmplio;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
        ...
        if v_vlda_prcsmnto = 'N' then
          ...
          if v_id_instncia_fljo > 0 then
            ...
            v_cdgo_crtra := pkg_gn_generalidades.fnc_cl_consecutivo(p_cdgo_clnte,
                                                                    'CIC');
            ...
            begin
              ...
              v_mnsjes := 'datos del insert  mc_g_embargos_cartera - p_cdgo_clnte: ' ||
                          p_cdgo_clnte || ' - v_cdgo_crtra: ' ||
                          v_cdgo_crtra || ' - v_id_estdos_crtra: ' ||
                          v_id_estdos_crtra || ' - v_id_tpos_mdda_ctlar: ' ||
                          v_id_tpos_mdda_ctlar || ' - sysdate: ' ||
                          trunc(sysdate) || ' - v_id_lte_mdda_ctlar: ' ||
                          v_id_lte_mdda_ctlar;
              pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                    null,
                                    v_nmbre_up,
            ...
            for c_mvmntos in (select m.id_embrgos_smu_sjto,
                               ...
                               (select 1
                                        from mc_g_embargos_simu_sujeto s
                                       where s.id_embrgos_smu_sjto =
                                             m.id_embrgos_smu_sjto
                                         and s.indcdor_prcsdo = 'S'
                                         and exists
                                       (select 1
                                                from mc_g_embargos_simu_lote l
                                               where l.id_embrgos_smu_lte =
                                                     s.id_embrgos_smu_lte
                                                 and l.id_tpos_mdda_ctlar =
                                                     v_id_tpos_mdda_ctlar))
              ...
              v_mnsjes := 'Dentro del for c_mvmntos 2 - v_id_prcsos_jrdco: ' ||
                          v_id_prcsos_jrdco;
              pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                    null,
                                    v_nmbre_up,
            ...
            v_vlor_embrgo := (v_vlor_cptal + ((v_vlor_cptal * 50) / 100) +
                             v_vlor_intrs);
            ...
            for c_rspnsbles in (select r.id_embrgos_smu_sjto,
                                 ...
                                 where r.id_embrgos_smu_sjto =
                                       c_sjtos.id_embrgos_smu_sjto) loop
            ...
            v_mnsjes := 'Tipo de embargo - v_cdgo_embrgos_tpo: ' ||
                        v_cdgo_embrgos_tpo;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
            ...
            for c_entddes in (select id_entddes, ofcio_x_prptrio
                                from json_table(p_json_entidades,
                                                '$[*]'
                                                columns(id_entddes number path
                                                        '$.ID_ENTDDES',
                                                        ofcio_x_prptrio
                                                        varchar2 path
              ...
              if c_entddes.ofcio_x_prptrio = 'S' then
                ...
                for c_rspnsbles in (select id_embrgos_rspnsble
                                     ...
                                     where id_embrgos_crtra =
                                           v_id_embrgos_crtra) loop
                  ...
                  if v_cdgo_embrgos_tpo = 'BIM' or v_existe_bim = 'S' then
                    ...
                    for c_prpddes in (select a.id_prpddes_bien
                                        ...
                                        join mc_d_propiedades_bien_entidad b
                                          on a.id_prpddes_bien =
                                             b.id_prpddes_bien
                                       where b.id_entddes =
                                             c_entddes.id_entddes) loop
  ...
  begin
    ...
    v_slct_sjto_impsto := v_slct_sjto_impsto ||
                          ' group by b.id_impsto_sbmpsto, b.id_sjto_impsto';
    ...
    if p_id_embrgos_rslcion is not null then
      v_slct_rspnsble := v_slct_rspnsble ||
                         ...
                         ' and B.ID_EMBRGOS_RSLCION = ' ||
                         p_id_embrgos_rslcion || ' )';
    end if;
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          v_nl,
                          'Id Acto: ' || v_id_acto ||
                          ' - Codigo Respuesta: ' || v_cdgo_rspsta ||
  ...
  begin
    ...
    if p_id_usrio is not null then
      begin
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nmbre_up,
                              v_nl,
                              'Id funcionario firma: ' || p_id_usrio ||
                              ' - ' || v_nmbre_trcro,
                              1);
      exception
        when no_data_found then
          ...
          return;
        when others then
          v_mnsje := ': Error al consultar los datos del usuario.' ||
                     p_id_usrio || ' - ' || sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
    ...
    begin
      ...
      v_mnsje := 'Id_usuario: ' || v_id_usrio_apex || ' - Sesion: ' ||
                 v('APP_SESSION');
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
      ...
      if dbms_lob.getlength(v_blob) < 5 then
        raise_application_error(-20001,
                                'El v_blob tiene un tama?o err?neo');
      end if;
      ...
      begin
        select cdgo_dstno_dcmnto
         ...
         where cdgo_clnte = p_cdgo_clnte
           and id_acto_tpo in
               (select id_acto_tpo from gn_g_actos where id_acto = p_id_acto);
      exception
        when no_data_found then
          o_cdgo_rspsta  := 30;
      ...
      if (v_cdgo_dstno_dcmnto = 'BFILE') then
        ...
        begin
          select nmbre_drctrio
            ...
            from gn_d_actos_tipo
           where cdgo_clnte = p_cdgo_clnte
             and id_acto_tpo in (select id_acto_tpo
                                   from gn_g_actos
        ...
        exception
          ...
          when others then
            o_cdgo_rspsta  := 40;
            o_mnsje_rspsta := 'Error al intentar consultar el directorio de destino.' ||
                              sqlerrm;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
    ...
    exception
      when others then
        ...
        v_mnsje := 'No se pudo Generar el Archivo del Documento del acto #:' ||
                   nvl(p_id_acto, 0) || ' - ' || sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
  ...
  begin
    ...
    exception
      when no_data_found then
        ...
        return;
      when others then
        v_mnsje        := 'Error al intentar consultar datos del funcionario. ' ||
                          sqlerrm;
        o_cdgo_rspsta  := 5;
        o_mnsje_rspsta := v_mnsje;
        return;
    ...
    for c_crtra in (select id_embrgos_crtra,
                      ...
                      from json_table(p_json,
                                      '$[*]' columns(id_embrgos_crtra number path
                                              '$.ID_EMBRGOS_CRTRA',
                                              --ID_SJTO           number path '$.ID_SJTO',
                                              id_instncia_fljo number path
                                              '$.ID_INSTNCIA_FLJO',
                                              id_fljo_trea number path
                                              '$.ID_FLJO_TREA'))) loop
      ...
      if v_type = 'S' then
        ...
        if o_id_lte_mdda_ctlar_ip = 0 then
          ...
          exception
            when others then
              o_cdgo_rspsta  := 10;
              o_mnsje_rspsta := 'Error al intentar registrar lote NPE. ' ||
                                sqlerrm;
              return;
          end;
        ...
        if v_id_lte_mdda_ctlar is null or v_id_lte_mdda_ctlar = 0 then
          ...
          exception
            when others then
              o_cdgo_rspsta  := 20;
              o_mnsje_rspsta := 'Error al intentar crear lote de Embargo. ' ||
                                sqlerrm;
              return;
          end;
        ...
        exception
          ...
          when others then
            o_cdgo_rspsta  := 25;
            o_mnsje_rspsta := 'Error al intentar consultar el tipo de Medida Cautelar. ' ||
                              sqlerrm;
            return;
        end;
        ...
        if v_prmte_embrgar = 'S' then
          ...
          exception
            when others then
              o_cdgo_rspsta  := 30;
              o_mnsje_rspsta := 'Error al intentar registrar Resoluci?n de Embargo. ' ||
                                sqlerrm;
              return;
          end;
          ...
          for c_rspnsbles in (select a.id_embrgos_rspnsble
                               ...
                               where exists (select 1
                                        from mc_g_solicitudes_y_oficios b
                                       where (b.id_embrgos_rspnsble =
                                             a.id_embrgos_rspnsble or
                                             b.id_embrgos_rspnsble is null)
                                         and b.id_embrgos_crtra =
                                             a.id_embrgos_crtra
                                         and b.activo = 'S')
                                 and a.id_embrgos_crtra =
                                     c_crtra.id_embrgos_crtra
                                 and a.activo = 'S') loop
            begin
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          v_nmbre_up,
                          v_nl,
                          'Entrando a la up que genera los documentos de embargo ' ||
                          systimestamp,
                          1);
    begin
      select id_fncnrio
    ...
    exception
      ...
      when others then
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := 'Error al intentar consultar datos del funcionario. ' ||
                          sqlerrm;
        return;
    end;

    o_mnsje_rspsta := 'Id del funcionario: ' || v_id_fncnrio ||
                      ' - p_tpo_plntlla: ' || p_tpo_plntlla;
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
                          v_nl,
    ...
    o_mnsje_rspsta := 'Tip_Plantilla: ' || p_tpo_plntlla || ' - Masivo:' ||
                      v_msvo;
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
    ...
    for c_embrgos in (select a.id_embrgos_rslcion,
                        ...
                        from json_table(p_json_rslciones,
                                        '$[*]' columns(id_embrgos_rslcion
                                                number path '$.ID_ER',
                                                id_embrgos_crtra number path
                                                '$.ID_EC',
                                                id_instncia_fljo number path
                                                '$.ID_IF')) a
      ...
      o_mnsje_rspsta := 'for c_embrgos - id_embrgos_crtra: ' ||
                        c_embrgos.id_embrgos_crtra;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
      ...
      o_mnsje_rspsta := 'Tip_acto: ' || v_cdgo_acto_tpo_rslcion ||
                        ' - Consecut: ' || v_cdgo_cnsctvo ||
                        ' - Plantilla: ' || v_id_plntlla_rslcion ||
      ...
      o_mnsje_rspsta := 'Cod_octo: ' || v_cdgo_acto_tpo_ofcio ||
                        ' - Consecut: ' || v_cdgo_cnsctvo_oficio ||
                        ' - Oficio: ' || v_id_plntlla_ofcio;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
      ...
      if v_prmte_embrgar = 'S' then
        ...
        if (p_gnra_ofcio = 'S') then
          for c_entddes in (select a.id_slctd_ofcio, a.id_embrgos_rspnsble
            ...
            v_data := '<id_embrgos_crtra>' || c_embrgos.id_embrgos_crtra ||
                      '</id_embrgos_crtra><id_slctd_ofcio>' ||
                      c_entddes.id_slctd_ofcio ||
                      '</id_slctd_ofcio><id_acto>' || v_id_acto_ofi ||
                      '</id_acto>';

            v_documento_ofi := pkg_gn_generalidades.fnc_ge_dcmnto(v_data,
                                                                  v_id_plntlla_ofcio);
  ...
  begin
    ...
    v_mnsje_rspsta := '2 - tpo_plntlla: ' || p_tpo_plntlla || ' - msvo: ' ||
                      v_msvo;
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
    ...
    for c_dsmbrgos in (select a.id_dsmbrgos_rslcion,
                         ...
                         from json_table(p_json_rslciones,
                                         '$[*]'
                                         columns(id_dsmbrgos_rslcion number path
                                                 '$.ID_DR',
                                                 id_embrgos_crtra number path
                                                 '$.ID_EC',
                                                 id_instncia_fljo number path
                                                 '$.ID_IF',
                                                 id_tpos_mdda_ctlar number path
                                                 '$.ID_TMC',
                                                 id_csles_dsmbrgo number path
                                                 '$.ID_CD',
                                                 id_fljo_trea number path
                                                 '$.ID_FT',
                                                 id_fljo_trea_estdo number path
                                                 '$.ID_FTE')) a
      ...
      v_mnsje_rspsta := '3 - Datos plantilla Resoluciones - cdgo_acto_tpo_rslcion: ' ||
                        v_cdgo_acto_tpo_rslcion || ' - cdgo_cnsctvo: ' ||
                        v_cdgo_cnsctvo || ' - id_plntlla_rslcion: ' ||
                        v_id_plntlla_rslcion;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
      ...
      select a.id_acto_tpo, c.cdgo_cnsctvo, b.id_plntlla
       ...
       inner join df_c_consecutivos c
          on c.id_cnsctvo = b.id_cnsctvo
       where (b.id_csles_dsmbrgo = c_dsmbrgos.id_csles_dsmbrgo or
             b.id_csles_dsmbrgo is null)
      ...
      for c_ofcios in (select a.id_dsmbrgo_ofcio, b.id_embrgos_rspnsble
                        ...
                        where a.id_dsmbrgos_rslcion =
                              c_dsmbrgos.id_dsmbrgos_rslcion) loop
        ...
        if (p_gnra_ofcio = 'S') then
          ...
          v_mnsje_rspsta := '7 - Datos del Acto Oficio - Id_Acto_Ofi: ' ||
                            v_id_acto_ofi;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
          ...
          v_mnsje_rspsta := '8 - Datos del Documento Oficio - HTML.' ||
                            v_id_acto_ofi;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
  ...
  begin
        ...
        from (select DISTINCT (id_embrgos_rslcion) as id_embrgos_rslcion
               ...
               where id_embrgos_rslcion in
                     (select b.id_rslcnes
                        from json_table(p_json_rslciones,
                                        '$[*]'
                                        columns(id_rslcnes varchar2(4000) PATH
                                                '$.ID_ER')) b)
                 and gnra_ofcio = 'S');
    exception
      when no_data_found then
    ...
    for c_crtra in (select a.id_embrgos_rslcion,
      ...
      o_mnsje_rspsta := 'Codigo Acto: ' || v_cdgo_acto_tpo_rslcion ||
                        ' - Codigo Consecutivo: ' || v_cdgo_cnsctvo ||
                        ' - Plantilla Resoluci?n: ' || v_id_plntlla_rslcion;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
      ...
      o_mnsje_rspsta := 'Codigo Acto: ' || v_cdgo_embrgos_tpo ||
                        ' - Tipo Impresi?n Oficio: ' ||
                        v_tpo_imprsion_ofcio;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
      ...
      if v_prmte_embrgar = 'S' then
        ...
        if c_crtra.id_acto is null then
          ...
          v_data := '<data><id_embrgos_rslcion>' ||
                    c_crtra.id_embrgos_rslcion ||
        ...
        o_mnsje_rspsta := 'Id Reporte Resoluci?n: ' || v_id_rprte ||
                          ' - data: ' || v_data;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
  ...
  exception
    when others then
      rollback;
      v_mnsje        := 'Error al realizar la generacion de actos de medida cautelar. ' ||
                        sqlerrm;
      o_cdgo_rspsta  := 99;
      o_mnsje_rspsta := v_mnsje;
  ...
  begin
      ...
      from (select DISTINCT (id_dsmbrgos_rslcion) as id_dsmbrgos_rslcion
             ...
             where id_dsmbrgos_rslcion in
                   (select b.id_dsmbrgos_rslcion
                      from json_table(p_json_rslciones,
                                      '$[*]'
                                      columns(id_dsmbrgos_rslcion
                                              varchar2(400) PATH '$.ID_DR')) b));
    ...
    for c_dsmbrgo in (select a.id_dsmbrgos_rslcion,
      ...
      v_mnsje := 'Datos plantilla resoluci?n - v_cdgo_acto_tpo_rslcion: ' ||
                 v_cdgo_acto_tpo_rslcion || ' - v_cdgo_cnsctvo: ' ||
                 v_cdgo_cnsctvo || ' - v_id_plntlla_rslcion: ' ||
                 v_id_plntlla_rslcion;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
      ...
      v_mnsje := 'Datos embargo - v_cdgo_embrgos_tpo: ' ||
                 v_cdgo_embrgos_tpo || ' - v_tpo_imprsion_ofcio: ' ||
                 v_tpo_imprsion_ofcio;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
      ...
      for c_ofcios in (select c.id_dsmbrgo_ofcio,
                        ...
                        where a.id_embrgos_crtra =
                              c_dsmbrgo.id_embrgos_crtra
                          and c.id_dsmbrgos_rslcion =
                              c_dsmbrgo.id_dsmbrgos_rslcion
                          and a.activo = 'S'
        ...
        -- Y el tipo de impresion de oficio sea "IND" -> "INDIVIDUAL"
        -- Entonces generamos la plantilla normal
        if (v_cdgo_embrgos_tpo in ('BIM', 'FNC') and
           v_tpo_imprsion_ofcio = 'IND') then
          ...
          -- Y el tipo de impresion de oficio sea "GEN" -> "GENERALIDADO"
          -- Entonces generamos el BLOB con la plantilla generalizada
        elsif (v_cdgo_embrgos_tpo in ('BIM', 'FNC') and
              v_tpo_imprsion_ofcio = 'GEN') then
          ...
          select json_object('id_rprte' value v_id_rprte,
                             'cdgo_clnte' value p_cdgo_clnte,
                             'id_dsmbrgo_ofcio' value
                             c_ofcios.id_dsmbrgo_ofcio,
                             'id_slctd_ofcio' value c_ofcios.id_slctd_ofcio,
                             'id_tpos_mdda_ctlar' value
                             c_dsmbrgo.id_tpos_mdda_ctlar,
                             'id_dsmbrgos_rslcion' value
                             json_object('id_dsmbrgos_rslcion' value
                                         v_dsmbrgos_rslcion))
            into v_data
            from dual;
          ...
          if v_tpo_imprsion_ofcio = 'IND' then
            ...
            select json_object('id_rprte' value v_id_rprte,
                               ...
                               'id_dsmbrgo_ofcio' value
                               c_ofcios.id_dsmbrgo_ofcio,
                               'id_slctd_ofcio' value
                               c_ofcios.id_slctd_ofcio,
                               'id_tpos_mdda_ctlar' value
                               c_dsmbrgo.id_tpos_mdda_ctlar,
                               'id_dsmbrgos_rslcion' value
                               json_object('id_dsmbrgos_rslcion' value
    ...
    if v_id_fncnrio is not null or v_id_fncnrio > 0 then
      ...
      for embargos in (select a.id_embrgos_rslcion,
        ...
        begin
          ...
          v_mnsje := '3. Dato - v_id_fljo_trea_estdo: ' ||
        ...
        v_mnsje := '4. Embargos.id_instncia_fljo:' ||
                   embargos.id_instncia_fljo || 'embargos.id_fljo_trea: ' ||
                   embargos.id_fljo_trea ||
        ...
        v_mnsje := '5. embargos.id_instncia_fljo:' ||
                   embargos.id_instncia_fljo || 'embargos.id_fljo_trea: ' ||
                   embargos.id_fljo_trea || ' v_id_fljo_trea:' ||
                   v_id_fljo_trea || ' v_type:' || v_type || ' v_mnsje:' ||
                   v_mnsje || ' v_id_fljo_trea_estdo:' ||
                   v_id_fljo_trea_estdo || ' v_error:' || v_error;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
        ...
        if v_type = 'S' then
          ...
          if v_id_fljo_trea_estdo is not null then
            ...
            v_mnsje := '9. Dato - v_id_instncia_trnscion: ' ||
  ...
  begin
    ...
    for desembargos in (select a.id_dsmbrgos_rslcion,
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            6,
                            'embargos.id_instncia_fljo:' ||
                            desembargos.id_instncia_fljo ||
                            'embargos.id_fljo_trea: ' ||
                            desembargos.id_fljo_trea || ' v_id_fljo_trea:' ||
                            v_id_fljo_trea || ' v_type:' || v_type ||
                            ' v_mnsje:' || v_mnsje || ' v_error:' ||
                            v_error || ' ' || systimestamp,
                            6);
      ...
      if v_type = 'S' then
        ...
        values
          (v_id_lte_mdda_ctlar_ip,
           desembargos.id_dsmbrgos_rslcion,
           v_mnsje);
        --pkg_sg_log.prc_rg_log( p_cdgo_clnte, null, 'pkg_cb_proceso_juridico.prc_rg_proceso_juridico',  v_nl, 'se escribe en el detalle el sujeto '||sujetos.id_prcsos_smu_sjto||' lote igual a '||V_id_prcso_jrdco_lte_ip || systimestamp, 6);
  ...
  function fnc_rt_csal_dsmbargo(p_id_embrgos_crtra in number,
                                p_cdgo_clnte       in number) return number is
  ...
  begin
    ...
    -- ===================================================================================
    -- PASO 1 (NUEVA PRIORIDAD): Buscar primero si existe una solicitud de desembargo.
    -- ===================================================================================
    ...
    -- Si la función anterior encontró una causal por solicitud, se retorna inmediatamente.
    if v_id_csles_dsmbrgo is not null then
      return v_id_csles_dsmbrgo;
    end if;

    -- ===================================================================================
    -- PASO 2: Si no se encontró solicitud, continuar con la lógica original de saldo en cartera.
    -- ===================================================================================
    v_vlor_sldo_cptal := pkg_cb_medidas_cautelares.fnc_vl_saldo_cartera_desembrgo(p_tpo_crtra        => 'CE',
                                                                                  p_id_embrgos_crtra => p_id_embrgos_crtra,
                                                                                  p_cdgo_clnte       => p_cdgo_clnte);

    -- Determinar el tipo de desembargo basado en el saldo
    ...
    -- ===================================================================================
    -- PASO 3: Con el tipo de desembargo, obtener el ID de la causal.
    -- ===================================================================================
    -- Solo intentar la búsqueda si se obtuvo un tipo de desembargo en el paso anterior.
    if v_tpo_desembargo is not null then
      ...
      exception
        when no_data_found then
          -- Si no se encuentra una causal para el código, se asigna null.
          v_id_csles_dsmbrgo := null;
      end;
    end if;

    -- ===================================================================================
    -- PASO 4: Retornar el ID de la causal encontrada (o null si no se encontró ninguna).
    -- ===================================================================================
    return v_id_csles_dsmbrgo;

  end fnc_rt_csal_dsmbargo;
  ...
  begin
    ...
    v_vlor_sldo_cptal := 0;
    v_vlor_sldo_cptal := pkg_cb_medidas_cautelares.fnc_vl_saldo_cartera_desembrgo(p_tpo_crtra        => 'CE', --p_tpo_crtra,
                                                                                  p_id_embrgos_crtra => p_id_embrgos_crtra,
                                                                                  p_cdgo_clnte       => p_cdgo_clnte);
      ...
      begin
        ...
        select a.id_dsmbrgo_slctud, count(b.id_dsmbrgo_slctud_entddes)
         ...
         where a.id_embrgos_rslcion = v_id_embrgos_rslcion
           ...
           and a.id_dsmbrgo_slctud =
               (select max(c.id_dsmbrgo_slctud)
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          ...
                          'pkg_cb_medidas_cautelares.prc_procesar_embargo',
                          v_nl,
                          'Entrando a la up que genera el proceso de embargo ' ||
                          systimestamp,
                          1);
    ...
    for cartera in (select id_embrgos_crtra,
      ...
      if v_prmte_embrgar = 'S' then
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              '</id_embrgos_crtra><id_embrgos_rslcion>' ||
                              v_id_embrgos_rslcion ||
                              '</id_embrgos_rslcion>' || ' PLANTILLA:' ||
                              v_id_plntlla_rslcion || systimestamp,
                              1);
        v_documento := pkg_gn_generalidades.fnc_ge_dcmnto('<id_embrgos_crtra>' ||
                                                          cartera.id_embrgos_crtra ||
                                                          '</id_embrgos_crtra><id_embrgos_rslcion>' ||
      ...
      if p_tpo_dsmbrgo = 'T' then
        ...
        for oficios in (select b.id_slctd_ofcio, b.id_embrgos_rspnsble
                         ...
                         (select 1
                                 ...
                                 where a.id_embrgos_rslcion =
                                   ...
                                   and (a.id_embrgos_rspnsble =
                                       b.id_embrgos_rspnsble or
        ...
        for oficios in (select a.id_slctd_ofcio,
                          ...
                          from json_table(p_json_oficios,
                                          '$[*]'
                                          columns(id_slctd_ofcio number path
                                                  '$.ID_SO',
                                                  id_embrgos_rslcion number path
                                                  '$.ID_ER',
                                                  id_embrgos_crtra number path
                                                  '$.ID_EC')) a,
  ...
  begin
    ...
    begin
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_nmbre_up,
                            v_nl,
                            'numero maximo de registros a procesar ' ||
                            v_nmro_rslcion_mxmo_sncrno,
                            1);
    exception
      when no_data_found then
        o_cdgo_rspsta  := 10;
    ...
    if (v_nmro_regstro_prcsmnto <= v_nmro_rslcion_mxmo_sncrno) then
      ...
      exception
        when others then
          o_cdgo_rspsta  := 50;
          o_mnsje_rspsta := '|MCT_TPO_PRCSMNTO CDGO: ' || o_cdgo_rspsta ||
                            'Problema al iniciar el desembargo masivo.' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      begin
        ...
        for embargos in (select a.cdgo_clnte,
                                a.id_instncia_fljo,
                                a.cdgo_csal
                           from json_table(p_json_embargos,
                                           '$[*]'
                                           columns(cdgo_clnte number path
                                                   '$.ID_CC',
                                                   id_instncia_fljo number path
                                                   '$.ID_IF',
                                                   cdgo_csal varchar2 path
                                                   '$.CD_TD')) a
      ...
      begin
        ...
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              ...
                              v_nmbre_up,
                              v_nl,
                              'Entrando al Else p_csles_dsmbargo' ||
                              p_csles_dsmbargo,
                              1);
      ...
      exception
        when others then
          o_cdgo_rspsta  := 70;
          o_mnsje_rspsta := '|MCT_TPO_PRCSMNTO CDGO: ' || o_cdgo_rspsta ||
                            'Problema al iniciar job desembargo masivo.' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
  ...
  begin
    ...
    o_cdgo_rspsta := 0;
    v_mnsje_error := 'p_cdgo_clnte - ' || p_cdgo_clnte || 'p_id_usuario - ' ||
                     p_id_usuario || 'p_csles_dsmbargo - ' ||
                     p_csles_dsmbargo || 'p_json_embargos - ' ||
    ...
    begin
      ...
      v_mnsje_error := 'v_id_estdos_crtra: ' || v_id_estdos_crtra ||
                       ' v_id_fljo_trea: ' || v_id_fljo_trea;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
    ...
    begin
      ...
      v_mnsje_error := 'v_cnsctivo_lte: ' || v_cnsctivo_lte ||
                       ' o_id_lte_mdda_ctlar: ' || o_id_lte_mdda_ctlar;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
    ...
    for embargos in (select a.id_embrgos_rslcion,
      ...
      begin
        ...
        v_mnsje_error := 'v_cdgo_acto_tpo_rslcion: ' ||
                         v_cdgo_acto_tpo_rslcion || ' v_cdgo_cnsctvo: ' ||
                         v_cdgo_cnsctvo || ' v_id_plntlla_rslcion: ' ||
                         v_id_plntlla_rslcion;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
      ...
      v_mnsje_error := 'embargos.id_embrgos_crtra: ' ||
                       embargos.id_embrgos_crtra ||
      ...
      begin
        ...
        v_mnsje_error := 'v_id_acto: ' || v_id_acto || ' v_fcha: ' ||
                         v_fcha || ' v_nmro_acto: ' || v_nmro_acto;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
      ...
      exception
        when others then
          o_cdgo_rspsta := 10;
          v_mnsje_error := 'CDG-' || o_cdgo_rspsta ||
                           ': No se pudo generar el acto de resoluci?n de desembargo. ' ||
                           sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      exception
        when others then
          o_cdgo_rspsta := 11;
          v_mnsje_error := 'Error al actualizar la informaci?n del desembargo. ' ||
                           sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      begin
        update mc_g_desembargos_resolucion
           set dcmnto_dsmbrgo = to_clob(v_documento),
               id_plntlla     = v_id_plntlla_rslcion
         where id_dsmbrgos_rslcion = v_id_dsmbrgos_rslcion;
      ...
      exception
        when others then
          o_cdgo_rspsta := 16;
          v_mnsje_error := 'Error al generar el blob de la resolucion de desembargo. ' ||
                           sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
      ...
      exception
        when others then
          o_cdgo_rspsta := 28;
          v_mnsje_error := 'CDG-' || o_cdgo_rspsta ||
                           ': No se pudo actualizar la poblaci?n.' ||
                           sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
    ...
    if (v_count = 0) then
      ...
      o_cdgo_rspsta := 0;
      --o_mnsje_rspsta := 'Se Genero el Lote de Desembargo No. ' || v_cnsctivo_lte || ' con un  numero total de ' || v_count|| ' desembargos.';
      v_mnsje_error := 'Se Genero el Lote de Desembargo No. ' ||
                       v_cnsctivo_lte || ' con un  numero total de ' ||
                       v_count || ' desembargos.';
  ...
  begin
    ...
    if p_request = 'CREATE' then
      ...
      begin
        ...
        delete from mc_g_secuestre_documentos
         where id_scstre_dcmnto = p_id_scstre_dcmnto;
  ...
  begin
    ...
    for documentos in (select b.dscrpcion,
                              a.id_actos_tpo_trea,
                              a.id_acto_tpo,
                              c.id_scstre_dcmnto
  ...
  begin
    ...
    for mddas_ctlres in (select id_scstre_gstion
                           from json_table(p_json_mddas,
                                           '$[*]'
                                           columns(id_scstre_gstion number path
                                                   '$.ID_SG'))) loop
  ...
  begin
    ...
    select count(a.id_embrgos_rspnsble)
     ...
     where trim(a.idntfccion) = trim(v_idntfccion)
       and (v_nmbre_cmplto is null or
            a.nmbre_cmplto like '%' || trim(v_nmbre_cmplto) || '%')
  ...
  begin
    ...
    for cartera in (select a.id_embrgos_crtra,
                           a.id_sjto_impsto,
                           a.vgncia,
                           a.id_prdo
         ...
         and a.id_mvmnto_dtlle =
             (select max(e.id_mvmnto_dtlle)
               ...
               where f.cdgo_clnte = p_cdgo_clnte
                 ...
                 and exists
               (select 1
                        from mc_g_embargos_cartera_detalle i
                       where i.id_embrgos_crtra = p_id_embrgos_crtra
                         and i.vgncia = e.vgncia
                         and i.id_prdo = e.id_prdo
                         and i.id_cncpto = e.id_cncpto));
  ...
  function fnc_cl_embargo_cartera_estado(p_id_embrgos_crtra in number,
                                         p_cdgo_clnte       in number)
    ...
    for c_vgncias in (select listagg(vgncia, ', ') within group(order by vgncia) vgncias,
                             ...
                             case
                               when a.cdgo_mvnt_fncro_estdo = 'CN' then
                                'Convenio'
                               when a.cdgo_mvnt_fncro_estdo = 'NO' and
                                    sum(sldo_crtra) = 0 then
                                'Pago'
      ...
      v_dscrpcion  := v_dscrpcion || 'Causal: ' ||
                      c_vgncias.dsccrpcion_csal || ' (' ||
                      c_vgncias.vgncias || ') ';
      v_count      := v_count + 1;
  ...
  */
  ...
  begin
    ...
    begin
      delete mc_g_desembargos_poblacion where cdgo_clnte = p_cdgo_clnte;
    exception
      when others then
        o_cdgo_rspsta  := 10;
        o_mnsje_rspsta := 'PRC_AC_DS_PB CDGO: ' || o_cdgo_rspsta ||
                          '  No se Pudo Realizar el Proceso de Borrado de la Poblacion de Desembargo' ||
                          sqlerrm;
        rollback;
    end;
    if o_cdgo_rspsta = 0 then
      ...
      for c_dsmbrgos_pblcion in (select b.nmro_acto,
                                  ...
                                  inner join mc_d_tipos_mdda_ctlar g
                                   ...
                                   join table(pkg_cb_medidas_cautelares.fnc_cl_embargo_cartera_estado(p_id_embrgos_crtra => a.id_embrgos_crtra, p_cdgo_clnte => p_cdgo_clnte)) h
                                     on h.id_embrgos_crtra =
                                        a.id_embrgos_crtra
                                  where a.cdgo_clnte = p_cdgo_clnte
                                    and case --case agregado para la validacion de la cartera
                                          when cdgo_csal = 'P' and
                                               h.sldo_crtra = 0 then
                                           1
                                          when cdgo_csal = 'C' then
                                           1
                                          else
                                           0
                                        end = 1
                                  ...
                                  where a.cdgo_clnte = p_cdgo_clnte
                                    ...
                                    and b.id_embrgos_rslcion not in
                                        (select id_embrgos_rslcion
                                           from mc_g_desembargos_poblacion)
                                    and g.actvo = 'S') loop
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
                              'v_idntfccion_sjto dentro del for: ' ||
                              v_idntfccion_sjto,
                              6);
        insert into mc_g_desembargos_poblacion
          (nmro_acto,
                       ...
                       from (select b.cdgo_clnte,
                                    ...
                                    (select listagg(vgncia, ',') within group(order by vgncia)
                                       from (select distinct vgncia
                                              ...
                                              where b.id_embrgos_crtra =
                                                    dtl.id_embrgos_crtra) a) as vgncias,
                                    b.id_instncia_fljo,
                                    c.id_fljo_trea,
                                    c.cdgo_estdos_crtra
                               from mc_g_embargos_resolucion a
                               ...
                               join (select m.id_embrgos_crtra
                                      ...
                                      join mc_g_embargos_resolucion r
                                        on r.id_embrgos_crtra =
                                           a.id_embrgos_crtra
                                      join mc_g_solicitudes_y_oficios s
                                        on s.id_embrgos_crtra =
                                           r.id_embrgos_crtra
                                      join mc_g_embrgos_crt_prc_jrd p
                                        on p.id_embrgos_crtra =
                                           a.id_embrgos_crtra
                                      left join (select x.id_embrgos_crtra,
                                                       y.id_dsmbrgos_rslcion
                                                  from mc_g_desembargos_cartera x
                                                  join mc_g_desembargos_resolucion y
                                                    on x.id_dsmbrgos_rslcion =
                                                       y.id_dsmbrgos_rslcion) b
                                        on b.id_embrgos_crtra =
                                           a.id_embrgos_crtra
                                      join v_gf_g_cartera_x_concepto c
                                        on c.cdgo_clnte = m.cdgo_clnte
  ...
  begin
    ...
    begin
      ...
      o_mnsje_rspsta := 'cdgo_ofcio_tpo' ||
                        t_mc_d_configuraciones_gnral.cdgo_ofcio_tpo;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
    ...
    if t_mc_d_configuraciones_gnral.cdgo_ofcio_tpo = 'OLT' then
      ...
      exception
        ...
        when others then
          o_cdgo_rspsta  := 4;
          o_mnsje_rspsta := 'CDG -' || o_cdgo_rspsta ||
                            ': Error al consultar la informaci?n del tipo de acto.' ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
        ...
        begin
          update mc_g_desembargos_oficio
             set id_acto    = v_id_acto_ofcio,
                 ...
                 (select a.nmro_acto
                    from gn_g_actos a
                   where a.id_acto = v_id_acto_ofcio)
    ...
    if t_mc_d_configuraciones_gnral.cdgo_ofcio_tpo = 'OER' then
      ...
      for c_dsmbrgos in (select c.id_embrgos_crtra,
        ...
        begin
          ...
          o_mnsje_rspsta := 'v_cdgo_acto_tpo_ofcio: ' ||
                            v_cdgo_acto_tpo_ofcio ||
                            ' v_cdgo_cnsctvo_ofcio: ' ||
                            v_cdgo_cnsctvo_ofcio || ' v_id_plntlla_ofcio: ' ||
                            v_id_plntlla_ofcio || ' v_id_rprte_ofcio: ' ||
                            v_id_rprte_ofcio;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
        ...
        for c_ofcios in (select b.id_slctd_ofcio, b.id_embrgos_rspnsble
                           from v_mc_g_solicitudes_y_oficios b
                          where b.id_embrgos_rslcion =
                                c_dsmbrgos.id_embrgos_rslcion
                            and b.id_embrgos_crtra =
                                c_dsmbrgos.id_embrgos_crtra) loop

          o_mnsje_rspsta := 'c_ofcios.id_slctd_ofcio ' ||
                            c_ofcios.id_slctd_ofcio ||
                            ', c_ofcios.id_embrgos_rspnsble: ' ||
                            c_ofcios.id_embrgos_rspnsble;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
  ...
  exception
    ...
    when others then
      o_cdgo_rspsta  := 99;
      o_mnsje_rspsta := 'CDG-' || o_cdgo_rspsta ||
                        ': Error al generar oficio de desembargo.' ||
                        sqlerrm;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
  ...
  begin
    ...
    SELECT RTRIM(XMLAGG(XMLELEMENT(E, id_embrgos_rslcion || ',') ORDER BY id_embrgos_rslcion).EXTRACT('//text()').GETCLOBVAL(),
                 ',')
      into v_embrgos_rslcion
      FROM (SELECT DISTINCT id_embrgos_rslcion
              FROM mc_g_solicitudes_y_oficios O
             WHERE id_embrgos_rslcion in
                   (select b.id_rslcnes
                      from json_table(p_json_rslciones,
                                      '$[*]' columns(id_rslcnes varchar2(50) PATH
                                              '$.ID_ER')) b)
               AND gnra_ofcio = 'N');
    /* Actualizado JLUJAN 24/07/2025
      select LISTAGG(id_embrgos_rslcion, ',')
        into v_embrgos_rslcion
        from (select DISTINCT (id_embrgos_rslcion) as id_embrgos_rslcion
                from mc_g_solicitudes_y_oficios
               where id_embrgos_rslcion in
                 ...
                 and gnra_ofcio = 'N');
    */
    o_mnsje_rspsta := v_embrgos_rslcion;
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
                          v_nl,
  ...
  begin
    ...
    exception
      when others then
        o_cdgo_rspsta  := 50;
        o_mnsje_rspsta := o_cdgo_rspsta || ' Error al crear el job: ' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
  ...
  begin
    ...
    v_mnsje := 'Datos - p_cdgo_clnte: ' || p_cdgo_clnte ||
               ' - p_id_usuario: ' || p_id_usuario || ' - p_id_json: ' ||
               p_id_json;
    pkg_sg_log.prc_rg_log(p_cdgo_clnte, null, v_nmbre_up, v_nl, v_mnsje, 1);
  ...
  begin
    ...
    for c_crtra in (select a.id_embrgos_crtra,
      ...
      o_mnsje_rspsta := '2 - Datos del oficio - v_cdgo_acto_tpo_ofcio: ' ||
                        v_cdgo_acto_tpo_ofcio ||
                        ' - v_cdgo_cnsctvo_oficio: ' ||
                        v_cdgo_cnsctvo_oficio || ' - v_id_plntlla_ofcio: ' ||
                        v_id_plntlla_ofcio;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
      ...
      o_mnsje_rspsta := '3 - Datos del embargo tipo - v_cdgo_embrgos_tpo: ' ||
                        v_cdgo_embrgos_tpo || ' - v_tpo_imprsion_ofcio: ' ||
                        v_tpo_imprsion_ofcio;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
      ...
      for c_entddes in (select a.id_slctd_ofcio,
        ...
        if (v_cdgo_embrgos_tpo in ('BIM', 'FNC') and
          ...
          o_mnsje_rspsta := '5 - Id Reporte Oficio: ' || v_id_rprte ||
                            ' - data: ' || v_data;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
          ...
          if c_entddes.id_acto_ofcio is null then
            ...
            select json_object('id_rprte' value v_id_rprte,
                               'id_acto_slctud' value
                               c_entddes.id_acto_slctud,
                               'cdgo_clnte' value p_cdgo_clnte,
                               'id_tpos_mdda_ctlar' value
                               c_crtra.id_tpos_mdda_ctlar,
                               'id_embrgos_rslcion' value
                               json_object('v_embrgos_rslcion' value
                                           c_crtra.id_embrgos_rslcion) --c_crtra.id_embrgos_rslcion
                               )
              into v_data
              from dual;
            ...
            select json_object('id_rprte' value v_id_rprte,
                               ...
                               'id_embrgos_rslcion' value
                               json_object('v_embrgos_rslcion' value
                                           c_crtra.id_embrgos_rslcion) --v_embrgos_rslcion--c_crtra.id_embrgos_rslcion
                               )
              into v_data
              from dual;
          ...
          o_mnsje_rspsta := '7 - Id Reporte Oficio: ' || v_id_rprte ||
                            ' - data: ' || v_data;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
          ...
          o_mnsje_rspsta := '8 - Tipo de impresion EBF: ' ||
                            v_tpo_imprsion_ofcio;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
          ...
          if v_tpo_imprsion_ofcio = 'IND' then
            ...
            o_mnsje_rspsta := '10 - Id Reporte Oficio: ' || v_id_rprte ||
                              ' - data: ' || v_data;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
        ...
        o_mnsje_rspsta := '12 - Id Reporte Oficio: ' || v_id_rprte ||
                          ' - data: ' || v_data;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
        ...
        o_mnsje_rspsta := '12 - Datos antes de generar el blob - p_cdgo_clnte: ' ||
                          p_cdgo_clnte || ' - v_id_acto_ofi: ' ||
                          v_id_acto_ofi || ' - v_data: ' || v_data ||
        ...
        update mc_g_solicitudes_y_oficios
           set gnra_ofcio     = 'S',
               rslcnes_imprsn = c_crtra.id_embrgos_rslcion
         where id_embrgos_crtra = c_crtra.id_embrgos_crtra
           and id_embrgos_rslcion = c_crtra.id_embrgos_rslcion;
  ...
  begin
    ...
    for c_crtra in (select min(a.id_embrgos_crtra) as id_embrgos_crtra,
      ...
      o_mnsje_rspsta := '4 - Datos del acto - v_id_acto_ofi: ' ||
                        v_id_acto_ofi;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
      ...
      if (v_cdgo_embrgos_tpo in ('BIM', 'FNC') and
        ...
        select json_object('id_rprte' value v_id_rprte,
                           ...
                           'id_embrgos_rslcion' value
                           json_object('v_embrgos_rslcion' value
                                       p_embrgos_rslcion) --c_crtra.id_embrgos_rslcion
                           )
          into v_data
          from dual;

        o_mnsje_rspsta := '6 - Id Reporte Oficio: ' || v_id_rprte ||
                          ' - data: ' || v_data;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
        ...
        o_mnsje_rspsta := '7 - Tipo de impresion EBF: ' ||
                          v_tpo_imprsion_ofcio;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
        ...
        if v_tpo_imprsion_ofcio = 'IND' then
          ...
          o_mnsje_rspsta := '8 - Id Reporte Oficio: ' || v_id_rprte ||
                            ' - data: ' || v_data;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
          ...
          o_mnsje_rspsta := '9 - Datos  Reporte - v_id_rprte: ' ||
                            v_id_rprte || ' - v_data: ' || v_data;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
          ...
          o_mnsje_rspsta := '10 - Datos  Reporte - v_id_rprte: ' ||
                            v_id_rprte || ' - v_data: ' || v_data;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
  ...
  begin
    ...
    if (v_vlda_entdd = 'S') then
      ...
      o_mnsje_rspsta := 'Datos de la resoluci?n - v_embrgos_crtra: ' ||
                        v_embrgos_crtra || ' - v_slctd_ofcio: ' ||
                        v_slctd_ofcio || ' - v_acto_slctud: ' ||
                        v_acto_slctud || ' - v_tpos_mdda_ctlar: ' ||
                        v_tpos_mdda_ctlar;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
        ...
        update mc_g_solicitudes_y_oficios a
         ...
         where a.id_embrgos_rslcion in
               (select id_embrgos_rslcion
                  from json_table(p_json_rslciones,
                                  '$[*]'
                                  columns(id_embrgos_rslcion varchar2(400) PATH
                                          '$.ID_ER')))
           and a.id_entddes in
               (select id_entddes
                  from mc_d_entidades
      ...
      if (v_cdgo_embrgos_tpo in ('BIM', 'FNC') and
        ...
        v_data := '<data><id_slctd_ofcio>' || v_slctd_ofcio ||
                  '</id_slctd_ofcio></data>';
  ...
  begin
    ...
    for c_dsmbrgos in (select a.id_dsmbrgos_rslcion,
      ...
      for c_ofcios in (select a.id_dsmbrgo_ofcio, b.id_embrgos_rspnsble
        ...
        o_mnsje_rspsta := '3 - datos del acto - id_acto_ofi: ' ||
                          v_id_acto_ofi;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
    ...
    for c_dsmbrgo in (select a.id_dsmbrgos_rslcion,
      ...
      for c_ofcios in (select c.id_dsmbrgo_ofcio,
        ...
        if (v_cdgo_embrgos_tpo in ('BIM', 'FNC') and
          ...
          o_mnsje_rspsta := '8 - id_rprte: ' || v_id_rprte || ' - data: ' ||
                            v_data;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
          ...
          select json_object('id_rprte' value v_id_rprte,
                             ...
                             'id_dsmbrgos_rslcion' value
                             json_object('id_dsmbrgos_rslcion' value
                                         c_ofcios.id_dsmbrgos_rslcion) --v_dsmbrgos_rslcion)
                             )
            into v_data
            from dual;

          o_mnsje_rspsta := '9 - id_rprte: ' || v_id_rprte || ' - data: ' ||
                            v_data;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
          ...
          o_mnsje_rspsta := '10 - tpo_imprsion_ofcio: ' ||
                            v_tpo_imprsion_ofcio;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
  ...
  begin
    ...
    if v_id_prcso_dsmbrgo is null then
      o_cdgo_rspsta  := 10;
      o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                        ' - No se pudo obtener el ID PROCESO DE DESEMBARGO de los parametros de configuracion';
      return;
    end if;
    ...
    if (v_vlda_entdad > 0) then
      ...
      exception
        when no_data_found then
          o_cdgo_rspsta  := 20;
          o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                            ' - No se encontro informacion del tipo de medida cautelar.';
          return;
        when others then
          o_cdgo_rspsta  := 20;
          o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                            ' - Error al intentar consultar informacion del tipo de medida cautelar. ' ||
                            sqlerrm;
          return;
      end;
      ...
      exception
        when no_data_found then
          o_cdgo_rspsta  := 30;
          o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                            ' - No se obtuvo datos de la plantilla de los Oficios.';
          return;
        when others then
          o_cdgo_rspsta  := 30;
          o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                            ' - Error al intentar consultar informacion de la plantilla de los Oficios. ' ||
                            sqlerrm;
          return;
      end;
      ...
      if (v_id_acto_ofi is null) then
        o_cdgo_rspsta  := 40;
        o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                          ' - No se genero el acto generalizado.';
        return;
      end if;
      ...
      update mc_g_desembargos_oficio
         set id_acto   = v_id_acto_ofi,
             fcha_acto = v_fcha_ofi,
             nmro_acto = v_nmro_acto_ofi
       where id_dsmbrgo_ofcio in
             (select e.id_dsmbrgo_ofcio
                from json_table(p_json_rslciones,
                                '$[*]'
                                columns(id_dsmbrgos_rslcion number path
                                        '$.ID_DR',
      ...
      if (v_documento_ofi is null) then
        o_cdgo_rspsta  := 50;
        o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                          ' - No se genero el documento del oficio generalizado.';
        return;
      end if;
      --insert into muerto (n_001,v_001,c_001,t_001) values (1020,'Documento HTML Oficios',v_documento_ofi,systimestamp);
          ...
          if (v_cdgo_embrgos_tpo in ('BIM', 'FNC') and
            ...
            exception
              when no_data_found then
                o_cdgo_rspsta  := 70;
                o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                                  ' - No se obtuvo datos del reporte.';
                return;
              when others then
                o_cdgo_rspsta  := 70;
                o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                                  ' - Error al intentar consultar informacion del reporte. ' ||
                                  sqlerrm;
                return;
            end;
            ...
            if (v_id_rprte is null) then
              o_cdgo_rspsta  := 80;
              o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                                ' - No se obtuvo la informacion del reporte parametrizado para Oficio de Desembargo (Generalizado).';
              return;
            end if;
            ...
            exception
              when no_data_found then
                o_cdgo_rspsta  := 90;
                o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                                  ' - No se obtuvo datos el tipo de impresion de oficio por tipo de entidad.';
                return;
              when others then
                o_cdgo_rspsta  := 90;
                o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                                  ' - Error al intentar consultar informacion para el tipo de impresion de oficio por tipo de entidad. ' ||
                                  sqlerrm;
                return;
            end;
            ...
            if v_tpo_imprsion_ofcio = 'IND' then
              ...
              exception
                when no_data_found then
                  o_cdgo_rspsta  := 100;
                  o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                                    ' - No se obtuvo datos para la plantilla de oficios.';
                  return;
                when others then
                  o_cdgo_rspsta  := 100;
                  o_mnsje_rspsta := 'MCT: ' || o_cdgo_rspsta ||
                                    ' - Error al intentar consultar informacion para la plantilla de oficios. ' ||
                                    sqlerrm;
                  return;
              end;
    ...
    for c_dsmbrgos in (select a.id_dsmbrgos_rslcion,
      ...
      exception
        ...
        when others then
          o_cdgo_rspsta  := 10;
          o_mnsje_rspsta := 'Error al intentar consultar informacion del tipo de medida cautelar. ' ||
                            sqlerrm;
          return;
      end;
       ...
       where id_embrgos_rslcion in
             (select id_embrgos_rslcion
                from json_table(v_json_resol,
                                '$[*]' columns(id_embrgos_rslcion number path
                                        '$.ID_ER')))
  ...
  begin
    ...
    if json_value(p_json, '$.TPO_ENTDD') = 'BR' then
      ...
      for c_embrgo in (select distinct (b.nmro_acto) nmro_acto,
                         ...
                         join mc_g_embargos_sjto c
                           on b.id_embrgos_crtra = c.id_embrgos_crtra
                         join mc_g_embrgos_crt_prc_jrd i
                           on i.id_embrgos_crtra = c.id_embrgos_crtra
                         left join cb_g_procesos_juridico_sjto d
                           on c.id_sjto = d.id_sjto
                          and d.id_prcsos_jrdco = i.id_prcsos_jrdco
                        ...
                        where a.id_embrgos_crtra in
                              (select id_embrgos_crtra
                                ...
                                where id_lte_mdda_ctlar =
                                      json_value(p_json, '$.LTE_ENTDD_BR'))
                          and a.id_entddes in
                              (select id_entddes
                                 from mc_d_entidades
                                where cdgo_entdad_tpo =
                                      json_value(p_json, '$.TPO_ENTDD'))
                        order by b.nmro_acto asc) loop
      ...
      for c_embrgo in (select distinct (b.nmro_acto) nmro_acto,
                         ...
                         left join mc_g_embargos_cartera h
                           on b.id_embrgos_crtra = h.id_embrgos_crtra
                        where a.id_embrgos_rslcion in
                              (select TO_NUMBER(rslciones)
                                 from (select level,
                                              (regexp_substr((select json_value(p_json,
                                                                               '$.RSLCNES_IMPRSN'
                                                                               RETURNING CLOB)
                                                               from dual),
                                                             '[^,]+',
                                         ...
                                         from dual
                                       connect by level <=
                                                  regexp_count((select json_value(p_json,
                                                                                 '$.RSLCNES_IMPRSN'
                                                                                 RETURNING CLOB)
                                                                 from dual),
                                                               ',') + 1
    ...
    dbms_lob.createtemporary(lob_loc => v_file_blob,
                             cache   => true,
    ...
    begin
      ...
      for c_datos in (select --b.id_sjto_impsto,
                      distinct (b.id_sjto) as id_sjto,
                        ...
                        join v_si_i_sujetos_impuesto b
                          on a.idntfccn_sjto = b.idntfccion_sjto
                       where a.id_lte = p_id_lte
                            --Modificación alcaba 2024-04-30
                         and b.id_sjto not in
                             (select 1
                                from v_cb_g_procesos_simu_sujeto h
                               where
                               --h.cdgo_clnte = a.cdgo_clnte
                                  h.id_sjto = b.id_sjto)
        ...
        begin
          insert into mc_g_embargos_simu_sujeto
            (id_embrgos_smu_lte, id_sjto, vlor_ttal_dda, fcha_ingrso)
          values
            (v_lte_simu, c_datos.id_sjto, 0, sysdate)
          returning id_embrgos_smu_sjto into v_id_embrgos_smu_sjto;
        exception
          when others then
            o_cdgo_rspsta  := 20;
            o_mnsje_rspsta := 'No se pudo registrar en mc_g_embargos_simu_sujeto - ' ||
                              sqlerrm;
            rollback;
            return;
        end;
        ...
        for responsables in (select a.prmer_nmbre,
                             ...
                             --Modificación alcaba 2024-04-30
                               join si_i_sujetos_impuesto e
                                 on e.id_sjto_impsto = a.id_sjto_impsto --Nueva linea
          ...
          for terceros in (select t.idntfccion,
            ...
            if lpad(terceros.idntfccion, 12, '0') <> '000000000000' then
              ...
              exception
                when others then
                  o_cdgo_rspsta  := 30;
                  o_mnsje_rspsta := 'No se pudo registrar en mc_g_embargos_simu_rspnsble - ' ||
                                    sqlerrm;
                  rollback;
                  return;
              end;
        ...
        for movimientos in (select a.id_sjto_impsto sujeto_impsto,
                             ...
                             where a.cdgo_clnte = p_cdgo_clnte
                               ...
                               and a.vgncia between c_datos.vgncia_dsde and
                                   c_datos.vgncia_hsta) loop
          ...
          exception
            when others then
              o_cdgo_rspsta  := 50;
              o_mnsje_rspsta := 'No se pudo registrar en mc_g_embargos_smu_mvmnto - ' ||
                                sqlerrm;
              rollback;
              return;
          end;
  ...
  function fnc_cl_slct_cncpt_crtr_embrg(p_id_prcsos_jrdco in number)
    return clob as
  ...
  begin
    ...
    for c_cnct_crtr in ( /*select
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  c.prdo,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  c.dscrpcion_cncpto*/
                        select distinct b.ID_IMPSTO_ACTO_CNCPTO,
                                         a.id_prcsos_jrdco,
                                         b.vgncia,
                                         b.prdo,
                                         b.dscrpcion_cncpto,
                         ...
                         where b.VLOR_SLDO_CPTAL > 0
                           ...
                           and b.id_prdo = a.id_prdo
                              --and b.id_cncpto = a.id_cncpto
                           and a.estdo = 'A'
                           and a.id_prcsos_jrdco = p_id_prcsos_jrdco) loop

      v_select := v_select || '<tr><td style="text-align:left;">' ||
                  c_cnct_crtr.dscrpcion_cncpto ||
                  '</td>
                                            <td style="text-align:right;">' ||
                  to_char(c_cnct_crtr.vlor_sldo_cptal,
                          'FM$999G999G999G999G999G999G990') ||
                  '</td>
                      <td style="text-align:right;">' ||
                  to_char(c_cnct_crtr.vlor_intresl,
                          'FM$999G999G999G999G999G999G990') ||
                  '</td>
                      <td style="text-align:right;">' ||
                  to_char(c_cnct_crtr.vr_deuda,
                          'FM$999G999G999G999G999G999G990') ||
                  '</td>
                                            </tr>';
    ...
    v_select := v_select ||
                '<tr><td style="text-align:left;">Total</td><td style="text-align:right;">' ||
                trim(to_char(v_ttal_cptal, 'FM$999G999G999G999G999G999G990')) ||
                '</td><td style="text-align:right;">' ||
                trim(to_char(v_ttal_intres,
                             'FM$999G999G999G999G999G999G990')) ||
                '</td><td style="text-align:right;">' ||
                trim(to_char(v_ttal, 'FM$999G999G999G999G999G999G990')) ||
                '</td></tr></table>';
