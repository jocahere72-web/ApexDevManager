  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_WF_FUNCIONES" as
  ...
  function fnc_vl_acto(p_id_acto in gn_g_actos.id_acto%type) return varchar2;
  ...
  function fnc_vl_prsc_atrzcion(p_cdgo_clnte    in number,
                                p_id_prscrpcion in number) return varchar2;
  ...
  */
  ...
  /*Funcion de gestión jurídica que valida si el recurso asociado a un flujo tiene vigencias seleccionadas*/
  function fnc_vl_gj_recurso_vgncia(p_id_instncia_fljo in number)
    return varchar2;
  /*Funcion de gestión jurídica que valida si el flujo ha sido instanciado en las tablas*/
  function fnc_vl_gj_recurso(p_id_instncia_fljo in number) return varchar2;

  /*Funcion de gestión jurídica que valida el estado air en caso de ser necesario*/
  function fnc_vl_gj_valida_air(p_id_instncia_fljo in number) return varchar2;

  /*Funcion de gestión jurídica que valida si hay actos obligatorios pendientes por generar*/
  function fnc_vl_gj_valida_actos_tarea(p_id_instncia_fljo in number,
                                        p_id_fljo_trea     in number)
    return varchar2;
  /*Funcion de gestión jurídica que valida si hay documentos obligatorios pendientes por generar*/
  ...
  function fnc_vl_gj_tpo_rcrso(p_id_instncia_fljo in number) return varchar2;
