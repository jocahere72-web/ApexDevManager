  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "PKG_PC_PORTAL_CIUDADANO" as
  ...
  /*--Jean Adies 29/01/2025
  UP que valida los registros no procesados y posteriormente elimina aquellos registros no procesados despues
  de un periodo de tiempo el cual es recibido en el parametro p_tmpo_brrdo
  */
