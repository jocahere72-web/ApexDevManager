  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "PKG_GI_RENTAS" as
  ...
  function fnc_cl_concepto_preliquidacion(p_cdgo_clnte              in number,
                                          ...
                                          p_vlor_aux_lqdcion        in number default null, --Req0026210
                                          p_id_impsto_acto_slccndo  in varchar2 default null) --Req0026754
   return g_impuesto_acto_conceptos
    ...
    v_indcdor_vlda_prdo        gi_d_rntas_cnfgrcion_sbmpst.indcdor_vlda_prdo%type := 'N';
    v_cdgo_prdcdad             gi_d_rntas_cnfgrcion_sbmpst.cdgo_prdcdad%type;
    v_indcdor_vlor_aux_lqdcion gi_d_rntas_cnfgrcion_sbmpst.indcdor_vlor_aux_lqdcion%type; --Req0026210

    v_vlor_aux_lqdcion_antrior gi_g_rentas.vlor_aux_lqdcion%type; --REQ0026214 -- 18/03/2025
    v_indcdor_acmla_bse        gi_d_rntas_cnfgrcion_sbmpst.indcdor_acmla_bse%type;
  ...
  begin
    ...
    v_mnsje_rspsta := '********** p_id_impsto: ' || p_id_impsto ||
                      ' p_id_impsto_acto_slccndo: ' ||
                      p_id_impsto_acto_slccndo || ' p_id_impsto_sbmpsto: ' ||
                      p_id_impsto_sbmpsto || ' p_id_impsto_acto: ' ||
                      p_id_impsto_acto || ' p_id_sjto_impsto: ' ||
                      p_id_sjto_impsto || ' p_json_cncptos: ' ||
                      p_json_cncptos || ' p_vlor_bse: ' || p_vlor_bse ||
                      ...
                      p_vlor_cntrto_ese || ' p_vlor_aux_lqdcion: ' ||
                      p_vlor_aux_lqdcion;
    ...
    if p_indcdor_lqdccion_adcnal = 'S' and p_id_rnta_antrior is not null then
      ...
      -- Buscamos si el subimpuesto acumula las bases gravables para los contratos adicionales
      -- y asi liquidar el nuevo contrato con la base del mismo, o la suma de todos los contratos
      -- amarrados al contrato padre -- REQ0026214 - 18/03/2025
      begin
        select indcdor_acmla_bse
          into v_indcdor_acmla_bse
      ...
      exception
        when others then
          v_indcdor_acmla_bse := 'N';
      end;

      begin
        select nvl(sum(vlor_bse_grvble), 0), nvl(sum(vlor_aux_lqdcion), 0) -- REQ0026214 - 18/03/2025
          into v_vlor_bse_antrior, v_vlor_aux_lqdcion_antrior
          from gi_g_rentas
         where id_rnta =
               (select id_rnta
        ...
        -- Si el subtributo aculama base, se suman las anteriores -- REQ0026214 - 18/03/2025
        if v_indcdor_acmla_bse = 'S' then
    ...
    Begin
      select indcdor_vlda_prdo, cdgo_prdcdad, indcdor_vlor_aux_lqdcion --Req0026210
        into v_indcdor_vlda_prdo,
             v_cdgo_prdcdad,
             v_indcdor_vlor_aux_lqdcion --Req0026210
        from v_gi_d_rntas_cnfgrcion_sbmpst
       where cdgo_clnte = p_cdgo_clnte
         and id_impsto_sbmpsto = p_id_impsto_sbmpsto;
    exception
    ...
    for c_dtos_actos_cncptos in (select a.vgncia,
                                       ...
                                       --                  'S',
                                       --                  v_vlor_bse * (prcntje_bse_lqdcion / 100),
                                       --                  'N',
                                       --                  1)) bse_grvble, --Req0026109
                                       -- --to_number(decode(a.indcdor_usa_bse, 'S', v_vlor_bse, 'N', 1)) bse_grvble, --Req0026109


                                          to_number(decode(a.indcdor_usa_bse,
                                                       'S',
                                                         --Req0026754
                                                          nvl((select bse_grvble * (prcntje_bse_lqdcion / 100)
                                                              from json_table(p_json_cncptos, '$[*]' columns
                                                                               id_cncpto      path '$.ID_CNCPTO',
                                                                               id_impsto_acto path '$.ID_IMPSTO_ACTO',
                                                                               bse_grvble     path '$.BSE_GRVBLE'
                                                                               )
                                                               where id_cncpto        = a.id_cncpto
                                                                  and id_impsto_acto  = a.id_impsto_acto
                                                              ), (v_vlor_bse * (prcntje_bse_lqdcion / 100))
                                                              ),
                                                       'N',
                                                       1)) bse_grvble,
                                        ...
                                        where id_impsto_acto  = a.id_impsto_acto
                                              and id_cncpto = a.id_cncpto),1)  fctor
                                  ...
                                  where a.cdgo_clnte = p_cdgo_clnte
                                    ...
                                    and a.id_impsto_acto  in  (select  id_impsto_acto  --req0026754
                                                              from json_table(p_id_impsto_acto_slccndo,  '$[*]'
                                                                                  columns (id_impsto_acto number path '$.ID_IMPSTO_ACTO')
                                                                             )
                                                              )--= p_id_impsto_acto
                                    and a.vgncia =
                                        extract(year from
                                    ...
                                    and (trunc(to_date(p_fcha_expdcion)) between
                                       ...
                                       --Si el subimpuesto busca la tarifa con el valor auxiliar
                                       --and   --Req0026210
                                       --(case
                                       -- when v_indcdor_vlor_aux_lqdcion = 'S'  then
                                       --    p_vlor_aux_lqdcion
                                       -- else
                                       --    v_vlor_bse
                                        --end) between vlor_bse_incial and vlor_bse_fnal

                                    and --Req0026210
                                        (case
                                        -- REQ0026214 - 18/03/2025.
                                        -- Si existe una liquidación inicial, la liquidación se realiza en base a la tarifa inicial.
                                          when v_indcdor_vlor_aux_lqdcion = 'S' and p_indcdor_lqdccion_adcnal = 'S' and v_id_ultma_rnta is not null then
                                               v_vlor_aux_lqdcion_antrior
                                          when v_indcdor_vlor_aux_lqdcion = 'S' then
                                              p_vlor_aux_lqdcion
                                          else

                                              --Req0026754
                                               nvl((select bse_grvble  * 1  --Error(655,50): PL/SQL: ORA-00932: tipos de dato inconsistentes: se esperaba NUMBER se ha obtenido CHAR por eso multiplico * 1
                                                  from json_table(p_json_cncptos, '$[*]' columns
                                                                   id_cncpto      path '$.ID_CNCPTO',
                                                                   id_impsto_acto path '$.ID_IMPSTO_ACTO',
                                                                   bse_grvble     path '$.BSE_GRVBLE')
                                                   where  id_cncpto = a.id_cncpto
                                                      and id_impsto_acto  = a.id_impsto_acto
                                                  ),v_vlor_bse)  --fin Req0026754

                                                 -- v_vlor_bse
                                        end) between vlor_bse_incial and vlor_bse_fnal
                                       --and v_vlor_bse between vlor_bse_incial and vlor_bse_fnal

                                    and ( (a.id_cncpto, a.id_impsto_acto) in  --Req0026754 Se agrego   a.id_impsto_acto
                                                                            (select id_cncpto, a.id_impsto_acto
                                                                                from json_table(p_json_cncptos, '$[*]' columns
                                                                                                id_cncpto         path '$.ID_CNCPTO'
                                                                                                ,id_impsto_acto    path '$.ID_IMPSTO_ACTO'
                                                                                                )
    ...
    for c_dtos_actos_cncptos in (select a.vgncia,
                                        ...
                                        to_number(decode(a.indcdor_usa_bse,
                                                         'S',
                                                         /* case
                                                         when  a.indcdor_utlza_bse_pntual = 'S' then
                                                            --Req0026754
                                                             (d.bse_grvble * (prcntje_bse_lqdcion / 100))
                                                         else
                                                            (v_vlor_bse * (prcntje_bse_lqdcion / 100))
                                                         end,*/
                                                         case
                                                           when d.bse_grvble is not null and
                                                                a.indcdor_utlza_bse_pntual = 'S' then
                                                           --Req0026754
                                                            (to_number(d.bse_grvble) *
                                                            (prcntje_bse_lqdcion / 100))
                                                           else
                                                            (v_vlor_bse *
                                                            (prcntje_bse_lqdcion / 100))
                                                         end,
                                 ...
                                 --Impuestos Actos seleccionados
                                   join (select id_impsto_acto --req0026754
                                          from json_table(p_id_impsto_acto_slccndo,
                                                          '$[*]' columns
                                                          id_impsto_acto
                                                          number path
                                                          '$.ID_IMPSTO_ACTO')) c
                                     on c.id_impsto_acto = a.id_impsto_acto
                                 --Conceptos seleccionados
                                   left join (select id_impsto_acto,
                                                    id_cncpto,
                                                    fctor,
                                                    bse_grvble
                                               from json_table(p_json_cncptos,
                                                               ...
                                                               id_impsto_acto path
                                                               '$.ID_IMPSTO_ACTO')) d
                                     on d.id_impsto_acto = a.id_impsto_acto
                                  ...
                                  where a.cdgo_clnte = p_cdgo_clnte
                                    ...
                                    and --Req0026210
                                        ...
                                        -- REQ0026214 - 18/03/2025.
                                        -- Si existe una liquidación inicial, la liquidación se realiza en base a la tarifa inicial.
                                          when v_indcdor_vlor_aux_lqdcion = 'S' and
                                               p_indcdor_lqdccion_adcnal = 'S' and
                                               v_id_ultma_rnta is not null then
                                           v_vlor_aux_lqdcion_antrior
                                          when v_indcdor_vlor_aux_lqdcion = 'S' then
                                           p_vlor_aux_lqdcion
                                          when d.bse_grvble is not null and
                                           ...
                                           v_vlor_bse
                                        end) between vlor_bse_incial and
                                        vlor_bse_fnal
                                       --and v_vlor_bse between vlor_bse_incial and vlor_bse_fnal

                                    and (a.id_cncpto = d.id_cncpto and
                                        a.id_impsto_acto = d.id_impsto_acto and
                                        p_json_cncptos is not null or
                                        p_json_cncptos is null)
                                  order by a.id_cncpto_bse nulls first,
                                           a.orden) loop
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_nmbre_up,
                            v_nl,
                            ' ------->>>> c_dtos_actos_cncptos.id_impsto_acto: ' ||
                            c_dtos_actos_cncptos.id_impsto_acto,
                            1);
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
      ...
      if p_indcdor_lqdccion_adcnal = 'S' and v_id_ultma_rnta is not null and
         v_indcdor_acmla_bse = 'S' then
        -- -- REQ0026214 - 18/03/2025
        ...
        --f p_indcdor_lqdccion_adcnal = 'S' and v_id_ultma_rnta is not null and v_indcdor_acmla_bse = 'S' then
        c_dtos_actos_cncptos.vlor_pgdo  := 0;
        c_dtos_actos_cncptos.vlor_lqddo := c_dtos_actos_cncptos.bse_grvble *
                                           c_dtos_actos_cncptos.vlor_trfa_clcldo *
                                           nvl(c_dtos_actos_cncptos.fctor,
                                               1);
      end if;
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_nmbre_up,
                            v_nl,
                            '--> c_dtos_actos_cncptos.bse_grvble:  ' ||
                            c_dtos_actos_cncptos.bse_grvble,
                            6);
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_nmbre_up,
                            v_nl,
                            '--> c_dtos_actos_cncptos.vlor_lqddo:  ' ||
                            c_dtos_actos_cncptos.vlor_lqddo,
                            6);
      ...
      */
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_nmbre_up,
                            v_nl,
                            '------> c_dtos_actos_cncptos.vlor_lqdcion_mnma:  ' ||
                            c_dtos_actos_cncptos.vlor_lqdcion_mnma,
                            6);
      ...
      if (c_dtos_actos_cncptos.gnra_intres_mra = 'S') then
        if (v_indcdor_fcha_vncmnto_clclda = 'S') then
          c_dtos_actos_cncptos.fcha_vncmnto := pkg_gi_rentas.fnc_cl_fcha_vncmnto_lqdcion(p_cdgo_clnte           => p_cdgo_clnte,
                                                                                         p_indcdor_usa_extrnjro => p_indcdor_usa_extrnjro,
                                                                                         p_id_impsto_sbmpsto    => p_id_impsto_sbmpsto,
                                                                                         p_id_impsto_acto       => c_dtos_actos_cncptos.id_impsto_acto, --Req0026754 -- ,p_id_impsto_acto),
                                                                                         p_fcha_expdcion        => p_fcha_expdcion);
        end if;
      else
      ...
      t_impuesto_acto_conceptos.prcntje_bse_lqdcion      := c_dtos_actos_cncptos.prcntje_bse_lqdcion;
      t_impuesto_acto_conceptos.indcdor_utlza_bse_pntual := c_dtos_actos_cncptos.indcdor_utlza_bse_pntual; --Req0026754
      t_impuesto_acto_conceptos.indcdor_rqre_fctor       := c_dtos_actos_cncptos.indcdor_rqre_fctor; --Req0026754
      t_impuesto_acto_conceptos.fctor                    := c_dtos_actos_cncptos.fctor; --Req0026754
      ...
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            ...
                            v_nmbre_up,
                            v_nl,
                            'c_dtos_actos_cncptos.vlor_ttal :  ' ||
                            c_dtos_actos_cncptos.vlor_ttal,
                            6);
    ...
    for i in 1 .. c_impuesto_acto_conceptos.count loop
        ...
        for j in 1 .. c_impuesto_acto_conceptos.count loop
          if c_impuesto_acto_conceptos(j).id_cncpto = c_impuesto_acto_conceptos(i).id_cncpto_bse then
            ...
            c_impuesto_acto_conceptos(i).vlor_lqddo := c_impuesto_acto_conceptos(i).bse_grvble * c_impuesto_acto_conceptos(i).vlor_trfa_clcldo *
                                                        nvl(c_impuesto_acto_conceptos(i).fctor,
                                                                                        1); --Req0026754
          end if;
        end loop;
      end if;
      ...
      if c_impuesto_acto_conceptos(i).cdgo_rdndeo_exprsion != 'SRDNDEO' and c_impuesto_acto_conceptos(i).vlor_lqddo between 1 and 100 then
    ...
    for c_actos_cncpto in (select a.id_impsto_acto_cncpto,
                             ...
                             from json_table(p_actos_cncpto,
                                             ...
                                             columns(id_impsto_acto_cncpto path
                                                     ...
                                                     vlor_intres path
                                                     '$.VLOR_INTRES_MRA',
                                                     prcntje_bse_lqdcion path
                                                     '$.PRCNTJE_BSE_LQDCION',
                                                     fctor path '$.FCTOR' --Req0026754
                                                     )) a
                             join gi_g_rentas_acto b
      ...
      begin
        ...
        insert into gi_g_rentas_acto_concepto
          (id_rnta_acto,
           ...
           vlor_intres,
           fcha_vncmnto,
           prcntje_bse_lqdcion, --Req0026109
           fctor) --Req0026754
        values
          (c_actos_cncpto.id_rnta_acto,
           ...
           c_actos_cncpto.prcntje_bse_lqdcion, --Req0026109
           c_actos_cncpto.fctor); --Req0026754
  ...
  procedure prc_rg_proyeccion_renta(p_cdgo_clnte              in number,
                                    ...
                                    p_vlor_aux_lqdcion        in number default null, --Req0026210
                                    p_id_rnta_cntrto_extrno   in number default null, --Req0026403
      ...
      begin
        insert into gi_g_rentas
          (cdgo_clnte,
           ...
           id_entdad,
           id_sjto_scrsal,
           vlor_aux_lqdcion, --Req0026210
           id_rnta_cntrto_extrno) --Req0026403
        values
          (p_cdgo_clnte,
           p_id_impsto,
           p_id_impsto_sbmpsto,
           ...
           p_id_entdad,
           p_id_sjto_scrsal,
           p_vlor_aux_lqdcion, --Req0026210
           p_id_rnta_cntrto_extrno) --Req0026403
        ...
        update gi_g_rentas
           set id_impsto_sbmpsto     = p_id_impsto_sbmpsto,
               ...
               vlor_cntrto_ese       = decode(p_indcdor_cntrto_ese,
                                              ...
                                              'N',
                                              0),
               vlor_aux_lqdcion      = p_vlor_aux_lqdcion, --Req0026210
               id_rnta_cntrto_extrno = p_id_rnta_cntrto_extrno --Req0026403
  ...
  procedure prc_rg_liquidacion_rentas(p_cdgo_clnte        in number,
                                      ...
                                      p_id_sjto_scrsal    in number default null,
                                      p_id_rnta_antrior   in clob default null, --REQ0026214 -- 18/03/2025
    ...
    v_id_usrio                 number;
    v_indcdor_vlor_aux_lqdcion gi_d_rntas_cnfgrcion_sbmpst.indcdor_vlor_aux_lqdcion%type; --Req0026210
    v_indcdor_lqdccion_adcnal  gi_d_rntas_cnfgrcion_sbmpst.indcdor_lqdccion_adcnal%type; --REQ0026214 -- 18/03/2025
    v_vlor_aux_lqdcion_antrior gi_g_rentas.vlor_aux_lqdcion%type; --REQ0026214 -- 18/03/2025
    v_id_ultma_rnta            number; --REQ0026214 -- 18/03/2025
  ...
  begin
    ...
    begin
      select a.fcha_expdcion
        into v_fcha_expdcion
        from gi_g_rentas a
       where id_rnta = p_id_rnta;
    exception
      when others then
        v_fcha_expdcion := sysdate;
    end;

    --REQ0026214 - 18/03/2025.
    --Se busca si el sumbimpuesto utiliza liquidación adicional
    begin
      select a.indcdor_lqdccion_adcnal
        into v_indcdor_lqdccion_adcnal
    ...
    exception
      when others then
        v_indcdor_lqdccion_adcnal := 'N';
    end;

    -- Se consulta los datos de la liquidación anterior -- -- REQ0026214 - 18/03/2025
    if v_indcdor_lqdccion_adcnal = 'S' and p_id_rnta_antrior is not null then

      begin
        select nvl(sum(vlor_aux_lqdcion), 0)
          into v_vlor_aux_lqdcion_antrior
          from gi_g_rentas
         where id_rnta =
               (select id_rnta
                  from json_table(p_id_rnta_antrior,
    ...
    end if; -- Se consulta los datos de la liquidación anterior -- -- REQ0026214 - 18/03/2025

    --Req0026210
    --Se busca si el sumbimpuesto utiliza valor auxiliar para buscar la tarifa
    begin
      select a.indcdor_vlor_aux_lqdcion
        into v_indcdor_vlor_aux_lqdcion
        from v_gi_d_rntas_cnfgrcion_sbmpst a
       where cdgo_clnte = p_cdgo_clnte
         and id_impsto = p_id_impsto
         and id_impsto_sbmpsto = p_id_impsto_sbmpsto;
      ...
      for c_lqdcion_cncpto in (select x.cdgo_cncpto,
                                 ...
                                 left join v_gi_d_tarifas_esquema b
                                  ...
                                  and a.trfa = b.vlor_trfa_clcldo
                                     ...
                                     -- Se adiciono esta linea 24/03/2026 HJPB
                                     -- Se ajusta la lógica de consulta, ya que cuando existen conceptos base no se estaba aplicando el filtro por vigencia
                                     -- Esto  duplicaba el valor liquidado, afectando la cartera, liquidación y generación de documentos
                                  and (vgncia_bse is null or
                                      vgncia_bse =
                                      extract(year from
                                               to_date(v_fcha_expdcion)))
                                 ...
                                 join gi_g_rentas d
                                  ...
                                  and --Req0026210
                                      ...
                                      -- Si existe una liquidación inicial, la liquidación se realiza en base a la tarifa inicial.
                                        when v_indcdor_vlor_aux_lqdcion = 'S' and
                                             v_indcdor_lqdccion_adcnal = 'S' and
                                             v_id_ultma_rnta is not null then
                                         v_vlor_aux_lqdcion_antrior
                                        when v_indcdor_vlor_aux_lqdcion = 'S' then
                                         d.vlor_aux_lqdcion
                                      ...
                                      vlor_bse_fnal
                               --and a.bse_cncpto between vlor_bse_incial and vlor_bse_fnal  --asi estaba
        ...
        begin
          ...
          values
            (o_id_lqdcion,
             ...
             c_lqdcion_cncpto.fctor); --Req0026754
    ...
    begin
      pkg_gi_rentas.prc_rg_proyeccion_renta(p_cdgo_clnte           => p_cdgo_clnte,
                                           ...
                                           ,
                                            ...
                                            p_vlor_aux_lqdcion        => p_vlor_aux_lqdcion, --Req0026210
                                            p_id_rnta_cntrto_extrno   => p_id_rnta_cntrto_extrno, --Req0026403
                                            --##
      ...
      if o_cdgo_rspsta = 0 then
        ...
        begin
          pkg_gi_rentas.prc_rg_liquidacion_rentas(p_cdgo_clnte        => p_cdgo_clnte,
                                                  ...
                                                  p_entrno            => p_entrno,
                                                  p_id_sjto_scrsal    => p_id_sjto_scrsal,
                                                  p_id_rnta_antrior   => p_id_rnta_antrior, --REQ0026214 -- 18/03/2025
            ...
            begin
              ...
              if v_vgncia_prdo is not null then
                ...
                begin
                  ...
                  /* Se puso en comentario por el --Req0026754
                  ...
                  */
                  begin
                    ...
                    select a.fcha_vncmnto,
                     ...
                     where a.cdgo_clnte = p_cdgo_clnte
                       and a.id_impsto = p_id_impsto
                       and a.id_impsto_sbmpsto = p_id_impsto_sbmpsto
                       and a.id_impsto_acto in
                           (select id_impsto_acto
                              from json_table(p_json_impsto_acto_cncpto,
                                              '$[*]'
                                              columns(id_impsto_acto number path
                                                      '$.ID_IMPSTO_ACTO')))
                       and a.gnra_intres_mra = 'S'
                       and a.vgncia = extract(year from p_fcha_expdcion)
                          -- Se valida que la tarifa este entre la fecha de expedici?n
                       and (trunc(p_fcha_expdcion) between
                           trunc(fcha_incial) and trunc(fcha_fnal))
                     order by a.fcha_vncmnto
                  ...
                  exception
                    ...
                    when others then
                      o_cdgo_rspsta  := 122;
                      o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                                        ': Error al consultar el impuesto acto para la renta id_rnta : ' ||
                                        p_id_rnta || sqlerrm;
                      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                            null,
                                            v_nmbre_up,
      ...
      --Req0026403
      if p_id_rnta_cntrto_extrno is not null then
        begin
          update gi_g_rentas_contrato_externo
             set id_rnta = p_id_rnta, estdo = 'PROCESADO'
           where id_rnta_cntrto_extrno = p_id_rnta_cntrto_extrno;
        exception
          when others then
            o_cdgo_rspsta  := 36;
            o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                              ': Error al actualizar la renta en la tabla de contrato externo.' ||
                              sqlerrm;
            rollback;
            return;
        end;
  ...
  procedure prc_ap_solicitud_renta(p_cdgo_clnte        in number,
                                   ...
                                   p_id_rprte_rcbo     in number default null,
                                   o_id_dcmnto         out number,
                                   o_nmro_dcmnto       out number,
                                   o_cdgo_rspsta       out number,
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        --Req0026403
        if t_gi_g_rentas.id_rnta_cntrto_extrno is not null then
          begin
            update gi_g_rentas_contrato_externo
               set id_rnta = p_id_rnta, estdo = 'PROCESADO'
             where id_rnta_cntrto_extrno =
                   t_gi_g_rentas.id_rnta_cntrto_extrno;
          exception
            when others then
              o_cdgo_rspsta  := 36;
              o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
    ...
    if v_vlor_ttal_dcmnto > 0 then
      ...
      -- Consulta el impuesto acto  --##
      begin
        /* se puso en comentario Req0026754
        select id_impsto_Acto, dias_mrgn_mra
          into v_id_impsto_Acto, v_dias_mrgn_mra
          from gi_g_rentas_acto
         where id_rnta = p_id_rnta;
        ...
        --Req0026754
        select a.fcha_vncmnto, a.id_impsto_acto, a.gnra_intres_mra
          into v_fcha_vncmnto_acto, v_id_impsto_acto, v_gnra_intres_mra
          from v_gi_d_tarifas_esquema a
         where a.cdgo_clnte = p_cdgo_clnte
           ...
           and a.id_impsto_acto in
               (select id_impsto_acto
                 ...
                 where id_rnta = p_id_rnta)
           and a.gnra_intres_mra = 'S'
           and a.vgncia = extract(year from t_gi_g_rentas.fcha_expdcion)
              -- Se valida que la tarifa este entre la fecha de expedici?n
           and (trunc(t_gi_g_rentas.fcha_expdcion) between
               trunc(fcha_incial) and trunc(fcha_fnal))
         order by a.fcha_vncmnto
         fetch first 1 rows only;
    ...
    if v_vlor_ttal_dcmnto > 0 then
      o_mnsje_rspsta := 'va a fnc_gn_blob_documento - p_id_rnta : ' ||
                        p_id_rnta || ' o_id_dcmnto : ' || o_id_dcmnto ||
                        ' p_cdgo_clnte : ' || p_cdgo_clnte ||
                        ' p_id_rprte_rcbo : ' || p_id_rprte_rcbo;
      pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                            null,
                            v_nmbre_up,
                            v_nl,
      ...
      begin
        ...
        v_blob := pkg_gn_generalidades.fnc_gn_blob_documento(p_id_rprte    => p_id_rprte_rcbo, --103,
                                                             p_prmtro_1    => p_id_rnta,
                                                             p_prmtro_2    => o_id_dcmnto,
                                                             p_nmbre_rprte => 'Liquidacion_' ||
                                                                              t_gi_g_rentas.nmro_rnta,
                                                             p_app_id      => V('APP_ID'),
                                                             p_page_id     => V('APP_PAGE_ID'));

        o_mnsje_rspsta := 'paso fnc_gn_blob_documento ' || o_id_dcmnto;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
        ...
        begin
          ...
          values
            (p_id_rnta || o_id_dcmnto, p_id_rnta, v_blob, 'RENTAS');
          commit;
        exception
          when others then
            null;
      ...
      exception
        when others then
          o_cdgo_rspsta  := 15;
          o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                            ' Error al insertar el blob : ' || p_id_rnta ||
                            sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
  ...
  begin
    ...
    if t_gi_g_rentas.id_rnta_cntrto_extrno is not null then
      begin
        update gi_g_rentas_contrato_externo
           set id_rnta = null, estdo = 'REGISTRADO'
         where id_rnta_cntrto_extrno = t_gi_g_rentas.id_rnta_cntrto_extrno;
      exception
        when others then
          o_cdgo_rspsta  := 36;
          o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
      ...
      begin
        ...
        if v_vgncia_prdo is not null then
          ...
          begin
            ...
            o_mnsje_rspsta := ' v_vlor_ttal_dcmnto : ' ||
                              v_vlor_ttal_dcmnto;
            pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                  null,
                                  v_nmbre_up,
            ...
            begin
              ...
              select a.fcha_vncmnto, a.id_impsto_acto, a.gnra_intres_mra
               ...
               where a.id_impsto_acto in
                 ...
                 and a.gnra_intres_mra = 'S'
                 and a.vgncia =
                     extract(year from t_gi_g_rentas.fcha_expdcion)
                    -- Se valida que la tarifa este entre la fecha de expedici?n
                 and (trunc(t_gi_g_rentas.fcha_expdcion) between
                     trunc(fcha_incial) and trunc(fcha_fnal))
               order by a.fcha_vncmnto
            ...
            v_fcha_vncmnto_clclda := pkg_gi_rentas.fnc_cl_fecha_documento_pago(p_cdgo_clnte           => p_cdgo_clnte,
                                                                               ...
                                                                               p_id_impsto_acto       => v_id_impsto_acto,
                                                                               p_indcdor_usa_extrnjro => t_gi_g_rentas.indcdor_usa_extrnjro,
                                                                               p_fcha_expdcion        => t_gi_g_rentas.fcha_expdcion);
            ...
            begin
              for i in 1 .. v_nmro_dcmntos loop
                ...
                -- Valida si hay tasas mora parametrizadas   --HJPB 23/09/2021
                v_fcha_vlda    := pkg_gn_generalidades.fnc_vl_fcha_vncmnto_tsas_mra(p_cdgo_clnte   => p_cdgo_clnte,
                                                                                    p_id_impsto    => t_gi_g_rentas.id_impsto,
                                                                                    p_fcha_vncmnto => v_fcha_vncmnto);
                o_mnsje_rspsta := ' v_fcha_vlda : ' || v_fcha_vlda || ' - ' || i;
                pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                      null,
                                      v_nmbre_up,
                                      v_nl,
  ...
  function fnc_tipos_adjunto(p_cdgo_clnte             in number,
                             ...
                             p_id_impsto_sbmpsto      in number,
                             p_id_impsto_acto         in number,
                             p_id_impsto_acto_slccndo in varchar2) --Req0026754
  ...
  begin
    ...
    select count(1)
     ...
     where id_impsto = p_id_impsto
       and id_impsto_sbmpsto = p_id_impsto_sbmpsto
       and id_impsto_acto in
           (select id_impsto_acto --req0026754
              from json_table(p_id_impsto_acto_slccndo,
                              '$[*]' columns(id_impsto_acto number path
                                      '$.ID_IMPSTO_ACTO'))); --= p_id_impsto_acto;
    ...
    if v_vlor_dda = 0 then
      ...
      exception
        when others then
          o_cdgo_rspsta  := 1;
          o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                            'Error al actualizar la renta como pagada id renta : ' ||
                            p_id_rnta || '.' || sqlerrm;
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
  ...
  /*
  --Procedimiento que anula una renta que no este pagada ni en proceso de pago por PSE
  procedure prc_rg_anulacion_renta(p_cdgo_clnte        in number,
                                   p_id_impsto         in number,
                                   p_id_impsto_sbmpsto in number,
                                   p_id_rnta           in number,
                                   p_id_lqdcion        in number,
    ...
    v_nl               number;
    v_nmbre_up         varchar2(70) := 'pkg_gi_rentas.prc_rg_anulacion_renta';
    v_dcmnto_pgdo      number;
    v_obsrvcion        gi_g_rentas_solicitud_traza.obsrvcion%type;
    v_cdgo_tpo_oprcion ws_d_provedores_cliente.cdgo_tpo_oprcion%type;

    v_id_sjto_impsto        si_i_sujetos_impuesto.id_sjto_impsto%type;
    v_id_lqdcion            gi_g_rentas.id_lqdcion%type;
    v_id_rnta_cntrto_extrno gi_g_rentas.id_rnta_cntrto_extrno%type;
  begin
    ...
    --Se verifica que la renta NO este pagada
    begin
      select count(*)
        into v_dcmnto_pgdo
        from gi_g_rentas a
        join re_g_documentos b
          on b.id_orgen = a.id_lqdcion
        join v_re_g_recaudos d
          on d.id_orgen = b.id_dcmnto
      ...
      if v_dcmnto_pgdo > 0 then
        o_cdgo_rspsta  := 1;
        o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                          ' No se puede anular la renta debido a que ya fue pagada ó tiene pagos parciales ';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
    ...
    exception
      when others then
        o_cdgo_rspsta  := 5;
        o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                          ' Error al buscar datos del pago ';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
        ...
        rollback;
        return;
    end; -- Fin Se verifica que la renta NO este pagada

    -- Se busca el tipo de operacion si el subimpuesto es multicredito (MLTCDT) o monocredito (MNCDT)
    begin
      select cdgo_tpo_oprcion
        into v_cdgo_tpo_oprcion
    ...
    exception
      when others then
        o_cdgo_rspsta  := 10;
        o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                          ' Error al buscar el tipo de operación del subimpuesto ';
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
                              v_nl,
        ...
        rollback;
        return;
    end; -- Fin Se busca el tipo de operacion si el subimpuesto es multicredito (MLTCDT) o monocredito (MNCDT)

    if v_cdgo_tpo_oprcion is not null then
      --Se verifica que la renta NO haya iniciado un pago por PSE
      begin
        select count(*)
          into v_dcmnto_pgdo
         ...
         where cdgo_clnte = p_cdgo_clnte
           ...
           and id_impsto_sbmpsto = p_id_impsto_sbmpsto
           and (CASE
                 WHEN v_cdgo_tpo_oprcion = 'MLTCDT' then
                  p_id_lqdcion
                 WHEN v_cdgo_tpo_oprcion = 'MNCDT' then
                  (select id_dcmnto
                     from re_g_documentos
                    where id_orgen = p_id_lqdcion)
                 else
                  0
               END) in id_orgen
           and indcdor_estdo_trnsccion in ('AP', 'IN', 'PE') -- Aprobada, Iniciada, Pendiente
           and cdgo_orgn_tpo = 'DC';

        if v_dcmnto_pgdo > 0 then
          o_cdgo_rspsta  := 15;
          o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                            ' No se puede anular la renta ya que inicio un pago por PSE ';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
      ...
      exception
        when others then
          o_cdgo_rspsta  := 20;
          o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                            ' Error al buscar datos del pago de PSE ';
          pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                null,
                                v_nmbre_up,
                                v_nl,
          ...
          rollback;
          return;
      end; -- Fin Se verifica que la renta NO haya iniciado un pago por PSE
    end if; --if v_cdgo_tpo_oprcion is not null

    -- Se inserta la traza de la renta
    v_obsrvcion := 'Renta ANULADA - ' || p_obsrvcion;
    begin
      pkg_gi_rentas.prc_rg_solicitud_renta_traza(p_cdgo_clnte          => p_cdgo_clnte,
                                                 p_id_rnta             => p_id_rnta,
                                                 p_id_usrio            => p_id_usrio,
                                                 p_cdgo_rnta_estdo_nvo => 'ANL',
                                                 p_obsrvcion           => upper(v_obsrvcion),
                                                 o_cdgo_rspsta         => o_cdgo_rspsta,
                                                 o_mnsje_rspsta        => o_mnsje_rspsta);
      if o_cdgo_rspsta != 0 then
        o_cdgo_rspsta  := 25;
    ...
    --Se busca el sujeto impuesto y liquidacion
    begin
      select id_sjto_impsto, id_lqdcion,    id_rnta_cntrto_extrno
        into v_id_sjto_impsto, v_id_lqdcion, v_id_rnta_cntrto_extrno
        from gi_g_rentas
       where id_rnta = p_id_rnta;
    exception
      when others then
        o_cdgo_rspsta  := 35;
        o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                          ' No se pudo consultar el sujeto impuesto o liquidacion de la renta id : ' ||
                          p_id_rnta || sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
    ...
    -- Se actualiza el estado de la renta a ANL(Anulado)
    begin
      update gi_g_rentas
         set cdgo_rnta_estdo = 'ANL'
       where id_rnta = p_id_rnta;
    ...
    exception
      when others then
        o_cdgo_rspsta  := 35;
        o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                          ' Error al actualizar el estado de la renta ' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
        ...
        rollback;
        return;
    end; -- Fin Se actualiza el estado de la renta a ANL(Anulado)

     --Req0026403
    if v_id_rnta_cntrto_extrno is not null then
        begin
            update gi_g_rentas_contrato_externo
            set     id_rnta = null,
                    estdo = 'REGISTRADO'
        ...
        exception
           when others then
            o_cdgo_rspsta  := 36;
            o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||': Error al actualizar la renta en la tabla de contrato externo.' || sqlerrm;
            rollback;
            return;
      end;
    end if;
    ...
    exception
      when others then
        o_cdgo_rspsta  := 40;
        o_mnsje_rspsta := 'No. ' || o_cdgo_rspsta ||
                          ' Error al actualizar el estado de la liquidacion de la renta ' ||
                          sqlerrm;
        pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                              null,
                              v_nmbre_up,
        ...
        rollback;
        return;
    end; -- Fin Se inactiva la liquidacion
    ...
    o_cdgo_rspsta  := 0;
    o_mnsje_rspsta := ' Anulación Registrada Exitosamente. ';
    pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                          null,
                          v_nmbre_up,
                          v_nl,
  ...
  exception
    when others then
      ...
      rollback;
      return;
  end prc_rg_anulacion_renta;*/

  --Req0026754
  function fnc_cl_detalle_liquidacion(p_id_dcmnto in number) return clob as
  ...
  begin
    ...
    pkg_sg_log.prc_rg_log(23001,
                          ...
                          6,
                          ' RENTAS  p_id_dcmnto  ' || p_id_dcmnto,
                          6);

    begin
      select id_lqdcion, id_rnta
        into v_id_lqdcion, v_id_rnta
        from gi_g_rentas
    ...
    v_select := '<table align="center" border="1px"  style="border-collapse: collapse; border-color: black !important; <Font size=1>">
                <tr>
                  <th style="padding: 10px !important; width:40%">ITEM</th>
                  <th style="padding: 10px !important; width:10%">DIAS</th>
                  <th style="padding: 10px !important; width:15%">TARIFA</th>
                  <th style="padding: 10px !important; width:15%">CANTIDAD</th>
                  <th style="padding: 10px !important; width:20%">TOTAL</th>
                </tr>';

    for c_lqdcion in (select dscrpcion_cncpto cncpto, --nmbre_impsto_acto || '-'||dscrpcion_cncpto cncpto,
                             vlor_bse_grvble,
                             txto_trfa,
                             vlor_lqddo,
                             fctor
                       ...
                       order by dscrpcion_cncpto) loop

      v_select := v_select || '<tr>' ||
                  '<td style="text-align:left;">      <Font size=2>' ||
                  c_lqdcion.cncpto || '</td>' ||
                  '<td style="text-align:center;">    <Font size=2>' ||
                  c_lqdcion.vlor_bse_grvble || '</td>' ||
                  '<td style="text-align:center;">    <Font size=2>' ||
                  c_lqdcion.txto_trfa || '</td>' ||
                  '<td style="text-align:center;">    <Font size=2>' ||
                  c_lqdcion.fctor || '</td>' ||
                  '<td style="text-align:right;">     <Font size=2>' ||
                  to_char(c_lqdcion.vlor_lqddo,
                          'FM$999G999G999G999G999G999G990') || '</td>' ||
                 --'<td style="text-align:center;">' || to_char(c_lqdcion.fcha_vncmnto, 'DD/MM/YYYY') || '</td>' ||
                 -- '<td style="text-align:center;">' || c_lqdcion.estdo_cta || '</td>' ||
                  '</tr>';

      v_vlor_lqddo := v_vlor_lqddo + c_lqdcion.vlor_lqddo;

    end loop;

    v_select := v_select ||
                '<tr><td colspan="4" style="text-align:right;">Total</td><td style="text-align:right;">' || '$' ||
                trim(to_char(nvl(v_vlor_lqddo, 0),
  ...
  exception
    when v_error then
      raise_application_error(-20001,
                              ' Se presento un error al generar la información de la liquidación.' ||
                              sqlerrm);

  end fnc_cl_detalle_liquidacion;
