  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_RG_DECLARACION_EXTERNA" (p_cdgo_clnte                 in number,
           ...
           for c_vlr in (SELECT columna, valor
             ...
             if (c_vlr.columna = v_resultado and v_resultado <> 'N') then
               ...
               select JSON_OBJECT('ID' VALUE
                                  ...
                                  'ATR' || c_clmnas.id_frmlrio_rgion_atrbto ||
                                  'FLA' || 1,
               ...
               pkg_sg_log.prc_rg_log(p_cdgo_clnte,
                                     ...
                                     v_nmbre_up,
                                     v_nvel,
                                     'v_json v_resultado N[' || v_resultado ||
                                     ']-->' || v_json,
                                     6);
