  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_PAGOS_AJ1" ( p_id_entdad         in  number
...
begin
  ...
  v_archvo_log   := 'PRC_MIGRA_PAGOS_AJ1_LOG_'||v_fcha_hra||'.txt';
  v_archvo_cmmit := 'PRC_MIGRA_PAGOS_AJ1_COMMIT_'||v_fcha_hra||'.txt';
  --v_archvo_error := 'PRC_MIGRA_PAGOS_AJ1_ERROR_'||v_fcha_hra||'.txt';
  ...
  v_txto := 'Se inicia proceso de ajuste 1 informaci?n de pagos-recuados ';
