  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_RECAUDOS_ICA_2025_1" (P_CDGO_CLNTE IN NUMBER,
...
BEGIN
  ...
  DELETE FROM MIGRA.MG_G_INTERMEDIA_ICA_RECAUDO_2025_DETALLE D
   WHERE EXISTS
   (SELECT 1
  ...
  DELETE FROM MIGRA.MG_G_INTERMEDIA_ICA_RECAUDO_2025_MAESTRO A
   WHERE (TO_CHAR(A.FCHA_PGO, 'yyyy') = P_VGNCIA OR P_VGNCIA IS NULL)
     AND A.ID_RCDO IS NULL;
  COMMIT;
  ...
  FOR R1 IN C1 LOOP
    ...
    BEGIN
      SELECT A.ID_SJTO_IMPSTO
       ...
       WHERE A.CDGO_CLNTE = P_CDGO_CLNTE
         ...
         AND A.IDNTFCCION = R1.MODPSUIM;
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
        V_ID_SJTO_IMPSTO := NULL;
    END;

    INSERT INTO MIGRA.MG_G_INTERMEDIA_ICA_RECAUDO_2025_MAESTRO
      (CDGO_IMPSTO,
       CDGO_SBIMPSTO,
       CDGO_BNCO,
       NMRO_CNTA,
    ...
    FOR R2 IN C2(R1.MODPDPNU, R1.MODPSUIM, R1.MODPSECU, R1.MODPNUPA) LOOP
      INSERT INTO MIGRA.MG_G_INTERMEDIA_ICA_RECAUDO_2025_DETALLE
        (ID_INTRMDIA_MSTRO,
         CDGO_IMPSTO,
         CDGO_SBIMPSTO,
         VGNCIA,
  ...
  GENESYS.SITPR001(V_TXTO, V_ARCHVO_CMMIT);
  COMMIT;
END PRC_MIGRA_RECAUDOS_ICA_2025_1;
/
