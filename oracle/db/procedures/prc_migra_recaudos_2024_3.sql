  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_RECAUDOS_2024_3" (P_CDGO_CLNTE IN VARCHAR2,
  ...
  CURSOR C0 IS
    SELECT TRUNC(A.FCHA_PGO) FCHA_PGO,
      ...
      FROM MIGRA.MG_G_INTERMEDIA_IPU_RECAUDO_2024_MAESTRO A
  ...
  CURSOR C2(R_ID_INTRMDIA_MSTRO NUMBER) IS
    SELECT VGNCIA,
      ...
      FROM (SELECT VGNCIA,
              ...
              FROM MIGRA.MG_G_INTERMEDIA_IPU_RECAUDO_2024_DETALLE A
    ...
    FOR R1 IN C1(R0.FCHA_PGO, R0.ID_BNCO, R0.ID_BNCO_CNTA) LOOP
      ...
      EXCEPTION
        WHEN OTHERS THEN
          ...
          UPDATE MIGRA.MG_G_INTERMEDIA_IPU_RECAUDO_2024_MAESTRO A
