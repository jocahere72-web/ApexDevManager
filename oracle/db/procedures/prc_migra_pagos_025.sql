  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_PAGOS_025" as
          ...
          select a.*,
            ...
            from (
                  select m.clmna4, m.clmna5, m.clmna6,
                    ...
                    from migra.mg_g_intermedia_recaudo_p2 m
...
begin
  ...
  v_archvo_log   := 'prc_migra_pagos_025_LOG_'||v_fcha_hra||'.txt';
  v_archvo_cmmit := 'prc_migra_pagos_025_COMMIT_'||v_fcha_hra||'.txt';
  v_archvo_error := 'prc_migra_pagos_025_ERROR_'||v_fcha_hra||'.txt';
