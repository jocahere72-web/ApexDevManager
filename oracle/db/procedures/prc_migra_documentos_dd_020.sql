  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_DOCUMENTOS_DD_020" is
...
begin
  ...
  v_archvo_log     := 'PRC_MIGRA_DOCUMENTOS_DD_020_LOG_'||v_fcha_hra||'.txt';
  v_archvo_cmmit   := 'PRC_MIGRA_DOCUMENTOS_DD_020_COMMIT_'||v_fcha_hra||'.txt';
  v_archvo_error   := 'PRC_MIGRA_DOCUMENTOS_DD_020_ERROR_'||v_fcha_hra||'.txt';
...
end PRC_MIGRA_DOCUMENTOS_DD_020;
