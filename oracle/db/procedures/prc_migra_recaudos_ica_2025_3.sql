  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_RECAUDOS_ICA_2025_3" (P_CDGO_CLNTE IN VARCHAR2,
  ...
  CURSOR C0 IS
    SELECT TRUNC(A.FCHA_PGO) FCHA_PGO,
      ...
      FROM MIGRA.MG_G_INTERMEDIA_ICA_RECAUDO_2025_MAESTRO A
...
END PRC_MIGRA_RECAUDOS_ICA_2025_3;
/
