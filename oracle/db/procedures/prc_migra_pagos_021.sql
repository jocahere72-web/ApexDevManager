  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_PAGOS_021" as
...
begin
  ...
  v_archvo_log   := 'prc_migra_pagos_021_LOG_'||v_fcha_hra||'.txt';
  v_archvo_cmmit := 'prc_migra_pagos_021_COMMIT_'||v_fcha_hra||'.txt';
  v_archvo_error := 'prc_migra_pagos_021_ERROR_'||v_fcha_hra||'.txt';


  v_txto := 'Iniciando proceso de cargue de pagos con documento -';
