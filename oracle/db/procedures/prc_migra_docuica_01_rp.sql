  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_DOCUICA_01_RP" ( p_id_entdad          in  number
...
begin
   ...
   v_archvo_log   := 'PRC_MIGRA_DOCUICA_01_RP_LOG_'||v_fcha_hra||'.txt';
   v_archvo_cmmit := 'PRC_MIGRA_DOCUICA_01_RP_COMMIT_'||v_fcha_hra||'.txt';
   v_cntdor       := 0;
   ...
   -- escribir a log
   v_txto := 'Se inicia proceso de cargue de documentos ica PRC_MIGRA_DOCUICA_01_RP';
   ...
   for r1 in c1(p_cdgo_clnte, p_id_entdad) loop      --, p_fcha_dsde, p_fcha_hsta
     ...
     begin
       ...
       values(r1.cdgo_clnte, v_id_impsto, v_id_impsto_sbmpsto, v_id_sjto_impsto,
              r1.clmna1, 'DDE',
              null, null,
              TO_DATE(r1.clmna10,'DD/MM/YYYY'), TO_DATE(r1.clmna11,'DD/MM/YYYY'),
              r1.clmna15, r1.clmna16, r1.clmna17,
              r1.clmna18, r1.clmna17,
