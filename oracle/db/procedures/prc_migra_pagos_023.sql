  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_PAGOS_023" as
            ...
            from (
                  select m.clmna4, m.clmna5, m.clmna6,
                   ...
                   where m.CDGO_CLNTE        = r_cdgo_clnte and
                         ...
                         m.clmna47           = 'DN' and
                         m.clmna41           = 'OK'
                         --and (m.clmna40           = 'PE' OR m.clmna40 IS NULL)
...
cursor c1(r_cdgo_clnte  number,
  ...
  select t.id_intrmdia, t.id_entdad,t.cdgo_clnte,
   ...
   where t.CDGO_CLNTE        = r_cdgo_clnte and
         ...
         t.clmna47           = 'DN' and
         t.clmna41           = 'OK'
         --and (t.clmna40           = 'PE' OR t.clmna40 IS NULL)
...
begin
  ...
  v_archvo_log   := 'prc_migra_pagos_023_LOG_'||v_fcha_hra||'.txt';
  v_archvo_cmmit := 'prc_migra_pagos_023_COMMIT_'||v_fcha_hra||'.txt';
  v_archvo_error := 'prc_migra_pagos_023_ERROR_'||v_fcha_hra||'.txt';


  v_txto := 'Iniciando proceso de cargue de pagos con documento no cargado';
