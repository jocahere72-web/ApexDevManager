  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_RECAUDOS_2024_1" (P_CDGO_CLNTE IN NUMBER,
...
BEGIN
  ...
  DELETE FROM MIGRA.MG_G_INTERMEDIA_IPU_RECAUDO_2024_DETALLE D
   WHERE EXISTS
   (SELECT 1
  ...
  DELETE FROM MIGRA.MG_G_INTERMEDIA_IPU_RECAUDO_2024_MAESTRO A
   WHERE (TO_CHAR(A.FCHA_PGO, 'yyyy') = P_VGNCIA OR P_VGNCIA IS NULL);
  COMMIT;
  ...
  FOR R1 IN C1 LOOP
    ...
    INSERT INTO MIGRA.MG_G_INTERMEDIA_IPU_RECAUDO_2024_MAESTRO
      (CDGO_IMPSTO,
       CDGO_SBIMPSTO,
       CDGO_BNCO,
       NMRO_CNTA,
    ...
    FOR R2 IN C2(R1.MODPDPNU, R1.MODPSUIM, R1.MODPSECU, R1.MODPNUPA) LOOP
      INSERT INTO MIGRA.MG_G_INTERMEDIA_IPU_RECAUDO_2024_DETALLE
        (ID_INTRMDIA_MSTRO,
         CDGO_IMPSTO,
         CDGO_SBIMPSTO,
         VGNCIA,
