  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "PRC_MIGRA_DOCUICA_03_RF" ( p_id_entdad         in  number
...
v_indcdor_aplcdo    re_g_documentos.indcdor_pgo_aplcdo%type;
/*
v_cnvnio            boolean;
...
begin
   ...
   v_archvo_log   := 'PRC_MIGRA_DOCUICA_03_RF_LOG_'||v_fcha_hra||'.txt';
   v_archvo_cmmit := 'PRC_MIGRA_DOCUICA_03_RF_COMMIT_'||v_fcha_hra||'.txt';
   v_cntdor       := 0;
   ...
   -- escribir a log
   v_txto := 'Se inicia proceso de cargue de documentos ica PRC_MIGRA_DOCUICA_03_RF';
   ...
   for r1 in c1(p_cdgo_clnte, p_id_entdad) loop      --, p_fcha_dsde, p_fcha_hsta
     ...
     v_vlor_ttal_dbe  := nvl(r1.clmna4,0) + nvl(r1.clmna6,0) + nvl(r1.clmna8,0);
     v_vlor_ttal_hber := nvl(r1.clmna5,0) + nvl(r1.clmna7,0) + nvl(r1.clmna9,0);


     if r1.clmna3 = 'RP_LICAS' then        v_cdgo_dcmnto_tpo := 'DNO';
     elsif r1.clmna3 = 'RP_NORMAL' then    v_cdgo_dcmnto_tpo := 'DNO';
     elsif r1.clmna3 = 'RP_CUOTA' then     v_cdgo_dcmnto_tpo := 'DCO';
     elsif r1.clmna3 = 'RP_AP_INI' then    v_cdgo_dcmnto_tpo := 'DNO';
     end if;

     v_indcdor_aplcdo := 'N';

     if r1.clmna13 = '24' then v_indcdor_aplcdo := 'S';
     elsif r1.clmna13 = '23' then v_indcdor_aplcdo := 'N';
     end if;
     ...
     begin
       ...
       values(r1.cdgo_clnte, v_id_impsto, v_id_impsto_sbmpsto, v_id_sjto_impsto,
              r1.clmna3, 'DDM',
              null, null,
              TO_DATE(r1.clmna12,'DD/MM/YYYY'), TO_DATE(r1.clmna11,'DD/MM/YYYY'),
              v_vlor_ttal_dbe, v_vlor_ttal_hber, r1.clmna10,
              v_indcdor_aplcdo, r1.clmna10,
