...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Gestión de Vehículos')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_6700075000')
...
,p_authentication_id=>wwv_flow_api.id(237331657134530890)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20260225140312'
