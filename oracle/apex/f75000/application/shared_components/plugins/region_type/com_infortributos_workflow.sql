...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(82929603128795095)
...
,p_reference_id=>36869248211865148
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
,p_files_version=>5
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(82929937027795095)
,p_plugin_id=>wwv_flow_api.id(82929603128795095)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(82930321926795096)
,p_plugin_id=>wwv_flow_api.id(82929603128795095)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(82930753593795097)
,p_plugin_id=>wwv_flow_api.id(82929603128795095)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(82931128018795099)
,p_plugin_id=>wwv_flow_api.id(82929603128795095)
,p_attribute_scope=>'COMPONENT'
