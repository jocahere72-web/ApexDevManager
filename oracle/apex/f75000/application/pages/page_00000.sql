...
,p_required_role=>wwv_flow_api.id(237333110205541418)
,p_protection_level=>'D'
,p_last_upd_yyyymmddhh24miss=>'20200725113320'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(339556276254842861)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'t-BreadcrumbRegion--useBreadcrumbTitle:t-BreadcrumbRegion--showBreadcrumb:t-Form--noPadding:t-Form--stretchInputs:t-Form--leftLabels:t-Form--labelsAbove:margin-top-none:margin-bottom-none:margin-left-none:margin-right-none'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(237253545553524204)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(237363008639118413)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(339556276254842861)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(174341735334171166)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(174341879032171167)
,p_event_id=>wwv_flow_api.id(174341735334171166)
,p_event_result=>'TRUE'
