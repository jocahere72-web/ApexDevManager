...
'',
'}'))
,p_step_template=>wwv_flow_api.id(29904037144317076)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(308642635338871438)
,p_plug_name=>unistr('Autenticaci\00F3n')
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(29944246886317093)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(103274600822140591)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(308642635338871438)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(103275034700140594)
,p_name=>'P101_CDGO_CLNTE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(308642635338871438)
,p_prompt=>'Cliente'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(103275478162140597)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(103275819953140598)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(103276303270140610)
...
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_api.id(103275478162140597)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(103276767965140614)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(103277408789140614)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(103277095332140614)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(103278215835140615)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(103277864993140615)
,p_process_sequence=>10
