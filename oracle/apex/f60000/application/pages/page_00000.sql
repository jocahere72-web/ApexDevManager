...
,p_last_upd_yyyymmddhh24miss=>'20191018153024'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(470986653089672439)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136001121118904782)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(470986653089672439)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6014037074689121)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6014199177689122)
,p_event_id=>wwv_flow_api.id(6014037074689121)
,p_event_result=>'TRUE'
