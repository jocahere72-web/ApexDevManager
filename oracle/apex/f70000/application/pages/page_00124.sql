...
,p_last_upd_yyyymmddhh24miss=>'20200506163041'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3290166122043501)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3290291730043502)
,p_plug_name=>unistr('Par\00E1metros B\00FAsqueda')
,p_parent_plug_id=>wwv_flow_api.id(3290166122043501)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3290328360043503)
,p_plug_name=>'Totales'
,p_parent_plug_id=>wwv_flow_api.id(3290166122043501)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(164080910676707690)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3290418884043504)
,p_plug_name=>'Declaraciones Gestionadas'
,p_parent_plug_id=>wwv_flow_api.id(3290328360043503)
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
...
'where a.cdgo_dclrcion_estdo = :P124_CDGO_DCLRCION_ESTDO',
'',
'and (  (a.cdgo_dclrcion_estdo = ''REG'' and  a.fcha_rgstro        between :P124_FECHA  and :P124_FECHA_HASTA) or',
'      (a.cdgo_dclrcion_estdo = ''AUT''  and  a.fcha_rgstro        between :P124_FECHA  and :P124_FECHA_HASTA) or',
'      (a.cdgo_dclrcion_estdo = ''PRS''  and  a.fcha_prsntcion     between :P124_FECHA  and :P124_FECHA_HASTA) or',
'      (a.cdgo_dclrcion_estdo = ''APL''  and  a.fcha_aplccion      between :P124_FECHA  and :P124_FECHA_HASTA)',
'      );',
'',
''))
,p_plug_source_type=>'PLUGIN_COM.ORACLE.APEX.BADGE_LIST'
,p_ajax_items_to_submit=>'P124_CDGO_DCLRCION_ESTDO,P124_FECHA,P124_FECHA_HASTA'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3301510565244301)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(3370603758362701)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(3370783645362702)
,p_region_id=>wwv_flow_api.id(3370603758362701)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(3370868365362703)
,p_chart_id=>wwv_flow_api.id(3370783645362702)
,p_seq=>10
...
'and         a.cdgo_dclrcion_estdo = :P124_CDGO_DCLRCION_ESTDO',
'and (  (a.cdgo_dclrcion_estdo = ''REG'' and  a.fcha_rgstro        between :P124_FECHA  and :P124_FECHA_HASTA) or',
'      (a.cdgo_dclrcion_estdo = ''AUT''  and  a.fcha_rgstro        between :P124_FECHA  and :P124_FECHA_HASTA) or',
'      (a.cdgo_dclrcion_estdo = ''PRS''  and  a.fcha_prsntcion     between :P124_FECHA  and :P124_FECHA_HASTA) or',
'      (a.cdgo_dclrcion_estdo = ''APL''  and  a.fcha_aplccion      between :P124_FECHA  and :P124_FECHA_HASTA)',
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(3370976003362704)
,p_chart_id=>wwv_flow_api.id(3370783645362702)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(3371077780362705)
,p_chart_id=>wwv_flow_api.id(3370783645362702)
,p_axis=>'y'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(3371533704362710)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(3290291730043502)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3371171935362706)
,p_name=>'P124_FECHA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(3290291730043502)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3371436284362709)
,p_name=>'P124_FECHA_HASTA'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(3290291730043502)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(3371679997362711)
,p_name=>'P124_CDGO_DCLRCION_ESTDO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(3290291730043502)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(3371246226362707)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(3371383777362708)
,p_event_id=>wwv_flow_api.id(3371246226362707)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'$("#P124_FECHA_HASTA").datepicker( ''option'' , ''minDate'' , $("#P124_FECHA").val());',
