...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(149217132615128065)
...
,p_plug_template=>wwv_flow_api.id(168781231745188214)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(149217238607128066)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6015044686689131)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6015187536689132)
,p_event_id=>wwv_flow_api.id(6015044686689131)
,p_event_result=>'TRUE'
