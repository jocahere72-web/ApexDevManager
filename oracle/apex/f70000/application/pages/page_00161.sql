...
,p_name=>unistr('Liquidaci\00F3n de plusval\00EDa masivo')
,p_page_mode=>'MODAL'
,p_step_title=>unistr('Liquidaci\00F3n Masiva de Plusval\00EDa')
,p_autocomplete_on_off=>'OFF'
,p_page_template_options=>'#DEFAULT#'
,p_dialog_height=>'auto'
,p_dialog_width=>'50%'
,p_last_updated_by=>'NCARRASQUILLA'
,p_last_upd_yyyymmddhh24miss=>'20200930164541'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(151367955465283279)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(92961270990121696)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(151367955465283279)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(92964986082121725)
,p_branch_name=>'Ir al inicio'
,p_branch_action=>'f?p=&APP_ID.:154:&SESSION.::&DEBUG.:RP,161::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(92961270990121696)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92962435364121708)
,p_name=>'P161_VGNCIA'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(151367955465283279)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92963608906121710)
,p_name=>'P161_BRANCH_APP'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(151367955465283279)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(92964054468121711)
,p_name=>'P161_BRANCH_PAGE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(151367955465283279)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(92964492297121724)
...
,p_process_when_button_id=>wwv_flow_api.id(92961270990121696)
