...
'',
'background : url(#WORKSPACE_IMAGES#Logo_Transparente_tax.ico);',
'width : 400px;',
'height : 90px;',
'}',
'',
...
'}',
''))
,p_step_template=>wwv_flow_api.id(164064250960707625)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'SROMERO'
,p_last_upd_yyyymmddhh24miss=>'20191219160910'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(369501118532510713)
...
,p_plug_template=>wwv_flow_api.id(164080694370707690)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(164133066188779878)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(369501118532510713)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(164133474943779890)
,p_name=>'P101_CDGO_CLNTE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(369501118532510713)
,p_prompt=>'Cliente'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(164133903605779895)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(164134277351779895)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(164134776756779916)
...
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_api.id(164133903605779895)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(164135116779779936)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(164135784446779937)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(164135347500779937)
...
'        a.nmbre_clnte',
'    into :F_ID_PAIS_CLNTE, :F_CDGO_PAIS_CLNTE, :F_ID_DPRTMNTO_CLNTE, :F_CDGO_DPRTMNTO_CLNTE, :F_ID_MNCPIO_CLNTE, :F_CDGO_MNCPIO_CLNTE, :F_NMBRE_CLNTE',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(164136600786779938)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(164136155097779938)
,p_process_sequence=>10
