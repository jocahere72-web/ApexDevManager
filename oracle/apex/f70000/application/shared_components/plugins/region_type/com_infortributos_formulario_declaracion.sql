...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(21919547564837089)
...
'    ',
'    v_ulr_srvcio        varchar2(1000) := v(''F_DRCCION_SRVDOR_PBLCO'') || ''declaraciones/gestion'';--p_region.attribute_11;',
'    l_clob              clob;',
...
'        apex_json.write(''urlServicio'', v(''F_DRCCION_SRVDOR_PBLCO'') || ''declaraciones/gestion'');--p_region.attribute_11); --v_ulr_srvcio',
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(21920973837844632)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(21921443435846342)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(22247987267148093)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(22248817494150891)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
,p_prompt=>'Ejecutar Validaciones'
,p_attribute_type=>'CHECKBOX'
,p_is_required=>false
,p_default_value=>'Y'
,p_is_translatable=>false
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(22249463917154360)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
,p_prompt=>'Validar Numero Minimo de Filas'
,p_attribute_type=>'CHECKBOX'
,p_is_required=>false
,p_default_value=>'Y'
,p_supported_ui_types=>'DESKTOP:JQM_SMARTPHONE'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(34940869359903334)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(40739825525293772)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(45593207223476477)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(49147914939326707)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(49793547771709433)
,p_plugin_id=>wwv_flow_api.id(21919547564837089)
,p_attribute_scope=>'COMPONENT'
