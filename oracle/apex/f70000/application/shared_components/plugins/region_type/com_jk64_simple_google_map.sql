...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(529286656642845611)
...
'#IMAGE_PREFIX#plugins/infortributos/com.jk64.simple_google_map/simplemap.js',
'#IMAGE_PREFIX#plugins/infortributos/com.jk64.simple_google_map/simplemap.min.js'))
...
'--g_tochar_format constant varchar2(100) := ''fm990.0999999999999999'';',
'',
'function render (',
...
'    */',
'	insert into gti_aux(col1, col2) values (10, ''l_latlong:'' || l_latlong); commit;',
'	insert into gti_aux(col1, col2) values (20, ''l_lat_ cadena:'' || substr(l_latlong,1,instr(l_latlong,'','')-1) ); commit;',
'    insert into gti_aux(col1, col2) values (10, ''l_lon_ cadena:'' || substr(l_latlong,instr(l_latlong,'','')+1) ); commit;',
'    ',
'',
'    ',
'    l_lat := to_number( replace ( substr(l_latlong, 1, instr(l_latlong,'','')-1 ) , ''.'', '','') );',
'    l_lng := to_number( replace ( substr(l_latlong, instr(l_latlong,'','')+1 )    , ''.'', '','') ) ;',
'    ',
'    -- substr(l_latlong, 1, instr(l_latlong,'','')-1 )',
'    --substr(l_latlong, instr(l_latlong,'','')+1) )',
'    ',
'	insert into gti_aux(col1, col2) values (2, ''l_lat:'' || to_char(l_lat,g_tochar_format) ); commit;',
'	insert into gti_aux(col1, col2) values (3, ''l_lng:'' || l_lng); commit;',
'	',
...
,p_reference_id=>80207916210784713
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80832943077998050)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80833362922998050)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80833793935998050)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80834134117998051)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80834503699998051)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80834980927998051)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80835363596998051)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80835757711998051)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80836132161998051)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80836542589998051)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
,p_max_length=>2
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(80836132161998051)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80836924039998052)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80837353325998052)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80837769092998052)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80838141304998052)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
,p_unit=>'(0-23)'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(80837769092998052)
,p_depending_on_has_to_exist=>true
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80838547984998052)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80838984545998052)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80839367267998052)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80839702283998053)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(80840128359998053)
,p_plugin_attribute_id=>wwv_flow_api.id(80839702283998053)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(80840663719998053)
,p_plugin_attribute_id=>wwv_flow_api.id(80839702283998053)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(80841109089998053)
,p_plugin_attribute_id=>wwv_flow_api.id(80839702283998053)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(80841614888998053)
,p_plugin_attribute_id=>wwv_flow_api.id(80839702283998053)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(80844463375998055)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_name=>'address'
,p_display_name=>'address'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(80844879006998055)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_name=>'geolocate'
,p_display_name=>'geolocate'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(80845287993998056)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_name=>'mapclick'
,p_display_name=>'mapClick'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(80845620525998056)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
,p_name=>'maploaded'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(80846662252998057)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
...
begin
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(80847006814998057)
,p_plugin_id=>wwv_flow_api.id(529286656642845611)
