...
,p_last_upd_yyyymmddhh24miss=>'20190816090350'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(198230639644979772)
...
,p_plug_template=>wwv_flow_api.id(201784202300356733)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(198230760502979773)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(198230639644979772)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6015700274689138)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6015851726689139)
,p_event_id=>wwv_flow_api.id(6015700274689138)
,p_event_result=>'TRUE'
