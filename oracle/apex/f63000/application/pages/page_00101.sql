...
'',
'}'))
,p_step_template=>wwv_flow_api.id(197894407847249987)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'SROMERO'
,p_last_upd_yyyymmddhh24miss=>'20180201095250'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(309324768811086720)
,p_plug_name=>unistr('Autenticaci\00F3n')
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(197910782909250046)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(103956713176355880)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(309324768811086720)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(197933819388250119)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(103957157525355891)
,p_name=>'P101_CDGO_CLNTE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(309324768811086720)
,p_prompt=>'Cliente'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(103957559908355893)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(103957943417355893)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(103958394697355905)
...
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_api.id(103957559908355893)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(103958774725355908)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(103959395052355908)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(103959014476355908)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(103960253472355909)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(103959804624355908)
,p_process_sequence=>10
