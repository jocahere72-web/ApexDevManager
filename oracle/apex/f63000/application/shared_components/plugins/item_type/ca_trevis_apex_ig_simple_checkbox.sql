...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(91363577804573061)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(91363782264573078)
,p_plugin_id=>wwv_flow_api.id(91363577804573061)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(91364129490573080)
,p_plugin_id=>wwv_flow_api.id(91363577804573061)
,p_attribute_scope=>'COMPONENT'
