prompt --application/shared_components/reports/report_queries/gi_g_reporte_criticas_cinta
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(54958808060812061)
,p_name=>'gi_g_reporte_criticas_cinta'
...
,p_report_layout_id=>wwv_flow_api.id(57225023748770772)
,p_format=>'PDF'
,p_output_file_name=>'gi_g_reporte_criticas_cinta'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57227559097772847)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
...
'  from df_c_imagenes_cliente a',
'  join df_s_clientes b on (a.cdgo_clnte = b.cdgo_clnte) ',
' where a.cdgo_clnte = 1--:F_CDGO_CLNTE',
'   and a.cdgo_imgen_clnte = ''L_E'''))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57227748158772847)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57227962322772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57228126459772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  --Predios Cargados',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57228314298772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
' --Registros Enviados',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57228598421772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57228735761772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57228941077772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57229139043772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57229373334772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57229545091772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57229789157772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57229946147772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57230175803772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57230339690772848)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57230504399772849)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57230752722772849)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57230985294772849)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57231147001772849)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57231308462772849)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
' --valor_total_avaluos',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57231500069772849)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(57231790544772849)
,p_shared_query_id=>wwv_flow_api.id(54958808060812061)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--clases de predios',
