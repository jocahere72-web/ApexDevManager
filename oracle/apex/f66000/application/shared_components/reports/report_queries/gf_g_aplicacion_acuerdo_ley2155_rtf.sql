prompt --application/shared_components/reports/report_queries/gf_g_aplicacion_acuerdo_ley2155_rtf
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(14767922890549735)
,p_name=>'gf_g_aplicacion_acuerdo_ley2155_rtf'
...
'                              where a.id_cnvnio = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :F_APP_XML, p_nodo => ''ID_CNVNIO'') ) as vlor_ttal_cta_incal',
...
'where a.cdgo_clnte = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :F_APP_XML, p_nodo => ''COD_CLNTE'')',
'  and a.id_cnvnio =  pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :F_APP_XML, p_nodo => ''ID_CNVNIO'')'))
,p_format=>'PDF'
,p_output_file_name=>'gf_g_aplicacion_acuerdo_ley2155_rtf'
,p_content_disposition=>'ATTACHMENT'
,p_xml_items=>'F_CDGO_CLNTE'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(97955447120371957)
,p_shared_query_id=>wwv_flow_api.id(14767922890549735)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(97955698530371958)
,p_shared_query_id=>wwv_flow_api.id(14767922890549735)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(97955852247371958)
,p_shared_query_id=>wwv_flow_api.id(14767922890549735)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(97956050125371958)
,p_shared_query_id=>wwv_flow_api.id(14767922890549735)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--4. Cuota Inicial',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(97956277781371958)
,p_shared_query_id=>wwv_flow_api.id(14767922890549735)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--5. Plan de Pago',
'select nmro_cta,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(97956495963371958)
,p_shared_query_id=>wwv_flow_api.id(14767922890549735)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'',
'--6. Encabezado ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(97956653537371958)
,p_shared_query_id=>wwv_flow_api.id(14767922890549735)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(97956820715371958)
,p_shared_query_id=>wwv_flow_api.id(14767922890549735)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(97957082311371958)
,p_shared_query_id=>wwv_flow_api.id(14767922890549735)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
