prompt --application/shared_components/reports/report_queries/gf_g_resolucion_plantilla
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(77783296560366728)
,p_name=>'gf_g_resolucion_plantilla'
...
'   where id_acto =pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ID_ACTO'')'))
,p_format=>'PDF'
,p_output_file_name=>'gf_g_resolucion_plantilla'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(77799030683550751)
,p_shared_query_id=>wwv_flow_api.id(77783296560366728)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(77799237937550751)
,p_shared_query_id=>wwv_flow_api.id(77783296560366728)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(77799461982550751)
,p_shared_query_id=>wwv_flow_api.id(77783296560366728)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select  txto_dcmnto  ',
'from  gj_g_recursos_documento         ',
'where id_rcrso_etpa = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :F_APP_XML, p_nodo => ''id_rcrso_etpa'')     '))
);
end;
/
