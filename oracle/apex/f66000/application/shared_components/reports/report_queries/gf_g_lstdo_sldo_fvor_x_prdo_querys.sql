prompt --application/shared_components/reports/report_queries/gf_g_lstdo_sldo_fvor_x_prdo_querys
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(43073550205288397)
,p_name=>'gf_g_lstdo_sldo_fvor_x_prdo querys'
...
,p_format=>'PDF'
,p_output_file_name=>'gf_g_lstdo_sldo_fvor_x_prdo querys'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(43073755671288401)
,p_shared_query_id=>wwv_flow_api.id(43073550205288397)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(43073988804288401)
,p_shared_query_id=>wwv_flow_api.id(43073550205288397)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
