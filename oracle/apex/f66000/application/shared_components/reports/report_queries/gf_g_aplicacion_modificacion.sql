prompt --application/shared_components/reports/report_queries/gf_g_aplicacion_modificacion
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(110189597980730836)
,p_name=>'gf_g_aplicacion_modificacion'
...
,p_report_layout_id=>wwv_flow_api.id(121885818840090400)
,p_format=>'PDF'
,p_output_file_name=>'gf_g_aplicacion_modificacion'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(121886406909094121)
,p_shared_query_id=>wwv_flow_api.id(110189597980730836)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(121886685229094121)
,p_shared_query_id=>wwv_flow_api.id(110189597980730836)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--obtener html',
'select b.dcmnto,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(121886838785094121)
,p_shared_query_id=>wwv_flow_api.id(110189597980730836)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
