prompt --application/shared_components/reports/report_queries/gf_g_aplicacion_acuerdo_normal
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(97960714794571076)
,p_name=>'gf_g_aplicacion_acuerdo_normal'
...
,p_format=>'PDF'
,p_output_file_name=>'gf_g_aplicacion_acuerdo_normal'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73698951802765632)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--1. Datos generales acto apli',
'SELECT initcap_personalizado(a.nmbre_impsto_sbmpsto) nmbre_impsto,',
'       a.nmro_cnvnio,',
'       e.prmer_nmbre sujeto_pasivo,',
'       initcap(to_char(a.fcha_acto,',
'                       ''FMMONTH DD "de" YYYY '',',
...
'              a.idntfccion_sjto,',
'              ''P'',',
'              nvl(trim(n.mtrcla_inmblria),''NO REGISTRA''),',
'              null) nit_matricula,',
'       a.drccion,',
'       upper(a.nmbre_slctnte) nmbre_slctnte,',
'       a.nmro_idntfccion_slctnte,',
...
'  join pq_g_radicador o',
'    on o.id_rdcdor = a.id_rdcdor',
'  join v_sg_g_usuarios p',
'    on p.id_usrio = a.id_usrio_aprbcion',
' WHERE a.cdgo_clnte = :F_CDGO_CLNTE',
'   AND a.id_cnvnio = :p2_prmtro_1'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73699167976765632)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73699312676765632)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73699519210765632)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--4. Cuota Inicial',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73699780852765632)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--5. Plan de Pago',
'select nmro_cta,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73699918951765632)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'',
'--6. Encabezado ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73700111352765632)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73700312322765633)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73700553596765633)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(73700760639765633)
,p_shared_query_id=>wwv_flow_api.id(97960714794571076)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--10.-Porcentaje de la cuota inicial',
'SELECT ',
'  SUM(ROUND((b.vlor_ttal_dcmnto * 100.0) / b.VLOR_TTAL_DBE, 2)) AS total_porcentaje',
'FROM gf_g_cnvnios_cta_incl_vgnc a',
'JOIN re_g_documentos b ON a.id_dcmnto = b.id_dcmnto',
'LEFT JOIN v_re_g_recaudos c ON a.id_dcmnto = c.id_orgen',
'LEFT JOIN v_re_g_recaudos_control d ON d.id_rcdo_cntrol = c.id_rcdo_cntrol',
