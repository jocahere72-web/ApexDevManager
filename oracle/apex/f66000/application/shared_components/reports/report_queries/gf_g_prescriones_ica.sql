prompt --application/shared_components/reports/report_queries/gf_g_prescriones_ica
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(126235020351045038)
,p_name=>'gf_g_prescriones_ica'
...
,p_format=>'PDF'
,p_output_file_name=>'gf_g_prescriones_ica'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(126235275507045041)
,p_shared_query_id=>wwv_flow_api.id(126235020351045038)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(126235442184045042)
,p_shared_query_id=>wwv_flow_api.id(126235020351045038)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(126235635089045042)
,p_shared_query_id=>wwv_flow_api.id(126235020351045038)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(126235809537045043)
,p_shared_query_id=>wwv_flow_api.id(126235020351045038)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--Fecha del documento',
