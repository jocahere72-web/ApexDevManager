prompt --application/shared_components/reports/report_queries/gf_g_certificado_exenciones
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(83187965259364943)
,p_name=>'gf_g_certificado_exenciones'
...
,p_format=>'PDF'
,p_output_file_name=>'gf_g_certificado_exenciones'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(83428580287888154)
,p_shared_query_id=>wwv_flow_api.id(83187965259364943)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(83428726489888154)
,p_shared_query_id=>wwv_flow_api.id(83187965259364943)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'-- 2. Documento',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(83428950974888154)
,p_shared_query_id=>wwv_flow_api.id(83187965259364943)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--3. Firma Funcionario  ',
...
' where id_exncion_slctud           = json_value(:P37_JSON,''$.id_exncion_slctud'');'))
);
end;
/
