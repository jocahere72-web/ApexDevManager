prompt --application/shared_components/reports/report_queries/re_g_lstdo_rcdo_ttal_x_vgncia
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(19159642843881220)
,p_name=>'re_g_lstdo_rcdo_ttal_x_vgncia'
...
'                '))
,p_format=>'PDF'
,p_output_file_name=>'re_g_lstdo_rcdo_ttal_x_vgncia'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(21570105489156097)
,p_shared_query_id=>wwv_flow_api.id(19159642843881220)
...
'                         group by ( case when b.vgncia is not null then ',
'                                          decode( b.vgncia , /*extract( year from sysdate )*/ pkg_gn_generalidades.fnc_cl_defniciones_cliente( p_cdgo_clnte 			     => :F_CDGO_CLNTE',
'                                                                                                                               , p_cdgo_dfncion_clnte_ctgria => ''GFN''',
'                                                                                                                               , p_cdgo_dfncion_clnte		 => ''VAC'' ) , ''VIGENCIA ACTUAL'' , ''VIGENCIAS ANTERIORES'' )',
'                                    end )',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(21570399545156097)
,p_shared_query_id=>wwv_flow_api.id(19159642843881220)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
