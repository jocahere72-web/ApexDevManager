prompt --application/shared_components/reports/report_queries/gf_g_reversion_acuerdo
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(101547555040594654)
,p_name=>'gf_g_reversion_acuerdo'
...
,p_format=>'PDF'
,p_output_file_name=>'gf_g_reversion_acuerdo'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(121849765312893893)
,p_shared_query_id=>wwv_flow_api.id(101547555040594654)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(121849956821893894)
,p_shared_query_id=>wwv_flow_api.id(101547555040594654)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'  --obtener html',
' select a.dcmnto, b.nmro_acto, b.cdgo_cnvnio_estdo',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(121850142717893894)
,p_shared_query_id=>wwv_flow_api.id(101547555040594654)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
