prompt --application/shared_components/reports/report_queries/gf_cn_plan_pago
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(75381748160081134)
,p_name=>'gf_cn_plan_pago'
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(14548282290795441)
,p_shared_query_id=>wwv_flow_api.id(75381748160081134)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(14548450034795441)
,p_shared_query_id=>wwv_flow_api.id(75381748160081134)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
' select to_char(a.fcha_slctud, ''DD/MM/YYYY HH12:MI:SS AM'') fcha_slctud,',
'        (select trim(to_char(sum(vlor_cptal+vlor_intres),''$999,999,999,999,999'')) from gf_g_convenios_cartera where id_cnvnio = :P2_PRMTRO_1) ttal_crtra,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(14548630942795441)
,p_shared_query_id=>wwv_flow_api.id(75381748160081134)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select a.vgncia, ',
'        a.prdo,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(14548876528795441)
,p_shared_query_id=>wwv_flow_api.id(75381748160081134)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select  a.nmro_cta,',
