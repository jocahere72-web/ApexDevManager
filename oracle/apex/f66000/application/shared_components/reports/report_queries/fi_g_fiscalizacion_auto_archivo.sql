prompt --application/shared_components/reports/report_queries/fi_g_fiscalizacion_auto_archivo
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(28265430010309993)
,p_name=>'fi_g_fiscalizacion_auto_archivo'
...
,p_format=>'PDF'
,p_output_file_name=>'fi_g_fiscalizacion_auto_archivo'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28265691445309995)
,p_shared_query_id=>wwv_flow_api.id(28265430010309993)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28265801542309996)
,p_shared_query_id=>wwv_flow_api.id(28265430010309993)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28266075708309996)
,p_shared_query_id=>wwv_flow_api.id(28265430010309993)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28266264023309996)
,p_shared_query_id=>wwv_flow_api.id(28265430010309993)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28266465731309996)
,p_shared_query_id=>wwv_flow_api.id(28265430010309993)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--Sujeto',
