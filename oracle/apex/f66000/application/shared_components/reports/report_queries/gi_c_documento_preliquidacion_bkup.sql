prompt --application/shared_components/reports/report_queries/gi_c_documento_preliquidacion_bkup
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(70386302010248644)
,p_name=>'gi_c_documento_preliquidacion_bkup'
...
,p_format=>'PDF'
,p_output_file_name=>'gi_c_documento_preliquidacion_bkup'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70386560995248644)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#45  Q#40--query_48: estadisticas por predios destinos urbanos NO homologados por estatuto o por asignacion de la GGI */',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70386729008248644)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#43 Q#30_b ******** query_23: estadisticas (totales y porcentajes) por predios urbanos de destino habitacional x estrato reemplazando ''NO DEFINIDO'' por Estrato ''99 - Existen'' ***/',
'select c.Destino,',
...
'       c.avluo_igac avluo,',
'       (select p.CDGO_ESTRTO from si_c_sujetos s join si_i_predios p on s.id_sjto = p.id_sjto  where s.idntfccion = c.rfrncia_igac) estrto',
'from v_gi_g_cinta_igac c ',
'where c.nmro_orden_igac = ''001''',
'      and substr(c.rfrncia_igac,1,2)<>''00'' ',
'      and c.dstno_ecnmco_igac = ''A'' ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70386955133248644)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70387150156248644)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'  from v_gi_g_cinta_igac c where nmro_orden_igac=''001'' and ',
'   not exists (select ''x'' from  v_gi_g_cinta_igac p where p.rfrncia_igac = c.rfrncia_igac and p.vgncia_igac = (pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_VGNCIA'')-1)',
'                                                           and id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')) ',
'   and exists (select ''x'' from v_si_i_sujetos_impuesto pp where pp.idntfccion_sjto = c.rfrncia_igac)',
'   and c.vgncia_igac = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_VGNCIA'')',
'   and id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')   ',
'   ',
'',
'   ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70387362006248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70387563174248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70387771942248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#11 Total avaluos  */',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70387922789248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70388190256248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#17  */',
'select count(*)  value ,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70388321358248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#18 */',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70388568377248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70388776347248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70388961203248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70389179432248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70389326785248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#23 */',
'select a.dstno_ecnmco_igac "Destino IGAC" ,',
...
begin
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70389539600248645)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#24 */',
'select a.dstno_ecnmco_igac "Destino IGAC",',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70389768608248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#27*/ ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70389929330248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* #Q25 Predios Destinos No Homologados */ ',
'select  count(*) value,',
'',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70390128204248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#26*/',
'select  count(*) value,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70390363214248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70390552283248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70390730431248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70390967899248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#16 */',
'select a.dstno_ecnmco_igac "Destino IGAC" ,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70391157446248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#1 Registros y predios cargados   */',
'select count(*) value, ',
'       ''Registros Cargados'' as color,',
'       ''Registros recibidos y Predios recibidos'' as etiqueta from v_gi_g_cinta_igac where id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')',
'        and cdgo_clnte      = :F_CDGO_CLNTE',
'union all ',
'select count(*) as value,',
'''Predios Cargados'' as color,',
'''Registros recibidos y Predios recibidos'' as etiqueta',
'from v_gi_g_cinta_igac  where nmro_orden_igac = ''001''  and id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')',
' and cdgo_clnte      = :F_CDGO_CLNTE;',
''))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70391394881248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70391579857248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#3 incremento de predios reportados por la cinta CATASTRAL de vgncia vs cinta I.G.A.C de vgncia_anterior */',
'select ',
'     trim( to_char((b.cntdad_actual-a.cntdad_anterior),''999G999G999G999G999G999G990'')) incrmnto_prdios_reprtdos',
'',
' from',
'    ( select ',
'        count(*) cntdad_anterior',
'      from v_gi_g_cinta_igac ',
'      where nmro_orden_igac = ''001'' ',
'        and vgncia =  pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_VGNCIA'')-1',
'         and cdgo_clnte      = :F_CDGO_CLNTE) a,',
'    ( select ',
'        count(*) cntdad_actual',
'      from v_gi_g_cinta_igac  ',
'      where nmro_orden_igac= ''001'' ',
'        and vgncia = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_VGNCIA'')',
'         and cdgo_clnte      = :F_CDGO_CLNTE) b;   ',
'',
'',
'',
''))
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70391728068248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
' /*  Q#4  */',
' select ',
'     ',
'       trim(to_char(count(*),''999G999G999G999G999G999G990'')) AS predios_nuevos ',
'     ',
'  from v_gi_g_cinta_igac a',
' where a.nmro_orden_igac = ''001''',
'   and a.cdgo_clnte      = :F_CDGO_CLNTE',
'   and a.vgncia          = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_VGNCIA'')',
'   and not exists (',
'                    select ''x''',
'                     from v_gi_g_cinta_igac c',
'                    where c.rfrncia_igac  = a.rfrncia_igac',
'                      and c.cdgo_clnte      = :F_CDGO_CLNTE',
'                      and c.vgncia        = (pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_VGNCIA'') - 1)',
'                   )'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70391948581248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70392104071248646)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70392387624248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#30******** query_23: estadisticas por predios urbanos de destino habitacional x estrato reemplazando ''NO DEFINIDO'' por Estrato ''99 - Existen'' ***/',
'',
'select ''HABITACIONAL'' "Destino",',
'        Nvl(c.estrato_d,''Estrato 99 - Nuevos'') "Estrato",',
'        trim(to_char(c.cntdad ,''999G999G999G999G999G999G990''))  "Total Predios",',
...
'from (',
'',
'select b.estrato,(select decode(e.dscrpcion_estrto,''NO DEFINIDO'',''Estrato 99 - Existen'',e.dscrpcion_estrto,e.dscrpcion_estrto)  from df_s_estratos e where e.cdgo_estrto = b.estrato) estrato_d, ',
'count(*) cntdad, sum(b.avluo) Ttal_avluos      ',
'from (',
'select a.rfrncia_igac,a.avluo,',
'       case a.estrto',
'       when ''1'' then ''1''  ',
'       when ''2'' then ''2''',
'       when ''3'' then ''3''',
...
'       else ''98'' end estrato',
'from (',
'select c.rfrncia_igac,c.avluo_igac avluo,',
'       (select p.CDGO_ESTRTO from si_c_sujetos s join si_i_predios p on s.id_sjto = p.id_sjto  where s.idntfccion = c.rfrncia_igac) estrto',
'from v_gi_g_cinta_igac c ',
'where c.nmro_orden_igac = ''001''',
'      and substr(c.rfrncia_igac,1,2)<>''00'' ',
...
'      ) b',
'group by b.estrato',
'order by b.estrato) c;',
''))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70392588208248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('/* Q#31 query_33: cantidad de predios que actualmente estan con destino 22 - MUNICIPAL \2013 BANCO INMOBILIARIO METRO */'),
'select ',
'',
'trim(to_char(COUNT(*) ,''999G999G999G999G999G999G990'')) cntdad_pred_dest22_vgncia  ',
'',
...
'where b.nmtcnco=''22'' and a.cdgo_sjto_estdo=''A''',
'and c.id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70392721727248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('/*  Q#32 query_34: cantidad de predios que en IGAC en 2017 envia y haran parte de la liquidacion atipica 22 - MUNICIPAL \2013 BANCO INMOBILIARIO METRO*/'),
'SELECT ',
...
'where c.nmro_orden_igac = ''001'' ',
'    and c.id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')',
'    and c.rfrncia_igac in (select a.idntfccion_sjto from v_si_i_sujetos_impuesto a join v_si_i_predios b on a.id_sjto = b.id_sjto where b.nmtcnco=''22'' and a.cdgo_sjto_estdo=''A'') ',
'    and c.area_cnstrda_igac=0 ',
'    and c.cdgo_clnte= :F_CDGO_CLNTE'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70392953383248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#33 query_35: cantidad de predios que actualmente estan con destino 33-ENTIDADES ORDEN NACIONAL y DEPARTAMENTAL */',
'select ',
'trim(to_char(COUNT(*) ,''999G999G999G999G999G999G990'')) cntdad_pred_dest33_vgncia ',
'from v_si_i_sujetos_impuesto a',
'join v_si_i_predios b on a.id_sjto = b.id_sjto',
'join v_gi_g_cinta_igac c on a.idntfccion_sjto= c.rfrncia_igac and c.cdgo_clnte = :F_CDGO_CLNTE',
'where b.nmtcnco=''33'' and a.cdgo_sjto_estdo=''A''',
'and c.id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70393186780248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#34 query_36: cantidad de predios que en IGAC  envia y haran parte de la liquidacion atipica 33-ENTIDADES ORDEN NACIONAL y DEPARTAMENTAL */',
'',
'SELECT',
'trim(to_char( count(*) ,''999G999G999G999G999G999G990''))  ctdad_prd_dst33_vgn_liq_atip',
'from  v_gi_g_cinta_igac c',
'where c.nmro_orden_igac = ''001'' ',
'        and c.id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')',
'        and exists (select ''x'' from v_si_i_sujetos_impuesto a join v_si_i_predios b on a.id_sjto = b.id_sjto where a.idntfccion_sjto = c.rfrncia_igac and b.nmtcnco=''33'' and a.cdgo_sjto_estdo=''A'')',
'        and c.cdgo_clnte      = :F_CDGO_CLNTE',
''))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70393393089248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#35 query_37: cantidad de predios que en IGAC en 2017 envia y haran parte de la liquidacion atipica CAYENAS */',
'select ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70393500489248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#38- Q#47--query_47: estadisticas por predios destinos urbanos residencial (A) para estrato 1 con diferencial de avaluo grafica */',
'select a.dstno_ecnmco_igac "Destino IGAC",',
unistr('       a.dscrpcion         "Descripci\00F3n Destino",'),
'       a.estrto            "Estrato",',
...
'      and c.id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')',
'      and EXISTS (select ''x'' from si_c_sujetos s join si_i_predios p on s.id_sjto = p.id_sjto  where s.idntfccion = c.rfrncia_igac and p.cdgo_estrto =''1'')',
'      and c.cdgo_clnte      = :F_CDGO_CLNTE',
'group by c.dstno_ecnmco_igac',
'UNION',
'select c.dstno_ecnmco_igac, ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70393731656248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#36 query_38: cantidad de predios que actualmente estan liquidados como PLAN PARCIAL, rurales con destino habitacional estrato 1 */',
'',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70393989611248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#37 query_39: cantidad de predios que en IGAC  envia y haran parte de la liquidacion atipica 33-ENTIDADES ORDEN NACIONAL y DEPARTAMENTAL */',
'',
'select ',
...
'where c.nmro_orden_igac = ''001''  ',
'    and c.id_prcso_crga = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :P2_XML , p_nodo => ''P2_ARCHIVO'')',
'    and rfrncia_igac in (select idntfccion_sjto from v_si_i_sujetos_impuesto a join v_si_i_predios b on a.id_sjto = b.id_sjto where SUBSTR(a.idntfccion_sjto,1,2)=''00'' and b.cdgo_prdio_clsfccion=''01'' and b.nmtcnco = ''01'' AND a.cdgo_sjto_estdo=''A'')',
'    and c.cdgo_clnte      = :F_CDGO_CLNTE',
'order by c.rfrncia_igac;',
''))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70394142496248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#39 Q#47_totales--query_47: estadisticas por predios destinos urbanos residencial (A) para estrato 1 con diferencial de avaluo*/',
'select a.dstno_ecnmco_igac "Destino IGAC",',
unistr('       a.dscrpcion         "Descripci\00F3n Destino",'),
'       a.estrto            "Estrato",',
unistr('       a.tpo               "Avalu\00F3 Catastral",'),
...
begin
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70394365309248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#40--query_48: estadisticas por predios destinos urbanos NO homologados por estatuto o por asignacion de la GGI */',
'select a.dstno_ecnmco_igac "Destino IGAC",',
unistr('       a.dscrpcion         "Descripci\00F3n Destino",'),
'    --   a.cntdad             "No. Predios",',
'       trim(to_char( a.cntdad   ,''999G999G999G999G999G999G990''))    "No. Predios",',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70394583462248647)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#41_b --query_22: estadisticas por predios destinos urbanos  falta la columna de Homologacion */',
'',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70394738880248648)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('/*Q#44  Q#23_b   Predios que en la informaci\00F3n enviada por la Gerencia de Catastro posean los destinos homologados en el estatuto tributario*/'),
'select a.dstno_ecnmco_igac "Destino IGAC" ,',
unistr('               a.dscrpcion         "Descripci\00F3n Destino" ,'),
'              trim(to_char(a.cntdad ,''999G999G999G999G999G999G990''))  "No. Predios" ,',
'          --    a.cntdad             "No. Predios" ,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70394966311248648)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
' /*  Q#28  falta la columna de Homologacion   --     nvl((select d.hmlga_esttto from destinos_igac d where d.cdgo_dstno_igac = c.dstno_ecnmco_igac),''Z'') hmlga,*/',
'  select a.dstno_ecnmco_igac "Destino",',
unistr('       a.dscrpcion         "Descripci\00F3n Destino",'),
'    --   a.cntdad             "No. Predios",',
'      trim(to_char(a.cntdad  ,''999G999G999G999G999G999G990''))  "No. Predios",',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70395158175248651)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*  Q#29 falta la columna de Homologacion     /*  decode(a.hmlga,''S'',''SI'',''N'',''NO'',''Z'',''NO'') "Homologado"  --    nvl((select d.hmlga_esttto from destinos_igac d where d.cdgo_dstno_igac = c.dstno_ecnmco_igac),''Z'') hmlga, */',
'select a.dstno_ecnmco_igac "Destino",',
unistr('       a.dscrpcion         "Descripci\00F3n Destino",'),
'    --   a.cntdad             "No. Predios",',
'       trim(to_char(a.cntdad ,''999G999G999G999G999G999G990'')) "No. Predios",',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(70395341303248651)
,p_shared_query_id=>wwv_flow_api.id(70386302010248644)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#42 Q#28_b Predios Urbanos totales y porcentajes-- falta la columna de Homologacion   --     nvl((select d.hmlga_esttto from destinos_igac d where d.cdgo_dstno_igac = c.dstno_ecnmco_igac),''Z'') hmlga,*/',
'  select a.dstno_ecnmco_igac "Destino",',
unistr('       a.dscrpcion         "Descripci\00F3n Destino",'),
'    --   a.cntdad             "No. Predios",',
'      trim(to_char(a.cntdad  ,''999G999G999G999G999G999G990''))  "No. Predios",',
