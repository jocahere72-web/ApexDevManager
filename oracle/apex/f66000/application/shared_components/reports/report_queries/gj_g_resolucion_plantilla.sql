prompt --application/shared_components/reports/report_queries/gj_g_resolucion_plantilla
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(88003406312085890)
,p_name=>'gj_g_resolucion_plantilla'
...
,p_format=>'PDF'
,p_output_file_name=>'gj_g_resolucion_plantilla'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28719368869591549)
,p_shared_query_id=>wwv_flow_api.id(88003406312085890)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28719536513591549)
,p_shared_query_id=>wwv_flow_api.id(88003406312085890)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select  txto_dcmnto  ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28719713312591549)
,p_shared_query_id=>wwv_flow_api.id(88003406312085890)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28719954476591549)
,p_shared_query_id=>wwv_flow_api.id(88003406312085890)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--CUERPO DEL ACTO',
'select dcmnto ',
