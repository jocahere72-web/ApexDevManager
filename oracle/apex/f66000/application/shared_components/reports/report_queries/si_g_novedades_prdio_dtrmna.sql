prompt --application/shared_components/reports/report_queries/si_g_novedades_prdio_dtrmna
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(124646562752726040)
,p_name=>'si_g_novedades_prdio_dtrmna'
...
,p_format=>'PDF'
,p_output_file_name=>'si_g_novedades_prdio_dtrmna'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(124863588479107900)
,p_shared_query_id=>wwv_flow_api.id(124646562752726040)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(124863783358107900)
,p_shared_query_id=>wwv_flow_api.id(124646562752726040)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--1. Detalle',
...
'        a.vgncia, ',
'        a.nmro_dcmto_sprte, ',
'        to_char(a.fcha_dcmnto_sprte , ''dd/mm/yyyy'') fcha_dcmnto_sprte, ',
'        a.obsrvcion, ',
'        a.nmbre_trcro,',
'        decode(indcdor_dtrmndo, ''S'', ''Si'', ''No'') dtrmndo,',
'        to_char(a.fcha_rgstro , ''dd/mm/yyyy hh24:mi:ss'') fcha_rgstro',
'from    v_si_g_novedades_prdio_dtrmna a',
