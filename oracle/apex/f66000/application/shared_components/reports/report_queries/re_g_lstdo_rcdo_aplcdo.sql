prompt --application/shared_components/reports/report_queries/re_g_lstdo_rcdo_aplcdo
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(18288642641153551)
,p_name=>'re_g_lstdo_rcdo_aplcdo'
...
'        , b.idntfccion_sjto'))
,p_format=>'PDF'
,p_output_file_name=>'re_g_lstdo_rcdo_aplcdo'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(116917439731405115)
,p_shared_query_id=>wwv_flow_api.id(18288642641153551)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(116917657068405115)
,p_shared_query_id=>wwv_flow_api.id(18288642641153551)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
