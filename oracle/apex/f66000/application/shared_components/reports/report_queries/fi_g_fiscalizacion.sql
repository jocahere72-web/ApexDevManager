prompt --application/shared_components/reports/report_queries/fi_g_fiscalizacion
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(48974975693113726)
,p_name=>'fi_g_fiscalizacion'
...
,p_format=>'PDF'
,p_output_file_name=>'fi_g_fiscalizacion'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(103715470596477180)
,p_shared_query_id=>wwv_flow_api.id(48974975693113726)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(103715686479477180)
,p_shared_query_id=>wwv_flow_api.id(48974975693113726)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(103715894104477180)
,p_shared_query_id=>wwv_flow_api.id(48974975693113726)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(103716097021477180)
,p_shared_query_id=>wwv_flow_api.id(48974975693113726)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(103716254899477180)
,p_shared_query_id=>wwv_flow_api.id(48974975693113726)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--Sujeto',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(103716419539477180)
,p_shared_query_id=>wwv_flow_api.id(48974975693113726)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select d.nmro_acto as nmro_act',
'     , trunc(d.FCHA) as fcha_acto',
'     , pkg_gn_generalidades.fnc_cl_convertir_blob_a_base64( p_blob => c.firma_file_blob) as frma',
'     , c.nmbre_trcro',
'     , c.nmbre_crgo',
'     , pkg_gn_generalidades.fnc_cl_fecha_texto(d.FCHA) as fcha',
'     , e.NMBRE_TRCRO PRYCTO',
'  from genesys.fi_g_fiscalizacion_expdnte  a',
'join genesys.fi_g_fsclzcion_expdnte_acto b ',
'on b.id_fsclzcion_expdnte = a.id_fsclzcion_expdnte ',
'  left join v_df_c_funcionarios   c on b.id_fncnrio = c.id_fncnrio',
'  join gn_g_actos d on d.id_acto = b.id_acto',
'join v_sg_g_usuarios e on e.id_usrio = d.id_usrio',
'where b.id_fsclzcion_expdnte_acto = pkg_gn_generalidades.fnc_ca_extract_value( p_xml => :p2_xml , p_nodo => ''id_fsclzcion_expdnte_acto'')'))
);
end;
/
