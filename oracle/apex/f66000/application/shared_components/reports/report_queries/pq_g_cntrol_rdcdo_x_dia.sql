prompt --application/shared_components/reports/report_queries/pq_g_cntrol_rdcdo_x_dia
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(6908839729509945)
,p_name=>'pq_g_cntrol_rdcdo_x_dia'
...
,p_format=>'PDF'
,p_output_file_name=>'pq_g_cntrol_rdcdo_x_dia'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(13902421417771635)
,p_shared_query_id=>wwv_flow_api.id(6908839729509945)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(13902603966771635)
,p_shared_query_id=>wwv_flow_api.id(6908839729509945)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'join wf_g_instancias_transicion     e on d.id_instncia_fljo_gnrdo   = e.id_instncia_fljo',
'join v_sg_g_usuarios                f on e.id_usrio                 = f.id_usrio',
'where a.cdgo_clnte                  = :F_CDGO_CLNTE  ',
'  and a.id_usrio                    = :F_ID_USRIO   ',
'  and e.id_usrio                    = nvl((select extractvalue(xmltype(:P2_XML),''//ID_USRIO'') from dual),e.id_usrio)    ',
