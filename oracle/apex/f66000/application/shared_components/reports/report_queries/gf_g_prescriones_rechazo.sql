prompt --application/shared_components/reports/report_queries/gf_g_prescriones_rechazo
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(115466951806221106)
,p_name=>'gf_g_prescriones_rechazo'
...
,p_format=>'PDF'
,p_output_file_name=>'gf_g_prescriones_rechazo'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(115471039182236448)
,p_shared_query_id=>wwv_flow_api.id(115466951806221106)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(115471215628236448)
,p_shared_query_id=>wwv_flow_api.id(115466951806221106)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(115471417596236448)
,p_shared_query_id=>wwv_flow_api.id(115466951806221106)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(115471619199236449)
,p_shared_query_id=>wwv_flow_api.id(115466951806221106)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--Fecha del documento',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(115471828581236449)
,p_shared_query_id=>wwv_flow_api.id(115466951806221106)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
unistr('--Consulta que trae datos de proyecci\00F3n del documento'),
'select      a.id_acto,',
