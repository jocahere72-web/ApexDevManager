prompt --application/shared_components/reports/report_queries/gf_g_finalizacion_acuerdo
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(97506807253903711)
,p_name=>'gf_g_finalizacion_acuerdo'
...
,p_format=>'PDF'
,p_output_file_name=>'gf_g_finalizacion_acuerdo'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(98245907148975355)
,p_shared_query_id=>wwv_flow_api.id(97506807253903711)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(98246160713975355)
,p_shared_query_id=>wwv_flow_api.id(97506807253903711)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'   --obtener html',
'select a.dcmnto, b.nmro_acto,',
'       initcap(to_char(sysdate, ''FMMONTH DD'')||'' de ''||to_char(sysdate, ''YYYY''))fcha_hoy,',
'       initcap(b.obsrvcion) obsrvcion',
'  from  gf_g_convenios_documentos a',
'  join v_gf_g_convenios_finalizacion b on a.id_cnvnio = b.id_cnvnio and a.id_acto = b.id_acto',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(98246367786975355)
,p_shared_query_id=>wwv_flow_api.id(97506807253903711)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
