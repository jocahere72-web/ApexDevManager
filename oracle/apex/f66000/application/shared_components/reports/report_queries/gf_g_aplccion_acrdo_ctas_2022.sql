prompt --application/shared_components/reports/report_queries/gf_g_aplccion_acrdo_ctas_2022
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(28098029073331161)
,p_name=>'gf_g_aplccion_acrdo_ctas_2022'
...
'								  where a.id_cnvnio = :P2_PRMTRO_1 ) as vlor_ttal_cta_incal,',
'          i.indcdor_exge_cta_incial,',
'          to_char(a.ttal_cnvnio ,''FM$999G999G999G999G999G999G990'') ttal_cnvnio',
...
'     join gf_d_convenios_tipo            i on a.id_cnvnio_tpo        = i.id_cnvnio_tpo',
'	where a.cdgo_clnte = :F_CDGO_CLNTE',
'	  and a.id_cnvnio  = :P2_PRMTRO_1'))
,p_format=>'PDF'
,p_output_file_name=>'gf_g_aplccion_acrdo_ctas_2022'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(12124477299409978)
,p_shared_query_id=>wwv_flow_api.id(28098029073331161)
...
'          from genesys.df_s_identificaciones_tipo p',
...
'              (SELECT MAX(x.nmro_cnsctvo)',
'          FROM genesys.gi_g_declaraciones x',
'         WHERE x.id_sjto_impsto = a.id_sjto_impsto) nmro_cnsctvo,',
'       a.OBSRVCION,',
'       to_char(a.ttal_cnvnio,''FM$999G999G999G999G999G999G990'') ttal_cnvnio',
'  FROM genesys.v_gf_g_convenios a',
'  JOIN genesys.df_s_clientes b',
'    ON a.cdgo_clnte = b.cdgo_clnte',
'  JOIN genesys.v_gf_d_convenios_tipo c',
'    ON a.id_cnvnio_tpo = c.id_cnvnio_tpo',
'  LEFT JOIN genesys.df_c_decretos d',
'    ON c.id_dcrto = d.id_dcrto',
'  JOIN genesys.si_i_sujetos_responsable e',
'    ON e.id_sjto_impsto = a.id_sjto_impsto',
'   and e.prncpal_s_n = ''S''',
'  LEFT JOIN genesys.v_re_g_recaudos g',
'    ON a.id_dcmnto_cta_incial = g.id_orgen',
'  LEFT JOIN v_re_g_recaudos_control h',
'    ON g.id_rcdo_cntrol = h.id_rcdo_cntrol',
'  JOIN genesys.gf_d_convenios_tipo i',
'    ON a.id_cnvnio_tpo = i.id_cnvnio_tpo',
'  left join genesys.si_i_personas m',
'    on m.id_sjto_impsto = a.id_sjto_impsto',
'  left join genesys.si_i_predios n',
'    on n.id_sjto_impsto = a.id_sjto_impsto',
'  join genesys.pq_g_radicador o',
'    on o.id_rdcdor = a.id_rdcdor',
' WHERE a.cdgo_clnte = :F_CDGO_CLNTE',
'   AND a.id_cnvnio = :p2_prmtro_1'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(12124644770409978)
,p_shared_query_id=>wwv_flow_api.id(28098029073331161)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(12124832916409978)
,p_shared_query_id=>wwv_flow_api.id(28098029073331161)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(12125054263409978)
,p_shared_query_id=>wwv_flow_api.id(28098029073331161)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--4. Cuota Inicial',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(12125287773409978)
,p_shared_query_id=>wwv_flow_api.id(28098029073331161)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--5. Plan de Pago',
'select nmro_cta,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(12125488498409978)
,p_shared_query_id=>wwv_flow_api.id(28098029073331161)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'',
'--6. Encabezado ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(12125616841409978)
,p_shared_query_id=>wwv_flow_api.id(28098029073331161)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(12125840126409978)
,p_shared_query_id=>wwv_flow_api.id(28098029073331161)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'       initcap(d.nmbre_bnco) nmbre_bnco_mdio_pgo,',
'       --initcap(to_char(c.fcha_rcdo, ''FMMONTH DD "de" YYYY '')) fcha_rcdo',
'       initcap(to_char(c.fcha_rcdo, ''FMMONTH DD "de" YYYY'', ''NLS_DATE_LANGUAGE = SPANISH'')) fcha_rcdo',
'FROM genesys.gf_g_cnvnios_cta_incl_vgnc a',
'JOIN genesys.re_g_documentos b ',
'  ON a.id_dcmnto = b.id_dcmnto',
'LEFT JOIN genesys.v_re_g_recaudos c ',
'  ON a.id_dcmnto = c.id_orgen',
'LEFT JOIN genesys.v_re_g_recaudos_control d ',
...
'SELECT a.id_cnvnio,',
'       NULL AS id_dcmnto,',
'       b.nmro_cnsctvo AS nmro_dcmnto,',
'       to_char(b.vlor_pago,''FM$999G999G999G999G999G999G990'') as vlor_ttal_dcmnto,',
'       initcap(pkg_gn_generalidades.fnc_number_to_text(trunc(nvl(b.vlor_pago,0)), ''d'')) vlor_cta_ini_ltras,',
'       initcap(d.nmbre_bnco) nmbre_bnco_mdio_pgo,',
'      -- initcap(to_char(c.fcha_rcdo, ''FMMONTH DD "de" YYYY '')) fcha_rcdo',
'      initcap(to_char(c.fcha_rcdo, ''FMMONTH DD "de" YYYY'', ''NLS_DATE_LANGUAGE = SPANISH'')) fcha_rcdo',
'FROM genesys.gf_g_convenios a ',
'JOIN genesys.gi_g_declaraciones b',
...
'  ON d.id_rcdo_cntrol = c.id_rcdo_cntrol',
'WHERE a.id_cnvnio = :P2_PRMTRO_1',
'  AND b.vgncia = EXTRACT(YEAR FROM SYSDATE) - 1',
'  AND NOT EXISTS (',
'        SELECT 1',
'        FROM genesys.gf_g_cnvnios_cta_incl_vgnc x',
'        WHERE x.id_cnvnio = :P2_PRMTRO_1',
'  );',
''))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(12126034304409978)
,p_shared_query_id=>wwv_flow_api.id(28098029073331161)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
