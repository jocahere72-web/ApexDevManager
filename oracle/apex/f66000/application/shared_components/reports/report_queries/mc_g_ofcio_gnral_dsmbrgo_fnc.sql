prompt --application/shared_components/reports/report_queries/mc_g_ofcio_gnral_dsmbrgo_fnc
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(154147627523837792)
,p_name=>'mc_g_ofcio_gnral_dsmbrgo_fnc'
...
,p_format=>'PDF'
,p_output_file_name=>'mc_g_ofcio_gnral_dsmbrgo_fnc'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(76211945375836255)
,p_shared_query_id=>wwv_flow_api.id(154147627523837792)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(76212139564836255)
,p_shared_query_id=>wwv_flow_api.id(154147627523837792)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(76212314135836255)
,p_shared_query_id=>wwv_flow_api.id(154147627523837792)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select (select case',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(76212579875836255)
,p_shared_query_id=>wwv_flow_api.id(154147627523837792)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'    on d.id_embrgos_crtra	   = g.id_embrgos_crtra',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(76212740292836255)
,p_shared_query_id=>wwv_flow_api.id(154147627523837792)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(76212940301836256)
,p_shared_query_id=>wwv_flow_api.id(154147627523837792)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select listagg(REPLACE(''<strong>'' || b.nmbre_cmplto || ''</strong>'', ''  .'','''') || '' con identificaci&oacute;n Nro. <strong>'' || trim(b.idntfccion) || ''</strong>'', '', '') ',
...
'join genesys.mc_g_desembargos_cartera d on d.id_embrgos_crtra = c.id_embrgos_crtra ',
'where d.id_dsmbrgos_rslcion = json_value(:P2_XML, ''$.id_dsmbrgos_rslcion.id_dsmbrgos_rslcion'');'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(76213183079836256)
,p_shared_query_id=>wwv_flow_api.id(154147627523837792)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
