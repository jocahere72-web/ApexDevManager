prompt --application/shared_components/reports/report_queries/re_g_lstdo_rcdo_aplcdo_x_cntrol
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(18559119737424084)
,p_name=>'re_g_lstdo_rcdo_aplcdo_x_cntrol'
...
'        , b.idntfccion_sjto'))
,p_format=>'PDF'
,p_output_file_name=>'re_g_lstdo_rcdo_aplcdo_x_cntrol'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(22339482610687687)
,p_shared_query_id=>wwv_flow_api.id(18559119737424084)
...
'     join v_re_g_recaudos b',
'       on a.id_rcdo_cntrol = b.id_rcdo_cntrol',
'    left join si_i_sujetos_responsable c',
'       on b.id_sjto_impsto = c.id_sjto_impsto',
'      and c.prncpal_s_n    = ''S''',
'    where a.cdgo_clnte          = :F_CDGO_CLNTE',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(22339528414687691)
,p_shared_query_id=>wwv_flow_api.id(18559119737424084)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
