prompt --application/shared_components/reports/report_queries/gj_g_citacion
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(88004754565124156)
,p_name=>'gj_g_citacion'
...
,p_format=>'PDF'
,p_output_file_name=>'gj_g_citacion'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28720860319593273)
,p_shared_query_id=>wwv_flow_api.id(88004754565124156)
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28721084884593273)
,p_shared_query_id=>wwv_flow_api.id(88004754565124156)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select  txto_dcmnto  ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28721206731593273)
,p_shared_query_id=>wwv_flow_api.id(88004754565124156)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(28721402439593273)
,p_shared_query_id=>wwv_flow_api.id(88004754565124156)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'--CUERPO DEL ACTO',
'select dcmnto ',
