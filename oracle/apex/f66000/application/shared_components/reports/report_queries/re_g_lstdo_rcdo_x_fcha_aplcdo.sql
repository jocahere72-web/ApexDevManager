prompt --application/shared_components/reports/report_queries/re_g_lstdo_rcdo_x_fcha_aplcdo
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(75966520309336558)
,p_name=>'re_g_lstdo_rcdo_x_fcha_aplcdo'
...
'        , (select trim(c.prmer_nmbre || '' '' || c.sgndo_nmbre || '' '' || c.prmer_aplldo || '' '' || c.sgndo_aplldo ) ',
'            from si_i_sujetos_responsable c',
'            where b.id_sjto_impsto = c.id_sjto_impsto ',
'                and c.prncpal_s_n    = ''S'' ',
'                and rownum=1 ) as rspnsble',
...
' order by a.id_bnco_cnta ',
'        , a.nmbre_bnco',
'        , b.fcha_rcdo',
'        , b.idntfccion_sjto'))
,p_format=>'PDF'
,p_output_file_name=>'re_g_lstdo_rcdo_x_fcha_aplcdo'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(75969035833359911)
,p_shared_query_id=>wwv_flow_api.id(75966520309336558)
...
'        --, trim(c.prmer_nmbre || '' '' || c.sgndo_nmbre || '' '' || c.prmer_aplldo || '' '' || c.sgndo_aplldo ) as rspnsble',
'        , to_char( b.fcha_rcdo , ''DD/MM/YYYY'' ) as fcha_rcdo',
'		, to_char( b.fcha_apliccion , ''DD/MM/YYYY'' ) as fcha_apliccion',
'        , b.vlor',
'        , a.nmbre_impsto',
'        , json_value(:P37_JSON ,''$.fcha_incial'' ) as fcha_incial',
'        , json_value(:P37_JSON ,''$.fcha_fnal'' ) as fcha_fnal',
...
'      and a.id_impsto         = nvl( json_value(:P37_JSON ,''$.id_impsto'' ) , a.id_impsto )',
'      and a.id_impsto_sbmpsto = nvl( json_value(:P37_JSON ,''$.id_impsto_sbmpsto'' ) , a.id_impsto_sbmpsto )',
'      and trunc(b.fcha_apliccion) between json_value(:P37_JSON ,''$.fcha_incial'' )',
'                                 and json_value(:P37_JSON ,''$.fcha_fnal'' )',
'      and b.cdgo_rcdo_estdo = ''AP''',
'      and a.id_bnco = nvl( json_value(:P37_JSON ,''$.id_bnco'' ) , a.id_bnco )',
' order by a.id_bnco_cnta ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(75969223822359911)
,p_shared_query_id=>wwv_flow_api.id(75966520309336558)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
