prompt --application/shared_components/reports/report_queries/gi_c_documento_prlqdcion_18_10_19
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(25753689567915631)
,p_name=>'gi_c_documento_prlqdcion_18/10/19'
...
,p_format=>'PDF'
,p_output_file_name=>'gi_c_documento_prlqdcion_18/10/19'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26269785496868385)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
...
'                                                and c.id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'')',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26269955698868385)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26270128143868385)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26270342284868385)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26270509900868385)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26270723912868385)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'      (select d.nmbre_dstno_igac from df_s_destinos_igac d where d.cdgo_dstno_igac = c.dstno_ecnmco_igac) dscrpcion,',
'       max(''1'') Estrto,',
'       max(''<=135 SMMLV ($''||trim(to_char((135 * (  select  vlor as valor_SMLDV  from df_s_indicadores_economico where cdgo_indcdor_tpo = ''2'' and JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'') between extract(year from fcha_dsde) and extract(year from fcha_hs'
||'ta) )) ,''999G999G999G990''))|| '')'') tpo,',
...
'      c.avluo_igac <= (135 *(  select  vlor as valor_SMLDV  from df_s_indicadores_economico where cdgo_indcdor_tpo = ''2'' and JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'') between extract(year from fcha_dsde) and extract(year from fcha_hsta) ))',
'      and c.id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'')',
...
'      (select d.nmbre_dstno_igac from df_s_destinos_igac d where d.cdgo_dstno_igac = c.dstno_ecnmco_igac) dscrpcion,',
'      max(''1'') Estrto,',
'      max(''> 135 SMMLV ($''||trim(to_char((135 * (  select  vlor as valor_SMLDV  from df_s_indicadores_economico  where cdgo_indcdor_tpo = ''2''     and JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'') between extract(year from fcha_dsde) and extract(year from fch'
||'a_hsta) )) ,''999G999G999G990''))|| '')'') tpo,',
'       count(*) cntdad, sum(c.avluo_igac) ttal_avluos,',
'       max(1) orden       ',
'from v_gi_g_cinta_igac c',
'where c.nmro_orden_igac = ''001'' and substr(c.rfrncia_igac,1,2)<>''00'' and c.dstno_ecnmco_igac in (''A'') and',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26270972448868386)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'      (select d.nmbre_dstno_igac from df_s_destinos_igac d where d.cdgo_dstno_igac = c.dstno_ecnmco_igac) dscrpcion,',
'      max(''1'') Estrto,',
'      max(''<=135 SMMLV ($''||trim(to_char((135 * (  select  vlor as valor_SMLDV  from df_s_indicadores_economico where cdgo_indcdor_tpo = ''2'' and JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'') between extract(year from fcha_dsde) and extract(year from fcha_hst'
||'a) )) ,''999G999G999G990''))|| '')'') tpo,',
'      count(*) cntdad, sum(c.avluo_igac) ttal_avluos,',
'       max(1) orden       ',
'from v_gi_g_cinta_igac c',
'where c.nmro_orden_igac = ''001'' and substr(c.rfrncia_igac,1,2)<>''00'' and c.dstno_ecnmco_igac in (''A'') and',
...
'      and c.avluo_igac > (135 * (  select  vlor as valor_SMLDV  from df_s_indicadores_economico where cdgo_indcdor_tpo = ''2'' and JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'') between extract(year from fcha_dsde) and extract(year from fcha_hsta) )) ',
'      and c.id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'')',
'      and exists (select ''x'' from si_c_sujetos s join si_i_predios p on s.id_sjto =   p.ID_PRDIO  where s.idntfccion = c.rfrncia_igac and p.cdgo_estrto =''1'')',
'      -- p.id_sjto',
'    and c.cdgo_clnte      = :F_CDGO_CLNTE',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26271113627868386)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26271365380868386)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26271506823868386)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#6  incremento en predios sacar vigencia de la pagina */',
'select count(*) value, ',
'       ''Predios ''||(JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')) as color,',
'       ''Incremento en predios entre ''||(JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA''))||'' - '' ||(JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')-1)  as etiqueta',
'       from v_gi_g_cinta_igac where nmro_orden_igac=''001'' ',
'           and vgncia=JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'') ',
'           and id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'')',
'           and cdgo_clnte      = :F_CDGO_CLNTE',
'union all ',
'select count(*) value, ',
'       ''Predios ''||(JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')-1)  as color,',
'       ''Incremento en predios entre ''||(JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA''))||'' - '' ||(JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')-1)  as etiqueta',
'       from v_gi_g_cinta_igac where nmro_orden_igac=''001''',
'           and vgncia=(JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')-1)',
'           and id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'')',
'           and cdgo_clnte      = :F_CDGO_CLNTE;'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26271787589868386)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'                  where p.rfrncia_igac = c.rfrncia_igac and vgncia=(JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')-1) ',
'                       and id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO''))  ',
'and',
'not exists (select ''x'' from v_si_i_sujetos_impuesto pp where pp.idntfccion_sjto = c.rfrncia_igac )',
'and vgncia=JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'') and id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'')  */',
'',
'select ',
...
' and not exists ( select ''x'' ',
'                  from  v_gi_g_cinta_igac p ',
'                  where p.rfrncia_igac = c.rfrncia_igac and p.vgncia=(JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')-1) ',
'              --    and p.id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'') ',
'                   and p.cdgo_clnte      = :F_CDGO_CLNTE',
'                      )  ',
'and',
'not exists (select ''x'' from v_si_i_sujetos_impuesto pp where pp.idntfccion_sjto = c.rfrncia_igac )',
'and c.vgncia = JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'') ',
'and c.id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'') ',
'and c.cdgo_clnte      = :F_CDGO_CLNTE;',
''))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26271931246868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'                                                      and p.vgncia = (JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')-1)',
'                                                    --  and p.id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'')',
'                                                    ) ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26272187229868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'       from v_gi_g_cinta_igac c where nmro_orden_igac=''001'' and c.avluo_igac > 0  and id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'') and c.cdgo_clnte = :F_CDGO_CLNTE',
'union all ',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26272393910868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26272512200868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#11 Total avaluos  */',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26272718798868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#17  */',
'select count(*)  value ,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26272959583868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#18 */',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26273133793868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26273360238868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#20 calcular el porcentaje incremento de predios de una vigencia a otra  :P2_VGNCIA */',
'select trunc((((select count(*) predios_2017 ',
'                from v_gi_g_cinta_igac  where nmro_orden_igac=''001''  and id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'') and cdgo_clnte      = :F_CDGO_CLNTE',
'                and vgncia = JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA''))*100)/',
'               (select count(*) predios_2016 from v_gi_g_cinta_igac  where nmro_orden_igac=''001''  and id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'') and cdgo_clnte      = :F_CDGO_CLNTE',
'               and vgncia = JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')-1))-100,2)||''%'' Incremento',
'',
'from dual;'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26273586851868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
'                  and c.avluo_igac <= (454*( select    vlor as valor_uvt  from df_s_indicadores_economico where cdgo_indcdor_tpo = ''UVT'' and JSON_VALUE(:F_APP_XML, ''$.P2_VGNCIA'')  between extract(year from fcha_dsde) and extract(year from fcha_hsta))'
||')',
'                 and c.id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'')',
'                  and c.cdgo_clnte      = :F_CDGO_CLNTE',
'                group by c.dstno_ecnmco_igac ) a ,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26273756767868387)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26273956383868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/*Q#23 */',
'select a.dstno_ecnmco_igac "Destino IGAC",',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26274142171868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26274381182868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#25*/',
'select  count(*) value,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26274588784868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26274783636868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#26*/ ',
...
'from v_gi_g_cinta_igac c',
'where c.nmro_orden_igac = ''001''  and c.id_prcso_crga = JSON_VALUE(:F_APP_XML, ''$.P2_ARCHIVO'')*/',
'  )a,',
'  (',
'  select 1 tipo,''Urbano'' clse, count(*) cntdad, sum(c.avluo_igac) ttal_avluos       ',
'from v_gi_g_cinta_igac c',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26274986873868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26275118744868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26275385830868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26275534295868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26275778360868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26275984087868388)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26276172276868389)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26276318335868389)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26276520549868389)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
'/* Q#16 */',
'select a.dstno_ecnmco_igac "Destino IGAC" ,',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26276735880868389)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26276940098868389)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26277170444868389)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26277300772868389)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
' /*  Q#4  Predios Nuevos */',
'',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(26277524826868389)
,p_shared_query_id=>wwv_flow_api.id(25753689567915631)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
