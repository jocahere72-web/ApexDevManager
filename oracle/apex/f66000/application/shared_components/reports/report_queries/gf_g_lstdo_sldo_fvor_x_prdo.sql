prompt --application/shared_components/reports/report_queries/gf_g_lstdo_sldo_fvor_x_prdo
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(45554535196158254)
,p_name=>'gf_g_lstdo_sldo_fvor_x_prdo'
,p_query_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
' select b.nmro_dcmnto ',
'       , b.idntfccion_sjto_frmtda',
'       ,to_char( b.fcha_rcdo , ''YYYYMM'' )',
...
'       , c.id_bnco_cnta',
'       , c.nmro_cnta      ',
'       , json_value( :P26_JSON , ''$.nmbre_rprte'') as nmbre_rprte          ',
...
'      and a.id_impsto         = 16--json_value( :P26_JSON , ''$.id_impsto'') ',
'      and a.id_impsto_sbmpsto = 13--json_value( :P26_JSON , ''$.id_impsto_sbmpsto'')',
'      and d.prncpal_s_n       = ''S''      ',
'      and to_char( b.fcha_rcdo , ''YYYYMM'' )  =  json_value( :P26_JSON , ''$.prdo_dsde'')  --and json_value( :P26_JSON , ''$.prdo_hsta'') ',
' order by c.nmro_cnta;'))
,p_report_layout_id=>wwv_flow_api.id(46902423737168812)
,p_format=>'PDF'
,p_output_file_name=>'gf_g_lstdo_sldo_fvor_x_prdo'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(21799886398959467)
,p_shared_query_id=>wwv_flow_api.id(45554535196158254)
...
'       , json_value( :P37_JSON , ''$.prdo_dsde'') as prdo',
'    from gf_g_saldos_favor a ',
'    join v_re_g_recaudos b ',
'      on a.id_orgen           = b.id_rcdo',
'    join v_re_g_recaudos_control c',
...
'      and d.prncpal_s_n       = ''S''      ',
'      and to_char( b.fcha_rcdo , ''YYYYMM'' )  = json_value( :P37_JSON , ''$.prdo_dsde'')  --and json_value( :P26_JSON , ''$.prdo_hsta'') ',
'      and b.cdgo_rcdo_estdo = ''AP''',
' order by c.nmro_cnta;'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(21800076486959468)
,p_shared_query_id=>wwv_flow_api.id(45554535196158254)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
