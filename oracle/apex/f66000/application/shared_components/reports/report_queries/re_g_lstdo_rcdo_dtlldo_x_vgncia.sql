prompt --application/shared_components/reports/report_queries/re_g_lstdo_rcdo_dtlldo_x_vgncia
begin
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(21931803815929762)
,p_name=>'re_g_lstdo_rcdo_dtlldo_x_vgncia'
...
'                        , sum( case when  b.vgncia = extract( year from sysdate ) then',
...
'                , a.cdgo_cncpto'))
,p_format=>'PDF'
,p_output_file_name=>'re_g_lstdo_rcdo_dtlldo_x_vgncia'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(100834527518190838)
,p_shared_query_id=>wwv_flow_api.id(21931803815929762)
...
'                        , sum(( b.vlor_cptal + b.vlor_intres )) as vlor_ttal',
'                        , sum(b.vlor_sldo_fvor) as vlor_sldo_fvor',
'                        , sum( case when  decode(a.id_impsto,a.cdgo_clnte||2, b.vgncia + 1,b.vgncia) >= extract(YEAR FROM b.fcha_rcdo) then',
'                                                       ( b.vlor_cptal + b.vlor_intres )',
'                                       else',
'                                           0',
'                                      end ) as vlor_ttal_actual',
...
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(100834761893190838)
,p_shared_query_id=>wwv_flow_api.id(21931803815929762)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
