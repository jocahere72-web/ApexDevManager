...
,p_last_upd_yyyymmddhh24miss=>'20191018153122'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(73955806426464426)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(35903247762418514)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(73955806426464426)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6015938328689140)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6016005824689141)
,p_event_id=>wwv_flow_api.id(6015938328689140)
,p_event_result=>'TRUE'
