...
,p_step_title=>unistr('Gesti\00F3n de Reportes - Conectar')
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(35702542648290393)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'JCUAO'
,p_last_upd_yyyymmddhh24miss=>'20181019171533'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(35820893073290485)
,p_plug_name=>unistr('Gesti\00F3n de Reportes')
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(35741953385290410)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(35825576322290492)
,p_plug_name=>'Selector de Idioma'
,p_parent_plug_id=>wwv_flow_api.id(35820893073290485)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(35720985559290402)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(35823669791290491)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(35820893073290485)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(35821228793290485)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(35820893073290485)
,p_prompt=>'usuario'
...
,p_field_template=>wwv_flow_api.id(35793786432290432)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(35821636343290485)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(35822714596290490)
...
,p_lov=>'.'||wwv_flow_api.id(35821979602290485)||'.'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(35793786432290432)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(35824455611290491)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(35824073401290491)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(35825221845290492)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(35824837539290491)
,p_process_sequence=>10
