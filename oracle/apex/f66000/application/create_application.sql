...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'GestiÃ³n de Reportes')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_66000')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'C6D5338CFDD105AC6A35E6ABBE7782108D7003FE4DB5EAD5ADB84E0EB71E30F1'
...
,p_documentation_banner=>unistr('Aplicaci\00F3n creada desde el asistente de creaci\00F3n de aplicaciones 2018.10.19.')
,p_authentication=>'PLUGIN'
,p_authentication_id=>wwv_flow_api.id(35890083377296882)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20260415102356'
