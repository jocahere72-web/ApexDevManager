...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Sistema de NotificaciÃ³n')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_74000')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'512E28FFFCB16FCD94C535916AB5559AA90EAEFC34986FB97C463A0AE464C0EE'
...
,p_documentation_banner=>unistr('Aplicaci\00F3n creada desde el asistente de creaci\00F3n de aplicaciones 2018.09.21.')
,p_authentication=>'PLUGIN'
,p_authentication_id=>wwv_flow_api.id(30427528097583284)
,p_populate_roles=>'A'
