...
,p_step_title=>unistr('SISTEMA DE NOTIFICACI\00D3N - Conectar')
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(30301577495578271)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'JCUAO'
,p_last_upd_yyyymmddhh24miss=>'20180921093012'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30418245452578349)
,p_plug_name=>unistr('SISTEMA DE NOTIFICACI\00D3N')
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(30339409783578288)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30422960775578360)
,p_plug_name=>'Selector de Idioma'
,p_parent_plug_id=>wwv_flow_api.id(30418245452578349)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(30421021396578358)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(30418245452578349)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30418646298578351)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30418245452578349)
,p_prompt=>'usuario'
...
,p_field_template=>wwv_flow_api.id(30391237912578312)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30419012599578352)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30420141094578354)
...
,p_lov=>'.'||wwv_flow_api.id(30419372435578352)||'.'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(30391237912578312)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30421875749578359)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30421422421578358)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30422657806578359)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30422240830578359)
,p_process_sequence=>10
