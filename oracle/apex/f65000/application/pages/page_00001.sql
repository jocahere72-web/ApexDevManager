...
,p_name=>'Panel de Notificaciones'
,p_alias=>'NOTIFICACIONES'
,p_step_title=>unistr('SISTEMA DE NOTIFICACI\00D3N')
,p_autocomplete_on_off=>'OFF'
,p_javascript_file_urls=>'#IMAGE_PREFIX#javascript/infortributos/js/utilidades.js'
,p_javascript_code_onload=>wwv_flow_string.join(wwv_flow_t_varchar2(
'$("#P1_FCHA_FNAL").datepicker( ''option'' , ''minDate'' , $("#P1_FCHA_INCIAL").val());',
...
'    color: #fff;',
'}'))
,p_step_template=>wwv_flow_api.id(30294100180578264)
,p_page_template_options=>'#DEFAULT#'
,p_last_updated_by=>'JLUJAN'
,p_last_upd_yyyymmddhh24miss=>'20250312170943'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(99049228844367001)
...
'           nvl(b.actos_notificados,0) as "Actos Notificados", ',
'           nvl(b.cantidad_notificaciones,0) - nvl(b.actos_notificados,0) as "Actos No Notificados", ',
'           nvl(b.cantidad_notificaciones,0) as "Total de Notificaciones"',
'    from df_s_clientes a',
'    left join(',
'         select sum(case when a.indcdor_ntfcdo = ''S'' then 1 else 0 end) actos_notificados,count(a.id_acto) cantidad_notificaciones, a.cdgo_clnte',
'        from v_nt_g_notfccnes_gn_g_actos a',
'        where a.fcha_incio_ntfccion is not null and',
'             ((:P1_FCHA_INCIAL is not null and :P1_FCHA_FNAL is not null and trunc(a.fcha) between :P1_FCHA_INCIAL and :P1_FCHA_FNAL) or',
...
'              (:P1_FCHA_INCIAL is null and :P1_FCHA_FNAL is null)) and',
'             a.id_ntfccion is not null',
'        group by a.cdgo_clnte',
'    ) b on a.cdgo_clnte = b.cdgo_clnte',
'    where a.actvo = ''S'' and',
'          a.cdgo_clnte = :F_CDGO_CLNTE',
')unpivot(',
'    value',
'    for label in ("Actos Notificados", "Actos No Notificados", "Total de Notificaciones")',
');'))
,p_plug_source_type=>'PLUGIN_COM.ORACLE.APEX.BADGE_LIST'
,p_ajax_items_to_submit=>'P1_FCHA_INCIAL,P1_FCHA_FNAL'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'f?p=&APP_ID.:28:&SESSION.::&DEBUG.:RP,28:P28_NTFCCION,P28_FCHA_INCIAL,P28_FCHA_FNAL:&LABEL.,&P1_FCHA_INCIAL.,&P1_FCHA_FNAL.'
,p_attribute_05=>'F'
,p_attribute_06=>'L'
,p_attribute_07=>'BOX'
,p_attribute_08=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(99116917123831101)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(99117064523831102)
,p_region_id=>wwv_flow_api.id(99116917123831101)
,p_chart_type=>'donut'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(99117166806831103)
,p_chart_id=>wwv_flow_api.id(99117064523831102)
,p_seq=>10
,p_name=>'New'
...
'from(',
'    select a.nmbre_clnte, ',
'           nvl(b.actos_notificados,0)/nvl(b.cantidad_notificaciones,1)*100 as "Actos Notificados", ',
'          (nvl(b.cantidad_notificaciones,0) - nvl(b.actos_notificados,0))/nvl(b.cantidad_notificaciones,1)*100 as "Actos No Notificados"',
'    from df_s_clientes a',
'    left join(',
'        select sum(case when a.indcdor_ntfcdo = ''S'' then 1 else 0 end) actos_notificados,count(a.id_acto) cantidad_notificaciones, a.cdgo_clnte',
'        from v_nt_g_notfccnes_gn_g_actos a',
...
')unpivot(',
'    value',
'    for label in ("Actos Notificados", "Actos No Notificados")',
')'))
...
,p_items_label_css_classes=>'font-size:18px;color:white;'
,p_threshold_display=>'onIndicator'
,p_link_target=>'f?p=&APP_ID.:28:&SESSION.::&DEBUG.:RP,28:P28_NTFCCION,P28_FCHA_INCIAL,P28_FCHA_FNAL:&LABEL.,&P1_FCHA_INCIAL.,&P1_FCHA_FNAL.'
,p_link_target_type=>'REDIRECT_APP'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(99117688767831108)
,p_plug_name=>'Notificaciones por mes'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_escape_on_http_output=>'Y'
,p_plug_template=>wwv_flow_api.id(30339999956578288)
...
wwv_flow_api.create_jet_chart(
 p_id=>wwv_flow_api.id(99117731740831109)
,p_region_id=>wwv_flow_api.id(99117688767831108)
,p_chart_type=>'bar'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(99117812030831110)
,p_chart_id=>wwv_flow_api.id(99117731740831109)
,p_seq=>10
,p_name=>'Actos Notificados'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select to_char( a.first, ''Month'') mes,a.first, a.last, sum(nvl(b.actos_notificados,0)) actos_notificados, sum(nvl(b.cantidad_notificaciones,0))cantidad_notificaciones',
'from(select to_date(''01/''||to_char(add_months(sysdate , -level+1),''MM/yyyy''),''dd/MM/yyyy'') first, LAST_DAY(add_months(sysdate , -level+1)) last',
'     from dual',
'     connect by level <= months_between(sysdate,add_months(sysdate , -6))) a',
'left join ( ',
'    select sum(case when a.indcdor_ntfcdo = ''S'' then 1 else 0 end) actos_notificados,count(a.id_acto) cantidad_notificaciones, trunc(a.fcha)fcha',
'    from v_nt_g_notfccnes_gn_g_actos a',
'    where a.cdgo_clnte = :F_CDGO_CLNTE and',
'          a.fcha_incio_ntfccion is not null and',
'          a.id_ntfccion is not null',
'    group by trunc(a.fcha) ',
') b on b.fcha between a.first and a.last',
'group by a.first, a.last',
'order by a.first, mes desc'))
,p_items_value_column_name=>'ACTOS_NOTIFICADOS'
...
wwv_flow_api.create_jet_chart_series(
 p_id=>wwv_flow_api.id(99118130640831113)
,p_chart_id=>wwv_flow_api.id(99117731740831109)
,p_seq=>20
,p_name=>'Actos por Notificar'
,p_data_source_type=>'SQL'
,p_data_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select to_char( a.first, ''Month'') mes,a.first, a.last, sum(nvl(b.actos_notificados,0)) actos_notificados, sum(nvl(b.cantidad_notificaciones,0)) - sum(nvl(b.actos_notificados,0)) cantidad_notificaciones',
'from(select to_date(''01/''||to_char(add_months(sysdate , -level+1),''MM/yyyy''),''dd/MM/yyyy'') first, LAST_DAY(add_months(sysdate , -level+1)) last',
'     from dual',
'     connect by level <= months_between(sysdate,add_months(sysdate , -6))) a',
'left join ( ',
...
'group by a.first, a.last',
'order by a.first, mes desc'))
,p_items_value_column_name=>'CANTIDAD_NOTIFICACIONES'
,p_items_label_column_name=>'MES'
,p_assigned_to_y2=>'off'
,p_items_label_rendered=>false
,p_items_label_display_as=>'PERCENT'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(99118046830831112)
,p_chart_id=>wwv_flow_api.id(99117731740831109)
,p_axis=>'y'
,p_is_rendered=>'on'
...
wwv_flow_api.create_jet_chart_axis(
 p_id=>wwv_flow_api.id(99117903910831111)
,p_chart_id=>wwv_flow_api.id(99117731740831109)
,p_axis=>'x'
,p_is_rendered=>'on'
,p_format_scaling=>'auto'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(99478612882049302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(99478775224049303)
,p_name=>'P1_FCHA_INCIAL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(99478612882049302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(99478888594049304)
,p_name=>'P1_FCHA_FNAL'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(99478612882049302)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49418656444137103)
,p_name=>'Al cambiar fecha inicio'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_FCHA_INCIAL'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49418764632137104)
,p_event_id=>wwv_flow_api.id(49418656444137103)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49418864534137105)
,p_name=>'Al cambiar fecha inicio refrescar'
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_FCHA_INCIAL'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49418912438137106)
,p_event_id=>wwv_flow_api.id(49418864534137105)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(99049228844367001)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49420210866137119)
,p_event_id=>wwv_flow_api.id(49418864534137105)
,p_event_result=>'TRUE'
...
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(99116917123831101)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49419064604137107)
,p_name=>'Al cambiar fecha final refresar'
,p_event_sequence=>30
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P1_FCHA_FNAL'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49419174217137108)
,p_event_id=>wwv_flow_api.id(49419064604137107)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49420335532137120)
,p_event_id=>wwv_flow_api.id(49419064604137107)
,p_event_result=>'TRUE'
,p_action_sequence=>20
,p_execute_on_page_init=>'N'
