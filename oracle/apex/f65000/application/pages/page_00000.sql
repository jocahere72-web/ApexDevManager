...
,p_last_upd_yyyymmddhh24miss=>'20191023152105'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(30457969547944202)
...
,p_plug_template=>wwv_flow_api.id(30464304382005720)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30458175865944204)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(30457969547944202)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6013400659689115)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6013573521689116)
,p_event_id=>wwv_flow_api.id(6013400659689115)
,p_event_result=>'TRUE'
