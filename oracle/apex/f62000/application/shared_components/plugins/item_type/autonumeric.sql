...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(95717243302788791)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95717517549788792)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95717935371788793)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95718301687788793)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95718701168788793)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95719150502788793)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95719579383788794)
,p_plugin_attribute_id=>wwv_flow_api.id(95719150502788793)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95720069261788795)
,p_plugin_attribute_id=>wwv_flow_api.id(95719150502788793)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95720528930788796)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95720918517788796)
,p_plugin_attribute_id=>wwv_flow_api.id(95720528930788796)
,p_display_sequence=>10
,p_display_value=>'comma'
,p_return_value=>','
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95721467880788797)
,p_plugin_attribute_id=>wwv_flow_api.id(95720528930788796)
,p_display_sequence=>20
,p_display_value=>'dot'
,p_return_value=>'.'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95721939603788798)
,p_plugin_attribute_id=>wwv_flow_api.id(95720528930788796)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95722480495788798)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95722821975788799)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95723212802788799)
,p_plugin_attribute_id=>wwv_flow_api.id(95722821975788799)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95723734974788799)
,p_plugin_attribute_id=>wwv_flow_api.id(95722821975788799)
,p_display_sequence=>20
,p_display_value=>'one'
,p_return_value=>'1'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95724263344788799)
,p_plugin_attribute_id=>wwv_flow_api.id(95722821975788799)
,p_display_sequence=>30
,p_display_value=>'two'
,p_return_value=>'2'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95724772631788800)
,p_plugin_attribute_id=>wwv_flow_api.id(95722821975788799)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95725249959788800)
,p_plugin_attribute_id=>wwv_flow_api.id(95722821975788799)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95725793355788800)
,p_plugin_attribute_id=>wwv_flow_api.id(95722821975788799)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95726233510788800)
,p_plugin_attribute_id=>wwv_flow_api.id(95722821975788799)
,p_display_sequence=>70
,p_display_value=>'six'
,p_return_value=>'6'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95726748836788801)
,p_plugin_attribute_id=>wwv_flow_api.id(95722821975788799)
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95727206002788801)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95727674479788801)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95728041477788801)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95728483000788802)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95728838345788802)
,p_plugin_id=>wwv_flow_api.id(95717243302788791)
,p_attribute_scope=>'COMPONENT'
