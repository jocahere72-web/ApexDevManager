...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Workflow')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_62000')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'0AC6D3B919112A0E581F1BD88C684249ABCE716ACC70365DDBA6EE671EACF730'
,p_bookmark_checksum_function=>'SH512'
,p_compatibility_mode=>'5.1'
,p_flow_language=>'es-co'
,p_flow_language_derived_from=>'FLOW_PRIMARY_LANGUAGE'
,p_date_format=>'DD/MM/YYYY'
,p_date_time_format=>'DD-DD/MM/YYYY HH:MI PM'
,p_timestamp_format=>'DD/MM/YYYY HH:MI:SS PM'
,p_timestamp_tz_format=>'DD/MM/YYYY HH.MI.SSXFF PM TZR'
,p_direction_right_to_left=>'N'
,p_flow_image_prefix => nvl(wwv_flow_application_install.get_image_prefix,'')
,p_authentication=>'PLUGIN'
,p_authentication_id=>wwv_flow_api.id(323683663481283894)
,p_populate_roles=>'A'
...
,p_last_upd_yyyymmddhh24miss=>'20251114105655'
