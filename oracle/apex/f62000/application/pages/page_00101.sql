...
'',
'}'))
,p_step_template=>wwv_flow_api.id(39258529077898278)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(529055996812022485)
,p_plug_name=>unistr('Autenticaci\00F3n')
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(39298716164898312)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(323687962295291638)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(529055996812022485)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(39351721865898343)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323688396173291641)
,p_name=>'P101_CDGO_CLNTE'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(529055996812022485)
,p_prompt=>'Cliente'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323688839635291644)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(323689181426291645)
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(323689664743291657)
...
,p_always_execute=>'Y'
,p_associated_item=>wwv_flow_api.id(323688839635291644)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(323690129438291661)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(323690770262291661)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(323690456805291661)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(323691577308291662)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(323691226466291662)
,p_process_sequence=>10
