...
,p_last_upd_yyyymmddhh24miss=>'20191017170448'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(228067305921301106)
...
,p_plug_template=>wwv_flow_api.id(39277989388898302)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39426594378090573)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(228067305921301106)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6015486337689135)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6015568124689136)
,p_event_id=>wwv_flow_api.id(6015486337689135)
,p_event_result=>'TRUE'
