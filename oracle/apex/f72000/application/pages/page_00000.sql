...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(151110778838477225)
...
,p_plug_template=>wwv_flow_api.id(72934618827094507)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74480776552922430)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(151110778838477225)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6014699925689127)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6014780768689128)
,p_event_id=>wwv_flow_api.id(6014699925689127)
,p_event_result=>'TRUE'
