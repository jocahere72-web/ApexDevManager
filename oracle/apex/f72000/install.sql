...
@application/shared_components/navigation/lists/estados.sql
...
@application/shared_components/user_interface/lovs/dia_tipo.sql
@application/shared_components/user_interface/lovs/flujo_tarea.sql
@application/shared_components/user_interface/lovs/login_remember_username.sql
@application/shared_components/user_interface/lovs/lv_acciones.sql
@application/shared_components/user_interface/lovs/lv_flujos.sql
...
@application/shared_components/user_interface/lovs/lv_recursos_respuesta.sql
@application/shared_components/user_interface/lovs/lv_recursos_respuesta_fin.sql
@application/shared_components/user_interface/lovs/lv_rspsta.sql
@application/shared_components/user_interface/lovs/lv_tareas.sql
@application/shared_components/user_interface/lovs/lv_tareas_item.sql
@application/shared_components/user_interface/lovs/recurso_estado.sql
@application/shared_components/user_interface/lovs/tipo_acto.sql
@application/shared_components/user_interface/lovs/tipo_recurso.sql
@application/shared_components/user_interface/lovs/tipo_recurso_cliente.sql
@application/shared_components/user_interface/lovs/undad_drcion.sql
