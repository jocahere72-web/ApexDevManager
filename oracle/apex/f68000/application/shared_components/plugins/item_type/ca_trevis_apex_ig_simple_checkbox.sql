...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(79735839041788809)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80949313080001161)
,p_plugin_id=>wwv_flow_api.id(79735839041788809)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80949771421001161)
,p_plugin_id=>wwv_flow_api.id(79735839041788809)
,p_attribute_scope=>'COMPONENT'
