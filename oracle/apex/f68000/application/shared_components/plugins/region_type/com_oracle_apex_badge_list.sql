...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(23883672315715750)
...
,p_reference_id=>179021062266574069
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(23883973084715771)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(23884312423715774)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(23884731661715774)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(23892376294715786)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(23885111482715776)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(23885559644715780)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23885926949715780)
,p_plugin_attribute_id=>wwv_flow_api.id(23885559644715780)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23886450931715783)
,p_plugin_attribute_id=>wwv_flow_api.id(23885559644715780)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23886986272715784)
,p_plugin_attribute_id=>wwv_flow_api.id(23885559644715780)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23887484049715784)
,p_plugin_attribute_id=>wwv_flow_api.id(23885559644715780)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23887933204715784)
,p_plugin_attribute_id=>wwv_flow_api.id(23885559644715780)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23888458094715785)
,p_plugin_attribute_id=>wwv_flow_api.id(23885559644715780)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23888903178715785)
,p_plugin_attribute_id=>wwv_flow_api.id(23885559644715780)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(23889434282715785)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23889820523715785)
,p_plugin_attribute_id=>wwv_flow_api.id(23889434282715785)
,p_display_sequence=>0
,p_display_value=>'Small'
,p_return_value=>'S'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23890339412715786)
,p_plugin_attribute_id=>wwv_flow_api.id(23889434282715785)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23890839748715786)
,p_plugin_attribute_id=>wwv_flow_api.id(23889434282715785)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23891309536715786)
,p_plugin_attribute_id=>wwv_flow_api.id(23889434282715785)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23891825163715786)
,p_plugin_attribute_id=>wwv_flow_api.id(23889434282715785)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(23892376294715786)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23892734319715787)
,p_plugin_attribute_id=>wwv_flow_api.id(23892376294715786)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'BOX'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23893273938715787)
,p_plugin_attribute_id=>wwv_flow_api.id(23892376294715786)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23893773736715787)
,p_plugin_attribute_id=>wwv_flow_api.id(23892376294715786)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(23894220012715787)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23894657494715787)
,p_plugin_attribute_id=>wwv_flow_api.id(23894220012715787)
,p_display_sequence=>10
,p_display_value=>'Yes'
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(23895150427715788)
,p_plugin_attribute_id=>wwv_flow_api.id(23894220012715787)
,p_display_sequence=>20
,p_display_value=>'No'
,p_return_value=>'N'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(23895653669715788)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(23896923998715792)
,p_plugin_id=>wwv_flow_api.id(23883672315715750)
,p_name=>'SOURCE_SQL'
