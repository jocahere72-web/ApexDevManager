...
,p_last_upd_yyyymmddhh24miss=>'20191018101413'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(156912878005637563)
...
,p_plug_template=>wwv_flow_api.id(71824953016951567)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71949653589177217)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(156912878005637563)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6016112645689142)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6016241264689143)
,p_event_id=>wwv_flow_api.id(6016112645689142)
,p_event_result=>'TRUE'
