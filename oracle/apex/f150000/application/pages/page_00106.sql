...
,p_name=>'Plan de Pago - Solicitud de Acuerdo de Pago'
,p_step_title=>'Plan de Pago - Solicitud de Acuerdo de Pago'
...
,p_last_upd_yyyymmddhh24miss=>'20200521171800'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(190454981200268803)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(190455063916268803)
,p_plug_name=>'Datos del Convenio'
,p_parent_plug_id=>wwv_flow_api.id(190454981200268803)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(194790658699678453)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(194790837729678454)
...
,p_owner=>'SROMERO'
,p_internal_uid=>194790837729678454
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72553107528314202)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72553561411314213)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72553916346314217)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72554322398314218)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72554738721314218)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72555124965314218)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(194797962927683079)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'725555'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(191673878260583296)
,p_plug_name=>'Ayuda'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(72547579534314186)
,p_button_sequence=>60
,p_button_plug_id=>wwv_flow_api.id(190455063916268803)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(72545787695314174)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(190454981200268803)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(72546151728314184)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(72546483180314184)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(72560315508314274)
,p_branch_name=>unistr('Ir a P\00E1gina 107 - Garantia')
,p_branch_action=>'f?p=&APP_ID.:107:&SESSION.::&DEBUG.::P107_BRANCH:106&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(72546151728314184)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(72561105045314274)
,p_branch_name=>unistr('Ir a P\00E1gina 109 - Resumen Solicitud')
,p_branch_action=>'f?p=&APP_ID.:109:&SESSION.::&DEBUG.:108::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(72546151728314184)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(72560706129314274)
,p_branch_name=>unistr('Ir a P\00E1gina 105 - Cartera')
,p_branch_action=>'f?p=&APP_ID.:105:&SESSION.::&DEBUG.:RP::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(72546483180314184)
,p_branch_sequence=>40
);
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(70820728380843728)
...
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_api.id(72545787695314174)
,p_branch_sequence=>10
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(70819844800843719)
,p_name=>'P106_CDGO_RSPSTA'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(190455063916268803)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72546843358314184)
,p_name=>'P106_BRANCH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(190454981200268803)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72547913293314186)
,p_name=>'P106_FCHA_MXMA_CTAS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(190455063916268803)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72548899361314190)
,p_name=>'P106_FCHA_PRMRA_CTA'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(190455063916268803)
...
'begin ',
'',
'    if :P105_ID_CNVNIO is not null then ',
'        select a.fcha_prmra_cta',
'          into v_fcha_prmra_cta',
'          from v_gf_g_convenios   a',
'         where a.id_cnvnio = :P105_ID_CNVNIO;',
'',
'    elsif :P105_ID_PRYCCION is not null then ',
'        select a.fcha_prmra_cta',
'          into v_fcha_prmra_cta',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72549781943314192)
,p_name=>'P106_NMRO_MXMO_CTAS'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(190455063916268803)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72550677340314192)
,p_name=>'P106_NMRO_CTAS'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(190455063916268803)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72551598763314193)
,p_name=>'P106_CDGO_PRDCDAD_CTA'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(190455063916268803)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72552450246314198)
,p_name=>'P106_RSPSTA'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(190455063916268803)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_validation(
 p_id=>wwv_flow_api.id(72556035020314231)
...
'     end;',
'    ',
'    if v_nmro_pryccion  > 0 and :P106_CDGO_RSPSTA = 0 then ',
'        return true;',
'    else ',
'        return false;',
'    end if;',
...
,p_when_button_pressed=>wwv_flow_api.id(72546151728314184)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(72557563752314239)
,p_name=>unistr('Validar N\00FAmero de Cuotas')
,p_event_sequence=>20
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(72547579534314186)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(72558089806314256)
,p_event_id=>wwv_flow_api.id(72557563752314239)
,p_event_result=>'TRUE'
...
'if(parseInt($v(''P106_NMRO_CTAS'')) > parseInt($v(''P106_NMRO_MXMO_CTAS''))){',
'     errors.push({',
'            type:       "error",',
'            location:   [ "page", "inline" ],',
'            pageItem:   "P106_NMRO_CTAS",',
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(72558461216314256)
,p_name=>unistr('Actualizar Proyecci\00F3n')
,p_event_sequence=>20
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P106_FCHA_PRMRA_CTA,P106_CDGO_PRDCDAD_CTA,P106_NMRO_CTAS'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(72558905072314257)
,p_event_id=>wwv_flow_api.id(72558461216314256)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
'    v_fcha_prmra_cta    gf_g_convenios.fcha_prmra_cta%type      := :P106_FCHA_PRMRA_CTA;',
'    v_cdgo_prdcdad_cta  gf_g_convenios.cdgo_prdcdad_cta%type    := :P106_CDGO_PRDCDAD_CTA;',
'    v_nmro_ctas_cnvnio  gf_g_convenios.nmro_cta%type            := :P106_NMRO_CTAS;',
'',
'begin',
'    ',
...
'                                                   p_cdna_vgncia_prdo    => :P105_VGNCIA_PRDO ,',
'                                                   p_cdgo_rspsta         => v_cdgo_rspsta ,',
'                                                   p_mnsje_rspsta        => v_mnsje_rspsta);',
'       if (v_cdgo_rspsta  <> 0) then',
'           :P106_RSPSTA := null;',
'       else',
'           :P106_RSPSTA    :=     v_mnsje_rspsta;',
'       end if;',
'            ',
'    end;',
'end;                              ',
'						  ',
'  '))
,p_attribute_02=>'P106_FCHA_PRMRA_CTA,P106_NMRO_CTAS,P106_CDGO_PRDCDAD_CTA,P106_RSPSTA'
,p_attribute_03=>'P106_RSPSTA'
,p_attribute_04=>'N'
,p_stop_execution_on_error=>'Y'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(70821048964843731)
,p_event_id=>wwv_flow_api.id(72558461216314256)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(72559395842314257)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(72559808832314273)
,p_event_id=>wwv_flow_api.id(72559395842314257)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(194790658699678453)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(72557177122314239)
...
' :P105_ID_CNVNIO is not null and ',
' :P106_FCHA_PRMRA_CTA  is null and ',
' :P106_NMRO_CTAS is null and ',
' :P106_CDGO_PRDCDAD_CTA is null'))
,p_process_when_type=>'SQL_EXPRESSION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(72556705659314234)
...
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when=>wwv_flow_string.join(wwv_flow_t_varchar2(
' :P105_ID_PRYCCION is not null and ',
' :P106_FCHA_PRMRA_CTA  is null and ',
' :P106_NMRO_CTAS is null and ',
' :P106_CDGO_PRDCDAD_CTA is null and',
' :P105_ID_CNVNIO is null ',
''))
,p_process_when_type=>'SQL_EXPRESSION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(72556383917314231)
...
'           :P106_CDGO_RSPSTA    := v_cdgo_rspsta;',
'           apex_error.add_error(p_message          => v_mnsje_rspsta,',
'                                p_display_location => apex_error.c_inline_in_notification );',
'       else',
'           :P106_CDGO_RSPSTA    := nvl(v_cdgo_rspsta,0);',
'           :P106_RSPSTA    :=     v_mnsje_rspsta;',
'       end if;',
'            ',
'    end;',
...
' '))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(72547579534314186)
);
end;
/
