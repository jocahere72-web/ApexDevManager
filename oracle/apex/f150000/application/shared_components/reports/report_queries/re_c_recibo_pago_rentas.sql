...
wwv_flow_api.create_shared_query(
 p_id=>wwv_flow_api.id(5074194165595303)
...
,p_report_layout_id=>wwv_flow_api.id(5294432660376336)
,p_format=>'PDF'
,p_output_file_name=>'re_c_recibo_pago_rentas'
,p_content_disposition=>'ATTACHMENT'
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(5555939052604540)
,p_shared_query_id=>wwv_flow_api.id(5074194165595303)
...
'       ,    m.fcha_expdcion',
'       ,    n.dscrpcion',
'       ,    nvl(:F_NMBRE_USRIO, ''PORTAL'')nmbre_usrio',
'       ,    a.nmbre_mncpio',
'       ,    g.cdgo_ean',
'       ,    pkgbarcode.funcadfac(null,null, null, b.nmro_dcmnto, b.vlor_ttal_dcmnto, b.fcha_vncmnto, g.cdgo_ean, ''S'') txto_cdgo_brra',
'       ,    pkgbarcode.fungencod(''EANUCC128'',pkgbarcode.funcadfac(null,null, null, b.nmro_dcmnto, b.vlor_ttal_dcmnto, b.fcha_vncmnto, g.cdgo_ean, ''N'' ) )cdgo_brra',
...
'     join  si_i_personas  o on o.id_sjto_impsto = d.id_sjto_impsto',
'    where a.cdgo_clnte = :F_CDGO_CLNTE',
'      and b.id_dcmnto    = nvl(:P204_ID_DCMNTO, :P205_ID_DCMNTO)',
' order by  b.nmro_dcmnto;'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(5556154564604540)
,p_shared_query_id=>wwv_flow_api.id(5074194165595303)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
' where  a.id_dcmnto = nvl(:P204_ID_DCMNTO, :P205_ID_DCMNTO)',
'group by a.id_cncpto, b.dscrpcion_cncpto, b.txto_trfa, b.cdgo_cncpto, a.vlor_dbe;'))
);
wwv_flow_api.create_shared_query_stmnt(
 p_id=>wwv_flow_api.id(5556392546604540)
,p_shared_query_id=>wwv_flow_api.id(5074194165595303)
,p_sql_statement=>wwv_flow_string.join(wwv_flow_t_varchar2(
