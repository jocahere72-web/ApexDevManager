...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(145631688395974411)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(145631892855974428)
,p_plugin_id=>wwv_flow_api.id(145631688395974411)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(145632240081974430)
,p_plugin_id=>wwv_flow_api.id(145631688395974411)
,p_attribute_scope=>'COMPONENT'
