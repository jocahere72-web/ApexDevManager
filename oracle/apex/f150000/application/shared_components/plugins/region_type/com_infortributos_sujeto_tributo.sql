...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(69364487343128042)
...
,p_reference_id=>118927300343883739
,p_subscribe_plugin_settings=>true
,p_version_identifier=>'1.0'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(69364770208128052)
,p_plugin_id=>wwv_flow_api.id(69364487343128042)
