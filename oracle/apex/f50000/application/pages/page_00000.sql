...
,p_last_upd_yyyymmddhh24miss=>'20191018152806'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(2151882588634101)
...
,p_plug_template=>wwv_flow_api.id(29531267060068500)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(2151990885634102)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(2151882588634101)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6013813206689119)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6013961521689120)
,p_event_id=>wwv_flow_api.id(6013813206689119)
,p_event_result=>'TRUE'
