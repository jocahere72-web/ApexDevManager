...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(88424782383270265)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88545722593474175)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88547420721494501)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88549241563499026)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88486486875959885)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88621716114225514)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88622311859230381)
,p_plugin_attribute_id=>wwv_flow_api.id(88621716114225514)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88622756757233209)
,p_plugin_attribute_id=>wwv_flow_api.id(88621716114225514)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88623850838253542)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88624459221262160)
,p_plugin_attribute_id=>wwv_flow_api.id(88623850838253542)
,p_display_sequence=>10
,p_display_value=>'comma'
,p_return_value=>','
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88624790200263378)
,p_plugin_attribute_id=>wwv_flow_api.id(88623850838253542)
,p_display_sequence=>20
,p_display_value=>'dot'
,p_return_value=>'.'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88625204691267590)
,p_plugin_attribute_id=>wwv_flow_api.id(88623850838253542)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88512234080720732)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88626310560282407)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88626959261286079)
,p_plugin_attribute_id=>wwv_flow_api.id(88626310560282407)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88627361297289420)
,p_plugin_attribute_id=>wwv_flow_api.id(88626310560282407)
,p_display_sequence=>20
,p_display_value=>'one'
,p_return_value=>'1'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88627717099292134)
,p_plugin_attribute_id=>wwv_flow_api.id(88626310560282407)
,p_display_sequence=>30
,p_display_value=>'two'
,p_return_value=>'2'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88628130552294734)
,p_plugin_attribute_id=>wwv_flow_api.id(88626310560282407)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88628480009300453)
,p_plugin_attribute_id=>wwv_flow_api.id(88626310560282407)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88628913802302323)
,p_plugin_attribute_id=>wwv_flow_api.id(88626310560282407)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88629329661305092)
,p_plugin_attribute_id=>wwv_flow_api.id(88626310560282407)
,p_display_sequence=>70
,p_display_value=>'six'
,p_return_value=>'6'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(88629691702307671)
,p_plugin_attribute_id=>wwv_flow_api.id(88626310560282407)
,p_display_sequence=>80
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88515796621776714)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88517588466806865)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88519454788860156)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88597410277721328)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(88601041377731364)
,p_plugin_id=>wwv_flow_api.id(88424782383270265)
,p_attribute_scope=>'COMPONENT'
