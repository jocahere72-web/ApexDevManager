...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'GENESYS')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_50000')
...
,p_authentication_id=>wwv_flow_api.id(95358892576545375)
,p_populate_roles=>'A'
...
,p_substitution_string_01=>'MESSAGE'
,p_substitution_value_01=>'prueba'
,p_last_updated_by=>'CNEGRETE'
,p_last_upd_yyyymmddhh24miss=>'20260310143257'
