...
@application/shared_components/files/01_taxation_smart_diagramas_ups_zip.sql
@application/shared_components/files/02_taxation_smart_caracterización_de_procesos_zip.sql
@application/shared_components/files/03_taxation_smart_modelo_datos_zip.sql
@application/shared_components/files/04_taxation_smart_scripts_db_zip.sql
@application/shared_components/files/05_taxation_smart_aplicacion_zip.sql
...
@application/shared_components/reports/report_queries/gd_g_tabla_retencion_documental.sql
@application/shared_components/reports/report_layouts/gd_g_tabla_retencion_documental.sql
