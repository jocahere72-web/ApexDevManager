...
,p_step_title=>unistr('Mensajer\00EDa y Alerta - Conectar')
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(76337884906582437)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'JDIAZ'
,p_last_upd_yyyymmddhh24miss=>'20190121112901'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(76456000480582540)
,p_plug_name=>unistr('Mensajer\00EDa y Alerta')
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(76377205493582469)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(76460767731582548)
,p_plug_name=>'Selector de Idioma'
,p_parent_plug_id=>wwv_flow_api.id(76456000480582540)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(76458871002582546)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(76456000480582540)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(76456464533582542)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(76456000480582540)
,p_prompt=>'usuario'
...
,p_field_template=>wwv_flow_api.id(76429067252582499)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(76456872565582544)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(76457940131582544)
...
,p_lov=>'.'||wwv_flow_api.id(76457160012582544)||'.'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(76429067252582499)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(76459683599582547)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(76459210075582547)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(76460473858582548)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(76460022728582547)
,p_process_sequence=>10
