...
,p_last_upd_yyyymmddhh24miss=>'20191018153244'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(178689845894901130)
...
,p_plug_template=>wwv_flow_api.id(76387115193582473)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6013678368689117)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6013730328689118)
,p_event_id=>wwv_flow_api.id(6013678368689117)
,p_event_result=>'TRUE'
