...
,p_step_template=>wwv_flow_api.id(71584287105187926)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(71702402679188029)
,p_plug_name=>unistr('Mensajer\00EDa y Alerta')
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(71623607692187958)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(71707169930188037)
,p_plug_name=>'Selector de Idioma'
,p_parent_plug_id=>wwv_flow_api.id(71702402679188029)
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(71705273201188035)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(71702402679188029)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71702866732188031)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(71702402679188029)
,p_prompt=>'usuario'
...
,p_field_template=>wwv_flow_api.id(71675469451187988)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71703274764188033)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71704342330188033)
...
,p_lov=>'.'||wwv_flow_api.id(71703562211188033)||'.'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(71675469451187988)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71706085798188036)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71705612274188036)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71706876057188037)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71706424927188036)
,p_process_sequence=>10
