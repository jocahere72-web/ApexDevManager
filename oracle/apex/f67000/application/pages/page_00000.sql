...
,p_last_upd_yyyymmddhh24miss=>'20200911183603'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(173936248093506619)
...
,p_plug_template=>wwv_flow_api.id(71633517392187962)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71742980477782171)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(173936248093506619)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(8721707172834924)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(8721850870834925)
,p_event_id=>wwv_flow_api.id(8721707172834924)
,p_event_result=>'TRUE'
