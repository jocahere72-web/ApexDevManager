...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(30518071788463320)
,p_lov_name=>'LV_RECURSO_A_I_R'
,p_lov_query=>'.'||wwv_flow_api.id(30518071788463320)||'.'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(30518482922463320)
,p_lov_disp_sequence=>1
,p_lov_disp_value=>unistr('Admisi\00F3n')
,p_lov_return_value=>'A'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(30518871859463320)
,p_lov_disp_sequence=>2
,p_lov_disp_value=>unistr('Inadmisi\00F3n')
,p_lov_return_value=>'I'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(30519263278463320)
