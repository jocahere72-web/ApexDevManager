...
,p_step_title=>unistr('Gesti\00F3n de Cobro - Conectar')
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(17317006324919349)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'ADMIN'
,p_last_upd_yyyymmddhh24miss=>'20180918155935'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17435257317919446)
,p_plug_name=>unistr('Gesti\00F3n de Cobro')
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(17356454419919375)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(17439923879919453)
,p_plug_name=>'Selector de Idioma'
,p_parent_plug_id=>wwv_flow_api.id(17435257317919446)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(17438045514919451)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(17435257317919446)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17435631447919447)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(17435257317919446)
,p_prompt=>'usuario'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17436040800919448)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(17437144998919449)
...
,p_lov=>'.'||wwv_flow_api.id(17436335678919448)||'.'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(17408286777919397)
,p_item_template_options=>'#DEFAULT#'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17438850703919451)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17438473094919451)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17439612374919452)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(17439289973919452)
,p_process_sequence=>10
