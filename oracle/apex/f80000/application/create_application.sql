...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'GestiÃ³n de Cobro')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'80000')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'961785370CCC040F9206BA1F399753CC6106926BEF3E0462D5E99578F6B1F40F'
...
,p_documentation_banner=>unistr('Aplicaci\00F3n creada desde el asistente de creaci\00F3n de aplicaciones 2018.09.14.')
,p_authentication=>'PLUGIN'
,p_authentication_id=>wwv_flow_api.id(17444562489934100)
,p_populate_roles=>'A'
...
,p_substitution_value_01=>unistr('Gesti\00F3n de Cobro')
