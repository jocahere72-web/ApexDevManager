...
,p_last_upd_yyyymmddhh24miss=>'20190805095121'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(85813441744820124)
,p_plug_name=>'Breadcrumb'
,p_region_template_options=>'#DEFAULT#:t-BreadcrumbRegion--useBreadcrumbTitle:t-Form--noPadding:t-Form--stretchInputs:t-Form--leftLabels:t-Form--labelsAbove:margin-top-none:margin-bottom-none:margin-left-none:margin-right-none'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(88545999208834670)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(85813591439820125)
,p_name=>'P0_BREADCRUMB'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(85813441744820124)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6014826360689129)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6014954970689130)
,p_event_id=>wwv_flow_api.id(6014826360689129)
,p_event_result=>'TRUE'
