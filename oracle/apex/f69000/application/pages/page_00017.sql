...
,p_name=>'Cambio de Uso - Novedad Predial'
,p_step_title=>'Cambio de Uso - Novedad Predial'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(359213962496261286)
,p_plug_name=>'Registro Cambio de Uso'
...
,p_plug_read_only_when=>'P17_ID_NVDAD_PRDIO'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(360304822590654086)
...
,p_plug_display_when_condition=>'P17_ID_NVDAD_PRDIO'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(360505874185536786)
...
'                                                             , p_id_impsto         => :P17_ID_IMPSTO',
'                                                             , p_id_impsto_sbmpsto => :P17_ID_IMPSTO_SBMPSTO',
'                                                             , p_fecha             => :P17_FCHA_INCIO_APLCCION ))'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P17_FCHA_INCIO_APLCCION'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(360505934123536787)
...
,p_owner=>'NARDILA'
,p_internal_uid=>360505934123536787
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(123718550849616974)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(123718954244616977)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(123719306489616977)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(360512310971548026)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1237197'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>20
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(123720191582616981)
,p_report_id=>wwv_flow_api.id(360512310971548026)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(458972257130847146)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(459363489002624783)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(88536556043834667)
,p_plug_display_sequence=>20
...
'  <b>1.</b> El registro de novedad de cambio de uso suelo.<br/><br/>',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(123717849394616962)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(360304822590654086)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123720843880616983)
,p_name=>'P17_ID_IMPSTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(359213962496261286)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123721249637616987)
,p_name=>'P17_ID_IMPSTO_SBMPSTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(359213962496261286)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123721653578616988)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123722048002616988)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123722493734616988)
,p_name=>'P17_ID_ENTDAD_NVDAD'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(359213962496261286)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123723337875616991)
,p_name=>'P17_NMRO_DCMTO_SPRTE'
,p_is_required=>true
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(359213962496261286)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123724283666616995)
,p_name=>'P17_FCHA_DCMNTO_SPRTE'
,p_is_required=>true
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(359213962496261286)
,p_prompt=>'Fecha Acto'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123725127980616996)
,p_name=>'P17_FCHA_INCIO_APLCCION'
,p_is_required=>true
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(359213962496261286)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123726022716616997)
,p_name=>'P17_CDGO_ESTRTO'
,p_is_required=>true
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(359213962496261286)
,p_prompt=>'Nuevo Uso Suelo'
,p_display_as=>'PLUGIN_BE.CTB.SELECT2'
,p_lov=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select cdgo_prdio_uso_slo || '' - '' || dscrpcion',
'     , id_prdio_uso_slo',
'  from df_c_predios_uso_suelo',
' where cdgo_clnte = 6',
'   and cdgo_prdio_uso_slo <> ''99'''))
,p_lov_display_null=>'YES'
,p_begin_on_new_line=>'N'
,p_field_template=>wwv_flow_api.id(88588311049834706)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'YES'
,p_help_text=>'Uso Suelo del predio'
,p_attribute_01=>'SINGLE'
,p_attribute_08=>'CIC'
,p_attribute_10=>'300'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123726997550616997)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(123727867274616998)
,p_name=>'P17_ID_NVDAD_PRDIO'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(359213962496261286)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(123729642748617018)
,p_name=>'Al Cambiar Fecha Inicio Aplicacion'
,p_event_sequence=>10
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P17_FCHA_INCIO_APLCCION'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(123730125549617020)
,p_event_id=>wwv_flow_api.id(123729642748617018)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(360505874185536786)
,p_stop_execution_on_error=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(123729266683617018)
...
'          , b.cdgo_estrto_nvo',
'          , a.obsrvcion',
'       into :P17_ID_NVDAD_PRDIO',
'          , :P17_ID_ENTDAD_NVDAD',
'          , :P17_NMRO_DCMTO_SPRTE',
'          , :P17_FCHA_DCMNTO_SPRTE',
'          , :P17_FCHA_INCIO_APLCCION',
'          , :P17_CDGO_ESTRTO',
'          , :P17_OBSRVCION',
...
'          :P17_ID_NVDAD_PRDIO := null;',
'end;'))
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(123728862446617017)
,p_process_sequence=>10
...
'	apex_json.write( ''id_sjto_impsto''  , :P17_ID_SJTO_IMPSTO );',
'	apex_json.write( ''cdgo_estrto_nvo'' , :P17_CDGO_ESTRTO );  ',
'	apex_json.close_all;',
'	',
...
'                                                  , p_id_impsto	            => :P17_ID_IMPSTO',
'                                                  , p_id_impsto_sbmpsto	    => :P17_ID_IMPSTO_SBMPSTO',
'                                                  , p_id_entdad_nvdad	    => :P17_ID_ENTDAD_NVDAD',
'                                                  , p_id_acto_tpo           => :P17_ID_ACTO_TPO',
'                                                  , p_nmro_dcmto_sprte      => :P17_NMRO_DCMTO_SPRTE',
'                                                  , p_fcha_dcmnto_sprte     => :P17_FCHA_DCMNTO_SPRTE',
'                                                  , p_fcha_incio_aplccion   => :P17_FCHA_INCIO_APLCCION',
'                                                  , p_obsrvcion			    => :P17_OBSRVCION',
'                                                  , p_id_instncia_fljo	 	=> :F_ID_INSTNCIA_FLJO',
'                                                  , p_json                  => apex_json.get_clob_output',
'                                                  , o_cdgo_rspsta           => o_cdgo_rspsta',
'                                                  , o_mnsje_rspsta          => o_mnsje_rspsta',
'                                                  , o_id_nvdad_prdio        => :P17_ID_NVDAD_PRDIO );',
'    ',
...
,p_process_error_message=>'#SQLERRM_TEXT#'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(123717849394616962)
