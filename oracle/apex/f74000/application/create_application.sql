...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'FiscalizaciÃ³n')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'74000')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'B9AA0D48ED0B11C8E66D7C21640A330B0B1AA7B442E385D638563B03CC1BF8CD'
...
,p_documentation_banner=>unistr('Aplicaci\00F3n creada desde el asistente de creaci\00F3n de aplicaciones 2019.11.07.')
,p_authentication=>'PLUGIN'
,p_authentication_id=>wwv_flow_api.id(36130492720895887)
...
,p_last_upd_yyyymmddhh24miss=>'20260225140441'
