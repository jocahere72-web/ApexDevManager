...
,p_name=>'Requerimiento Especial'
,p_step_title=>'Requerimiento Especial'
...
,p_last_upd_yyyymmddhh24miss=>'20240711182733'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(215199679132001205)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(215917246727397455)
...
,p_attribute_03=>'P47_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P47_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(335759635399011705)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(352936815905173184)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(71996030251326852)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(335759635399011705)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14062372571039577)
...
'where a.id_fsclzcion_expdnte = :P47_ID_FSCLZCION_EXPDNTE AND',
'a.indcdor_mgrdo = ''S'';'))
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14063049284077161)
,p_name=>'P47_FNLZCION'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(215917246727397455)
,p_display_as=>'NATIVE_HIDDEN'
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71987784482300013)
,p_name=>'P47_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(215917246727397455)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71988154986300015)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71988525247300016)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71988923074300016)
,p_name=>'P47_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(215917246727397455)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(72121669225491302)
,p_name=>'P47_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(215917246727397455)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71986620326297309)
...
'        when others then',
'            :P47_ID_CNDDTO    := null;',
'            :P47_ID_SJTO_IMPSTO := null;',
'            :P47_ID_IMPSTO := null;',
'            :P47_ID_FSCLZCION_EXPDNTE := null;',
'    end;',
'    ',
'end;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(72121506213491301)
,p_process_sequence=>10
...
'                                     p_id_fsclzcion_expdnte_acto   => :P47_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P47_ID_CNDDTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14062622405057616)
...
'begin',
'',
'     APEX_UTIL.SET_SESSION_STATE(''P47_FNLZCION'',''S'');',
'    ',
...
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(14062372571039577)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31554846532798641)
...
'',
'begin',
'    :P47_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_acto(p_cdgo_clnte                  => :F_CDGO_CLNTE,',
'                                         p_id_usrio                    => :F_ID_USRIO,  ',
'                                         p_id_fsclzcion_expdnte_acto   => :P47_ID_FSCLZCION_EXPDNTE_ACTO,',
