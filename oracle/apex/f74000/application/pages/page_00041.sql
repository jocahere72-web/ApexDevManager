...
,p_name=>unistr('Certificaci\00F3n Ejecutoria Sancionatorio')
,p_step_title=>unistr('Certificaci\00F3n Ejecutoria Sancionatorio')
...
,p_last_upd_yyyymmddhh24miss=>'20240711095628'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(69482795714874202)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(270891039319274495)
...
,p_attribute_03=>'P41_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P41_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(358271742130812775)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
'',
'<p align="justify">',
unistr('<i>Funcionalidad que permite generar, modificar, visualizar y confirmar los actos parametrizados en la etapa Certificaci\00F3n Ejecutoria que no requieren confirmaci\00F3n por el supervisor.</i>'),
'</p>',
'',
'',
'<p align="justify">',
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(462680446275866967)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(71145585511880768)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(462680446275866967)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71128250926591773)
,p_name=>'P41_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(270891039319274495)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71128541811591834)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71128927118591835)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71129381800591837)
,p_name=>'P41_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(270891039319274495)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71129734490591840)
,p_name=>'P41_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(270891039319274495)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71140029999850486)
...
'    into   :P41_ID_SJTO_IMPSTO,',
'           :P41_ID_CNDDTO,',
'           :P41_ID_IMPSTO,',
'           :P41_ID_FSCLZCION_EXPDNTE',
...
'        :P41_ID_CNDDTO := null;',
'        :P41_ID_FSCLZCION_EXPDNTE := null;',
'        :P41_ID_IMPSTO := null;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71150378618917652)
...
'                                     p_id_fsclzcion_expdnte_acto   => :P41_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P41_ID_CNDDTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30895753495411529)
...
'',
'begin',
'    :P41_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_acto(p_cdgo_clnte                  => :F_CDGO_CLNTE,',
'                                         p_id_usrio                    => :F_ID_USRIO,  ',
'                                         p_id_fsclzcion_expdnte_acto   => :P41_ID_FSCLZCION_EXPDNTE_ACTO,',
