...
,p_step_title=>unistr('Fiscalizaci\00F3n - Conectar')
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(36462320271968630)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'LTORRES'
,p_last_upd_yyyymmddhh24miss=>'20191108090416'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(36094184247528485)
,p_plug_name=>unistr('Fiscalizaci\00F3n')
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(36502540889968650)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(36098841566528541)
,p_plug_name=>'Selector de Idioma'
,p_parent_plug_id=>wwv_flow_api.id(36094184247528485)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(36096987858528528)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(36094184247528485)
,p_button_name=>'LOGIN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36094552399528496)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(36094184247528485)
,p_prompt=>'usuario'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36094909546528502)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(36096021683528520)
...
,p_lov=>'.'||wwv_flow_api.id(36095275997528507)||'.'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(36554765804968673)
,p_item_template_options=>'#DEFAULT#'
,p_is_persistent=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(36097730158528536)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(36097338060528531)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(36098535270528541)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(36098147264528536)
,p_process_sequence=>10
