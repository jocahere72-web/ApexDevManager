...
,p_name=>unistr('Resoluci\00F3n Por No Declarar')
,p_step_title=>unistr('Resoluci\00F3n Por No Declarar')
...
,p_last_upd_yyyymmddhh24miss=>'20241021235551'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(58510096969731501)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(61166531951653801)
...
,p_attribute_03=>'P16_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P16_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(252719494695611384)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(269893244254761129)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
,p_plug_display_sequence=>20
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(60946545355236822)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(252719494695611384)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(61196661866114296)
...
,p_button_position=>'BELOW_BOX'
,p_button_redirect_url=>'f?p=&APP_ID.:31:&SESSION.::&DEBUG.:RP,31:P31_ID_FSCLZCION_EXPDNTE,P31_CDGO_ACTO_TPO,P31_ID_CNDDTO,P31_PGNA,P31_ID_SJTO_IMPSTO,P31_ID_PRGRMA,P31_ID_SBPRGRMA:&P16_ID_FSCLZCION_EXPDNTE.,RXD,&P16_ID_CNDDTO.,&APP_PAGE_ID.,&P16_ID_SJTO_IMPSTO.,&P16_ID_PRGRMA.,&P16_ID_SBPRGRMA.'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30941449409369514)
,p_name=>'P16_ID_PRGRMA'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(61166531951653801)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(30941598642369515)
,p_name=>'P16_ID_SBPRGRMA'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(61166531951653801)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(61166693077653802)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(61166785676653803)
,p_name=>'P16_ID_CNDDTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(61166531951653801)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(61197796293118608)
,p_name=>'P16_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(61166531951653801)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(61545461769082303)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(61711411576298301)
,p_name=>'P16_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(61166531951653801)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68427781424773002)
,p_name=>'P16_ID_ACTO'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(61166531951653801)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(62481198530177701)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(62481291461177702)
,p_event_id=>wwv_flow_api.id(62481198530177701)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(58510178684731502)
...
'    when others then',
'        :P16_ID_CNDDTO    := null;',
'        :P16_ID_SJTO_IMPSTO := null;',
'        :P16_ID_FSCLZCION_EXPDNTE := null;',
'        :P16_ID_PRGRMA := null;',
'        :P16_ID_SBPRGRMA := null;',
'',
'',
'end;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(68386474221104702)
,p_process_sequence=>10
...
'                                     p_id_fsclzcion_expdnte_acto   => :P16_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P16_ID_CNDDTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(73872261751605901)
,p_process_sequence=>10
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30939160389313052)
...
'',
'begin',
'    :P16_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_liquidacion( p_cdgo_clnte		          =>    :F_CDGO_CLNTE,',
'                                                 p_id_usrio                   =>    :F_ID_USRIO,',
'                                                 p_id_fsclzcion_expdnte       =>    :P16_ID_FSCLZCION_EXPDNTE,',
'                                                 p_id_fsclzcion_expdnte_acto  =>    :P16_ID_FSCLZCION_EXPDNTE_ACTO,',
