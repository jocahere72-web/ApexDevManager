...
,p_name=>'Certificacion de Ejecutoria'
,p_step_title=>'Certificacion de Ejecutoria'
...
,p_last_upd_yyyymmddhh24miss=>'20240711095517'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(62633091473845101)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(62633181063845102)
...
,p_attribute_03=>'P33_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P33_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(315367517163549627)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(332542393714700035)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(62648755197938251)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(315367517163549627)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(62633308209845104)
,p_name=>'P33_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(62633181063845102)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(62633478593845105)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(62633720583845108)
,p_name=>'P33_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(62633181063845102)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(62633843407845109)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(67675705220913601)
,p_name=>'P33_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(62633181063845102)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(62633231781845103)
...
'        :P33_ID_FSCLZCION_EXPDNTE := null;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(68386877587104706)
,p_process_sequence=>10
...
'                                     p_id_fsclzcion_expdnte_acto   => :P33_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P33_ID_CNDDTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30993684544320589)
...
'',
'begin',
'    :P33_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_acto(p_cdgo_clnte                  => :F_CDGO_CLNTE,',
'                                         p_id_usrio                    => :F_ID_USRIO,  ',
'                                         p_id_fsclzcion_expdnte_acto   => :P33_ID_FSCLZCION_EXPDNTE_ACTO,',
