...
,p_name=>unistr('Certificaci\00F3n Ejecutoria Inexacto')
,p_step_title=>unistr('Certificaci\00F3n Ejecutoria')
...
,p_last_upd_yyyymmddhh24miss=>'20240711095900'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(360670701838331243)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(361389004343732381)
...
,p_attribute_03=>'P50_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P50_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(481236167262352505)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(498414664905516099)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(73300811322024661)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(481236167262352505)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73298376591020571)
,p_name=>'P50_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(361389004343732381)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73298698487020683)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73299086043020689)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73299445120020690)
,p_name=>'P50_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(361389004343732381)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73299845442020690)
,p_name=>'P50_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(361389004343732381)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(73297487968015901)
...
'        when others then',
'            :P50_ID_CNDDTO    := null;',
'            :P50_ID_SJTO_IMPSTO := null;',
'            :P50_ID_IMPSTO := null;',
'            :P50_ID_FSCLZCION_EXPDNTE := null;',
'    end;',
'    ',
'end;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(73300230474021943)
...
'                                     p_id_fsclzcion_expdnte_acto   => :P50_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P50_ID_CNDDTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31599247808093002)
...
'',
'begin',
'    :P50_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_acto(p_cdgo_clnte                  => :F_CDGO_CLNTE,',
'                                         p_id_usrio                    => :F_ID_USRIO,  ',
'                                         p_id_fsclzcion_expdnte_acto   => :P50_ID_FSCLZCION_EXPDNTE_ACTO,',
