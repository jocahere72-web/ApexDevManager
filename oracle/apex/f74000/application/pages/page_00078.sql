...
,p_name=>unistr('Certificaci\00F3n De Ejecutoria Estampillas')
,p_step_title=>unistr('Certificaci\00F3n De Ejecutoria Liq')
...
,p_last_upd_yyyymmddhh24miss=>'20240711101204'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86458118794411404)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86458208384411405)
...
,p_attribute_03=>'P78_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P78_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(339192544484115930)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(356367421035266338)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23828168598566435)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(339192544484115930)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23825989542566361)
,p_name=>'P78_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(86458208384411405)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23826211724566406)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23826689892566406)
,p_name=>'P78_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(86458208384411405)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23827020476566406)
,p_name=>'P78_ID_IMPSTO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(86458208384411405)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23827422471566406)
,p_name=>'P78_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(86458208384411405)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23828884689566495)
...
'    when others then',
'        :P78_ID_CNDDTO    := null;',
'        :P78_ID_SJTO_IMPSTO := null;',
'        :P78_ID_FSCLZCION_EXPDNTE := null;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23829135610566500)
,p_process_sequence=>10
...
'',
'begin',
'     pkg_fi_fiscalizacion.prc_ac_estado_liquidacion(p_cdgo_clnte             =>  :F_CDGO_CLNTE,',
'                                                    p_id_fsclzcion_expdnte   =>  :P78_ID_FSCLZCION_EXPDNTE,                                                  ',
...
'                                     p_id_fsclzcion_expdnte_acto   => :P78_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P78_ID_CNDDTO,',
'                                     o_cdgo_rspsta                 => v_cdgo_rspsta,',
'                                     o_mnsje_rspsta                => v_mnsje_rspsta);',
'                                                      ',
'    if v_cdgo_rspsta > 0 then',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31599574844093581)
...
'',
'begin',
'    :P78_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;',
'    begin',
'        pkg_fi_fiscalizacion.prc_ac_estado_liquidacion( p_cdgo_clnte             =>  :F_CDGO_CLNTE,',
'                                                        p_id_fsclzcion_expdnte   =>  :P78_ID_FSCLZCION_EXPDNTE,                                                  ',
'                                                        o_cdgo_rspsta            =>  v_cdgo_rspsta,',
