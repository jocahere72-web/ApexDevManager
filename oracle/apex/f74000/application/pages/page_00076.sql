...
,p_name=>unistr('Determinaci\00F3n Oficial')
,p_step_title=>unistr('Determinaci\00F3n Oficial')
...
,p_last_upd_yyyymmddhh24miss=>'20240711103503'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(78310501891153259)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(81758432313390659)
...
,p_attribute_03=>'P76_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P76_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(81908799385031559)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(215403988771856023)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(232579348836012557)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(23634552071481560)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(215403988771856023)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23631936900481535)
,p_name=>'P76_ID_SJTO_IMPSTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(81908799385031559)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23632206207481556)
,p_name=>'P76_ID_CNDDTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(81908799385031559)
,p_prompt=>'Id Cnddto'
,p_display_as=>'NATIVE_TEXT_FIELD'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23632662788481556)
,p_name=>'P76_ID_DCLRCION_VGNCIA_FRMLRIO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(81908799385031559)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23633067591481556)
,p_name=>'P76_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(81908799385031559)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23633404571481557)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(23633854476481557)
,p_name=>'P76_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(81908799385031559)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23635200661481594)
...
'        when others then',
'            :P76_ID_CNDDTO    := null;',
'            :P76_ID_SJTO_IMPSTO := null;',
'            :P76_ID_IMPSTO := null;',
'            :P76_ID_FSCLZCION_EXPDNTE := null;',
'    end;',
'    ',
'end;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(23635652764481600)
,p_process_sequence=>10
...
'                                     p_id_fsclzcion_expdnte_acto   => :P76_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P76_ID_CNDDTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31606808033311996)
...
'begin',
'    :P76_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;',
'    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_acto(p_cdgo_clnte                  => :F_CDGO_CLNTE,',
'                                         p_id_usrio                    => :F_ID_USRIO,  ',
