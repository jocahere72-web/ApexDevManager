...
,p_name=>'Auto Archivo Liquidados'
,p_step_title=>'Auto Archivo Liquidados'
...
,p_last_upd_yyyymmddhh24miss=>'20240711094331'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(312856215321548834)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(313574035559946462)
...
,p_attribute_03=>'P85_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P85_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(433418361486562032)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(450596279342725271)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(25593989809222611)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(433418361486562032)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25591658510222600)
,p_name=>'P85_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(313574035559946462)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25592018392222608)
,p_name=>'P85_ID_SJTO_IMPSTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(313574035559946462)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25592488351222608)
,p_name=>'P85_ID_IMPSTO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(313574035559946462)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25592827350222608)
,p_name=>'P85_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(313574035559946462)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(25593225279222609)
,p_name=>'P85_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(313574035559946462)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(25594605640222657)
...
'        when others then',
'            :P85_ID_CNDDTO    := null;',
'            :P85_ID_SJTO_IMPSTO := null;',
'            :P85_ID_IMPSTO := null;',
'            :P85_ID_FSCLZCION_EXPDNTE := null;',
'    end;',
'    ',
'end;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(25595042289222660)
...
'                                     p_id_fsclzcion_expdnte_acto   => :P85_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P85_ID_CNDDTO,',
'                                     o_cdgo_rspsta                 => v_cdgo_rspsta,',
'                                     o_mnsje_rspsta                => v_mnsje_rspsta);',
'                                     ',
'   ',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31594889886910933)
...
'',
'begin',
'    :P85_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;',
'    begin',
'         for c_cnddto_vgncia in (',
'            select a.id_dclrcion, a.id_cnddto_vgncia',
'            from fi_g_candidatos_vigencia a',
