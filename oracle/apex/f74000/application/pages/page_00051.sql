...
,p_name=>unistr('Finalizaci\00F3n Inexacto')
,p_step_title=>unistr('Finalizaci\00F3n Inexacto')
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(360549180245784357)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(361267320439183206)
...
,p_attribute_03=>'P51_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P51_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(481113446198800844)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(498292058557965330)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(73286247889461388)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(481113446198800844)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73284447356459279)
,p_name=>'P51_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(361267320439183206)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73284770226459370)
,p_name=>'P51_ID_SJTO_IMPSTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(361267320439183206)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73285162485459370)
,p_name=>'P51_ID_IMPSTO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(361267320439183206)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73285545786459370)
,p_name=>'P51_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(361267320439183206)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(73286900266465285)
...
'        when others then',
'            :P51_ID_CNDDTO    := null;',
'            :P51_ID_SJTO_IMPSTO := null;',
'            :P51_ID_IMPSTO := null;',
'            :P51_ID_FSCLZCION_EXPDNTE := null;',
'    end;',
'    ',
'end;'))
