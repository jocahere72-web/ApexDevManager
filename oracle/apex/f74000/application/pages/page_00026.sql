...
,p_name=>'Auto de Apertura Sancionatorio'
,p_step_title=>'Auto de Apertura Sancionatorio'
...
,p_last_upd_yyyymmddhh24miss=>'20240711092105'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(60664895952731201)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(60733934040544901)
...
,p_attribute_03=>'P26_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P26_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(217546058884282152)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
'',
'<p align="justify">',
'<i>Funcionalidad que permite generar, modificar, visualizar y confirmar los actos parametrizados en la etapa Auto de Apertura.</i>',
'</p>',
'',
'',
'<p align="justify">',
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(252501772699845436)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(60728865493470880)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(252501772699845436)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60734091552544902)
,p_name=>'P26_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(60733934040544901)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60734136016544903)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60734252958544904)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(60855889232665201)
,p_name=>'P26_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(60733934040544901)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(69567492804588802)
,p_name=>'P26_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(60733934040544901)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(60703893765114401)
...
'    into   :P26_ID_SJTO_IMPSTO,',
'           :P26_ID_CNDDTO,',
'           :P26_ID_IMPSTO,',
'           :P26_ID_FSCLZCION_EXPDNTE',
...
'exception',
'    when others then',
'        :P26_ID_SJTO_IMPSTO := null;',
'        :P26_ID_CNDDTO := null;',
'        :P26_ID_FSCLZCION_EXPDNTE := null;',
'        :P26_ID_IMPSTO := null;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(69565913191579213)
...
'                                     p_id_fsclzcion_expdnte_acto   => :P26_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P26_ID_CNDDTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(30920093411475448)
...
'',
'begin',
'    :P26_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;',
'    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_acto(p_cdgo_clnte                  => :F_CDGO_CLNTE,',
'                                         p_id_usrio                    => :F_ID_USRIO,  ',
