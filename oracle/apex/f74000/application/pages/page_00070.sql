...
,p_name=>'Pliego de Cargos'
,p_step_title=>'Pliego de Cargos'
...
,p_last_upd_yyyymmddhh24miss=>'20241021235451'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(277822719265610684)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(277892090130432251)
...
,p_attribute_03=>'P70_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P70_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(365249363027674178)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(469661799181734359)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(147706148321391041)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(469661799181734359)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(147703589019391028)
,p_name=>'P70_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(277892090130432251)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(147703933362391032)
,p_name=>'P70_ID_SJTO_IMPSTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(277892090130432251)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(147704375055391033)
,p_name=>'P70_ID_IMPSTO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(277892090130432251)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(147704719118391033)
,p_name=>'P70_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(277892090130432251)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(147705126634391034)
,p_name=>'P70_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(277892090130432251)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(147706847098391052)
...
'    into   :P70_ID_SJTO_IMPSTO,',
'           :P70_ID_CNDDTO,',
'           :P70_ID_IMPSTO,',
'           :P70_ID_FSCLZCION_EXPDNTE',
...
'exception',
'    when others then',
'        :P70_ID_SJTO_IMPSTO := null;',
'        :P70_ID_CNDDTO := null;',
'        :P70_ID_FSCLZCION_EXPDNTE := null;',
'        :P70_ID_IMPSTO := null;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(147707261513391052)
...
'                                            p_id_fsclzcion_expdnte_acto   =>    :P70_ID_FSCLZCION_EXPDNTE_ACTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31605080789233682)
...
'',
'begin',
'    :P70_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_liquidacion( p_cdgo_clnte		          =>    :F_CDGO_CLNTE,',
'                                                 p_id_usrio                   =>    :F_ID_USRIO,',
'                                                 p_id_fsclzcion_expdnte       =>    :P70_ID_FSCLZCION_EXPDNTE,',
'                                                 p_id_fsclzcion_expdnte_acto  =>    :P70_ID_FSCLZCION_EXPDNTE_ACTO,',
