...
,p_name=>unistr('Certificaci\00F3n de Ejecutoria Liquidaci\00F3n Aforo')
,p_step_title=>unistr('Certificaci\00F3n de Ejecutoria Liquidaci\00F3n Aforo')
...
,p_last_upd_yyyymmddhh24miss=>'20240711101429'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(68089200301300001)
...
,p_attribute_03=>'P37_ID_SJTO_IMPSTO'
,p_attribute_04=>'F_ID_FNCNRIO'
,p_attribute_05=>'P37_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(68089385905300002)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(455641817434550741)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(472817473517703090)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
'',
'<p align="justify">',
unistr('<i>Funcionalidad que permite generar, modificar, visualizar y confirmar los actos parametrizados en la etapa Certificaci\00F3n Ejecutoria.</i>'),
'</p>',
'',
'',
'<p align="justify">',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(140274657743001115)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(455641817434550741)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68089490877300003)
,p_name=>'P37_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(68089200301300001)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68089576638300004)
,p_name=>'P37_ID_SJTO_IMPSTO'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(68089200301300001)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68089636986300005)
,p_name=>'P37_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(68089200301300001)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68089711822300006)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68089836370300007)
,p_name=>'P37_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(68089200301300001)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(68090282261300011)
...
'    when others then',
'        :P37_ID_CNDDTO    := null;',
'        :P37_ID_SJTO_IMPSTO := null;',
'        :P37_ID_FSCLZCION_EXPDNTE := null;',
'end;'))
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(68386632864104704)
,p_process_sequence=>10
...
'                                     p_id_fsclzcion_expdnte_acto   => :P37_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P37_ID_CNDDTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31063115138135214)
...
'',
'begin',
'    :P37_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_acto(p_cdgo_clnte                  => :F_CDGO_CLNTE,',
'                                         p_id_usrio                    => :F_ID_USRIO,  ',
'                                         p_id_fsclzcion_expdnte_acto   => :P37_ID_FSCLZCION_EXPDNTE_ACTO,',
