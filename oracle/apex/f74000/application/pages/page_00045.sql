...
,p_name=>'Auto Apertura Inexacto'
,p_step_title=>'Auto Apertura Inexacto'
...
,p_last_upd_yyyymmddhh24miss=>'20240711093943'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(71231777272448301)
,p_plug_name=>'Flujo'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(71948764924841801)
...
,p_attribute_05=>'P45_ID_FSCLZCION_EXPDNTE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(263762654519681512)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(280938715860839246)
,p_plug_name=>'Ayuda'
,p_region_template_options=>'#DEFAULT#:t-Region--removeHeader:t-Region--scrollBody'
,p_plug_template=>wwv_flow_api.id(36503027129968651)
...
'',
'<p align="justify">',
unistr('<i>Funcionalidad que permite generar, modificar, visualizar y confirmar los actos parametrizados en la etapa Auto Apertura que no requieren confirmaci\00F3n por el supervisor.</i>'),
'</p>',
'',
'',
'<p align="justify">',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(71989690381306948)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(263762654519681512)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(14955403313877532)
,p_name=>'P45_ID_FSCLZCION_EXPDNTE_ACTO'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(71948764924841801)
,p_display_as=>'NATIVE_HIDDEN'
,p_item_template_options=>'#DEFAULT#'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71948807601841802)
,p_name=>'P45_ID_CNDDTO'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(71948764924841801)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71948977081841803)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71949051949841804)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(71949167614841805)
,p_name=>'P45_ID_FSCLZCION_EXPDNTE'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(71948764924841801)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(71949228954841806)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>unistr('Informaci\00F3n')
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(14955024716867558)
...
'                                     p_id_fsclzcion_expdnte_acto   => :P45_ID_FSCLZCION_EXPDNTE_ACTO,',
'                                     p_id_cnddto                   => :P45_ID_CNDDTO,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(31493702675720113)
...
'',
'begin',
'    :P45_ID_FSCLZCION_EXPDNTE_ACTO := v_id_expdnte_acto;    ',
'    begin',
'        pkg_fi_fiscalizacion.prc_rg_acto(p_cdgo_clnte                  => :F_CDGO_CLNTE,',
'                                         p_id_usrio                    => :F_ID_USRIO,  ',
'                                         p_id_fsclzcion_expdnte_acto   => :P45_ID_FSCLZCION_EXPDNTE_ACTO,',
