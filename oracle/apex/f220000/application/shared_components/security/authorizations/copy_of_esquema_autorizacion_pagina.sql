prompt --application/shared_components/security/authorizations/copy_of_esquema_autorizacion_pagina
begin
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(3698647335745519)
,p_name=>'Copy of Esquema_autorizacion_pagina'
