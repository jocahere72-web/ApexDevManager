...
,p_last_upd_yyyymmddhh24miss=>'20191018110903'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(177796137702414574)
...
,p_plug_template=>wwv_flow_api.id(177323026447050602)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(177796158427414575)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(6015282486689133)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(6015303457689134)
,p_event_id=>wwv_flow_api.id(6015282486689133)
,p_event_result=>'TRUE'
