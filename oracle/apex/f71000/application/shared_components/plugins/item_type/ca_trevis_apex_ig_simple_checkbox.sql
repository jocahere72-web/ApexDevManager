...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(50330040753076795381)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80831478158997237)
,p_plugin_id=>wwv_flow_api.id(50330040753076795381)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(80831873024997237)
,p_plugin_id=>wwv_flow_api.id(50330040753076795381)
,p_attribute_scope=>'COMPONENT'
