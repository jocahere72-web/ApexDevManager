...
,p_step_title=>'Consulta General - Conectar'
,p_warn_on_unsaved_changes=>'N'
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'OFF'
,p_step_template=>wwv_flow_api.id(52088878512074783)
,p_page_template_options=>'#DEFAULT#'
,p_page_is_public_y_n=>'Y'
,p_last_updated_by=>'JCUAO'
,p_last_upd_yyyymmddhh24miss=>'20191010160027'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(22512560405661079)
,p_plug_name=>'Consulta General'
,p_icon_css_classes=>'app-icon'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(52129086978074801)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(22517169270661163)
,p_plug_name=>'Selector de Idioma'
,p_parent_plug_id=>wwv_flow_api.id(22512560405661079)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(22515242451661149)
,p_button_sequence=>40
,p_button_plug_id=>wwv_flow_api.id(22512560405661079)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(52181656467074832)
,p_button_is_hot=>'Y'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22512871009661094)
,p_name=>'P9999_USERNAME'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(22512560405661079)
,p_prompt=>'usuario'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22513270948661111)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(22514333862661143)
...
,p_lov=>'.'||wwv_flow_api.id(22513536875661111)||'.'
,p_label_alignment=>'RIGHT'
,p_field_template=>wwv_flow_api.id(52180871570074831)
,p_item_template_options=>'#DEFAULT#'
,p_is_persistent=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(22516060446661161)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(22515699903661150)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(22516895495661163)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(22516433278661161)
,p_process_sequence=>10
