...
,p_last_upd_yyyymmddhh24miss=>'20201221114014'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(170775087059904617)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(239520336406334484)
,p_plug_name=>unistr('Resoluci\00F3n Tipo II')
,p_parent_plug_id=>wwv_flow_api.id(170775087059904617)
...
'                                    and b.id_impsto         = :P32_ID_IMPSTO ',
'                                    and b.id_impsto_sbmpsto = :P32_ID_IMPSTO_SBMPSTO',
'                             )',
'      and a.rslcion       = :P32_RSLCION',
'      and a.rdccion       = :P32_RDCCION',
'      and a.cncla_inscrbe = ''I''',
'      and a.rfrncia_igac  = :P32_RFRNCIA_IGAC',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(239520372809334485)
...
,p_owner=>'NARDILA'
,p_internal_uid=>239520372809334485
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102003237010915638)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102003608737915649)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102004078268915649)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(239560727003959977)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1020044'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'RFRNCIA_IGAC_FRMTDA:RFRNCIA_IGAC:MTRCLA_INMBLRIA'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(239529783501380094)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(239529828487380095)
,p_max_row_count=>'1000000'
...
,p_download_formats=>'CSV:HTML:EMAIL:XLS:PDF:RTF'
,p_owner=>'NARDILA'
,p_internal_uid=>239529828487380095
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102005106142915661)
,p_db_column_name=>'RFRNCIA_IGAC_FRMTDA'
,p_display_order=>10
,p_column_identifier=>'A'
,p_column_label=>'Referencia'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102005570937915661)
,p_db_column_name=>'RFRNCIA_IGAC'
,p_display_order=>20
,p_column_identifier=>'B'
,p_column_label=>'Referencia'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102005928717915661)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102006342640915661)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102006767418915662)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102007107215915662)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(102007590326915678)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(239581537047042312)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1020079'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'RFRNCIA_IGAC_FRMTDA:RFRNCIA_IGAC:NMRO_ORDEN:TTAL_RGSTRO:AVLUO_CTSTRAL:VGNCIA:DECRTOS'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102000961151915624)
,p_name=>'P32_RFRNCIA_IGAC'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(170775087059904617)
,p_display_as=>'NATIVE_HIDDEN'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102001331969915632)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102001792712915632)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102002124644915632)
,p_name=>'P32_RSLCION'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(170775087059904617)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(102002531286915632)
,p_name=>'P32_RDCCION'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(170775087059904617)
,p_display_as=>'NATIVE_HIDDEN'
