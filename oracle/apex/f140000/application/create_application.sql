...
,p_name=>nvl(wwv_flow_application_install.get_application_name,'Consulta General')
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'F_140000')
,p_page_view_logging=>'YES'
,p_page_protection_enabled_y_n=>'Y'
,p_checksum_salt=>'0655F930110D63708A71AAAE6A6AC3B12AAE2352CFAAA3D9EC0C4D40314BB5C6'
...
,p_documentation_banner=>unistr('Aplicaci\00F3n creada desde el asistente de creaci\00F3n de aplicaciones 2019.10.10.')
,p_authentication=>'PLUGIN'
,p_authentication_id=>wwv_flow_api.id(22528639239756690)
